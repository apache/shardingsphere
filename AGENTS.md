...
Before running Maven, E2E, Proxy startup, database clients, IDE/MCP run configurations, or any command likely to output more than 100 lines,
I MUST ensure `.codex/context/token-efficiency.md` is available in the active context.
...
This file is the repository-local source of truth for token-efficient command classification, log capture, filtered summaries, and final reporting.
