...
public final class TestDecodingPluginDefault {
    ...
    public void assertDecodeWriteRowEvent() {
        ...
        WriteRowEvent actual = (WriteRowEvent) new DefaultDecodingPlugin(null).decode(data, lsn);
    ...
    public void assertDecodeUpdateRowEvent() {
        ...
        UpdateRowEvent actual = (UpdateRowEvent) new DefaultDecodingPlugin(null).decode(data, lsn);
        assertThat(actual.getLogSequenceNumber(), is(lsn));
        assertThat(actual.getTableName(), is("test"));
        assertThat(actual.getAfterRow().get(0), is("1 2 3'"));
    }
    ...
    public void assertDecodeDeleteRowEvent() {
        ...
        DeleteRowEvent actual = (DeleteRowEvent) new DefaultDecodingPlugin(null).decode(data, lsn);
        assertThat(actual.getLogSequenceNumber(), is(lsn));
        assertThat(actual.getTableName(), is("test"));
