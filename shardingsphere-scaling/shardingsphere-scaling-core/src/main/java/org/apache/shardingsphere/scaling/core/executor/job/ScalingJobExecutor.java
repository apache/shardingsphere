...
public final class ScalingJobExecutor extends AbstractLifecycleExecutor {
    ...
    private static final Pattern CONFIG_PATTERN = Pattern.compile(DataPipelineConstant.DATA_PIPELINE_ROOT + "/(\\d+)/config");
    ...
    private void watchGovernanceRepositoryConfiguration() {
        ScalingAPIFactory.getGovernanceRepositoryAPI().watch(DataPipelineConstant.DATA_PIPELINE_ROOT, event -> {
