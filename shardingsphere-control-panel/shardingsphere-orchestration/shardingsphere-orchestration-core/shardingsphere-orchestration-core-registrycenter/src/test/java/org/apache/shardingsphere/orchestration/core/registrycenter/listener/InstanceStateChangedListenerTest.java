...
public final class InstanceStateChangedListenerTest {
    ...
    public void assertCreateShardingOrchestrationEventWhenDisabled() {
        assertTrue(instanceStateChangedListener.createShardingOrchestrationEvent(new DataChangedEvent("test/test_ds", "state: " + RegistryCenterNodeStatus.DISABLED.name(), ChangedType.UPDATED)).isCircuitBreak());
    }
}
