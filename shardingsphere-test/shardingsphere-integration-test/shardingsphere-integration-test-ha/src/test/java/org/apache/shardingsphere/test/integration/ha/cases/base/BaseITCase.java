...
public abstract class BaseITCase {
    ...
    public BaseITCase(final HAParameterized haParameterized) {
        ...
        containerComposer = new DockerContainerComposer(haParameterized.getScenario(), haParameterized.getProxyContainerImage(), haParameterized.getDatabaseType(), haParameterized.getStorageContainerImage());
