...
public final class StandaloneComposedContainer implements ComposedContainer {
    ...
    public StandaloneComposedContainer(final ParameterizedArray parameterizedArray) {
        ...
        storageContainer = containers.registerContainer(StorageContainerFactory.newInstance(parameterizedArray.getDatabaseType(), scenario), parameterizedArray.getDatabaseType().getType(), scenario);
        adapterContainer = containers.registerContainer(AdapterContainerFactory.newInstance(
                parameterizedArray.getMode(), parameterizedArray.getAdapter(), parameterizedArray.getDatabaseType(), storageContainer, scenario), parameterizedArray.getAdapter(), scenario);
