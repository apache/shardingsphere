...
CREATE INDEX order_index_t_order ON tbl.t_order_0 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_1 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_2 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_3 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_4 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_5 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_6 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_7 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_8 (order_id);
...
CREATE INDEX order_index_t_order ON tbl.t_order_9 (order_id);
