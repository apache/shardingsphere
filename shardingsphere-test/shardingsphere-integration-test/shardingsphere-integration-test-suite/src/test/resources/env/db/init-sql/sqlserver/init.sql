...
CREATE TABLE db_0.t_single_table (single_id INT NOT NULL, status VARCHAR(45) NULL, PRIMARY KEY (single_id));
CREATE TABLE db_0.t_broadcast_table (id INT NOT NULL, id INT NOT NULL,status VARCHAR(45) NULL, PRIMARY KEY (id));
