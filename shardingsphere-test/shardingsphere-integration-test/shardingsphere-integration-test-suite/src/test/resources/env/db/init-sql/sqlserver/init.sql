...
CREATE TABLE db_0.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_1.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_2.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_3.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_4.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_5.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_6.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_7.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_8.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
...
CREATE TABLE db_9.t_message (message_id INT NOT NULL, user_id INT NOT NULL, number INT NULL, PRIMARY KEY (message_id));
