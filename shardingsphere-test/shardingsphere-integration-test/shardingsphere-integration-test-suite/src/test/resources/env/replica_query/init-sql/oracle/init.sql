...
CREATE TABLE primary_ds.t_single_table (id INT NOT NULL, status VARCHAR(45) NULL, PRIMARY KEY (id));
...
CREATE TABLE replica_0.t_single_table (id INT NOT NULL, status VARCHAR(45) NULL, PRIMARY KEY (id));
...
CREATE TABLE replica_1.t_single_table (id INT NOT NULL, status VARCHAR(45) NULL, PRIMARY KEY (id));
