...
public final class DockerComposedContainer extends BaseComposedContainer {
    ...
    public DockerComposedContainer(final TransactionParameterized parameterized) {
        ...
        if (TransactionTestConstants.PROXY.equalsIgnoreCase(parameterized.getAdapter())) {
            jdbcContainer = null;
            proxyContainer = (ShardingSphereProxyClusterContainer) AdapterContainerFactory.newInstance("Cluster", "proxy", databaseType, storageContainer, "", TransactionProxyClusterContainerConfigurationFactory.newInstance(databaseType));
