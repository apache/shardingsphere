...
public final class AdapterContainerFactory {
     ...
     * @return created instance
     */
    public static AdapterContainer newInstance(final String mode, final String adapter, final DatabaseType databaseType, final StorageContainer storageContainer, final String scenario, final String module) {
        switch (adapter) {
            case "proxy":
