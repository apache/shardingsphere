...
/**
 * MySQL container util.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class MySQLContainerUtil {
    
    private static final AtomicInteger ATOMIC_SERVER_ID = new AtomicInteger(1);
    ...
    public static int generateServerId() {
        return ATOMIC_SERVER_ID.getAndIncrement();
    }
}
