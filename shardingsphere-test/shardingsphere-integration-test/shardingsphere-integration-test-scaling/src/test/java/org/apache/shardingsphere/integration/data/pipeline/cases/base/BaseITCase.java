...
public abstract class BaseITCase {
    ...
    public BaseITCase(final ScalingParameterized parameterized) {
        ...
        if (ENV.getItEnvType() == ITEnvTypeEnum.DOCKER) {
            containerComposer = new DockerContainerComposer(parameterized.getProxyContainerImage(), parameterized.getDatabaseType(), parameterized.getStorageContainerImage());
        } else {
