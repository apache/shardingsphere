...
public final class DockerComposedContainer extends BaseComposedContainer {
    ...
    public DockerComposedContainer(final DatabaseType databaseType, final String dockerImageName) {
        ...
        ShardingSphereProxyClusterContainer proxyClusterContainer = (ShardingSphereProxyClusterContainer) AdapterContainerFactory.newInstance("Cluster", "proxy", databaseType, storageContainer, "", "scaling");
