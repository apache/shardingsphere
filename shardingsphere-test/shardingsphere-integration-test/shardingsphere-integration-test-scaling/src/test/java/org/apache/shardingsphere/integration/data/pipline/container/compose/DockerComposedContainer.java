...
public final class DockerComposedContainer extends BaseComposedContainer {
    ...
    public DataSource getProxyDataSource(final String databaseName) {
        ...
        String jdbcUrl = StringUtils.appendIfMissing(
                DataSourceEnvironment.getURL(getDatabaseContainer().getDatabaseType(), getProxyContainer().getHost(), getProxyContainer().getFirstMappedPort(), databaseName),
