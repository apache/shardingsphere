...
public class MySQLTextPrimaryKeyIT extends BaseMySQLITCase {
    
    private static final IntegrationTestEnvironment ENV = IntegrationTestEnvironment.getInstance();
    
    public MySQLTextPrimaryKeyIT(final ScalingParameterized parameterized) {
        super(parameterized);
    ...
    public static Collection<ScalingParameterized> getParameters() {
        ...
        for (String version : ENV.getMysqlVersions()) {
            ...
            result.add(new ScalingParameterized(DATABASE_TYPE, version, "env/scenario/primarykey/text_primary_key/mysql.xml"));
        }
        return result;
    }
    ...
    private void batchInsertOrder(final KeyGenerateAlgorithm keyGenerateAlgorithm) {
