...
/**
 * Show sharding tables count statement assert.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class ShowShardingTablesCountStatementAssert {
    
    public static void assertIs(final SQLCaseAssertContext assertContext, final ShowShardingTablesCountStatement actual,
                                final ShowShardingTablesCountStatementTestCase expected) {
