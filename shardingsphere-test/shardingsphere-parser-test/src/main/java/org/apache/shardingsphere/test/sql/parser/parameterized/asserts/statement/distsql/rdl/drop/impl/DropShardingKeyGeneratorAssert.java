...
import org.apache.shardingsphere.distsql.parser.statement.rdl.drop.DropShardingKeyGeneratorStatement;
...
public final class DropShardingKeyGeneratorAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DropShardingKeyGeneratorStatement actual, 
                                final DropShardingKeyGeneratorStatementTestCase expected) {
        if (null == expected) {
