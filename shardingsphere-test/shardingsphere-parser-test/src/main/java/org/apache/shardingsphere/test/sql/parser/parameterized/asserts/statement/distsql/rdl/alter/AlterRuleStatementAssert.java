...
import org.apache.shardingsphere.test.sql.parser.parameterized.asserts.statement.distsql.rdl.alter.impl.AlterDefaultSingleTableRuleResourceStatementAssert;
...
public final class AlterRuleStatementAssert {
    ...
    public static void assertIs(final SQLCaseAssertContext assertContext, final AlterRuleStatement actual, final SQLParserTestCase expected) {
        ...
        } else if (actual instanceof AlterDefaultSingleTableRuleResourceStatement) {
            AlterDefaultSingleTableRuleResourceStatementAssert.assertIs(assertContext, (AlterDefaultSingleTableRuleResourceStatement) actual, 
                    (AlterDefaultSingleTableRuleResourceStatementTestCase) expected);
        }
    }
}
