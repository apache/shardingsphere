...
/**
 * Show scaling status statement assert.
 */
public final class ShowScalingStatusStatementAssert {
    
    /**
     * Assert show scaling status is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual check scaling statement
     * @param expected expected check scaling statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final ShowScalingStatusStatement actual, final ShowScalingStatusStatementTestCase expected) {
        if (null == expected) {
