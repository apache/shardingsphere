...
/**
 * Start scaling statement assert.
 */
public final class StartScalingStatementAssert {
    
    /**
     * Assert start scaling statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual start scaling statement
     * @param expected expected start scaling statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final StartScalingStatement actual, final StartScalingStatementTestCase expected) {
        if (null == expected) {
