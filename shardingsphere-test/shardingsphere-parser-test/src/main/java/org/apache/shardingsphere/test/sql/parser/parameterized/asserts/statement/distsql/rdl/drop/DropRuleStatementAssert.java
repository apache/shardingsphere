...
import org.apache.shardingsphere.test.sql.parser.parameterized.asserts.statement.distsql.rdl.drop.impl.DropShardingScalingStatementAssert;
...
public final class DropRuleStatementAssert {
    ...
    public static void assertIs(final SQLCaseAssertContext assertContext, final DropRuleStatement actual, final SQLParserTestCase expected) {
        if (actual instanceof DropDatabaseDiscoveryRuleStatement) {
            ...
            DropShardingScalingStatementAssert.assertIs(assertContext, (DropShardingScalingStatement) actual, (DropShardingScalingStatementTestCase) expected);
        }
    }
}
