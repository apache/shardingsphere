...
import org.apache.shardingsphere.test.sql.parser.parameterized.asserts.statement.distsql.rdl.drop.impl.DropDefaultSingleTableRuleResourceAssert;
...
public final class DropRuleStatementAssert {
    ...
    public static void assertIs(final SQLCaseAssertContext assertContext, final DropRuleStatement actual, final SQLParserTestCase expected) {
        ...
        } else if (actual instanceof DropDefaultSingleTableRuleResourceStatement) {
            DropDefaultSingleTableRuleResourceAssert.assertIs(assertContext, (DropDefaultSingleTableRuleResourceStatement) actual, (DropDefaultSingleTableRuleResourceStatementTestCase) expected);
        }
    }
}
