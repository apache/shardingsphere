...
public final class ApplyMigrationStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final ApplyMigrationStatement actual, final ApplyMigrationStatementTestCase expected) {
        if (null == expected) {
