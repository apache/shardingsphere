...
import org.apache.shardingsphere.test.sql.parser.parameterized.asserts.statement.distsql.rdl.create.impl.CreateShardingAutoTableRuleStatementAssert;
...
public final class CreateRuleStatementAssert {
    ...
    public static void assertIs(final SQLCaseAssertContext assertContext, final CreateRuleStatement actual, final SQLParserTestCase expected) {
        if (actual instanceof CreateDatabaseDiscoveryRuleStatement) {
            ...
            CreateShardingAutoTableRuleStatementAssert.assertIs(assertContext, (CreateShardingAutoTableRuleStatement) actual, (CreateShardingAutoTableRuleStatementTestCase) expected);
