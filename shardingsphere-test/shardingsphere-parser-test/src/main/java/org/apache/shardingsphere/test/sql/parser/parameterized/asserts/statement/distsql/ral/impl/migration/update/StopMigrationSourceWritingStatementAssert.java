...
public final class StopMigrationSourceWritingStatementAssert {
     ...
     * @param expected expected stop migration source writing statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final StopMigrationSourceWritingStatement actual, final StopMigrationSourceWritingStatementTestCase expected) {
        if (null == expected) {
