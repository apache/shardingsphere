...
import org.apache.shardingsphere.data.pipeline.core.fixture.FixtureSingleTableDataCalculator;
...
public final class DataConsistencyCheckerImplTest {
    ...
    public void assertCountAndDataCheck() {
        ...
        Map<String, Boolean> dataCheckResultMap = dataConsistencyChecker.checkRecordsContent(new FixtureSingleTableDataCalculator());
