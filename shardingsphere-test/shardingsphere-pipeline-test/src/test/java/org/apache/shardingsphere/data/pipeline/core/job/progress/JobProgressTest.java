...
public final class JobProgressTest {
    ...
    public void assertInit() {
        JobProgress jobProgress = getJobProgress(ResourceUtil.readFile("job-progress.yaml"));
    ...
    public void assertGetNoFinishedInventoryFinishedPercentage() {
        JobProgress jobProgress = getJobProgress(ResourceUtil.readFile("job-progress-no-finished.yaml"));
        assertThat(jobProgress.getInventoryFinishedPercentage(), is(0));
    }
    
    @Test
    public void assertGetAllFinishedInventoryFinishedPercentage() {
        JobProgress jobProgress = getJobProgress(ResourceUtil.readFile("job-progress-all-finished.yaml"));
