...
public final class FinishedCheckJobTest {
    ...
    public void assertExecuteAllDisabledJob() {
        Optional<String> jobId = PipelineJobAPIFactory.getInstance().start(JobConfigurationBuilder.createJobConfiguration());
        assertTrue(jobId.isPresent());
        List<JobInfo> jobInfos = PipelineJobAPIFactory.getInstance().list();
