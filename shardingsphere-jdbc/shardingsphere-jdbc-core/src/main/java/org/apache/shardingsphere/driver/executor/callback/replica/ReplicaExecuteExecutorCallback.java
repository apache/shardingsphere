...
/**
 * SQL executor callback for execute for replica.
 */
public final class ReplicaExecuteExecutorCallback extends ReplicaSQLExecutorCallback<Boolean> implements RuleExecuteExecutorCallback<ReplicaRule> {
