...
public abstract class AbstractStatementAdapter extends AbstractUnsupportedOperationStatement {
    ...
    public final void setPoolable(final boolean poolable) throws SQLException {
        ...
        getInvocationRecorder().recordMethodInvocation(targetClass, "setPoolable", new Class[] {boolean.class}, new Object[] {poolable});
    ...
    public final void setFetchSize(final int rows) throws SQLException {
        fetchSize = rows;
        getInvocationRecorder().recordMethodInvocation(targetClass, "setFetchSize", new Class[] {int.class}, new Object[] {rows});
    ...
    public final void setFetchDirection(final int direction) throws SQLException {
        ...
        getInvocationRecorder().recordMethodInvocation(targetClass, "setFetchDirection", new Class[] {int.class}, new Object[] {direction});
    ...
    public final void setMaxFieldSize(final int max) throws SQLException {
        getInvocationRecorder().recordMethodInvocation(targetClass, "setMaxFieldSize", new Class[] {int.class}, new Object[] {max});
    ...
    public final void setMaxRows(final int max) throws SQLException {
        getInvocationRecorder().recordMethodInvocation(targetClass, "setMaxRows", new Class[] {int.class}, new Object[] {max});
    ...
    public final void setQueryTimeout(final int seconds) throws SQLException {
        getInvocationRecorder().recordMethodInvocation(targetClass, "setQueryTimeout", new Class[] {int.class}, new Object[] {seconds});
    ...
    public final void setEscapeProcessing(final boolean enable) throws SQLException {
        getInvocationRecorder().recordMethodInvocation(targetClass, "setEscapeProcessing", new Class[] {boolean.class}, new Object[] {enable});
