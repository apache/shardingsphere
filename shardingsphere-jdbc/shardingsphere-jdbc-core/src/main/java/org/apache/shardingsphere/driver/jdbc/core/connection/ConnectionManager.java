...
public final class ConnectionManager implements ExecutorJDBCConnectionManager, AutoCloseable {
    ...
    private Map<String, DataSourceProperties> createDataSourcePropertiesMap(final Collection<InstanceDefinition> instances, final Collection<ShardingSphereUser> users,
        ...
        for (InstanceDefinition each : instances) {
            result.put(each.getInstanceId(), createDataSourceProperties((ServerInstanceDefinition) each, users, dataSourcePropsSample, schema));
        }
        return result;
    }
    
    private DataSourceProperties createDataSourceProperties(final ServerInstanceDefinition instanceDefinition, final Collection<ShardingSphereUser> users,
                                                            final DataSourceProperties dataSourcePropsSample, final String schema) {
    ...
    private String createJdbcUrl(final ServerInstanceDefinition instanceDefinition, final String schema, final Map<String, Object> props) {
