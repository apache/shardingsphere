...
public final class JDBCLockEngine {
    ...
    public JDBCLockEngine(final MetaDataContexts metaDataContexts, final JDBCExecutor jdbcExecutor) {
        ...
        metadataRefreshEngine = new MetadataRefreshEngine(metaDataContexts.getDefaultMetaData(), metaDataContexts.getAuthentication(), metaDataContexts.getProps(), metaDataContexts.getLock());
    }
