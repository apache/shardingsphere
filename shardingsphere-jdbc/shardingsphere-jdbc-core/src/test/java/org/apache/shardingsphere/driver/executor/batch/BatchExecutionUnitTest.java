...
public final class BatchExecutionUnitTest {
    ...
    public void assertToString() {
        ...
        assertThat(actual.toString(), is(String.format("BatchExecutionUnit(executionUnit=ExecutionUnit"
                + "(dataSourceName=%s, sqlUnit=SQLUnit(sql=%s, parameters=[%d], actualTables=[], readOnly=false), schemaName=%s), jdbcAndActualAddBatchCallTimesMap={}, actualCallAddBatchTimes=0)",
                DATA_SOURCE_NAME, SQL, 1, "sharding_db")));
    }
}
