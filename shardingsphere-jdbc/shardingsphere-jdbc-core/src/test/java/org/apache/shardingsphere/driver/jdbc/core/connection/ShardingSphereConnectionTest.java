...
public final class ShardingSphereConnectionTest {
    ...
    public static void init() throws SQLException {
        ...
        dataSourceMap.put("test_ds_primary", primaryDataSource);
        dataSourceMap.put("test_ds_replica", replicaDataSource);
    }
    ...
    public void assertGetConnectionFromCache() throws SQLException {
        assertThat(connection.getConnection("test_ds_primary"), is(connection.getConnection("test_ds_primary")));
    }
