...
public final class PreparedStatementAdapterTest {
    ...
    public void setUp() throws SQLException {
        ...
        when(connection.getContextManager().getMetaDataContexts().getMetaData().get(connection.getDatabaseName()).getResource().getDatabaseType()).thenReturn(new MySQLDatabaseType());
