...
public final class PreparedStatementAdapterTest {
    ...
    public void assertSetObjectForBoolean() {
        ...
        shardingSpherePreparedStatement.setObject(6, boolFal, Types.BOOLEAN);
    ...
    private void assertDateTimeParameter(final PreparedStatement statement, final int index, final Object parameter, final int level) {
    ...
    private String parseTimeFromToString(final String value) {
