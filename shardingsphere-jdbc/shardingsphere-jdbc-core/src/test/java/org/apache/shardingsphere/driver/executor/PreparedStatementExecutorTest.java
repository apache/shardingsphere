...
public final class PreparedStatementExecutorTest extends AbstractBaseExecutorTest {
    ...
    public void assertExecuteQueryForSinglePreparedStatementSuccess() throws SQLException {
        ...
        assertThat(actual.executeQuery(getInputGroups(Collections.singletonList(preparedStatement), true)).iterator().next().getValue(1, String.class), is("value"));
    }
    ...
    public void assertExecuteQueryForMultiplePreparedStatementsSuccess() throws SQLException {
        ...
        List<QueryResult> result = actual.executeQuery(getInputGroups(Arrays.asList(preparedStatement1, preparedStatement2), true));
    ...
    public void assertExecuteQueryForSinglePreparedStatementFailure() throws SQLException {
        ...
        assertThat(actual.executeQuery(getInputGroups(Collections.singletonList(preparedStatement), true)), is(Collections.singletonList((QueryResult) null)));
    ...
    public void assertExecuteQueryForMultiplePreparedStatementsFailure() throws SQLException {
        ...
        List<QueryResult> actualResultSets = actual.executeQuery(getInputGroups(Arrays.asList(preparedStatement1, preparedStatement2), true));
    ...
    public void assertExecuteUpdateForSinglePreparedStatementSuccess() throws SQLException {
        ...
        assertThat(actual.executeUpdate(getInputGroups(Collections.singletonList(preparedStatement), false), createSQLStatementContext(), null), is(10));
    ...
    public void assertExecuteUpdateForMultiplePreparedStatementsSuccess() throws SQLException {
        ...
        assertThat(actual.executeUpdate(getInputGroups(Arrays.asList(preparedStatement1, preparedStatement2), false), createSQLStatementContext(), null), is(30));
    ...
    public void assertExecuteUpdateForSinglePreparedStatementFailure() throws SQLException {
        ...
        assertThat(actual.executeUpdate(getInputGroups(Collections.singletonList(preparedStatement), false), createSQLStatementContext(), null), is(0));
        verify(preparedStatement).executeUpdate();
    }
    ...
    public void assertExecuteUpdateForMultiplePreparedStatementsFailure() throws SQLException {
        ...
        assertThat(actual.executeUpdate(getInputGroups(Arrays.asList(preparedStatement1, preparedStatement2), false), createSQLStatementContext(), null), is(0));
        verify(preparedStatement1).executeUpdate();
        verify(preparedStatement2).executeUpdate();
    }
    ...
    public void assertExecuteForSinglePreparedStatementSuccessWithDML() throws SQLException {
        ...
        assertFalse(actual.execute(getInputGroups(Collections.singletonList(preparedStatement), false), mock(SQLStatement.class), null));
    ...
    public void assertExecuteForMultiplePreparedStatementsSuccessWithDML() throws SQLException {
        ...
        assertFalse(actual.execute(getInputGroups(Arrays.asList(preparedStatement1, preparedStatement2), false), mock(SQLStatement.class), null));
    ...
    public void assertExecuteForSinglePreparedStatementWithDQL() throws SQLException {
        ...
        assertTrue(actual.execute(getInputGroups(Collections.singletonList(preparedStatement), true), mock(SQLStatement.class), null));
        verify(preparedStatement).execute();
    }
    ...
    public void assertExecuteForMultiplePreparedStatements() throws SQLException {
        ...
        assertTrue(actual.execute(getInputGroups(Arrays.asList(preparedStatement1, preparedStatement2), true), mock(SQLStatement.class), null));
        verify(preparedStatement1).execute();
        verify(preparedStatement2).execute();
    }
    ...
    private Collection<InputGroup<StatementExecuteUnit>> getInputGroups(final List<PreparedStatement> preparedStatements, final boolean isQuery) {
