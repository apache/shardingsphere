...
public final class DataSourceMapSetterTest {
    ...
    public void assetMergedAll() throws SQLException {
        ...
        mockEnvironment.setProperty("spring.shardingsphere.datasource.common.is-template", "true");
        ...
        mockEnvironment.setProperty("spring.shardingsphere.datasource.ds0.template", "common");
        ...
        mockEnvironment.setProperty("spring.shardingsphere.datasource.ds1.template", "common");
