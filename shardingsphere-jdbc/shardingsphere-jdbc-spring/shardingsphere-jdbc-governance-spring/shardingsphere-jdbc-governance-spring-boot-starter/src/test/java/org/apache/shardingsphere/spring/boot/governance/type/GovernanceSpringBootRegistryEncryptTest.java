...
public class GovernanceSpringBootRegistryEncryptTest {
    ...
    public void assertWithEncryptDataSource() throws NoSuchFieldException, IllegalAccessException {
        ...
        EncryptRuleConfiguration config = (EncryptRuleConfiguration) metaDataContexts.getMetaData(DefaultSchema.LOGIC_NAME).getRuleMetaData().getConfigurations().iterator().next();
