...
public class YamlGovernanceShardingIntegrateTest extends AbstractYamlDataSourceTest {
    ...
    public void assertWithDataSource() throws Exception {
        File yamlFile = new File(YamlGovernanceShardingIntegrateTest.class.getResource(filePath).toURI());
