...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/b-SdbSt-query-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/b-SdbSt-query-rt.png)
### 单库单表更新
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/b-SdbSt-update-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/b-SdbSt-update-rt.png)
### 单库单表插入
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/b-SdbSt-insert-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/b-SdbSt-insert-rt.png)
## 极限测试
### 单库单表与两库各一表查询
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbSt-MdbSt-query-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbSt-MdbSt-query-rt.png)
### 单库两表与两库各两表查询
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbMt-MdbMt-query-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbMt-MdbMt-query-rt.png)
### 单库单表更新与两库各一表更新
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbSt-MdbSt-update-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbSt-MdbSt-update-rt.png)
### 单库两表与两库各2表更新
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbMt-MdbMt-update-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbMt-MdbMt-update-rt.png)
### 单库单表插入与两库各一表插入
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbSt-MdbSt-insert-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbSt-MdbSt-insert-rt.png)
### 单库两表与两库各2表插入
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbMt-MdbMt-insert-tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/l-SdbMt-MdbMt-insert-rt.png)
...
TPS展示
![TPS](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/152vs142tps.png)
RT展示
![RT](https://github.com/yue530tom/sharding-jdbc/blob/master/sharding-jdbc-doc/static/img/152vs142rt.png)
## 附录
