...
public final class MCPResourceDescriptor {
    ...
    public MCPResourceDescriptor(final String uriPattern, final String name, final String title, final String description, final String mimeType) {
        this(uriPattern, name, title, description, mimeType, Collections.emptyList(), MCPResourceAnnotations.EMPTY, Collections.emptyMap());
    }
