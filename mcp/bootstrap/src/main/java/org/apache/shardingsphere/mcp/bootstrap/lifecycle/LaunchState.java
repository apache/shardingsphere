...
public final class LaunchState {
     ...
     */
    public LaunchState(final MCPServerRegistry serverRegistry, final MCPRuntimeServices runtimeServices, final Collection<StreamableHttpMCPServer> httpServers,
