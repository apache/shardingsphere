...
final class StreamableHttpInitializeRequestUtils {
    
    static McpSchema.InitializeRequest normalizeProtocolVersion(final McpSchema.InitializeRequest initializeRequest) {
    ...
    private static String normalizeProtocolVersion(final String rawProtocolVersion) {
