...
3. Use validate_workflow when the plan has been applied and the user asks whether runtime state matches the plan.
4. Use apply_workflow only after reviewing plan artifacts or an execution_mode=preview response with the user.
5. Preserve user-provided corrections when re-planning with plan_encrypt_rule or plan_mask_rule.
