...
public final class MCPDescriptorCatalogLoader {
    ...
    public static MCPDescriptorCatalog load() {
        Collection<YamlMCPDescriptorCatalog> yamlCatalogs = MCPDescriptorCatalogYamlLoader.load();
        MCPDescriptorCatalog result = MCPDescriptorCatalogYamlSwapper.swap(yamlCatalogs);
        MCPDescriptorCatalogValidator.validate(result);
        return result;
    }
}
