...
class MCPMetadataSnapshotTest {
    ...
    @Test
    void assertGetSequences() {
        MCPSequenceMetadata expected = new MCPSequenceMetadata("logic_db", "public", "order_seq");
        MCPMetadataSnapshot snapshot = new MCPMetadataSnapshot(Collections.emptyList(), Map.of("public", List.of(expected)));
        assertThat(snapshot.getSequences("public"), is(List.of(expected)));
    }
