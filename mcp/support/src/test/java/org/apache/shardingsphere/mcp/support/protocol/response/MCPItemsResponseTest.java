...
class MCPItemsResponseTest {
    ...
    private static Stream<Arguments> assertToPayloadCases() {
        return Stream.of(
                Arguments.of("with items", new MCPItemsResponse(List.of("foo_item")),
                        Map.of("response_mode", "list", "items", List.of("foo_item"), "count", 1)),
                Arguments.of("with null items", new MCPItemsResponse(null),
                        Map.of("response_mode", "list", "items", List.of(), "count", 0)),
                Arguments.of("with navigation", new MCPItemsResponse(List.of("foo_item"), Map.of("self_uri", "shardingsphere://foo", "next_resources",
                        ...
                        Map.of("response_mode", "list", "items", List.of("foo_item"), "count", 1, "self_uri", "shardingsphere://foo",
