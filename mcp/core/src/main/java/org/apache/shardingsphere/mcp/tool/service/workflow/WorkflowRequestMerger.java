 ...
 */
final class WorkflowRequestMerger {
    
    WorkflowRequest merge(final WorkflowRequest previous, final WorkflowRequest current) {
        if (null == previous) {
            return copy(current);
        }
        ...
        result.setFeatureType(mergeString(previous.getFeatureType(), current.getFeatureType()));
        ...
        result.setAllowSampleData(null == current.getAllowSampleData() ? previous.getAllowSampleData() : current.getAllowSampleData());
    ...
    WorkflowRequest copy(final WorkflowRequest original) {
        if (null == original) {
            return null;
        }
        WorkflowRequest result = new WorkflowRequest();
        ...
        result.setAllowSampleData(original.getAllowSampleData());
