...
public final class EncryptRulesHandler implements ResourceHandler {
    ...
    public String getUriPattern() {
        return "shardingsphere://databases/{database}/encrypt-rules";
    }
    
    @Override
    public MCPResponse handle(final MCPRuntimeContext runtimeContext, final MCPUriVariables uriVariables) {
        return new MCPMetadataResponse(ruleInspectionService.queryEncryptRules(runtimeContext, uriVariables.getVariable("database"), ""));
    }
}
