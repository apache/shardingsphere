...
public final class DatabaseCapabilityCatalog {
    ...
    private static DatabaseCapability createDefaultCapability(final String databaseName, final String databaseType, final String databaseVersion, final DatabaseCapabilityOption option) {
