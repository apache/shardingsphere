 ...
 */
public final class MaskAlgorithmsHandler implements ResourceHandler {
    
    private final RuleInspectionService ruleInspectionService = new RuleInspectionService();
    
    @Override
    public String getUriPattern() {
        return "shardingsphere://plugins/mask-algorithms";
    }
    
    @Override
    public MCPResponse handle(final MCPRuntimeContext runtimeContext, final MCPUriVariables uriVariables) {
        return new MCPMetadataResponse(ruleInspectionService.enrichMaskAlgorithms(ruleInspectionService.queryMaskAlgorithms(runtimeContext)));
    }
}
