...
public final class EncryptAlgorithmsHandler implements ResourceHandler {
    ...
    public String getUriPattern() {
        return "shardingsphere://plugins/encrypt-algorithms";
    }
    
    @Override
    public MCPResponse handle(final MCPRuntimeContext runtimeContext, final MCPUriVariables uriVariables) {
        return new MCPMetadataResponse(ruleInspectionService.enrichEncryptAlgorithms(ruleInspectionService.queryEncryptAlgorithms(runtimeContext)));
    }
}
