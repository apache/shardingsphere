...
/**
 * Handler for sequences resource URI.
 */
public final class SequencesHandler implements ResourceHandler {
    
    @Override
    public String getUriPattern() {
        return "shardingsphere://databases/{database}/schemas/{schema}/sequences";
    }
    ...
    public MCPResponse handle(final MCPFeatureContext requestContext, final MCPUriVariables uriVariables) {
        ...
        return new MCPMetadataResponse(metadataQueryService.querySequences(databaseName, schemaName));
    }
}
