...
class MCPResourceControllerTest {
    ...
    void assertHandleWithUnsupportedResourceUri() {
        Map<String, Object> actual = new MCPResourceController(ResourceTestDataFactory.createRuntimeContext()).handle("unsupported://resource").toPayload();
    ...
    void assertHandleDatabaseCapabilities() {
        Map<String, Object> actual = new MCPResourceController(ResourceTestDataFactory.createRuntimeContext()).handle("shardingsphere://databases/logic_db/capabilities").toPayload();
    ...
    void assertHandleWithUnknownDatabaseCapabilities() {
        Map<String, Object> actual = new MCPResourceController(ResourceTestDataFactory.createRuntimeContext()).handle("shardingsphere://databases/missing_db/capabilities").toPayload();
    ...
    void assertHandleWithUnsupportedIndexResource() {
        Map<String, Object> actual = new MCPResourceController(
                ResourceTestDataFactory.createRuntimeContext()).handle("shardingsphere://databases/warehouse/schemas/warehouse/tables/facts/indexes").toPayload();
