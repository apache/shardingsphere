...
class BroadcastRuleCountHandlerTest {
    ...
    void assertGetContextType() {
        assertThat(new BroadcastRuleCountHandler().getContextType(), is(MCPDatabaseHandlerContext.class));
    }
    ...
    void assertHandle() {
        ...
        MCPResponse actual = new BroadcastRuleCountHandler(ruleInspectionService).handle(databaseContext, new MCPUriVariables(Map.of("database", "logic_db")));
