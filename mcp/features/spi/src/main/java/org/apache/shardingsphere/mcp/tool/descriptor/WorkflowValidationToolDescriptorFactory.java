...
/**
 * Workflow validation tool descriptor factory.
 */
public final class WorkflowValidationToolDescriptorFactory {
    
    private WorkflowValidationToolDescriptorFactory() {
    }
    ...
    public static MCPToolDescriptor create(final String toolName) {
        return new MCPToolDescriptor(toolName,
