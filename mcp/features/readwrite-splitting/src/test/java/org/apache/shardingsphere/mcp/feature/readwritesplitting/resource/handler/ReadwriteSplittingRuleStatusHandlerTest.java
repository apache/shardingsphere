...
class ReadwriteSplittingRuleStatusHandlerTest {
    ...
    void assertHandle() {
        try (MockedConstruction<ReadwriteSplittingInspectionService> mocked = mockConstruction(ReadwriteSplittingInspectionService.class)) {
            ReadwriteSplittingRuleStatusHandler handler = new ReadwriteSplittingRuleStatusHandler();
            ...
            MCPSuccessPayload actual = handler.handle(databaseContext, new MCPUriVariables(Map.of("database", "logic_db", "rule", "readwrite_ds")));
