 ...
 */
public final class ReadwriteSplittingRuleCountHandler implements MCPResourceHandler<MCPFeatureRequestContext> {
    ...
    public MCPSuccessPayload handle(final MCPFeatureRequestContext requestContext, final MCPUriVariables uriVariables) {
        return new MCPItemsPayload(inspectionService.queryRuleCount(requestContext.getQueryFacade(), uriVariables.getValue("database")),
