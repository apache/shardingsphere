 ...
 */
public final class ReadwriteSplittingRuleCountHandler implements MCPResourceHandler<MCPDatabaseRequestContext> {
    ...
    public MCPSuccessPayload handle(final MCPDatabaseRequestContext databaseContext, final MCPUriVariables uriVariables) {
        return new MCPItemsPayload(inspectionService.queryRuleCount(databaseContext.getQueryFacade(), uriVariables.getValue("database")),
