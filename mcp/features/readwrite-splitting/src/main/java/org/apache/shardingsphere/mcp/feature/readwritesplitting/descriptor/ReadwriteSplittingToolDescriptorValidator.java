...
public final class ReadwriteSplittingToolDescriptorValidator implements MCPToolDescriptorValidator {
    ...
    public boolean supports(final MCPToolDescriptor toolDescriptor) {
        return ReadwriteSplittingFeatureDefinition.PLAN_RULE_TOOL_NAME.equals(toolDescriptor.getName())
                || ReadwriteSplittingFeatureDefinition.PLAN_STATUS_TOOL_NAME.equals(toolDescriptor.getName());
    }
