 ...
 */
public final class MaskMCPFeatureProvider implements MCPFeatureProvider {
    
    private static final Collection<ToolHandler> TOOL_HANDLERS = List.of(
            new PlanMaskRuleToolHandler(),
            new ApplyMaskRuleToolHandler(),
            new ValidateMaskRuleToolHandler());
