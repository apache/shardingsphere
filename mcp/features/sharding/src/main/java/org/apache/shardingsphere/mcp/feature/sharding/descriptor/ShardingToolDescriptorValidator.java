...
public final class ShardingToolDescriptorValidator implements MCPToolDescriptorValidator {
    ...
    public boolean supports(final MCPToolDescriptor toolDescriptor) {
        return ShardingFeatureDefinition.PLAN_TABLE_RULE_TOOL_NAME.equals(toolDescriptor.getName())
                || ShardingFeatureDefinition.PLAN_TABLE_REFERENCE_TOOL_NAME.equals(toolDescriptor.getName())
                || ShardingFeatureDefinition.PLAN_DEFAULT_STRATEGY_TOOL_NAME.equals(toolDescriptor.getName())
                || ShardingFeatureDefinition.PLAN_KEY_GENERATOR_TOOL_NAME.equals(toolDescriptor.getName())
                || ShardingFeatureDefinition.PLAN_KEY_GENERATE_STRATEGY_TOOL_NAME.equals(toolDescriptor.getName())
                || ShardingFeatureDefinition.PLAN_COMPONENT_CLEANUP_TOOL_NAME.equals(toolDescriptor.getName());
    }
