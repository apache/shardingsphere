...
public final class EncryptWorkflowState implements WorkflowFeatureData {
    ...
    public EncryptWorkflowState copy() {
        ...
        result.setAllowIndexDDL(allowIndexDDL);
        result.setRequiresDecrypt(requiresDecrypt);
        result.setRequiresEqualityFilter(requiresEqualityFilter);
        result.setRequiresLikeQuery(requiresLikeQuery);
        result.setAssistedQueryAlgorithmType(assistedQueryAlgorithmType);
        result.setLikeQueryAlgorithmType(likeQueryAlgorithmType);
        result.setCipherColumnName(cipherColumnName);
        result.setAssistedQueryColumnName(assistedQueryColumnName);
        result.setLikeQueryColumnName(likeQueryColumnName);
        result.getAssistedQueryAlgorithmProperties().putAll(assistedQueryAlgorithmProperties);
        result.getLikeQueryAlgorithmProperties().putAll(likeQueryAlgorithmProperties);
