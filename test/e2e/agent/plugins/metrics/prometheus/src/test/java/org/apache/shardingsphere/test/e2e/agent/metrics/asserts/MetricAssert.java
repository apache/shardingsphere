...
public final class MetricAssert {
    ...
    private static void assertMetaData(final String metaDataURL, final MetricE2ETestCase expected) {
        ...
        MetricsMetaDataResponse actual = JsonUtils.fromJsonString(AgentE2EHttpUtils.getInstance().query(metaDataQueryURL), MetricsMetaDataResponse.class);
    ...
    private static void assertQueryData(final String queryURL, final MetricQueryAssertion expected) {
        ...
        MetricsQueryResponse actual = JsonUtils.fromJsonString(AgentE2EHttpUtils.getInstance().query(queryURLWithParam), MetricsQueryResponse.class);
