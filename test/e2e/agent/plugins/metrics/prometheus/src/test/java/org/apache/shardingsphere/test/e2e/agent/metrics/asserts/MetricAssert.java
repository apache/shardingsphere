...
public final class MetricAssert {
    ...
    private static void assertMetaData(final String metaDataURL, final MetricE2ETestCase expected) {
        ...
        MetricsMetaDataResponse actual = JsonEngine.fromJsonString(AgentE2EHttpUtils.query(metaDataQueryURL), MetricsMetaDataResponse.class);
    ...
    private static void assertQueryData(final String queryURL, final MetricQueryAssertion expected) {
        ...
        MetricsQueryResponse actual = JsonEngine.fromJsonString(AgentE2EHttpUtils.query(queryURLWithParam), MetricsQueryResponse.class);
