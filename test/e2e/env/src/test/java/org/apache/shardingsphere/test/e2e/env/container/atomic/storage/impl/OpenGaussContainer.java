...
public final class OpenGaussContainer extends DockerStorageContainer {
    ...
    public OpenGaussContainer(final String containerImage, final StorageContainerConfiguration storageContainerConfig, final Collection<String> databases) {
        super(TypedSPILoader.getService(DatabaseType.class, "openGauss"), Strings.isNullOrEmpty(containerImage) ? "opengauss/opengauss:3.1.0" : containerImage, databases);
