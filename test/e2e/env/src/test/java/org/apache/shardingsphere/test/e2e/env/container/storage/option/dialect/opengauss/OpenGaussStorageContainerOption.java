...
public final class OpenGaussStorageContainerOption implements StorageContainerOption {
    ...
    private final StorageContainerCreateOption createOption = new OpenGaussStorageContainerCreateOption();
    
    private final StorageContainerConnectOption connectOption = new OpenGaussStorageContainerConnectOption();
