...
public final class PostgreSQLStorageContainerOption implements StorageContainerOption {
    ...
    private final StorageContainerCreateOption createOption = new PostgreSQLStorageContainerCreateOption();
    
    private final StorageContainerConnectOption connectOption = new PostgreSQLStorageContainerConnectOption();
