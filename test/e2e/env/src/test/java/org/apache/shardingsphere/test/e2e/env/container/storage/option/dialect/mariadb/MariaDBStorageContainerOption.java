...
public final class MariaDBStorageContainerOption implements StorageContainerOption {
    ...
    private final StorageContainerCreateOption createOption = new MariaDBStorageContainerCreateOption();
    
    private final StorageContainerConnectOption connectOption = new MariaDBStorageContainerConnectOption();
