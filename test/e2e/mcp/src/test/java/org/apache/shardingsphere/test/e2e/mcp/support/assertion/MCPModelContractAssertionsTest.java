...
class MCPModelContractAssertionsTest {
    ...
    void assertCanonicalNextActionListsWithSchema() {
        assertDoesNotThrow(() -> MCPModelContractAssertions.assertCanonicalNextActionLists(
                Map.of("next_actions", Map.of("type", "array", "items", Map.of("type", "object")))));
    }
    ...
    void assertCanonicalNextActionListsWithUnknownType() {
        assertThrows(AssertionError.class, () -> MCPModelContractAssertions.assertCanonicalNextActionLists(
                Map.of("next_actions", List.of(Map.of("order", 1, "type", "unknown", "title", "Unknown")))));
    }
    
    @Test
    void assertCanonicalNextActionListsWithNonArray() {
        assertThrows(AssertionError.class, () -> MCPModelContractAssertions.assertCanonicalNextActionLists(Map.of("next_actions", "retry")));
    }
