...
final class LLMUsabilityScenario {
    ...
    LLMUsabilityScenario(final String scenarioId, final LLMUsabilityDimension dimension, final String runtimeKind, final LLME2EScenario llmScenario,
    ...
    LLME2EScenario llmScenario() {
        return llmScenario;
    }
    
    List<String> expectedFirstActionNames() {
