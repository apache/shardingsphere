...
class HttpProductionLLMH2SmokeE2ETest extends AbstractLLMSmokeE2ETest {
    ...
    protected void prepareRuntimeFixture() throws IOException {
        try {
            runtimeFixture = H2RuntimeTestSupport.createLLMRuntimeFixture(getTempDir(), "production-llm-h2-smoke", "logic_db", getTransport());
