...
final class StubLLMChatClient implements LLMChatClient {
    
    private final IOException waitUntilReadyFailure;
    
    private final Queue<LLMChatCompletion> completions;
    
    StubLLMChatClient(final LLMChatCompletion... completions) {
        this(null, completions);
    }
    
    StubLLMChatClient(final IOException waitUntilReadyFailure, final LLMChatCompletion... completions) {
