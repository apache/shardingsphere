...
class ProductionLLMH2SmokeE2ETest extends AbstractLLMMCPE2ETest {
    ...
    protected void prepareRuntimeFixture() throws IOException {
        try {
            jdbcUrl = H2RuntimeTestSupport.createJdbcUrl(getTempDir(), "production-llm-h2-smoke");
    ...
    void assertSmoke() throws IOException, InterruptedException {
        ...
        assertLLMSmoke(() -> createMinimalSmokeScenario("minimal-smoke-h2", "logic_db", "public", "orders", COUNT_ORDERS_SQL, totalOrders));
    }
}
