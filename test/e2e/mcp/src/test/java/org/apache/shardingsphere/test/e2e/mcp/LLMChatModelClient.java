 ...
 */
final class LLMChatModelClient implements LLMChatClient {
    
    private final LLME2EConfiguration config;
    
    private final HttpClient httpClient;
    
    LLMChatModelClient(final LLME2EConfiguration config, final HttpClient httpClient) {
        this.config = config;
    ...
    public LLMChatCompletion complete(final List<LLMChatMessage> messages, final List<Map<String, Object>> tools,
        ...
        Map<String, Object> payload = JsonUtils.fromJsonString(response.body(), new TypeReference<>() {
        });
    ...
    private boolean containsModel(final String responseBody) {
        Map<String, Object> payload = JsonUtils.fromJsonString(responseBody, new TypeReference<>() {
        });
