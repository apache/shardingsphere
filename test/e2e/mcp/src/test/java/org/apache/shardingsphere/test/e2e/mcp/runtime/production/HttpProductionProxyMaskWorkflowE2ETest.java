...
class HttpProductionProxyMaskWorkflowE2ETest extends AbstractProductionProxyWorkflowE2ETest {
    ...
    void assertPlanApplyAndValidateMaskCreateAlterWorkflowThroughProxy() throws Exception {
        try (MCPInteractionClient interactionClient = createOpenedInteractionClient()) {
            ...
            assertThat(String.valueOf(interactionClient.call("apply_encrypt_mask_rule", Map.of("plan_id", createPlanId)).get("status")), is("completed"));
            Map<String, Object> actualCreateValidationResponse = interactionClient.call("validate_encrypt_mask_rule", Map.of("plan_id", createPlanId));
            ...
            assertThat(String.valueOf(interactionClient.call("apply_encrypt_mask_rule", Map.of("plan_id", alterPlanId)).get("status")), is("completed"));
            Map<String, Object> actualAlterValidationResponse = interactionClient.call("validate_encrypt_mask_rule", Map.of("plan_id", alterPlanId));
    ...
    void assertPlanKeepsSiblingMaskRulesWhenDroppingOneColumnThroughProxy() throws Exception {
        try (MCPInteractionClient interactionClient = createOpenedInteractionClient()) {
            ...
            assertThat(String.valueOf(interactionClient.call("apply_encrypt_mask_rule", Map.of("plan_id", secondCreatePlanId)).get("status")), is("completed"));
            assertValidationPassed(interactionClient.call("validate_encrypt_mask_rule", Map.of("plan_id", secondCreatePlanId)));
            ...
            assertThat(String.valueOf(interactionClient.call("apply_encrypt_mask_rule", Map.of("plan_id", dropPlanId)).get("status")), is("completed"));
            assertValidationPassed(interactionClient.call("validate_encrypt_mask_rule", Map.of("plan_id", dropPlanId)));
    ...
    void assertPlanApplyValidateAndReadMaskResourcesWithCustomSpiAlgorithmThroughProxy() throws Exception {
        try (MCPInteractionClient interactionClient = createOpenedInteractionClient()) {
            ...
            List<Map<String, Object>> actualMaskPluginItems = getPayloadItems(interactionClient.readResource("shardingsphere://plugins/mask-algorithms"));
            ...
            List<Map<String, Object>> actualMaskRules = getPayloadItems(
                    interactionClient.readResource(String.format("shardingsphere://databases/%s/mask-rules", getLogicalDatabaseName())));
