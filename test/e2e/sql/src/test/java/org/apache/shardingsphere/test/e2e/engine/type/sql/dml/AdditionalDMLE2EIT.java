...
class AdditionalDMLE2EIT extends BaseDMLE2EIT {
    ...
    private int executeUpdateForStatementWithAutoGeneratedKeys(final AssertionTestParameter testParam,
                                                               final SQLE2ETestContext context, final Connection connection) throws SQLException {
    ...
    private int executeUpdateForStatementWithColumnIndexes(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (Statement statement = connection.createStatement()) {
            return statement.executeUpdate(context.getSQL(), new int[]{1});
        }
    }
    
    private int executeUpdateForPreparedStatementWithColumnIndexes(final SQLE2ETestContext context, final Connection connection) throws SQLException {
    ...
    private int executeUpdateForStatementWithColumnNames(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (Statement statement = connection.createStatement()) {
            return statement.executeUpdate(context.getSQL());
        }
    }
    
    private int executeUpdateForPreparedStatementWithColumnNames(final SQLE2ETestContext context, final Connection connection) throws SQLException {
    ...
    private int executeForStatementWithoutAutoGeneratedKeys(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (Statement statement = connection.createStatement()) {
    ...
    private int executeForPreparedStatementWithoutAutoGeneratedKeys(final SQLE2ETestContext context, final Connection connection) throws SQLException {
    ...
    private int executeForStatementWithColumnIndexes(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (Statement statement = connection.createStatement()) {
    ...
    private int executeForPreparedStatementWithColumnIndexes(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(context.getSQL(), new int[]{1})) {
            for (SQLValue each : context.getAssertion().getSQLValues()) {
                preparedStatement.setObject(each.getIndex(), each.getValue());
            }
    ...
    private int executeForStatementWithColumnNames(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (Statement statement = connection.createStatement()) {
    ...
    private int executeForPreparedStatementWithColumnNames(final SQLE2ETestContext context, final Connection connection) throws SQLException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(context.getSQL(), new String[]{"TODO"})) {
            for (SQLValue each : context.getAssertion().getSQLValues()) {
                preparedStatement.setObject(each.getIndex(), each.getValue());
            }
