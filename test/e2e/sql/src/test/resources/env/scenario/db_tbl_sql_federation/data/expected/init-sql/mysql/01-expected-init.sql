...
CREATE TABLE sql_federation.t_product_extend(extend_id INT PRIMARY KEY, product_id INT NOT NULL, type_int INT NOT NULL, type_smallint SMALLINT NOT NULL, type_numeric DECIMAL NOT NULL, type_float FLOAT NOT NULL, type_double DOUBLE NOT NULL, type_bit BIT(64) NOT NULL, type_tinyint TINYINT NOT NULL, type_mediumint mediumint NOT NULL, type_bigint BIGINT NOT NULL, type_date DATE NOT NULL, type_time TIME NOT NULL, type_datetime DATETIME NOT NULL, type_timestamp TIMESTAMP NOT NULL, type_year YEAR NOT NULL, type_char CHAR NOT NULL, type_text TEXT NOT NULL, type_varchar VARCHAR(50) NOT NULL, type_longtext LONGTEXT NOT NULL, type_longblob LONGBLOB NOT NULL, type_mediumtext mediumtext NOT NULL, type_mediumblob mediumblob NOT NULL, type_binary BINARY(255) NOT NULL, type_varbinary VARBINARY(1024) NOT NULL, type_blob BLOB NOT NULL, type_enum ENUM('spring', 'summer', 'autumn', 'winter') NOT NULL, type_set SET('spring', 'summer', 'autumn', 'winter') NOT NULL, type_json JSON NOT NULL);
