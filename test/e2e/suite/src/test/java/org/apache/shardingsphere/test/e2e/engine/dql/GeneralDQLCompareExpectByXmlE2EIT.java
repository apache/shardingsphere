...
public final class GeneralDQLCompareExpectByXmlE2EIT extends BaseDQLE2EIT {
    
    public GeneralDQLCompareExpectByXmlE2EIT(final AssertionTestParameter testParam) {
        super(testParam);
    }
    
    @Parameters(name = "{0}")
    public static Collection<AssertionTestParameter> getTestParameters() {
        return E2ETestParameterFactory.getAssertionTestParameters(SQLCommandType.DQL_COMPARE_EXPECT_BY_XML);
    }
