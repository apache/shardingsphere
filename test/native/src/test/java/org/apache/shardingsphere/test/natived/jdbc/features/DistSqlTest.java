...
class DistSqlTest {
     ...
     *
     * <p>
     * TODO Cleaning the logical database back to the initial YAML-only state requires unregistering the three storage units.
     *  That path is temporarily unavailable on the main branch because {@code ShardingRuleBuilder} refuses to rebuild a
     *  {@code ShardingRule} once every storage unit is gone, even when the surviving {@code ShardingRuleConfiguration}
     *  only carries non-data-source fields such as {@code defaultShardingColumn} or {@code keyGenerators}. It is tracked
     *  separately.
     * </p>
     *
    ...
    void assertShardingInLocalTransactions() throws SQLException {
        ...
        config.setJdbcUrl("jdbc:shardingsphere:classpath:test-native/yaml/jdbc/features/distsql.yaml");
