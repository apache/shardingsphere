...
import org.apache.shardingsphere.test.it.sql.parser.internal.cases.parser.jaxb.segment.impl.job.ExpectedBinlogDescription;
...
@Getter
@Setter
public final class DorisCreateSyncJobStatementTestCase extends SQLParserTestCase {
    ...
    private final List<ExpectedChannelDescription> channelDescriptions = new LinkedList<>();
