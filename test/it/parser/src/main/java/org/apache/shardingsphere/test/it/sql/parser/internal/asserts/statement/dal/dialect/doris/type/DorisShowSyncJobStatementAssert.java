...
public final class DorisShowSyncJobStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisShowSyncJobStatement actual, final DorisShowSyncJobStatementTestCase expected) {
        if (null != expected.getFromDatabase()) {
            DatabaseAssert.assertIs(assertContext, actual.getFromDatabase().orElse(null), expected.getFromDatabase());
        }
    }
}
