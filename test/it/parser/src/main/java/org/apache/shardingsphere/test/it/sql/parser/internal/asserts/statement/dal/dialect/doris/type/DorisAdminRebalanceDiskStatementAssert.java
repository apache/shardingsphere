...
public final class DorisAdminRebalanceDiskStatementAssert {
    ...
    /**
     * Assert admin rebalance disk statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual admin rebalance disk statement
     * @param expected expected admin rebalance disk statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminRebalanceDiskStatement actual, final DorisAdminRebalanceDiskStatementTestCase expected) {
        assertThat(assertContext.getText("cancel flag does not match: "), actual.isCancel(), is(expected.isCancel()));
