...
/**
 * Show create materialized view statement test case for Doris.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@Getter
@Setter
public final class DorisShowCreateMaterializedViewStatementTestCase extends SQLParserTestCase {
