...
public final class ExportStorageNodesStatementAssert {
    ...
    /**
     * Assert export storage nodes statement is correct with expected parser result.
     * 
     * @param assertContext assert context
     * @param actual actual export storage nodes statement
     * @param expected expected export storage nodes statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final ExportStorageNodesStatement actual,
                                final ExportStorageNodesStatementTestCase expected) {
        if (null == expected) {
