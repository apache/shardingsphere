...
public final class DorisAdminSetPartitionVersionStatementAssert {
    ...
    /**
     * Assert admin set table partition version statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual admin set table partition version statement
     * @param expected expected admin set table partition version statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminSetPartitionVersionStatement actual,
                                final DorisAdminSetPartitionVersionStatementTestCase expected) {
