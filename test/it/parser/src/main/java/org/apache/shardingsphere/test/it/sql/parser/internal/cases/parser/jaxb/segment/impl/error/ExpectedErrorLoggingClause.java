...
package org.apache.shardingsphere.test.it.sql.parser.internal.cases.parser.jaxb.segment.impl.error;
...
/**
 * Expected error logging clause.
 */
@Getter
@Setter
public final class ExpectedErrorLoggingClause extends AbstractExpectedSQLSegment {
    
    @XmlElement
    private ExpectedTable table;
    
    @XmlElement
    private ExpectedExpression tag;
    
    @XmlAttribute(name = "reject-limit")
