...
public final class DorisAdminSetReplicaVersionStatementAssert {
    ...
    /**
     * Assert admin set replica version statement is correct with expected parser result.
     *
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminSetReplicaVersionStatement actual, final DorisAdminSetReplicaVersionStatementTestCase expected) {
