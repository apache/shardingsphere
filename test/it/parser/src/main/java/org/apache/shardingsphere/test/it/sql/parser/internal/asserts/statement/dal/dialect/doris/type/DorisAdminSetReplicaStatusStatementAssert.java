...
public final class DorisAdminSetReplicaStatusStatementAssert {
    ...
    /**
     * Assert admin set replica status statement is correct with expected parser result.
     *
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminSetReplicaStatusStatement actual, final DorisAdminSetReplicaStatusStatementTestCase expected) {
