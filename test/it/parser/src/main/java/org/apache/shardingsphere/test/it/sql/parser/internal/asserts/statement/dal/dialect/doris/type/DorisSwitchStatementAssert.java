...
public final class DorisSwitchStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisSwitchStatement actual, final DorisSwitchStatementTestCase expected) {
        assertThat(assertContext.getText("Catalog name assertion error: "), actual.getCatalogName(), is(expected.getCatalogName().getName()));
    }
}
