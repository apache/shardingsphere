...
/**
 * Alter SQL block rule statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisAlterSqlBlockRuleStatementAssert {
    
    /**
     * Assert alter SQL block rule statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual alter SQL block rule statement
     * @param expected expected alter SQL block rule statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAlterSqlBlockRuleStatement actual, final DorisAlterSqlBlockRuleStatementTestCase expected) {
