...
public final class DropFileStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DropFileStatement actual, final DropFileStatementTestCase expected) {
    ...
    private static void assertFileName(final SQLCaseAssertContext assertContext, final DropFileStatement actual, final DropFileStatementTestCase expected) {
    ...
    private static void assertDatabaseName(final SQLCaseAssertContext assertContext, final DropFileStatement actual, final DropFileStatementTestCase expected) {
    ...
    private static void assertProperties(final SQLCaseAssertContext assertContext, final DropFileStatement actual, final DropFileStatementTestCase expected) {
