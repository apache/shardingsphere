...
public final class ReleaseSavepointStatementAssert {
    ...
    /**
     * Assert release savepoint statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual release savepoint statement
     * @param expected expected release savepoint statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final ReleaseSavepointStatement actual, final ReleaseSavepointStatementTestCase expected) {
