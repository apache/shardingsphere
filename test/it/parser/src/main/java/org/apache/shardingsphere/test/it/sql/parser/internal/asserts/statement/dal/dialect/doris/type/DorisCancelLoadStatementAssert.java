...
/**
 * Cancel load statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisCancelLoadStatementAssert {
    
    /**
     * Assert cancel load statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual cancel load statement
     * @param expected expected cancel load statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisCancelLoadStatement actual, final DorisCancelLoadStatementTestCase expected) {
