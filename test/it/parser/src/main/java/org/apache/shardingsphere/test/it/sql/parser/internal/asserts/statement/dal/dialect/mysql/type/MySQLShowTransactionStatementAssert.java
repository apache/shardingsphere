...
/**
 * Show transaction statement assert for MySQL.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class MySQLShowTransactionStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final MySQLShowTransactionStatement actual, final MySQLShowTransactionStatementTestCase expected) {
