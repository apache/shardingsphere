...
/**
 * Admin set table status statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisAdminSetTableStatusStatementAssert {
    
    /**
     * Assert admin set table status statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual admin set table status statement
     * @param expected expected admin set table status statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminSetTableStatusStatement actual, final DorisAdminSetTableStatusStatementTestCase expected) {
        assertNotNull(actual.getTable(), assertContext.getText("Table should not be null"));
