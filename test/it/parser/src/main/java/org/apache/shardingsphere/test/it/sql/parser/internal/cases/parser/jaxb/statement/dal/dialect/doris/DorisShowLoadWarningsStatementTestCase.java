...
/**
 * Show load warnings statement test case for Doris.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@Getter
@Setter
public final class DorisShowLoadWarningsStatementTestCase extends SQLParserTestCase {
    
    @XmlElement
    private ExpectedDatabase database;
    
    @XmlAttribute(name = "condition-type")
    private String conditionType;
    
    @XmlAttribute(name = "condition-value")
