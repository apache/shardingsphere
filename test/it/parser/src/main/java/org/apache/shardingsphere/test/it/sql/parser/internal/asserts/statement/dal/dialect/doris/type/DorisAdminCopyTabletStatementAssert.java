...
public final class DorisAdminCopyTabletStatementAssert {
    ...
    /**
     * Assert admin copy tablet statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual admin copy tablet statement
     * @param expected expected admin copy tablet statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminCopyTabletStatement actual, final DorisAdminCopyTabletStatementTestCase expected) {
        assertThat(assertContext.getText("Tablet ID does not match: "), actual.getTabletId(), is(expected.getTabletId()));
