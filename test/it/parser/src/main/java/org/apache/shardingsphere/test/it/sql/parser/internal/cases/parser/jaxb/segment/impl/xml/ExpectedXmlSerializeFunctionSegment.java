...
/**
 * Expected XML serialize function segment.
 */
@Getter
@Setter
public final class ExpectedXmlSerializeFunctionSegment extends AbstractExpectedSQLSegment {
    ...
    @XmlAttribute(name = "indent-size")
    private String indentSize;
    
    @XmlElement
    private ExpectedExpression parameter;
}
