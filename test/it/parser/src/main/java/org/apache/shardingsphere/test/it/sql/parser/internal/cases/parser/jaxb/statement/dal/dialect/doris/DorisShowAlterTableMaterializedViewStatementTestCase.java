...
/**
 * Show alter table materialized view statement test case for Doris.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@Getter
@Setter
public final class DorisShowAlterTableMaterializedViewStatementTestCase extends SQLParserTestCase {
