...
/**
 * Show events statement assert for MySQL.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class MySQLShowEventsStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final MySQLShowEventsStatement actual, final MySQLShowEventsStatementTestCase expected) {
