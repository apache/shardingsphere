...
/**
 * Show stream load statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisShowStreamLoadStatementAssert {
    
    /**
     * Assert show stream load statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual show stream load statement
     * @param expected expected show stream load statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisShowStreamLoadStatement actual, final DorisShowStreamLoadStatementTestCase expected) {
    ...
    private static void assertDatabase(final SQLCaseAssertContext assertContext, final DorisShowStreamLoadStatement actual, final DorisShowStreamLoadStatementTestCase expected) {
    ...
    private static void assertWhere(final SQLCaseAssertContext assertContext, final DorisShowStreamLoadStatement actual, final DorisShowStreamLoadStatementTestCase expected) {
    ...
    private static void assertOrderBy(final SQLCaseAssertContext assertContext, final DorisShowStreamLoadStatement actual, final DorisShowStreamLoadStatementTestCase expected) {
    ...
    private static void assertLimit(final SQLCaseAssertContext assertContext, final DorisShowStreamLoadStatement actual, final DorisShowStreamLoadStatementTestCase expected) {
