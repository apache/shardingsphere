...
/**
 * Create sharding key generate strategy statement assert.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class CreateShardingKeyGenerateStrategyStatementAssert {
    
    /**
     * Assert create sharding key generate strategy statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual create sharding key generate strategy statement
     * @param expected expected create sharding key generate strategy statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final CreateShardingKeyGenerateStrategyStatement actual,
                                final CreateShardingKeyGenerateStrategyStatementTestCase expected) {
