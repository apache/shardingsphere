...
/**
 * Admin clean trash statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisAdminCleanTrashStatementAssert {
    
    /**
     * Assert admin clean trash statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual admin clean trash statement
     * @param expected expected admin clean trash statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisAdminCleanTrashStatement actual, final DorisAdminCleanTrashStatementTestCase expected) {
