...
/**
 * Expected exchange partition definition.
 */
@Getter
@Setter
public final class ExpectedExchangePartitionDefinition extends AbstractExpectedSQLSegment {
    
    @XmlElement(name = "partition")
    private ExpectedPartition partition;
    
    @XmlElement(name = "exchange-table")
    private ExpectedSimpleTable exchangeTable;
}
