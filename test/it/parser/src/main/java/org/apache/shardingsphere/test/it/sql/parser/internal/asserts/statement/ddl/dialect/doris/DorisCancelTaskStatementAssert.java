...
public final class DorisCancelTaskStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisCancelTaskStatement actual, final DorisCancelTaskStatementTestCase expected) {
        if (null != expected.getJobName()) {
            assertThat(assertContext.getText("Job name does not match: "), actual.getJobName(), is(expected.getJobName()));
        }
