...
/**
 * Plan replayer play statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisPlanReplayerPlayStatementAssert {
    
    /**
     * Assert plan replayer play statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual plan replayer play statement
