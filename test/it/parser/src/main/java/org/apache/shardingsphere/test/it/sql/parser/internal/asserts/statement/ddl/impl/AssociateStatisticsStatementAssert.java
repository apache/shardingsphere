...
public final class AssociateStatisticsStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
    ...
    private static void assertTables(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
        if (null != expected.getTables()) {
            TableAssert.assertIs(assertContext, actual.getTables(), expected.getTables());
        }
    }
    
    private static void assertColumns(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
    ...
    private static void assertIndexes(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
    ...
    private static void assertFunctions(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
    ...
    private static void assertPackages(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
    ...
    private static void assertTypes(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
    ...
    private static void assertIndexTypes(final SQLCaseAssertContext assertContext, final AssociateStatisticsStatement actual, final AssociateStatisticsStatementTestCase expected) {
