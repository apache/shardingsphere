...
public final class CreateDatabaseStatementAssert {
    
    /**
     * Assert create database statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual create database statement
