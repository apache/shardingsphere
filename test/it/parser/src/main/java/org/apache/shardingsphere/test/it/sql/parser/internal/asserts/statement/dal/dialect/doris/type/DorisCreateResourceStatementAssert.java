...
/**
 * Create resource statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisCreateResourceStatementAssert {
    
    /**
     * Assert create resource statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual create resource statement
     * @param expected expected create resource statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisCreateResourceStatement actual, final DorisCreateResourceStatementTestCase expected) {
