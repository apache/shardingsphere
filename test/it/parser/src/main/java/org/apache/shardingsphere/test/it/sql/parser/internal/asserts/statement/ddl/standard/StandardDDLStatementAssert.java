...
import org.apache.shardingsphere.test.it.sql.parser.internal.asserts.statement.ddl.standard.type.CreateDatabaseStatementAssert;
...
import org.apache.shardingsphere.test.it.sql.parser.internal.asserts.statement.ddl.standard.type.DropDatabaseStatementAssert;
...
import org.apache.shardingsphere.test.it.sql.parser.internal.asserts.statement.ddl.standard.type.CreateTriggerStatementAssert;
...
import org.apache.shardingsphere.test.it.sql.parser.internal.asserts.statement.ddl.standard.type.CancelBuildIndexStatementAssert;
...
public final class StandardDDLStatementAssert {
    ...
    public static void assertIs(final SQLCaseAssertContext assertContext, final DDLStatement actual, final SQLParserTestCase expected) {
        ...
        } else if (actual instanceof BuildIndexStatement) {
            BuildIndexStatementAssert.assertIs(assertContext, (BuildIndexStatement) actual, (BuildIndexStatementTestCase) expected);
        } else if (actual instanceof CancelBuildIndexStatement) {
            CancelBuildIndexStatementAssert.assertIs(assertContext, (CancelBuildIndexStatement) actual, (CancelBuildIndexStatementTestCase) expected);
        } else if (actual instanceof CreateFileStatement) {
            CreateFileStatementAssert.assertIs(assertContext, (CreateFileStatement) actual, (CreateFileStatementTestCase) expected);
        ...
        } else if (actual instanceof CreateDatabaseStatement) {
            CreateDatabaseStatementAssert.assertIs(assertContext, (CreateDatabaseStatement) actual, (CreateDatabaseStatementTestCase) expected);
        } else if (actual instanceof DropDatabaseStatement) {
            DropDatabaseStatementAssert.assertIs(assertContext, (DropDatabaseStatement) actual, (DropDatabaseStatementTestCase) expected);
        }
    }
}
