...
/**
 * Show database statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisShowDatabaseStatementAssert {
    
    /**
     * Assert show database statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual show database statement
