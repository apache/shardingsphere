...
/**
 * Show trash statement assert for Doris.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DorisShowTrashStatementAssert {
    
    /**
     * Assert show trash statement is correct with expected parser result.
     *
     * @param assertContext assert context
     * @param actual actual show trash statement
     * @param expected expected show trash statement test case
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final DorisShowTrashStatement actual, final DorisShowTrashStatementTestCase expected) {
