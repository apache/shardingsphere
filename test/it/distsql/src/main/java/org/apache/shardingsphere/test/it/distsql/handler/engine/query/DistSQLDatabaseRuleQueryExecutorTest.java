...
public abstract class DistSQLDatabaseRuleQueryExecutorTest {
    ...
    protected void assertQueryResultRows(final DatabaseRuleConfiguration ruleConfig, final DistSQLStatement sqlStatement, final Collection<LocalDataQueryResultRow> expected) throws SQLException {
