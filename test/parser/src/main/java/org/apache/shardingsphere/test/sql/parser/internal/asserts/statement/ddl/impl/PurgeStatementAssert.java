...
import org.apache.shardingsphere.test.sql.parser.internal.jaxb.cases.domain.statement.ddl.PurgeStatementTestCase;

/**
 * Purge statement assert.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class PurgeStatementAssert {
