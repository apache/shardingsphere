...
public class AlterReadwriteSplittingStorageUnitStatusStatementAssert {
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final AlterReadwriteSplittingStorageUnitStatusStatement actual, final AlterReadwriteSplittingStorageUnitStatusStatementTestCase expected) {
        if (null == expected) {
