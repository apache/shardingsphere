...
import org.apache.shardingsphere.test.sql.parser.internal.jaxb.cases.domain.statement.distsql.rdl.drop.DropDataBaseDiscoveryHeartbeatStatementTestCase;
...
/**
 * Drop database discovery heartbeat statement assert.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class DropDatabaseDiscoveryHeartbeatStatementAssert {
    
    /**
     * Assert drop database discovery heartbeat statement is correct with expected parser result.
     *
