...
## Code push conventions
 ...
 - Use checkstyle to check code style, provide special reason if rule violated. Find checkstyle template from `sharding-jdbc/src/resources/dd_checks.xml`, please use checkstyle 6.2 to run the rule.
