...
public final class ExtractorUtils {
    ...
    /**
     * Get node only from first descendant, each descendant only has one child.
     *
     * @param node start node
     * @param ruleName rule name
     * @return matched node
     */
    public static Optional<ParserRuleContext> getNodeOnlyFromFirstDescendant(final ParserRuleContext node, final RuleName ruleName) {
