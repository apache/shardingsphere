...
public class TableReferencesClauseParser implements SQLClauseParser {
    ...
    protected final void parseTableFactor(final SQLStatement sqlStatement, final boolean isSingleTableOnly) {
        ...
        if (isSingleTableOnly || shardingRule.findTableRule(tableName).isPresent()
            ...
            sqlStatement.addSQLToken(new TableToken(beginPosition, skippedSchemaNameLength, tableName, QuoteCharacter.valueFrom(SQLUtil.getStartDelimiter(literals))));
    ...
    public final void parseSingleTableWithoutAlias(final SQLStatement sqlStatement) {
        ...
        sqlStatement.addSQLToken(new TableToken(beginPosition, skippedSchemaNameLength, SQLUtil.getExactlyValue(literals), QuoteCharacter.valueFrom(SQLUtil.getStartDelimiter(literals))));
