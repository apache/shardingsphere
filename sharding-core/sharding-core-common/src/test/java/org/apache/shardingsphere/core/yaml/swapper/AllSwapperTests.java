...
import org.apache.shardingsphere.core.yaml.swapper.impl.UserYamlSwapperTest;
...
@RunWith(Suite.class)
@SuiteClasses({
        MasterSlaveRuleConfigurationYamlSwapperTest.class, 
        ShardingRuleConfigurationYamlSwapperTest.class, 
