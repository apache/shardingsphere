...
public final class ShardingTableMetadataLoader implements TableMetadataLoader<ShardingRule> {
    ...
    private TableMetaData load(final DatabaseType databaseType, final Map<String, DataSource> dataSourceMap, 
                              final TableRule tableRule, final ShardingRule shardingRule, final ConfigurationProperties properties) throws SQLException {
