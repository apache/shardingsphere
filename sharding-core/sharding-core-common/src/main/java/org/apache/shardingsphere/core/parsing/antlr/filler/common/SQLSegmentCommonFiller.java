...
package org.apache.shardingsphere.core.parsing.antlr.filler.common;
 ...
 * @author duhongjun
 */
public interface SQLSegmentCommonFiller<T extends SQLSegment> extends SQLSegmentFiller {
     ...
     */
    void fill(T sqlSegment, SQLStatement sqlStatement, String sql, ShardingTableMetaData shardingTableMetaData);
}
