...
public final class SnowflakeShardingKeyGenerator implements ShardingKeyGenerator {
    ...
    private int getMaxVibrationOffset() {
        int result = Integer.valueOf(properties.getProperty("max.vibration.offset", String.valueOf(DEFAULT_VIBRATION_VALUE)));
    ...
    private void vibrateSequenceOffset() {
        sequenceOffset = (int) (sequenceOffset + 1) & getMaxVibrationOffset();
    }
}
