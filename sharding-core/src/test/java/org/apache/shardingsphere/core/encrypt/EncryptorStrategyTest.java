...
public final class EncryptorStrategyTest {
    ...
    public void assertValidConstructor() {
        ...
        EncryptorStrategy actual = new EncryptorStrategy(encryptorConfiguration);
    ...
    public void assertInvalidConstructor() {
        ...
        new EncryptorStrategy(encryptorConfiguration);
    }
