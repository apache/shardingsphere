...
public final class ShardingDataSourceNamesTest {
    ...
    public void assertGetAllDataSourceNames() {
        ...
        shardingRuleConfig.getMasterSlaveRuleConfigs().add(new MasterSlaveRuleConfiguration("ms_ds", "master_ds", 
                Collections.singletonList("slave_ds"), MasterSlaveLoadBalanceAlgorithmFactory.getInstance().newAlgorithm("ROUND_ROBIN", new Properties())));
