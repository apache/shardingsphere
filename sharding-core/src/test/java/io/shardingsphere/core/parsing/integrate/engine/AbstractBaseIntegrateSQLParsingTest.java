...
public abstract class AbstractBaseIntegrateSQLParsingTest {
    ...
    private static ShardingTableMetaData buildShardingTableMetaData() {
        ...
        tableMetaDataMap.put("t_order", new TableMetaData(Arrays.asList(new ColumnMetaData("order_id", "int", true), new ColumnMetaData("user_id", "int", false), new ColumnMetaData("status", "int", false))));
