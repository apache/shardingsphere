...
public final class SQLRewriteEngineTest {
    ...
    public void assertRewriteWithoutChange() {
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SELECT table_y.id FROM table_y WHERE table_y.id=?", DatabaseType.MySQL, selectStatement, null, Collections.<Object>singletonList(1));
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT table_y.id FROM table_y WHERE table_y.id=?"));
    }
    ...
    public void assertRewriteForTableName() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT table_1.id, x.name FROM table_1 x WHERE table_1.id=? AND x.name=?"));
    }
    ...
    public void assertRewriteForOrderByAndGroupByDerivedColumns() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT x.age, x.id as ORDER_BY_DERIVED_0, x.name as GROUP_BY_DERIVED_0 FROM table_1 x GROUP BY x.id ORDER BY x.name"));
    }
    ...
    public void assertRewriteForAggregationDerivedColumns() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT AVG(x.age), COUNT(x.age) as AVG_DERIVED_COUNT_0, SUM(x.age) as AVG_DERIVED_SUM_0 FROM table_1 x"));
    }
    ...
    public void assertRewriteForAutoGeneratedKeyColumn() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(tableUnit, tableTokens, null).getSql(), is("INSERT INTO table_1 (name, age, id) VALUES (?, ?, ?)"));
    }
    ...
    public void assertRewriteForAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(tableUnit, tableTokens, null).getSql(), is("INSERT INTO table_1(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteForAutoGeneratedKeyColumnWithoutColumnsWithoutParameter() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(tableUnit, tableTokens, null).getSql(), is("INSERT INTO table_1(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteForLimit() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 4"));
    }
    ...
    public void assertRewriteForRowNum() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(),
    ...
    public void assertRewriteForLimitForMemoryGroupBy() {
        ...
        selectStatement.getSqlTokens().add(new RowCountToken(36, 2));
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SELECT x.id FROM table_x x LIMIT 2, 2", DatabaseType.MySQL, selectStatement, null, Collections.emptyList());
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 2147483647"));
    }
    ...
    public void assertRewriteForLimitForNotRewriteLimit() {
        ...
        selectStatement.getSqlTokens().add(new RowCountToken(36, 2));
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SELECT x.id FROM table_x x LIMIT 2, 2", DatabaseType.MySQL, selectStatement, null, Collections.emptyList());
        assertThat(rewriteEngine.rewrite(false).toSQL(null, tableTokens, null).getSql(), is("SELECT x.id FROM table_1 x LIMIT 2, 2"));
    }
    ...
    public void assertRewriteForRowNumForNotRewriteLimit() {
        ...
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", DatabaseType.Oracle, selectStatement, null, Collections.emptyList());
        assertThat(rewriteEngine.rewrite(false).toSQL(null, tableTokens, null).getSql(),
    ...
    public void assertRewriteForDerivedOrderBy() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, null).getSql(), is("SELECT x.id, x.name FROM table_1 x GROUP BY x.id, x.name DESC ORDER BY id ASC,name DESC "));
    }
    ...
    public void assertSchemaTokenRewriteForTableName() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, shardingRule).getSql(), is("SHOW CREATE TABLE table_y ON db0"));
    }
    ...
    public void assertIndexTokenForIndexNameTableName() {
        ...
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, shardingRule).getSql(), is("CREATE INDEX index_name_table_1 ON table_1 ('column')"));
    }
