...
import io.shardingjdbc.core.merger.dql.common.fixture.TestStreamResultSetMerger;
...
public final class StreamResultSetMergerTest {
    ...
    public void setUp() {
        ...
        streamResultSetMerger.setCurrentQueryResult(new TestQueryResult(resultSet));
    }
