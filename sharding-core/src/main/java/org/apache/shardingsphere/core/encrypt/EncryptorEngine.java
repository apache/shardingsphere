...
public final class EncryptorEngine {
    ...
    public EncryptorEngine(final Map<String, EncryptorStrategy> shardingEncryptorStrategies) {
    ...
    public EncryptorEngine(final Map<String, EncryptorStrategy> shardingEncryptorStrategies, final EncryptorStrategy defaultEncryptorStrategy) {
        for (Entry<String, EncryptorStrategy> entry : shardingEncryptorStrategies.entrySet()) {
            if (null != entry.getValue()) {
                this.shardingEncryptorStrategies.put(entry.getKey(), entry.getValue());
            } else {
