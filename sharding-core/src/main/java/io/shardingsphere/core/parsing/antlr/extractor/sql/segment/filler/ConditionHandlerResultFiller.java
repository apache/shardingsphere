...
import io.shardingsphere.core.parsing.antlr.extractor.sql.segment.filler.AbstractHandlerResultFiller;
...
/**
 * Condition handler result filler.
 * 
 * @author duhongjun
 */
public class ConditionHandlerResultFiller extends AbstractHandlerResultFiller {
    
    public ConditionHandlerResultFiller() {
        super(ConditionExtractResult.class);
    }
