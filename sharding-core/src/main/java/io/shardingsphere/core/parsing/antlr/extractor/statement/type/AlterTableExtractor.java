...
import io.shardingsphere.core.parsing.antlr.extractor.statement.phrase.DropColumnExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.statement.phrase.RenameTableExtractor;
...
public abstract class AlterTableExtractor extends DDLStatementExtractor {
    ...
    public AlterTableExtractor() {
        ...
        addPhraseExtractor(new RenameTableExtractor());
