...
package io.shardingsphere.core.parsing.antlr.extractor.statement.dialect.sqlserver;

import io.shardingsphere.core.parsing.antlr.extractor.phrase.AddColumnExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.phrase.ModifyColumnExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.phrase.dialect.sqlserver.SQLServerAddIndexExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.phrase.dialect.sqlserver.SQLServerAddPrimaryKeyExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.phrase.dialect.sqlserver.SQLServerDropIndexExtractor;
