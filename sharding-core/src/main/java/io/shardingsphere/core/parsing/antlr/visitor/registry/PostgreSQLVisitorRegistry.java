...
/**
 * Visitor registry for PostgreSQL.
 * 
 * @author duhongjun
 * @author zhangliang
 */
public final class PostgreSQLVisitorRegistry implements DatabaseVisitorRegistry {
    ...
    private static void registerDDL() {
        ...
        VISITORS.put(SQLStatementType.ALTER_TABLE, new PostgreSQLAlterTableVisitor());
        VISITORS.put(SQLStatementType.DROP_TABLE, new OnlyMultiTableVisitor());
        VISITORS.put(SQLStatementType.TRUNCATE_TABLE, new OnlyMultiTableVisitor());
        VISITORS.put(SQLStatementType.CREATE_INDEX, new IndexWithTableStatementVisitor());
        VISITORS.put(SQLStatementType.ALTER_INDEX, new PostgreSQLAlterIndexVisitor());
