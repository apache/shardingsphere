...
/**
 * Condition segment filler.
 * 
 * @author duhongjun
 */
public class PredicateSegmentFiller implements SQLSegmentFiller {
    ...
    public void fill(final SQLSegment sqlSegment, final SQLStatement sqlStatement, final ShardingRule shardingRule, final ShardingTableMetaData shardingTableMetaData) {
        PredicateSegment predicateSegment = (PredicateSegment) sqlSegment;
        OrCondition orCondition = predicateSegment.getOrCondition().optimize();
