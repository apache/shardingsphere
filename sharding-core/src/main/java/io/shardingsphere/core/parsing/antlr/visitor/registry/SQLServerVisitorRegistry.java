...
/**
 * Visitor registry for SQLServer.
 * 
 * @author duhongjun
 * @author zhangliang
 */
public final class SQLServerVisitorRegistry implements DatabaseVisitorRegistry {
    ...
    private static void registerDDL() {
        ...
        VISITORS.put(SQLStatementType.ALTER_TABLE, new SQLServerAlterTableVisitor());
        ...
        VISITORS.put(SQLStatementType.ALTER_INDEX, new IndexWithTableStatementVisitor());
