...
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.ColumnDefinitionExtractResult;
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.DropColumnExtractResult;
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.DropPrimaryKeyExtractResult;
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.IndexExtractResult;
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.PrimaryKeyExtractResult;
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.TableExtractResult;
import io.shardingsphere.core.parsing.antlr.extractor.statement.clause.result.TableJoinExtractResult;
