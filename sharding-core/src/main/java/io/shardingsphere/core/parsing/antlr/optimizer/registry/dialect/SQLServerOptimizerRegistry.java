...
/**
 * SQL statement optimizer for SQLServer.
 * 
 * @author duhongjun
 * @author zhangliang
 */
public final class SQLServerOptimizerRegistry implements SQLStatementOptimizerRegistry {
    ...
    private static void registerDDL() {
        ...
        OPTIMIZER.put(SQLStatementType.ALTER_TABLE, new AlterTableOptimizer());
    }
