...
import io.shardingsphere.core.parsing.antlr.extractor.sql.statement.dialect.postgresql.PostgreSQLAlterIndexExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.sql.statement.dialect.postgresql.PostgreSQLAlterTableExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.sql.statement.dialect.postgresql.PostgreSQLDropIndexExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.sql.statement.dialect.postgresql.PostgreSQLDropTableExtractor;
import io.shardingsphere.core.parsing.antlr.extractor.sql.statement.dialect.postgresql.PostgreSQLTruncateTableExtractor;
