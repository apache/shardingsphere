 ...
 * @author duhongjun
 */
public class ColumnExtractHandler implements ASTExtractHandler<Optional<ColumnExtractResult>>{
    
    @Override
    public Optional<ColumnExtractResult> extract(ParserRuleContext ancestorNode) {
        ...
        return Optional.of(new ColumnExtractResult(ownerName, columnName));
    }
}
