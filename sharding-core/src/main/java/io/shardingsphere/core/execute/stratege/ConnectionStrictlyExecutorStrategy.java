...
package io.shardingsphere.core.execute.stratege;
...
/**
 * Connection strictly execute strategy.
 *
 * @author panjuan
 */
public final class ConnectionStrictlyExecutorStrategy extends ExecutorEngine {
    
    public ConnectionStrictlyExecutorStrategy(final int executorSize) {
        super(executorSize);
    }
