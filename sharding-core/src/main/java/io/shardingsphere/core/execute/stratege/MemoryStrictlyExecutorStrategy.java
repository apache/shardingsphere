...
/**
 * Memory strictly execute strategy.
 *
 * @author panjuan
 */
public final class MemoryStrictlyExecutorStrategy extends ExecutorEngine {
    
    public MemoryStrictlyExecutorStrategy(final int executorSize) {
        super(executorSize);
    }
