...
public final class SQLTokenGenerateEngineTest {
    ...
    public void setUp() {
        ...
        SelectItems selectItems = new SelectItems(1, 20, false, 
                Collections.<SelectItem>singletonList(new AggregationDistinctSelectItem(1, 2, AggregationType.COUNT, "(DISTINCT id)", "c", "id")), Collections.<String, Collection<String>>emptyMap());
