...
public final class ShardingRewriteEngineTest {
    ...
    private ShardingRule createShardingRule() throws IOException {
        URL url = ShardingRewriteEngineTest.class.getClassLoader().getResource("yaml/rewrite-rule.yaml");
    ...
    public void assertRewriteWithoutChange() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultWithoutChange(), "SELECT table_y.id FROM table_y WHERE table_y.id=?", Collections.<Object>singletonList(1));
    ...
    public void assertRewriteTableName() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(
    ...
    public void assertRewriteAggregationDerivedColumns() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForAggregationDerivedColumns(), "SELECT AVG(x.age) FROM table_x x", Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(), is(
    ...
    public void assertRewriteAutoGeneratedKeyColumn() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForAutoGeneratedKeyColumn(), "INSERT INTO table_x (name, age) VALUES (?, ?)", Arrays.<Object>asList("Bill", 1));
    ...
    public void assertRewriteDuplicateKeyWithoutColumnsWithoutParameter() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForDuplicateKeyWithoutColumnsWithoutParameter(),
    ...
    public void assertRewriteDuplicateKeyWithSetWithoutParameter() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForDuplicateKeyWithSetWithoutParameter(),
    ...
    public void assertRewriteColumnWithoutColumnsWithoutParameter() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForColumnWithoutColumnsWithoutParameter(), "INSERT INTO `table_x` VALUES (10, 1)", Arrays.<Object>asList("x", 1));
        assertThat(rewriteEngine.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteColumnWithoutColumnsWithParameter() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForColumnWithoutColumnsWithParameter(), "INSERT INTO `table_x` VALUES (?, ?)", Arrays.<Object>asList("x", 1));
        assertThat(rewriteEngine.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteLimit() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForLimit(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
    ...
    public void assertRewriteRowNumber() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForRowNumber(),
    ...
    public void assertRewriteTopAndRowNumber() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForTopAndRowNumber(),
    ...
    public void assertRewriteLimitForMemoryGroupBy() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForLimitForMemoryGroupBy(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
    ...
    public void assertRewriteRowNumForMemoryGroupBy() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForRowNumForMemoryGroupBy(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteTopAndRowNumberForMemoryGroupBy() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForTopAndRowNumberForMemoryGroupBy(), 
                "SELECT * FROM (SELECT TOP(4) row_number() OVER (ORDER BY x.id) AS rownum_, x.id FROM table_x x) AS row_ WHERE row_.rownum_>2", Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteLimitForNotRewritePagination() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForLimitForNotRewritePagination(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
    ...
    public void assertRewriteRowNumForNotRewritePagination() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForRowNumForNotRewritePagination(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteDerivedOrderBy() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForDerivedOrderBy(), "SELECT x.id, x.name FROM table_x x GROUP BY x.id, x.name DESC", Collections.emptyList());
    ...
    public void assertRewriteIndexTokenForIndexNameTableName() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForIndexTokenForIndexNameTableName(), "CREATE INDEX index_name ON table_x ('column')", Collections.emptyList());
    ...
    public void assertRewriteTableTokenWithoutBackQuoteForShow() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForTableTokenWithoutBackQuoteForShow(), "SHOW COLUMNS FROM table_x", Collections.emptyList());
    ...
    public void assertRewriteTableTokenWithBackQuoteForShow() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createRouteResultForTableTokenWithBackQuoteForShow(), "SHOW COLUMNS FROM `table_x`", Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForShow() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultForTableTokenWithSchemaForShow(), "SHOW COLUMNS FROM sharding_db.table_x", Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForSelect() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultForTableTokenWithSchemaForSelect(), "SELECT * FROM sharding_db.table_x", Collections.emptyList());
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithCipher() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList());
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithPlain() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList(), false);
    ...
    public void assertRewriteUpdateWithShardingEncryptor() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultForUpdateWithShardingEncryptor(), "UPDATE table_z SET id = 1 WHERE id = 2", Collections.emptyList());
    ...
    public void assertRewriteInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor() {
        ShardingRewriteEngine rewriteEngine = createRewriteEngine(createSQLRouteResultForInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor(), 
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithCipher() {
        ...
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT cipher FROM table_z WHERE cipher = ? AND name=?"));
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithPlain() {
        ...
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain = ? AND name=?"));
    ...
    private ShardingRewriteEngine createRewriteEngine(final SQLRouteResult routeResult, final String sql, final List<Object> parameters) {
        return createRewriteEngine(routeResult, sql, parameters, true);
    }
    
    private ShardingRewriteEngine createRewriteEngine(final SQLRouteResult routeResult, final String sql, final List<Object> parameters, final boolean isQueryWithCipherColumn) {
        return new ShardingRewriteEngine(shardingRule, null, routeResult, sql, parameters, isQueryWithCipherColumn);
    }
    
    @SneakyThrows
    private StandardParameterBuilder getParameterBuilder(final ShardingRewriteEngine rewriteEngine) {
