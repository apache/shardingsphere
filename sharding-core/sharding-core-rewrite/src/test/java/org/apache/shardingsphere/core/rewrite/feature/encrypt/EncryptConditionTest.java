...
public final class EncryptConditionTest {
    ...
    public void assertGetConditionValuesForEqual() {
        List<Object> actual = new EncryptCondition("col", null, -1, 0, 0, new LiteralExpressionSegment(0, 0, 1)).getValues(Collections.emptyList());
    ...
    public void assertGetConditionValuesForIn() {
        List<Object> actual = new EncryptCondition(
                "col", null, -1, 0, 0, Arrays.<ExpressionSegment>asList(new LiteralExpressionSegment(0, 0, 1), new LiteralExpressionSegment(0, 0, 2))).getValues(Collections.emptyList());
