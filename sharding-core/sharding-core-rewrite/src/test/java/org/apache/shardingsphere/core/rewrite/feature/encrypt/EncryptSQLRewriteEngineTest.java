...
public final class EncryptSQLRewriteEngineTest {
    ...
    public void assertInsertWithValuesWithPlaceholderWithPlainEncrypt() {
        ...
        SQLRewriteResult actual = getSQLRewriteResult(sql, parametersOfEqual, true);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher_plain(cipher_1, cipher_2, plain_1, plain_2) VALUES (?, ?, ?, ?), ('encryptValue', 'encryptValue', 3, 4)"));
        assertThat(actual.getParameters().size(), is(4));
        assertThat(actual.getParameters().get(0), is((Object) "encryptValue"));
        assertThat(actual.getParameters().get(1), is((Object) "encryptValue"));
        assertThat(actual.getParameters().get(2), is((Object) 1));
    ...
    public void assertInsertWithValuesWithoutPlaceholderWithQueryEncrypt() {
        String sql = "INSERT INTO t_cipher_assisted_query(encrypt_1, encrypt_2) VALUES (1, 2), (3, 4)";
        SQLRewriteResult actual = getSQLRewriteResult(sql, Collections.emptyList(), true);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher_assisted_query(cipher_1, cipher_2, assisted_query_1, assisted_query_2) " 
    ...
    public void assertInsertWithValuesWithoutPlaceholderWithQueryPlainEncrypt() {
        String sql = "INSERT INTO t_cipher_assisted_query_plain(encrypt_1, encrypt_2) VALUES (1, 2), (3, 4)";
        SQLRewriteResult actual = getSQLRewriteResult(sql, Collections.emptyList(), true);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher_assisted_query_plain(cipher_1, cipher_2, assisted_query_1, plain_1, assisted_query_2, plain_2) " 
    ...
    public void assertInsertWithSetWithoutPlaceholderWithEncrypt() {
        String sql = "INSERT INTO t_cipher SET encrypt_1 = 1, encrypt_2 = 2";
        SQLRewriteResult actual = getSQLRewriteResult(sql, Collections.emptyList(), true);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher SET cipher_1 = 'encryptValue', cipher_2 = 'encryptValue'"));
        assertTrue(actual.getParameters().isEmpty());
    }
    
    @Test
    public void assertInsertWithSetWithoutPlaceholderWithPlainEncrypt() {
        String sql = "INSERT INTO t_cipher_plain SET encrypt_1 = 1, encrypt_2 = 2";
        SQLRewriteResult actual = getSQLRewriteResult(sql, Collections.emptyList(), true);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher_plain SET cipher_1 = 'encryptValue', plain_1 = 1, cipher_2 = 'encryptValue', plain_2 = 2"));
        assertTrue(actual.getParameters().isEmpty());
    }
    
    @Test
    public void assertInsertWithSetWithPlaceholderWithQueryEncrypt() {
        String sql = "INSERT INTO t_cipher_assisted_query SET encrypt_1 = ?, encrypt_2 = ?";
        SQLRewriteResult actual = getSQLRewriteResult(sql, parametersOfEqual, true);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher_assisted_query SET cipher_1 = ?, assisted_query_1 = ?, cipher_2 = ?, assisted_query_2 = ?"));
        assertThat(actual.getParameters().size(), is(4));
        assertThat(actual.getParameters().get(0), is((Object) "encryptValue"));
        assertThat(actual.getParameters().get(1), is((Object) "assistedEncryptValue"));
    ...
    public void assertInsertWithSetWithPlaceholderWithQueryPlainEncrypt() {
        String sql = "INSERT INTO t_cipher_assisted_query_plain SET encrypt_1 = ?, encrypt_2 = ?";
        SQLRewriteResult actual = getSQLRewriteResult(sql, parametersOfEqual, false);
        assertThat(actual.getSql(), is("INSERT INTO t_cipher_assisted_query_plain SET "
                + "cipher_1 = ?, assisted_query_1 = ?, plain_1 = ?, cipher_2 = ?, assisted_query_2 = ?, plain_2 = ?"));
