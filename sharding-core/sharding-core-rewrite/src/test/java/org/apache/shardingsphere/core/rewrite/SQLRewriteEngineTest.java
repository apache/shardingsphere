...
public final class SQLRewriteEngineTest {
    ...
    public void assertRewriteWithoutChange() {
        ...
        assertThat(rewriteEngine.rewrite().toSQL(null, tableTokens).getSql(), is("SELECT table_y.id FROM table_y WHERE table_y.id=?"));
    }
    ...
    public void assertRewriteForTableName() {
        ...
        assertThat(rewriteEngine.rewrite().toSQL(null, tableTokens).getSql(), is("SELECT table_1.id, x.name FROM table_1 x WHERE table_1.id=? AND x.name=?"));
    }
    ...
    public void assertRewriteForOrderByAndGroupByDerivedColumns() {
        ...
        assertThat(rewriteEngine.rewrite().toSQL(null, tableTokens).getSql(), is(
    ...
    public void assertRewriteForAggregationDerivedColumns() {
        ...
        routeResult.setLimit(selectStatement.getLimit());
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SELECT AVG(x.age) FROM table_x x", DatabaseType.MySQL, routeResult, Collections.emptyList(), shardingDataSourceMetaData);
        assertThat(rewriteEngine.rewrite().toSQL(null, tableTokens).getSql(), is(
    ...
    public void assertRewriteForAutoGeneratedKeyColumn() {
        ...
        assertThat(rewriteEngine.rewrite().toSQL(routingUnit, tableTokens).getSql(), is("INSERT INTO table_1 (name, age, id) VALUES (?, ?, ?)"));
    }
    ...
    public void assertTableTokenWithSchemaForUpdate() {
        ...
        assertThat(rewriteEngine.rewrite().toSQL(null, tableTokens).getSql(), is("UPDATE table_1 SET user_id=1 WHERE order_id=1"));
    }
    ...
    public void assertSelectEqualWithShardingEncryptor() {
        ...
        selectStatement.getEncryptConditions().getOrConditions().get(0).getConditions().add(new Condition(column, new SQLParameterMarkerExpression(0)));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
    ...
    public void assertSelectBetweenWithShardingEncryptor() {
        ...
        selectStatement.getEncryptConditions().getOrConditions().add(new AndCondition());
        selectStatement.getEncryptConditions().getOrConditions().get(0).getConditions().add(new Condition(column, new SQLNumberExpression(3), new SQLNumberExpression(5)));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
    ...
    public void assertSelectInWithShardingEncryptor() {
        ...
        selectStatement.getEncryptConditions().getOrConditions().get(0).getConditions().add(new Condition(column, sqlExpressions));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
    ...
    public void assertSelectInWithShardingEncryptorWithParameter() {
        ...
        selectStatement.getEncryptConditions().getOrConditions().get(0).getConditions().add(new Condition(column, sqlExpressions));
        selectStatement.getEncryptConditions().getOrConditions().get(1).getConditions().add(new Condition(column, new SQLNumberExpression(3)));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
    ...
    public void assertUpdateWithShardingEncryptor() {
        ...
        updateStatement.getEncryptConditions().getOrConditions().get(0).getConditions().add(new Condition(column, new SQLNumberExpression(2)));
        routeResult = new SQLRouteResult(updateStatement);
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
    ...
    public void assertUpdateWithQueryAssistedShardingEncryptor() {
        ...
        updateStatement.getEncryptConditions().getOrConditions().add(new AndCondition());
        updateStatement.getEncryptConditions().getOrConditions().get(0).getConditions().add(new Condition(column, new SQLNumberExpression(3), new SQLParameterMarkerExpression(1)));
        routeResult = new SQLRouteResult(updateStatement);
        routeResult.setRoutingResult(new RoutingResult());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule,
