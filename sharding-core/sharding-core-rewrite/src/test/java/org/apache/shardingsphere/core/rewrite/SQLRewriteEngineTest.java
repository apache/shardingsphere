...
public final class SQLRewriteEngineTest {
    ...
    public void assertRewriteForTableName() {
        ...
        parameters.add(1);
        parameters.add("x");
        selectStatement.addSQLToken(new TableToken(7, 13, "table_x", QuoteCharacter.NONE, 0));
        selectStatement.addSQLToken(new TableToken(31, 37, "table_x", QuoteCharacter.NONE, 0));
        selectStatement.addSQLToken(new TableToken(47, 53, "table_x", QuoteCharacter.NONE, 0));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, 
    ...
    public void assertRewriteForOrderByAndGroupByDerivedColumns() {
        selectStatement.addSQLToken(new TableToken(18, 24, "table_x", QuoteCharacter.NONE, 0));
    ...
    public void assertRewriteForAggregationDerivedColumns() {
        selectStatement.addSQLToken(new TableToken(23, 29, "table_x", QuoteCharacter.NONE, 0));
    ...
    public void assertRewriteForDerivedOrderBy() {
        ...
        selectStatement.addSQLToken(new TableToken(25, 31, "table_x", QuoteCharacter.NONE, 0));
        selectStatement.addSQLToken(new OrderByToken(61, 61));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, 
    ...
    public void assertGenerateSQL() {
        ...
        selectStatement.addSQLToken(new TableToken(7, 13, "table_x", QuoteCharacter.NONE, 0));
        selectStatement.addSQLToken(new TableToken(31, 37, "table_x", QuoteCharacter.NONE, 0));
        selectStatement.addSQLToken(new TableToken(58, 64, "table_x", QuoteCharacter.NONE, 0));
    ...
    public void assertIndexTokenForIndexNameTableName() {
        ...
        selectStatement.addSQLToken(new TableToken(27, 33, "table_x", QuoteCharacter.NONE, 0));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
    ...
    public void assertIndexTokenForIndexNameTableNameWithoutLogicTableName() {
        ...
        selectStatement.addSQLToken(new TableToken(28, 34, "table_x", QuoteCharacter.NONE, 0));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
    ...
    public void assertTableTokenWithoutBackQuoteForShow() {
        showTablesStatement.addSQLToken(new TableToken(18, 24, "table_x", QuoteCharacter.NONE, 0));
    ...
    public void assertTableTokenWithBackQuoteForShow() {
        showTablesStatement.addSQLToken(new TableToken(18, 26, "`table_x`", QuoteCharacter.BACK_QUOTE, 0));
        routeResult = new SQLRouteResult(showTablesStatement);
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SHOW COLUMNS FROM `table_x`", DatabaseType.MySQL, routeResult, Collections.emptyList(), null);
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, shardingRule, shardingDataSourceMetaData).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertTableTokenWithSchemaForShow() {
        showTablesStatement.addSQLToken(new TableToken(18, 36, "table_x", QuoteCharacter.NONE, "sharding_db".length() + 1));
        routeResult = new SQLRouteResult(showTablesStatement);
    ...
    public void assertTableTokenWithBackQuoteWithSchemaForShow() {
        showTablesStatement.addSQLToken(new TableToken(18, 38, "`table_x`", QuoteCharacter.BACK_QUOTE, "sharding_db".length() + 1));
        routeResult = new SQLRouteResult(showTablesStatement);
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SHOW COLUMNS FROM sharding_db.`table_x`", DatabaseType.MySQL, routeResult, Collections.emptyList(), null);
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, shardingRule, shardingDataSourceMetaData).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertTableTokenWithSchemaWithBackQuoteForShow() {
        showTablesStatement.addSQLToken(new TableToken(18, 40, "`table_x`", QuoteCharacter.BACK_QUOTE, "`sharding_db`".length() + 1));
        routeResult = new SQLRouteResult(showTablesStatement);
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SHOW COLUMNS FROM `sharding_db`.`table_x`", DatabaseType.MySQL, routeResult, Collections.emptyList(), null);
        assertThat(rewriteEngine.rewrite(true).toSQL(null, tableTokens, shardingRule, shardingDataSourceMetaData).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertTableTokenWithSchemaForSelect() {
        selectStatement.addSQLToken(new TableToken(14, 32, "table_x", QuoteCharacter.NONE, "sharding_db".length() + 1));
        routeResult = new SQLRouteResult(selectStatement);
        routeResult.setLimit(selectStatement.getLimit());
    ...
    public void assertTableTokenWithSchemaForInsert() {
        insertStatement.addSQLToken(new TableToken(12, 30, "table_x", QuoteCharacter.NONE, "sharding_db".length() + 1));
        routeResult = new SQLRouteResult(insertStatement);
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, 
    ...
    public void assertTableTokenWithSchemaForUpdate() {
        updateStatement.addSQLToken(new TableToken(7, 27, "table_x", QuoteCharacter.NONE, "`sharding_db`".length() + 1));
    ...
    public void assertTableTokenWithSchemaForDelete() {
        deleteStatement.addSQLToken(new TableToken(12, 34, "`table_x`", QuoteCharacter.BACK_QUOTE, "`sharding_db`".length() + 1));
    ...
    public void assertSelectEqualWithShardingEncryptor() {
        ...
        selectStatement.addSQLToken(new TableToken(15, 21, "table_z", QuoteCharacter.NONE, 0));
    ...
    public void assertSelectEqualWithQueryAssistedShardingEncryptor() {
        ...
        selectStatement.addSQLToken(new TableToken(15, 21, "table_k", QuoteCharacter.NONE, 0));
        selectStatement.addSQLToken(new EncryptColumnToken(29, 32, column, true));
        selectStatement.getEncryptConditions().getOrCondition().getAndConditions().add(new AndCondition());
        selectStatement.getEncryptConditions().getOrCondition().getAndConditions().get(0).getConditions().add(new Condition(column, new SQLParameterMarkerExpression(0)));
        routeResult = new SQLRouteResult(selectStatement);
    ...
    public void assertUpdateWithShardingEncryptor() {
        Column column = new Column("id", "table_z");
        updateStatement.addSQLToken(new TableToken(7, 13, "table_z", QuoteCharacter.NONE, 0));
    ...
    public void assertUpdateWithQueryAssistedShardingEncryptor() {
        ...
        parameters.add(5);
        Column column = new Column("id", "table_k");
        updateStatement.addSQLToken(new TableToken(7, 13, "table_k", QuoteCharacter.NONE, 0));
        updateStatement.addSQLToken(new EncryptColumnToken(19, 24, column, false));
