...
public final class ShardingSQLRewriterTest {
    ...
    public void assertRewriteForTableName() {
        SQLRewriteEngine rewriteEngine = createSQLRewriteEngine(createSQLRouteResultForTableName(), Arrays.<Object>asList(1, "x"));
    ...
    private SQLRouteResult createSQLRouteResultForTableName() {
        SelectStatement selectStatement = new SelectStatement();
    ...
    public void assertRewriteForOrderByAndGroupByDerivedColumns() {
        SQLRewriteEngine rewriteEngine = createSQLRewriteEngine(createSQLRouteResultForOrderByAndGroupByDerivedColumns(), Collections.emptyList());
    ...
    private SQLRouteResult createSQLRouteResultForOrderByAndGroupByDerivedColumns() {
        SelectStatement selectStatement = new SelectStatement();
    ...
    public void assertRewriteForAggregationDerivedColumns() {
        SQLRewriteEngine rewriteEngine = createSQLRewriteEngine(createSQLRouteResultForAggregationDerivedColumns(), Collections.emptyList());
        assertThat(rewriteEngine.generateSQL(null, logicTableAndActualTables).getSql(), is(
                "SELECT AVG(x.age) , COUNT(x.age) AS AVG_DERIVED_COUNT_0 , SUM(x.age) AS AVG_DERIVED_SUM_0 FROM table_1 x"));
    }
    
    private SQLRouteResult createSQLRouteResultForAggregationDerivedColumns() {
        SelectStatement selectStatement = new SelectStatement();
    ...
    public void assertRewriteForAutoGeneratedKeyColumn() {
        ...
        SQLRewriteEngine rewriteEngine = createSQLRewriteEngine(createSQLRouteResultForAutoGeneratedKeyColumn(), Arrays.<Object>asList("Bill", 1));
    ...
    private SQLRouteResult createSQLRouteResultForAutoGeneratedKeyColumn() {
