...
public final class ShardingSQLRewriterTest {
    ...
    public void assertRewriteWithoutChange() {
        ...
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(
                selectStatement, Collections.<ShardingCondition>emptyList(), new AndCondition(), selectStatement.getItems(), new GroupBy(Collections.<OrderByItem>emptyList(), 0)));
