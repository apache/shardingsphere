...
public final class ShardingSQLRewriterTest {
    ...
    public void assertRewriteForLimitForMemoryGroupBy() {
        ...
        ShardingSelectOptimizedStatement optimizedStatement = new ShardingSelectOptimizedStatement(
                selectStatement, Collections.<ShardingCondition>emptyList(), new AndCondition(), selectStatement.getItems());
        optimizedStatement.getOrderByItems().add(new OrderByItem(new ColumnOrderByItemSegment(0, 0, columnSegment, OrderDirection.ASC, OrderDirection.ASC)));
        optimizedStatement.getGroupByItems().add(new OrderByItem(new ColumnOrderByItemSegment(0, 0, columnSegment, OrderDirection.DESC, OrderDirection.ASC)));
        optimizedStatement.setPagination(new Pagination(offsetSegment, rowCountSegment, Collections.emptyList()));
        routeResult = new SQLRouteResult(optimizedStatement);
        routeResult.setRoutingResult(new RoutingResult());
        selectStatement.setLogicSQL("SELECT x.id FROM table_x x LIMIT 2, 2");
    ...
    public void assertRewriteForDerivedOrderBy() {
        ...
        ShardingSelectOptimizedStatement optimizedStatement = new ShardingSelectOptimizedStatement(
                selectStatement, Collections.<ShardingCondition>emptyList(), new AndCondition(), selectStatement.getItems());
        optimizedStatement.getGroupByItems().add(new OrderByItem(new ColumnOrderByItemSegment(0, 0, columnSegment1, OrderDirection.ASC, OrderDirection.ASC)));
        optimizedStatement.getOrderByItems().add(new OrderByItem(new ColumnOrderByItemSegment(0, 0, columnSegment1, OrderDirection.ASC, OrderDirection.ASC)));
        optimizedStatement.getGroupByItems().add(new OrderByItem(new ColumnOrderByItemSegment(0, 0, columnSegment2, OrderDirection.DESC, OrderDirection.ASC)));
        optimizedStatement.getOrderByItems().add(new OrderByItem(new ColumnOrderByItemSegment(0, 0, columnSegment2, OrderDirection.DESC, OrderDirection.ASC)));
        optimizedStatement.setGroupByLastIndex(60);
    ...
    public void assertSelectEqualWithShardingEncryptor() {
        ...
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(selectStatement, Collections.<ShardingCondition>emptyList(), encryptConditions, selectStatement.getItems()));
        routeResult.setRoutingResult(new RoutingResult());
