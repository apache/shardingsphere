...
public final class ShardingSQLRewriterTest {
    ...
    public void assertRewriteAutoGeneratedKeyColumn() {
        ...
        assertThat(rewriteEngine.generateSQL(createRoutingUnit(), logicTableAndActualTables).getSql(), is("INSERT INTO table_1 (name, age, id) VALUES (?, ?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        assertThat(rewriteEngine.generateSQL(createRoutingUnit(), logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithoutParameter() {
        ...
        assertThat(rewriteEngine.generateSQL(createRoutingUnit(), logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteDuplicateKeyWithoutColumnsWithoutParameter() {
        ...
        assertThat(rewriteEngine.generateSQL(createRoutingUnit(), logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1) ON DUPLICATE KEY UPDATE name = VALUES(name)"));
    }
    ...
    public void assertRewriteDuplicateKeyWithSetWithoutParameter() {
        ...
        assertThat(rewriteEngine.generateSQL(createRoutingUnit(), logicTableAndActualTables).getSql(), is("INSERT INTO `table_1` set name = 10, id = 1 ON DUPLICATE KEY UPDATE name = VALUES(name)"));
    }
    ...
    private SQLRouteResult createSQLRouteResultForTableTokenWithSchemaForInsert() {
        ...
        SQLRouteResult result = new SQLRouteResult(new ShardingInsertOptimizedStatement(insertStatement, Collections.<ShardingCondition>emptyList(), insertColumns, null));
        result.setRoutingResult(new RoutingResult());
        return result;
    }
    ...
    private SQLRouteResult createSQLRouteResultForTableTokenWithSchemaForUpdate() {
        ...
        SQLRouteResult result = new SQLRouteResult(new ShardingWhereOptimizedStatement(updateStatement, new ShardingConditions(Collections.<ShardingCondition>emptyList()), new AndCondition()));
        result.setRoutingResult(new RoutingResult());
        return result;
    }
    ...
    private SQLRouteResult createSQLRouteResultForTableTokenWithSchemaForDelete() {
        ...
        SQLRouteResult result = new SQLRouteResult(new ShardingWhereOptimizedStatement(deleteStatement, new ShardingConditions(Collections.<ShardingCondition>emptyList()), new AndCondition()));
        RoutingResult routingResult = new RoutingResult();
        routingResult.getRoutingUnits().add(new RoutingUnit("ds"));
        result.setRoutingResult(routingResult);
        return result;
    ...
    public void assertRewriteInsertWithQueryAssistedShardingEncryptor() {
        ...
        assertThat(rewriteEngine.generateSQL(createRoutingUnit(), logicTableAndActualTables).getSql(), 
