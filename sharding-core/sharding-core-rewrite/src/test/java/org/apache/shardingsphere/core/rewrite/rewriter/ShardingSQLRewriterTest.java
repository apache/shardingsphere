...
public final class ShardingSQLRewriterTest {
    ...
    public void assertRewriteForAutoGeneratedKeyColumn() {
        ...
        InsertClauseOptimizedStatement optimizedStatement = new InsertClauseOptimizedStatement(insertStatement, Collections.<ShardingCondition>emptyList(), Arrays.asList("name", "age", "id"));
    ...
    public void assertRewriteForAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        InsertClauseOptimizedStatement optimizedStatement = new InsertClauseOptimizedStatement(insertStatement, Collections.<ShardingCondition>emptyList(), Arrays.asList("name", "id"));
    ...
    public void assertTableTokenWithSchemaForInsert() {
        ...
        routeResult = new SQLRouteResult(new InsertClauseOptimizedStatement(insertStatement, Collections.<ShardingCondition>emptyList(), Arrays.asList("order_id", "user_id", "status")));
        routeResult.setRoutingResult(new RoutingResult());
    ...
    public void assertInsertWithQueryAssistedShardingEncryptor() {
        ...
        InsertClauseOptimizedStatement optimizedStatement = new InsertClauseOptimizedStatement(insertStatement, Collections.<ShardingCondition>emptyList(), Arrays.asList("name", "id", "query_name"));
