...
public final class ShardingSQLRewriterTest {
    ...
    public void assertRewriteForAutoGeneratedKeyColumn() {
        ...
        optimizedStatement.addUnit(expressionSegments, parameters, 3);
    ...
    public void assertRewriteForAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        optimizedStatement.addUnit(expressionSegments, parameters, 2);
        optimizedStatement.getUnits().get(0).getDataNodes().add(new DataNode("db0.table_1"));
        RoutingUnit routingUnit = new RoutingUnit("db0");
        routingUnit.getTableUnits().add(new TableUnit("table_x", "table_1"));
        routeResult = new SQLRouteResult(optimizedStatement);
    ...
    public void assertRewriteForLimit() {
        ...
        ShardingSelectOptimizedStatement optimizedStatement = new ShardingSelectOptimizedStatement(selectStatement, Collections.<ShardingCondition>emptyList());
    ...
    public void assertTableTokenWithSchemaForInsert() {
        ...
        routeResult = new SQLRouteResult(new ShardingInsertOptimizedStatement(insertStatement, Collections.<ShardingCondition>emptyList(), insertColumns, null));
        routeResult.setRoutingResult(new RoutingResult());
    ...
    public void assertTableTokenWithSchemaForUpdate() {
        ...
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(updateStatement, Collections.<ShardingCondition>emptyList()));
        routeResult.setRoutingResult(new RoutingResult());
    ...
    public void assertTableTokenWithSchemaForDelete() {
        ...
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(deleteStatement, Collections.<ShardingCondition>emptyList()));
        RoutingResult routingResult = new RoutingResult();
        routingResult.getRoutingUnits().add(new RoutingUnit("ds"));
        routeResult.setRoutingResult(routingResult);
    ...
    public void assertSelectEqualWithShardingEncryptor() {
        ...
        selectStatement.getEncryptConditions().getConditions().add(new Condition(column, new PredicateSegment(29, 32, null, null), new ParameterMarkerExpressionSegment(0, 0, 0)));
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(selectStatement, Collections.<ShardingCondition>emptyList()));
        routeResult.setRoutingResult(new RoutingResult());
    ...
    public void assertSelectInWithShardingEncryptor() {
        ...
        Column column = new Column("id", "table_z");
        selectStatement.getEncryptConditions().getConditions().add(new Condition(column, new PredicateSegment(29, 39, null, null), expressionSegments));
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(selectStatement, Collections.<ShardingCondition>emptyList()));
        routeResult.setRoutingResult(new RoutingResult());
    ...
    public void assertSelectInWithShardingEncryptorWithParameter() {
        ...
        Column column = new Column("id", "table_z");
        selectStatement.getEncryptConditions().getConditions().add(new Condition(column, new PredicateSegment(29, 40, null, null), expressionSegments));
        selectStatement.getEncryptConditions().getConditions().add(new Condition(column, new PredicateSegment(45, 50, null, null), new LiteralExpressionSegment(0, 0, 3)));
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(selectStatement, Collections.<ShardingCondition>emptyList()));
        routeResult.setRoutingResult(new RoutingResult());
    ...
    public void assertUpdateWithShardingEncryptor() {
        ...
        updateStatement.getEncryptConditions().getConditions().add(new Condition(column, new PredicateSegment(32, 37, null, null), new LiteralExpressionSegment(0, 0, 2)));
        routeResult = new SQLRouteResult(new ShardingSelectOptimizedStatement(updateStatement, Collections.<ShardingCondition>emptyList()));
        routeResult.setRoutingResult(new RoutingResult());
