...
public final class ShardingRewriterTest {
    ...
    public void assertRewriteWithoutChange() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createSQLRouteResultWithoutChange(), "SELECT table_y.id FROM table_y WHERE table_y.id=?", Collections.<Object>singletonList(1));
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT table_y.id FROM table_y WHERE table_y.id=?"));
    }
    ...
    public void assertRewriteTableName() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(),
    ...
    public void assertRewriteOrderByAndGroupByDerivedColumns() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is(
    ...
    public void assertRewriteAggregationDerivedColumns() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForAggregationDerivedColumns(), "SELECT AVG(x.age) FROM table_x x", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is(
    ...
    public void assertRewriteAutoGeneratedKeyColumn() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForAutoGeneratedKeyColumn(), "INSERT INTO table_x (name, age) VALUES (?, ?)", Arrays.<Object>asList("Bill", 1));
        assertThat(new ShardingSQLRewriteEngine(routingUnit, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("INSERT INTO table_1 (name, age, id) VALUES (?, ?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        assertThat(new ShardingSQLRewriteEngine(routingUnit, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithoutParameter() {
        ...
        assertThat(new ShardingSQLRewriteEngine(routingUnit, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteDuplicateKeyWithoutColumnsWithoutParameter() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForDuplicateKeyWithoutColumnsWithoutParameter(),
                "INSERT INTO `table_x` VALUES (10) ON DUPLICATE KEY UPDATE name = VALUES(name)", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(routingUnit, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), 
    ...
    public void assertRewriteDuplicateKeyWithSetWithoutParameter() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForDuplicateKeyWithSetWithoutParameter(),
    ...
    public void assertRewriteColumnWithoutColumnsWithoutParameter() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(
                createRouteResultForColumnWithoutColumnsWithoutParameter(), "INSERT INTO `table_x` VALUES (10, 1)", Arrays.<Object>asList("x", 1));
        assertThat(new ShardingSQLRewriteEngine(routingUnit, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteColumnWithoutColumnsWithParameter() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForColumnWithoutColumnsWithParameter(), "INSERT INTO `table_x` VALUES (?, ?)", Arrays.<Object>asList("x", 1));
        assertThat(new ShardingSQLRewriteEngine(routingUnit, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteLimit() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForLimit(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 4"));
    }
    ...
    public void assertRewriteRowNumber() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForRowNumber(),
    ...
    public void assertRewriteTopAndRowNumber() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForTopAndRowNumber(),
    ...
    public void assertRewriteLimitForMemoryGroupBy() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForLimitForMemoryGroupBy(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 2147483647"));
    }
    ...
    public void assertRewriteRowNumForMemoryGroupBy() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForRowNumForMemoryGroupBy(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(),
    ...
    public void assertRewriteTopAndRowNumberForMemoryGroupBy() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForTopAndRowNumberForMemoryGroupBy(), 
                "SELECT * FROM (SELECT TOP(4) row_number() OVER (ORDER BY x.id) AS rownum_, x.id FROM table_x x) AS row_ WHERE row_.rownum_>2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(),
    ...
    public void assertRewriteLimitForNotRewritePagination() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForLimitForNotRewritePagination(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT x.id FROM table_1 x LIMIT 2, 2"));
    }
    ...
    public void assertRewriteRowNumForNotRewritePagination() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForRowNumForNotRewritePagination(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(),
    ...
    public void assertRewriteDerivedOrderBy() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForDerivedOrderBy(), "SELECT x.id, x.name FROM table_x x GROUP BY x.id, x.name DESC", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), 
                is("SELECT x.id, x.name FROM table_1 x GROUP BY x.id, x.name DESC ORDER BY x.id ASC,x.name DESC "));
    }
    ...
    public void assertRewriteIndexTokenForIndexNameTableName() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForIndexTokenForIndexNameTableName(), "CREATE INDEX index_name ON table_x ('column')", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("CREATE INDEX index_name_table_1 ON table_1 ('column')"));
    }
    ...
    public void assertRewriteIndexTokenForIndexNameTableNameWithoutLogicTableName() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("CREATE INDEX logic_index_table_1 ON table_1 ('column')"));
    }
    ...
    public void assertRewriteTableTokenWithoutBackQuoteForShow() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForTableTokenWithoutBackQuoteForShow(), "SHOW COLUMNS FROM table_x", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithoutBackQuoteFromSchemaForShow() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, Collections.singletonMap("table_x", "table_x")).generateSQL(sqlRewriteBuilder).getSql(), is("SHOW COLUMNS FROM table_x"));
    }
    ...
    public void assertRewriteTableTokenWithBackQuoteForShow() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createRouteResultForTableTokenWithBackQuoteForShow(), "SHOW COLUMNS FROM `table_x`", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertRewriteTableTokenWithBackQuoteFromSchemaForShow() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SHOW COLUMNS FROM `table_1` FROM 'sharding_db'"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForShow() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createSQLRouteResultForTableTokenWithSchemaForShow(), "SHOW COLUMNS FROM sharding_db.table_x", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForSelect() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createSQLRouteResultForTableTokenWithSchemaForSelect(), "SELECT * FROM sharding_db.table_x", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT * FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForInsert() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("INSERT INTO table_1 (order_id, user_id, status) values (1, 1, 'OK')"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForUpdate() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("UPDATE table_1 SET user_id=1 WHERE order_id=1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForDelete() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("DELETE FROM `table_1` WHERE user_id=1"));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithCipher() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), 
                is("SELECT cipher FROM table_z WHERE cipher IN ('encryptValue', 'encryptValue')"));
    }
    
    @Test
    public void assertRewriteSelectInWithShardingEncryptorWithPlain() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(
                createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList(), false);
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT plain FROM table_z WHERE plain IN ('3', '5')"));
    }
    ...
    public void assertRewriteUpdateWithShardingEncryptor() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createSQLRouteResultForUpdateWithShardingEncryptor(), "UPDATE table_z SET id = 1 WHERE id = 2", Collections.emptyList());
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), 
    ...
    public void assertRewriteInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor() {
        SQLRewriteBuilder sqlRewriteBuilder = createSQLRewriteBuilder(createSQLRouteResultForInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor(), 
    ...
    public void assertRewriteSelectInWithAggregationDistinct() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT DISTINCT id, id FROM table_z WHERE id in (3,5)"));
    }
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithCipher() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT cipher FROM table_z WHERE cipher = ? AND name=?"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(0), is((Object) "encryptValue"));
    }
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithPlain() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT plain FROM table_z WHERE plain = ? AND name=?"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(0), is((Object) 1));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithCipher() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), 
                is("SELECT cipher FROM table_z WHERE cipher IN (?, ?) or cipher = 'encryptValue'"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(0), is((Object) "encryptValue"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(1), is((Object) "encryptValue"));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithPlain() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT plain FROM table_z WHERE plain IN (?, ?) or plain = '3'"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(0), is((Object) 1));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(1), is((Object) 2));
    }
    ...
    public void assertRewriteSelectEqualWithQueryAssistedShardingEncryptor() {
        ...
        assertThat(new ShardingSQLRewriteEngine(null, logicTableAndActualTables).generateSQL(sqlRewriteBuilder).getSql(), is("SELECT cipher as alias FROM table_k WHERE query = ? AND name=?"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(0), is((Object) "assistedEncryptValue"));
    }
    ...
    private SQLRewriteBuilder createSQLRewriteBuilder(final SQLRouteResult routeResult, final String sql, final List<Object> parameters) {
        return createSQLRewriteBuilder(routeResult, sql, parameters, true);
    }
    ...
    private SQLRewriteBuilder createSQLRewriteBuilder(final SQLRouteResult sqlRouteResult, final String sql, final List<Object> parameters, final boolean isQueryWithCipherColumn) {
        ...
        new ShardingSQLRewriteBuilderDecorator(shardingRule, sqlRouteResult).decorate(result);
        new EncryptSQLRewriteBuilderDecorator(shardingRule.getEncryptRule(), isQueryWithCipherColumn).decorate(result);
        return result;
    }
}
