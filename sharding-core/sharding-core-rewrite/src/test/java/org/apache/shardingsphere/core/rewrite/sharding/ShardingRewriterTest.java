...
public final class ShardingRewriterTest {
    ...
    public void assertRewriteWithoutChange() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultWithoutChange(), "SELECT table_y.id FROM table_y WHERE table_y.id=?", Collections.<Object>singletonList(1));
    ...
    public void assertRewriteTableName() {
        BasicRewriter rewriter = createRewriter(
    ...
    public void assertRewriteAggregationDerivedColumns() {
        BasicRewriter rewriter = createRewriter(createRouteResultForAggregationDerivedColumns(), "SELECT AVG(x.age) FROM table_x x", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is(
    ...
    public void assertRewriteAutoGeneratedKeyColumn() {
        BasicRewriter rewriter = createRewriter(createRouteResultForAutoGeneratedKeyColumn(), "INSERT INTO table_x (name, age) VALUES (?, ?)", Arrays.<Object>asList("Bill", 1));
    ...
    public void assertRewriteDuplicateKeyWithoutColumnsWithoutParameter() {
        BasicRewriter rewriter = createRewriter(createRouteResultForDuplicateKeyWithoutColumnsWithoutParameter(),
    ...
    public void assertRewriteDuplicateKeyWithSetWithoutParameter() {
        BasicRewriter rewriter = createRewriter(createRouteResultForDuplicateKeyWithSetWithoutParameter(),
    ...
    public void assertRewriteColumnWithoutColumnsWithoutParameter() {
        BasicRewriter rewriter = createRewriter(createRouteResultForColumnWithoutColumnsWithoutParameter(), "INSERT INTO `table_x` VALUES (10, 1)", Arrays.<Object>asList("x", 1));
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteColumnWithoutColumnsWithParameter() {
        BasicRewriter rewriter = createRewriter(createRouteResultForColumnWithoutColumnsWithParameter(), "INSERT INTO `table_x` VALUES (?, ?)", Arrays.<Object>asList("x", 1));
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteLimit() {
        BasicRewriter rewriter = createRewriter(createRouteResultForLimit(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
    ...
    public void assertRewriteRowNumber() {
        BasicRewriter rewriter = createRewriter(createRouteResultForRowNumber(),
    ...
    public void assertRewriteTopAndRowNumber() {
        BasicRewriter rewriter = createRewriter(createRouteResultForTopAndRowNumber(),
    ...
    public void assertRewriteLimitForMemoryGroupBy() {
        BasicRewriter rewriter = createRewriter(createRouteResultForLimitForMemoryGroupBy(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
    ...
    public void assertRewriteRowNumForMemoryGroupBy() {
        BasicRewriter rewriter = createRewriter(createRouteResultForRowNumForMemoryGroupBy(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteTopAndRowNumberForMemoryGroupBy() {
        BasicRewriter rewriter = createRewriter(createRouteResultForTopAndRowNumberForMemoryGroupBy(), 
                "SELECT * FROM (SELECT TOP(4) row_number() OVER (ORDER BY x.id) AS rownum_, x.id FROM table_x x) AS row_ WHERE row_.rownum_>2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteLimitForNotRewritePagination() {
        BasicRewriter rewriter = createRewriter(createRouteResultForLimitForNotRewritePagination(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
    ...
    public void assertRewriteRowNumForNotRewritePagination() {
        BasicRewriter rewriter = createRewriter(createRouteResultForRowNumForNotRewritePagination(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteDerivedOrderBy() {
        BasicRewriter rewriter = createRewriter(createRouteResultForDerivedOrderBy(), "SELECT x.id, x.name FROM table_x x GROUP BY x.id, x.name DESC", Collections.emptyList());
    ...
    public void assertRewriteIndexTokenForIndexNameTableName() {
        BasicRewriter rewriter = createRewriter(createRouteResultForIndexTokenForIndexNameTableName(), "CREATE INDEX index_name ON table_x ('column')", Collections.emptyList());
    ...
    public void assertRewriteTableTokenWithoutBackQuoteForShow() {
        BasicRewriter rewriter = createRewriter(createRouteResultForTableTokenWithoutBackQuoteForShow(), "SHOW COLUMNS FROM table_x", Collections.emptyList());
    ...
    public void assertRewriteTableTokenWithBackQuoteForShow() {
        BasicRewriter rewriter = createRewriter(createRouteResultForTableTokenWithBackQuoteForShow(), "SHOW COLUMNS FROM `table_x`", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForShow() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultForTableTokenWithSchemaForShow(), "SHOW COLUMNS FROM sharding_db.table_x", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForSelect() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultForTableTokenWithSchemaForSelect(), "SELECT * FROM sharding_db.table_x", Collections.emptyList());
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithCipher() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList());
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithPlain() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList(), false);
    ...
    public void assertRewriteUpdateWithShardingEncryptor() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultForUpdateWithShardingEncryptor(), "UPDATE table_z SET id = 1 WHERE id = 2", Collections.emptyList());
    ...
    public void assertRewriteInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor() {
        BasicRewriter rewriter = createRewriter(createSQLRouteResultForInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor(), 
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithCipher() {
        ...
        assertThat(rewriter.getParameterBuilder().getParameters().get(0), is((Object) "encryptValue"));
    }
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithPlain() {
        ...
        assertThat(rewriter.getParameterBuilder().getParameters().get(0), is((Object) 1));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithCipher() {
        ...
        assertThat(rewriter.getParameterBuilder().getParameters().get(0), is((Object) "encryptValue"));
        assertThat(rewriter.getParameterBuilder().getParameters().get(1), is((Object) "encryptValue"));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithPlain() {
        ...
        assertThat(rewriter.getParameterBuilder().getParameters().get(0), is((Object) 1));
        assertThat(rewriter.getParameterBuilder().getParameters().get(1), is((Object) 2));
    }
    ...
    public void assertRewriteSelectEqualWithQueryAssistedShardingEncryptor() {
        ...
        assertThat(rewriter.getParameterBuilder().getParameters().get(0), is((Object) "assistedEncryptValue"));
    }
    ...
    private BasicRewriter createRewriter(final SQLRouteResult routeResult, final String sql, final List<Object> parameters) {
        return createRewriter(routeResult, sql, parameters, true);
    }
    
    private BasicRewriter createRewriter(final SQLRouteResult sqlRouteResult, final String sql, final List<Object> parameters, final boolean isQueryWithCipherColumn) {
        BasicRewriter result = new BasicRewriter(sqlRouteResult.getSqlStatementContext(), sql, parameters);
        new ShardingRewriterDecorator().decorate(result, parameters, shardingRule, null, sqlRouteResult);
        new EncryptRewriterDecorator().decorate(result, parameters, shardingRule.getEncryptRule(), null, isQueryWithCipherColumn);
        return result;
    }
}
