...
public final class ShardingRewriterTest {
    ...
    public void assertRewriteWithoutChange() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultWithoutChange(), "SELECT table_y.id FROM table_y WHERE table_y.id=?", Collections.<Object>singletonList(1));
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT table_y.id FROM table_y WHERE table_y.id=?"));
    }
    ...
    public void assertRewriteTableName() {
        ShardingRewriter rewriter = createrewriter(
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT table_1.id, x.name FROM table_1 x WHERE table_1.id=? AND x.name=?"));
    }
    ...
    public void assertRewriteOrderByAndGroupByDerivedColumns() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is(
    ...
    public void assertRewriteAggregationDerivedColumns() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForAggregationDerivedColumns(), "SELECT AVG(x.age) FROM table_x x", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is(
    ...
    public void assertRewriteAutoGeneratedKeyColumn() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForAutoGeneratedKeyColumn(), "INSERT INTO table_x (name, age) VALUES (?, ?)", Arrays.<Object>asList("Bill", 1));
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO table_1 (name, age, id) VALUES (?, ?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithoutParameter() {
        ...
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteDuplicateKeyWithoutColumnsWithoutParameter() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForDuplicateKeyWithoutColumnsWithoutParameter(),
                "INSERT INTO `table_x` VALUES (10) ON DUPLICATE KEY UPDATE name = VALUES(name)", Collections.emptyList());
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1) ON DUPLICATE KEY UPDATE name = VALUES(name)"));
    }
    ...
    public void assertRewriteDuplicateKeyWithSetWithoutParameter() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForDuplicateKeyWithSetWithoutParameter(),
                "INSERT INTO `table_x` set name = 10, id = 1 ON DUPLICATE KEY UPDATE name = VALUES(name)", Collections.emptyList());
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1` set name = 10, id = 1 ON DUPLICATE KEY UPDATE name = VALUES(name)"));
    }
    ...
    public void assertRewriteColumnWithoutColumnsWithoutParameter() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForColumnWithoutColumnsWithoutParameter(), "INSERT INTO `table_x` VALUES (10, 1)", Arrays.<Object>asList("x", 1));
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteColumnWithoutColumnsWithParameter() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForColumnWithoutColumnsWithParameter(), "INSERT INTO `table_x` VALUES (?, ?)", Arrays.<Object>asList("x", 1));
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteLimit() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForLimit(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 4"));
    }
    ...
    public void assertRewriteRowNumber() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForRowNumber(),
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteTopAndRowNumber() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForTopAndRowNumber(),
    ...
    public void assertRewriteLimitForMemoryGroupBy() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForLimitForMemoryGroupBy(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 2147483647"));
    }
    ...
    public void assertRewriteRowNumForMemoryGroupBy() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForRowNumForMemoryGroupBy(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteTopAndRowNumberForMemoryGroupBy() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForTopAndRowNumberForMemoryGroupBy(), 
                "SELECT * FROM (SELECT TOP(4) row_number() OVER (ORDER BY x.id) AS rownum_, x.id FROM table_x x) AS row_ WHERE row_.rownum_>2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteLimitForNotRewritePagination() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForLimitForNotRewritePagination(), "SELECT x.id FROM table_x x LIMIT 2, 2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT x.id FROM table_1 x LIMIT 2, 2"));
    }
    ...
    public void assertRewriteRowNumForNotRewritePagination() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForRowNumForNotRewritePagination(), 
                "SELECT * FROM (SELECT row_.*, rownum rownum_ FROM (SELECT x.id FROM table_x x) row_ WHERE rownum<=4) t WHERE t.rownum_>2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteDerivedOrderBy() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForDerivedOrderBy(), "SELECT x.id, x.name FROM table_x x GROUP BY x.id, x.name DESC", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT x.id, x.name FROM table_1 x GROUP BY x.id, x.name DESC ORDER BY x.id ASC,x.name DESC "));
    }
    ...
    public void assertRewriteIndexTokenForIndexNameTableName() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForIndexTokenForIndexNameTableName(), "CREATE INDEX index_name ON table_x ('column')", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("CREATE INDEX index_name_table_1 ON table_1 ('column')"));
    }
    ...
    public void assertRewriteIndexTokenForIndexNameTableNameWithoutLogicTableName() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("CREATE INDEX logic_index_table_1 ON table_1 ('column')"));
    }
    ...
    public void assertRewriteTableTokenWithoutBackQuoteForShow() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForTableTokenWithoutBackQuoteForShow(), "SHOW COLUMNS FROM table_x", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithoutBackQuoteFromSchemaForShow() {
        ...
        assertThat(rewriter.generateSQL(null, Collections.singletonMap("table_x", "table_x")).getSql(), is("SHOW COLUMNS FROM table_x"));
    }
    ...
    public void assertRewriteTableTokenWithBackQuoteForShow() {
        ShardingRewriter rewriter = createrewriter(createRouteResultForTableTokenWithBackQuoteForShow(), "SHOW COLUMNS FROM `table_x`", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM `table_1`"));
    }
    ...
    public void assertRewriteTableTokenWithBackQuoteFromSchemaForShow() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM `table_1` FROM 'sharding_db'"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForShow() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultForTableTokenWithSchemaForShow(), "SHOW COLUMNS FROM sharding_db.table_x", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForSelect() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultForTableTokenWithSchemaForSelect(), "SELECT * FROM sharding_db.table_x", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT * FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForInsert() {
        ...
        assertThat(rewriter.generateSQL(
    ...
    public void assertRewriteTableTokenWithSchemaForUpdate() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("UPDATE table_1 SET user_id=1 WHERE order_id=1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForDelete() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("DELETE FROM `table_1` WHERE user_id=1"));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithCipher() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT cipher FROM table_z WHERE cipher IN ('encryptValue', 'encryptValue')"));
    }
    
    @Test
    public void assertRewriteSelectInWithShardingEncryptorWithPlain() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultForSelectInWithShardingEncryptor(), "SELECT id FROM table_z WHERE id in (3,5)", Collections.emptyList(), false);
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain IN ('3', '5')"));
    }
    ...
    public void assertRewriteUpdateWithShardingEncryptor() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultForUpdateWithShardingEncryptor(), "UPDATE table_z SET id = 1 WHERE id = 2", Collections.emptyList());
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("UPDATE table_z SET plain = 1, cipher = 'encryptValue' WHERE cipher = 'encryptValue'"));
    }
    ...
    public void assertRewriteInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor() {
        ShardingRewriter rewriter = createrewriter(createSQLRouteResultForInsertWithGeneratedKeyAndQueryAssistedShardingEncryptor(), 
                "INSERT INTO `table_w` set name = 10 ON DUPLICATE KEY UPDATE name = VALUES(name)", Collections.emptyList());
        assertThat(rewriter.generateSQL(routingUnit, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteSelectInWithAggregationDistinct() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT DISTINCT id, id FROM table_z WHERE id in (3,5)"));
    }
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithCipher() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT cipher FROM table_z WHERE cipher = ? AND name=?"));
        assertThat(getParameterBuilder(rewriter).getParameters().get(0), is((Object) "encryptValue"));
    }
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithPlain() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain = ? AND name=?"));
        assertThat(getParameterBuilder(rewriter).getParameters().get(0), is((Object) 1));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithCipher() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT cipher FROM table_z WHERE cipher IN (?, ?) or cipher = 'encryptValue'"));
        assertThat(getParameterBuilder(rewriter).getParameters().get(0), is((Object) "encryptValue"));
        assertThat(getParameterBuilder(rewriter).getParameters().get(1), is((Object) "encryptValue"));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithPlain() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain IN (?, ?) or plain = '3'"));
        assertThat(getParameterBuilder(rewriter).getParameters().get(0), is((Object) 1));
        assertThat(getParameterBuilder(rewriter).getParameters().get(1), is((Object) 2));
    }
    ...
    public void assertRewriteSelectEqualWithQueryAssistedShardingEncryptor() {
        ...
        assertThat(rewriter.generateSQL(null, logicTableAndActualTables).getSql(), is("SELECT cipher as alias FROM table_k WHERE query = ? AND name=?"));
        assertThat(getParameterBuilder(rewriter).getParameters().get(0), is((Object) "assistedEncryptValue"));
    }
    ...
    private ShardingRewriter createrewriter(final SQLRouteResult routeResult, final String sql, final List<Object> parameters) {
        return createrewriter(routeResult, sql, parameters, true);
    }
    
    private ShardingRewriter createrewriter(final SQLRouteResult routeResult, final String sql, final List<Object> parameters, final boolean isQueryWithCipherColumn) {
        return new ShardingRewriter(shardingRule, null, routeResult, sql, parameters, isQueryWithCipherColumn);
    }
    
    @SneakyThrows
    private StandardParameterBuilder getParameterBuilder(final ShardingRewriter rewriter) {
        Field field = rewriter.getClass().getDeclaredField("parameterBuilder");
        field.setAccessible(true);
        return (StandardParameterBuilder) field.get(rewriter);
    }
}
