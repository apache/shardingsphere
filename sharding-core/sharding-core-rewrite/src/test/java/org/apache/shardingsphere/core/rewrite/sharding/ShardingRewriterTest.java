...
public final class ShardingRewriterTest {
    ...
    public void assertRewriteWithoutChange() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT table_y.id FROM table_y WHERE table_y.id=?"));
    }
    ...
    public void assertRewriteTableName() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(),
    ...
    public void assertRewriteOrderByAndGroupByDerivedColumns() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is(
    ...
    public void assertRewriteAutoGeneratedKeyColumn() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO table_1 (name, age, id) VALUES (?, ?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithParameter() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (?, ?)"));
    }
    ...
    public void assertRewriteAutoGeneratedKeyColumnWithoutColumnsWithoutParameter() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, routingUnit, logicTableAndActualTables).getSql(), is("INSERT INTO `table_1`(name, id) VALUES (10, 1)"));
    }
    ...
    public void assertRewriteDuplicateKeyWithoutColumnsWithoutParameter() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, routingUnit, logicTableAndActualTables).getSql(), 
    ...
    public void assertRewriteLimit() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 4"));
    }
    ...
    public void assertRewriteLimitForMemoryGroupBy() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT x.id FROM table_1 x LIMIT 0, 2147483647"));
    }
    ...
    public void assertRewriteLimitForNotRewritePagination() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT x.id FROM table_1 x LIMIT 2, 2"));
    }
    ...
    public void assertRewriteIndexTokenForIndexNameTableName() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("CREATE INDEX index_name_table_1 ON table_1 ('column')"));
    }
    ...
    public void assertRewriteIndexTokenForIndexNameTableNameWithoutLogicTableName() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("CREATE INDEX logic_index_table_1 ON table_1 ('column')"));
    }
    ...
    public void assertRewriteTableTokenWithoutBackQuoteForShow() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithoutBackQuoteFromSchemaForShow() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, Collections.singletonMap("table_x", "table_x")).getSql(), is("SHOW COLUMNS FROM table_x"));
    }
    ...
    public void assertRewriteTableTokenWithBackQuoteFromSchemaForShow() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SHOW COLUMNS FROM `table_1` FROM 'sharding_db'"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForSelect() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT * FROM table_1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForInsert() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, 
    ...
    public void assertRewriteTableTokenWithSchemaForUpdate() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("UPDATE table_1 SET user_id=1 WHERE order_id=1"));
    }
    ...
    public void assertRewriteTableTokenWithSchemaForDelete() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("DELETE FROM `table_1` WHERE user_id=1"));
    }
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithPlain() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain IN ('3', '5')"));
    }
    ...
    public void assertRewriteSelectInWithAggregationDistinct() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT DISTINCT id, id FROM table_z WHERE id in (3,5)"));
    }
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithCipher() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT cipher FROM table_z WHERE cipher = ? AND name=?"));
    ...
    public void assertRewriteSelectEqualWithShardingEncryptorWithPlain() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain = ? AND name=?"));
    ...
    public void assertRewriteSelectInWithShardingEncryptorWithParameterWithPlain() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT plain FROM table_z WHERE plain IN (?, ?) or plain = '3'"));
        assertThat(sqlRewriteBuilder.getParameterBuilder().getParameters().get(0), is((Object) 1));
    ...
    public void assertRewriteSelectEqualWithQueryAssistedShardingEncryptor() {
        ...
        assertThat(new ShardingRewriteEngine().generateSQL(sqlRewriteBuilder, null, logicTableAndActualTables).getSql(), is("SELECT cipher as alias FROM table_k WHERE query = ? AND name=?"));
