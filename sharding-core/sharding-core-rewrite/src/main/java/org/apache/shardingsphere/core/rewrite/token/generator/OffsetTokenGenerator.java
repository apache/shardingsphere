...
public final class OffsetTokenGenerator implements OptionalSQLTokenGenerator<ShardingRule>, IgnoreForSingleRoute {
    ...
    @Override
    public Optional<OffsetToken> generateSQLToken(final OptimizedStatement optimizedStatement, final BaseParameterBuilder baseParameterBuilder, final ShardingRule shardingRule) {
        ...
        return offset.isPresent()
                ...
                getRevisedOffset((SelectStatement) optimizedStatement.getSQLStatement(), baseParameterBuilder.getOriginalParameters(), offset.get()))) : Optional.<OffsetToken>absent();
    }
