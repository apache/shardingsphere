...
import org.apache.shardingsphere.core.rewrite.token.generator.InsertGeneratedKeyColumnTokenGenerator;
...
public final class ShardingTokenGenerateEngine extends SQLTokenGenerateEngine<ShardingRule> {
    ...
    static {
        ...
        SQL_TOKEN_GENERATORS.add(new InsertGeneratedKeyColumnTokenGenerator());
