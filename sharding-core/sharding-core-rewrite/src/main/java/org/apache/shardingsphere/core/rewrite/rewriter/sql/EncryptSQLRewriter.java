...
public final class EncryptSQLRewriter implements SQLRewriter {
    ...
    public void rewrite(final SQLBuilder sqlBuilder, final ParameterBuilder parameterBuilder, final SQLToken sqlToken) {
        if (sqlToken instanceof InsertValuesToken) {
            appendInsertValuesPlaceholder(sqlBuilder, (InsertValuesToken) sqlToken);
            ...
            appendInsertSetAddItemsPlaceholder(sqlBuilder, (InsertSetAddAssistedColumnsToken) sqlToken);
    ...
    private void appendInsertValuesPlaceholder(final SQLBuilder sqlBuilder, final InsertValuesToken insertValuesToken) {
        sqlBuilder.appendPlaceholder(new InsertValuesPlaceholder(insertValuesToken.getInsertValues()));
    }
    ...
    private void appendInsertSetAddItemsPlaceholder(final SQLBuilder sqlBuilder, final InsertSetAddAssistedColumnsToken insertSetAddAssistedColumnsToken) {
        sqlBuilder.appendPlaceholder(new InsertSetAddItemsPlaceholder(insertSetAddAssistedColumnsToken.getColumnNames(), insertSetAddAssistedColumnsToken.getColumnValues()));
    }
