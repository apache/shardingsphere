...
public final class RemoveTokenGenerator implements CollectionSQLTokenGenerator<BaseRule> {
    ...
    @Override
    public Collection<RemoveToken> generateSQLTokens(final OptimizedStatement optimizedStatement, final BaseParameterBuilder baseParameterBuilder, final BaseRule baseRule) {
