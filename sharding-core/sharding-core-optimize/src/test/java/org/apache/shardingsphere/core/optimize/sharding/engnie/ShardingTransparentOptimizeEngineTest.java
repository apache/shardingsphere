...
public final class ShardingTransparentOptimizeEngineTest {
    
    @Test
    public void assertOptimize() {
        SQLStatement sqlStatement = new DDLStatement();
        ShardingTransparentOptimizedStatement actual = new ShardingTransparentOptimizeEngine().optimize(null, null, "", Collections.emptyList(), sqlStatement);
