...
public final class InsertOptimizeEngineTest {
    ...
    private void initializeInsertSetWithPlaceHolder() {
        ...
        insertSetStatementWithPlaceHolder.addSQLToken(new TableToken(12, 18, "t_order", QuoteCharacter.NONE, 0));
    ...
    private void initializeInsertSetWithPlaceHolderWithQueryEncrypt() {
        ...
        insertSetStatementWithPlaceHolderWithQueryEncrypt.addSQLToken(new TableToken(12, 26, "t_encrypt_query", QuoteCharacter.NONE, 0));
    ...
    private void initializeInsertSetWithoutPlaceHolder() {
        ...
        insertSetStatementWithoutPlaceHolder.addSQLToken(new TableToken(12, 18, "t_order", QuoteCharacter.NONE, 0));
    ...
    private void initializeInsertSetWithoutPlaceHolderWithEncrypt() {
        ...
        insertSetStatementWithoutPlaceHolderWithEncrypt.addSQLToken(new TableToken(12, 20, "t_encrypt", QuoteCharacter.NONE, 0));
