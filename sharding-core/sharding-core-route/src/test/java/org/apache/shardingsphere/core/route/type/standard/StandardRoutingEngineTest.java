...
public final class StandardRoutingEngineTest {
    ...
    public void setEngineContext() {
        ...
        standardRoutingEngine = new StandardRoutingEngine(shardingRule, "t_order", new ShardingSelectOptimizedStatement(new SelectStatement(), shardingConditions, new AndCondition()));
    }
