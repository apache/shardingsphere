...
public final class DatabaseTest {
    ...
    public void assertDatabaseSelectSQLPagination() {
        ...
        assertThat(((SelectSQLStatementContext) actual.getShardingStatementContext()).getPagination().getActualOffset(), is(0L));
        assertThat(((SelectSQLStatementContext) actual.getShardingStatementContext()).getPagination().getActualRowCount().orNull(), is(5L));
        ...
        assertThat(((SelectSQLStatementContext) actual.getShardingStatementContext()).getPagination().getActualOffset(), is(5L));
        assertThat(((SelectSQLStatementContext) actual.getShardingStatementContext()).getPagination().getActualRowCount().orNull(), is(5L));
    }
    ...
    public void assertDatabasePrepareSelectSQLPagination() {
        ...
        assertThat(((SelectSQLStatementContext) actual.getShardingStatementContext()).getPagination().getActualOffset(), is(5L));
        assertThat(((SelectSQLStatementContext) actual.getShardingStatementContext()).getPagination().getActualRowCount().orNull(), is(10L));
        assertThat(actual.getRoutingResult().getRoutingUnits().size(), is(1));
