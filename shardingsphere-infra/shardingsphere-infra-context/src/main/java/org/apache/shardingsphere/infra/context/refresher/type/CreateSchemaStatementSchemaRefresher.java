...
public final class CreateSchemaStatementSchemaRefresher implements MetaDataRefresher<CreateSchemaStatement> {
    ...
    public void refresh(final ShardingSphereDatabaseMetaData databaseMetaData, final FederationDatabaseMetaData database, final Map<String, OptimizerPlannerContext> optimizerPlanners,
        ...
        databaseMetaData.getDatabase().getSchemas().put(actualSchemaName, new ShardingSphereSchema());
        ...
        AddSchemaEvent event = new AddSchemaEvent(databaseMetaData.getDatabase().getName(), actualSchemaName);
