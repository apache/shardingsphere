...
public final class KernelProcessorTest {
    ...
    public void assertGenerateExecutionContext() {
        ...
        ShardingSphereMetaData metaData = new ShardingSphereMetaData("logic_schema", mock(DatabaseType.class),
                mock(ShardingSphereResource.class, RETURNS_DEEP_STUBS), new ShardingSphereRuleMetaData(Collections.emptyList(), Collections.emptyList()), Collections.emptyMap());
