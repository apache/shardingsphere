...
public final class FixtureRuleBuilder implements ShardingSphereRuleBuilder<FixtureRule, FixtureRuleConfiguration> {
    ...
    @Override
    public FixtureRule build(final String schemaName, final Map<String, DataSource> dataSourceMap, 
                             final DatabaseType databaseType, final FixtureRuleConfiguration ruleConfig, final Collection<ShardingSphereRule> builtRules) {
