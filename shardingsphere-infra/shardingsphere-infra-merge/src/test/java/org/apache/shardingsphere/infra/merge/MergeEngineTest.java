...
public final class MergeEngineTest {
    ...
    public void assertMergeWithIndependentRule() throws SQLException {
        ...
        MergeEngine mergeEngine = new MergeEngine(DefaultDatabase.LOGIC_NAME, databaseType, databaseMetaData, props, Collections.singletonList(new IndependentRuleFixture()));
    ...
    public void assertMergeWithMergerRuleOnly() throws SQLException {
        MergeEngine mergeEngine = new MergeEngine(DefaultDatabase.LOGIC_NAME, databaseType, databaseMetaData, props, Collections.singletonList(new MergerRuleFixture()));
        MergedResult actual = mergeEngine.merge(Collections.singletonList(queryResult), sqlStatementContext);
    ...
    public void assertMergeWithDecoratorRuleOnly() throws SQLException {
        MergeEngine mergeEngine = new MergeEngine(DefaultDatabase.LOGIC_NAME, databaseType, databaseMetaData, props, Collections.singletonList(new DecoratorRuleFixture()));
        MergedResult actual = mergeEngine.merge(Collections.singletonList(queryResult), sqlStatementContext);
    ...
    public void assertMergeWithMergerRuleAndDecoratorRuleTogether() throws SQLException {
        MergeEngine mergeEngine = new MergeEngine(DefaultDatabase.LOGIC_NAME, databaseType, databaseMetaData, props, Arrays.asList(new MergerRuleFixture(), new DecoratorRuleFixture()));
        MergedResult actual = mergeEngine.merge(Collections.singletonList(queryResult), sqlStatementContext);
