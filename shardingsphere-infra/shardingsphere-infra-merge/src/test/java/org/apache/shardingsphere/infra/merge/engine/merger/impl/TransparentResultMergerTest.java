...
public final class TransparentResultMergerTest {
    ...
    public void assertMerge() throws SQLException {
        ...
        assertTrue(new TransparentResultMerger().merge(Collections.singletonList(queryResult), mock(SQLStatementContext.class), mock(ShardingSphereDatabase.class), mock(SessionContext.class)).next());
    }
}
