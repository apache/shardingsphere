...
public final class DatabaseTypeFactory {
     ...
     */
    public static DatabaseType getDatabaseType(final Map<String, ? extends DatabaseConfiguration> schemaConfigs, final ConfigurationProperties props) {
    ...
    private static boolean isComplete(final DatabaseConfiguration schemaConfig) {
