...
package org.apache.shardingsphere.infra.datasource.pool.destroyer.type;
...
public final class HikariDataSourcePoolDestroyer implements DataSourcePoolDestroyer {
    ...
    public void destroy(final DataSource dataSource) {
        ...
        executor.execute(() -> {
            while (true) {
                if (null == hikariDataSource.getHikariPoolMXBean() || 0 == hikariDataSource.getHikariPoolMXBean().getActiveConnections()) {
