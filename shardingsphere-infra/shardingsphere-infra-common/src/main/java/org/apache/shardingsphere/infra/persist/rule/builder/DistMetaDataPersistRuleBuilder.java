 ...
 */
public final class DistMetaDataPersistRuleBuilder implements KernelRuleBuilder, GlobalRuleBuilder<DistMetaDataPersistRuleConfiguration> {
    
    @Override
    public DistMetaDataPersistRule build(final DistMetaDataPersistRuleConfiguration ruleConfig, final Map<String, ShardingSphereMetaData> mataDataMap) {
