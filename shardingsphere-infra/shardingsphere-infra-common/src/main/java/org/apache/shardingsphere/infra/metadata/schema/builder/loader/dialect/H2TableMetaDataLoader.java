...
public class H2TableMetaDataLoader implements DialectTableMetaDataLoader {
    ...
    @Override
    public Map<String, TableMetaData> load(DataSource dataSource, Collection<String> existedTables) throws SQLException {
        ...
        try (
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    ColumnMetaData columnMetaData = loadColumnMetaData(dataTypes, resultSet, tablePrimaryKeys.getOrDefault(tableName, Collections.emptyList()), tableGenerated.getOrDefault(tableName, Collections.emptyMap()));
    ...
    private ColumnMetaData loadColumnMetaData(final Map<String, Integer> dataTypeMap, final ResultSet resultSet, final Collection<String> primaryKeys, final Map<String, Boolean> tableGenerated) throws SQLException {
        String columnName = resultSet.getString("COLUMN_NAME");
        String dataType = resultSet.getString("DATA_TYPE");
        boolean primaryKey = primaryKeys.contains(columnName);
        boolean generated = tableGenerated.get(columnName);
    ...
    private Map<String, Collection<String>> loadTablePrimaryKeys(final DataSource dataSource, final Collection<String> tableNames) throws SQLException {
    ...
    private Map<String, Map<String, Boolean>> loadTableGenerated(final DataSource dataSource, final Collection<String> tableNames) throws SQLException {
