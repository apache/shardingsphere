...
public final class ShardingSphereDatabaseTest {
    ...
    public void assertIsComplete() {
        ShardingSphereResource resource = new ShardingSphereResource(
                Collections.singletonMap("ds", mock(DataSource.class)), mock(DataSourcesMetaData.class), mock(CachedDatabaseMetaData.class), mock(DatabaseType.class));
        ...
        assertTrue(new ShardingSphereDatabase("foo_db", mock(DatabaseType.class), resource, ruleMetaData, mock(ShardingSphereDatabaseMetaData.class)).isComplete());
    }
    ...
    public void assertIsNotCompleteWithoutRule() {
        ...
        assertFalse(new ShardingSphereDatabase("foo_db", mock(DatabaseType.class), resource, ruleMetaData, mock(ShardingSphereDatabaseMetaData.class)).isComplete());
    }
