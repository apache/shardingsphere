...
public final class TableMetaDataUtilTest {
    ...
    public void assertGetTableMetaDataLoadMaterialWhenConfigCheckMetaDataEnable() {
        ...
        Collection<TableMetaDataLoaderMaterials> actual = TableMetaDataUtil.getTableMetaDataLoadMaterial(Collections.singleton("t_order"), materials, true);
        assertThat(actual.size(), is(2));
        Iterator<TableMetaDataLoaderMaterials> iterator = actual.iterator();
        TableMetaDataLoaderMaterials firstMaterial = iterator.next();
        ...
        TableMetaDataLoaderMaterials secondMaterial = iterator.next();
    ...
    public void assertGetTableMetaDataLoadMaterialWhenNotConfigCheckMetaDataEnable() {
        ...
        GenericSchemaBuilderMaterials materials = new GenericSchemaBuilderMaterials(mock(DatabaseType.class), mock(DatabaseType.class), mockDataSourceMap(),
                Arrays.asList(dataNodeContainedRule, mock(DataSourceContainedRule.class)), mock(ConfigurationProperties.class), "sharding_db");
        Collection<TableMetaDataLoaderMaterials> actual = TableMetaDataUtil.getTableMetaDataLoadMaterial(Collections.singleton("t_order"), materials, false);
    ...
    public void assertGetTableMetaDataLoadMaterialWhenNotConfigCheckMetaDataEnableForSingleTableDataNode() {
        ...
        Collection<TableMetaDataLoaderMaterials> actual = TableMetaDataUtil.getTableMetaDataLoadMaterial(Collections.singleton("t_single"), materials, false);
        assertThat(actual.size(), is(1));
        Iterator<TableMetaDataLoaderMaterials> iterator = actual.iterator();
        TableMetaDataLoaderMaterials firstMaterial = iterator.next();
