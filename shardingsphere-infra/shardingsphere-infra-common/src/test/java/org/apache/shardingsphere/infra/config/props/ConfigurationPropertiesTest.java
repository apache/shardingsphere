...
public final class ConfigurationPropertiesTest {
    ...
    public void assertGetValue() {
        ...
        assertTrue(actual.getValue(ConfigurationPropertyKey.SQL_FEDERATION_TYPE));
    ...
    private Properties createProperties() {
        ...
        result.setProperty(ConfigurationPropertyKey.SQL_FEDERATION_TYPE.getKey(), Boolean.TRUE.toString());
    ...
    public void assertGetDefaultValue() {
        ...
        assertFalse(actual.getValue(ConfigurationPropertyKey.SQL_FEDERATION_TYPE));
