...
public final class TableMetaDataLoaderTest {
    ...
    public void assertLoadWithExistedTable() throws SQLException {
        ...
        Map<String, SchemaMetaData> actual = SchemaMetaDataLoaderEngine.load(Collections.singletonList(
                new TableMetaDataLoaderMaterials(Collections.singletonList(TEST_TABLE), dataSource, "sharding_db")), databaseType);
    ...
    public void assertLoadWithNotExistedTable() throws SQLException {
        Map<String, SchemaMetaData> actual = SchemaMetaDataLoaderEngine.load(Collections.singletonList(
                new TableMetaDataLoaderMaterials(Collections.singletonList(TEST_TABLE), dataSource, "sharding_db")), mock(DatabaseType.class));
        assertFalse(actual.isEmpty());
        assertTrue(actual.containsKey("sharding_db"));
