...
public final class SQLRewriteEntry {
    ...
    public SQLRewriteResult rewrite(final String sql, final List<Object> parameters, final RouteContext routeContext) {
        ...
        RouteResult routeResult = routeContext.isRouteStageContextEmpty() ? routeContext.getOriginRouteStageContext().getRouteResult() : routeContext.lastRouteStageContext().getRouteResult();
    ...
    private SQLRewriteContext createSQLRewriteContext(final String sql, final List<Object> parameters, final RouteContext routeContext) {
        SQLStatementContext sqlStatementContext = routeContext.isRouteStageContextEmpty()
                ? routeContext.getOriginRouteStageContext().getSqlStatementContext() : routeContext.firstRouteStageContext().getSqlStatementContext();
