...
public final class PaginationContextTest {
    ...
    private void getRevisedRowCount(final SelectStatement selectStatement) {
        ...
        Map<String, ShardingSphereDatabaseMetaData> databaseMetaDataMap = Collections.singletonMap(DefaultDatabase.LOGIC_NAME, mock(ShardingSphereDatabaseMetaData.class));
        SelectStatementContext selectStatementContext = new SelectStatementContext(databaseMetaDataMap, Collections.emptyList(), selectStatement, DefaultDatabase.LOGIC_NAME);
