...
public final class PaginationContextTest {
    ...
    private void getRevisedRowCount(final SelectStatement selectStatement) {
        ...
        Map<String, ShardingSphereMetaData> metaDataMap = Collections.singletonMap(DefaultDatabase.LOGIC_NAME, mock(ShardingSphereMetaData.class));
        SelectStatementContext selectStatementContext = new SelectStatementContext(metaDataMap, Collections.emptyList(), selectStatement, DefaultDatabase.LOGIC_NAME);
