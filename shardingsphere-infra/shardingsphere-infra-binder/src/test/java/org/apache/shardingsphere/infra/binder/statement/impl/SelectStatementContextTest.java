...
public final class SelectStatementContextTest {
    ...
    public void assertSetIndexForItemsByIndexOrderBy(final SelectStatement selectStatement) {
        ...
        SelectStatementContext selectStatementContext = new SelectStatementContext(
                Collections.singletonMap(DefaultSchema.LOGIC_NAME, metaData), selectStatement, DefaultSchema.LOGIC_NAME);
    ...
    private SelectStatementContext createSelectStatementContext(final SelectStatement selectStatement) {
        return new SelectStatementContext(Collections.singletonMap(DefaultSchema.LOGIC_NAME, mock(ShardingSphereMetaData.class)), selectStatement, DefaultSchema.LOGIC_NAME);
    }
    ...
    public void assertSetWhere(final SelectStatement selectStatement) {
        ...
        ShardingSphereMetaData metaData = mock(ShardingSphereMetaData.class);
        selectStatement.setProjections(new ProjectionsSegment(0, 0));
        SelectStatementContext actual = new SelectStatementContext(Collections.singletonMap(DefaultSchema.LOGIC_NAME, metaData), selectStatement, DefaultSchema.LOGIC_NAME);
