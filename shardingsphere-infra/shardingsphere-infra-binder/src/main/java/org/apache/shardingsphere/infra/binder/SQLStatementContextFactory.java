...
public final class SQLStatementContextFactory {
     ...
     */
    public static SQLStatementContext<?> newInstance(final List<Object> parameters, final SQLStatement sqlStatement) {
        if (sqlStatement instanceof DMLStatement) {
            return getDMLStatementContext(parameters, (DMLStatement) sqlStatement);
        }
    ...
    private static SQLStatementContext<?> getDMLStatementContext(final List<Object> parameters, final DMLStatement sqlStatement) {
        if (sqlStatement instanceof SelectStatement) {
            return new SelectStatementContext(parameters, (SelectStatement) sqlStatement);
        }
        ...
        if (sqlStatement instanceof InsertStatement) {
            return new InsertStatementContext(parameters, (InsertStatement) sqlStatement);
        }
    ...
    private static SQLStatementContext<?> getDDLStatementContext(final DDLStatement sqlStatement) {
        ...
        if (sqlStatement instanceof PostgreSQLPrepareStatement) {
            return new PrepareStatementContext((PostgreSQLPrepareStatement) sqlStatement);
        }
        return new CommonSQLStatementContext<>(sqlStatement);
    }
