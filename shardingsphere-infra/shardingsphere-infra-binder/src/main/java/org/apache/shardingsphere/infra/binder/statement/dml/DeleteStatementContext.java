...
public final class DeleteStatementContext extends CommonSQLStatementContext<DeleteStatement> implements TableAvailable, WhereAvailable, SchemaAvailable {
    ...
    public DeleteStatementContext(final Map<String, ShardingSphereMetaData> metaDataMap, final List<Object> parameters, final DeleteStatement sqlStatement, final String schemaName) {
        super(sqlStatement);
