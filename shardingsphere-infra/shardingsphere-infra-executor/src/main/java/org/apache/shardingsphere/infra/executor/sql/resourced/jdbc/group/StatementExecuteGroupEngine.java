...
public final class StatementExecuteGroupEngine extends ResourceManagedExecuteGroupEngine<StatementExecuteUnit, JDBCExecutionConnection, Connection, StatementOption> {
    ...
    public StatementExecuteGroupEngine(final int maxConnectionsSizePerQuery, final JDBCExecutionConnection executionConnection, final StatementOption option,
                                       final Collection<ShardingSphereRule> rules, final ExecutionContext executionContext) {
        super(maxConnectionsSizePerQuery, executionConnection, option, rules, executionContext);
    }
