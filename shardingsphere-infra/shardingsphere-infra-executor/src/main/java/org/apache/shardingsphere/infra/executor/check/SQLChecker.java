...
public interface SQLChecker<T extends ShardingSphereRule> extends OrderedSPI<T> {
     ...
     */
    SQLCheckResult check(SQLStatement sqlStatement, List<Object> parameters, Grantee grantee, String currentDatabase, Map<String, ShardingSphereDatabaseMetaData> databaseMetaDataMap, T rule);
