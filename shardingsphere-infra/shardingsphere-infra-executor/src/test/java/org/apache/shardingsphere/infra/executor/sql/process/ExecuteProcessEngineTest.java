...
public final class ExecuteProcessEngineTest {
    ...
    public void assertExecuteIDCanBePutAndRemoved() {
        ...
        LogicSQL logicSQL2 = createLogicSQL();
        ExecutionGroupContext<? extends SQLExecutionUnit> executionGroupContext2 = createMockedExecutionGroups(2, 2);
        ConfigurationProperties actual2 = createConfigurationProperties();

        ExecuteProcessEngine.initialize(logicSQL2, executionGroupContext2, actual2);
        assertTrue(executionGroupContext2.getExecutionID().equals(ExecutorDataMap.getValue().get("EXECUTE_ID")));
        assertTrue(ExecuteProcessReporterFixture.ACTIONS.get(2).equals("Report the summary of this task."));
        ExecuteProcessEngine.finish(executionGroupContext2.getExecutionID());
