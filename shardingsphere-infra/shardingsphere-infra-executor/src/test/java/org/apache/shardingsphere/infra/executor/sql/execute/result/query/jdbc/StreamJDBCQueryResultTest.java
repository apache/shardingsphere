...
public final class StreamJDBCQueryResultTest {
    ...
    public void assertNext() throws SQLException {
        StreamJDBCExecuteQueryResult queryResult = new StreamJDBCExecuteQueryResult(getResultSet());
    ...
    public void assertGetValueByBoolean() throws SQLException {
        ...
        assertTrue((boolean) new StreamJDBCExecuteQueryResult(resultSet).getValue(1, boolean.class));
    }
    ...
    public void assertGetValueByByte() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, byte.class), is((byte) 0x00));
    }
    ...
    public void assertGetValueByShort() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, short.class), is((short) 1));
    }
    ...
    public void assertGetValueByInt() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, int.class), is(1));
    }
    ...
    public void assertGetValueByLong() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, long.class), is(1L));
    }
    ...
    public void assertGetValueByFloat() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, float.class), is(1.0F));
    }
    ...
    public void assertGetValueByDouble() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, double.class), is(1.0D));
    }
    ...
    public void assertGetValueByString() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, String.class), is("value"));
    }
    ...
    public void assertGetValueByBigDecimal() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, BigDecimal.class), is(new BigDecimal("0")));
    }
    ...
    public void assertGetValueByBytes() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, byte[].class), is(value));
    }
    ...
    public void assertGetValueByDate() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, Date.class), is(new Date(0L)));
    }
    ...
    public void assertGetValueByTime() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, Time.class), is(new Time(0L)));
    }
    ...
    public void assertGetValueByBlob() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, Blob.class), is(value));
    }
    ...
    public void assertGetValueByClob() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, Clob.class), is(value));
    }
    ...
    public void assertGetValueByArray() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, Array.class), is(value));
    }
    ...
    public void assertGetValueByTimestamp() throws SQLException {
        ...
        assertThat(new StreamJDBCExecuteQueryResult(resultSet).getValue(1, Timestamp.class), is(new Timestamp(0L)));
    }
    ...
    public void assertGetCalendarValueWithDate() throws SQLException {
        ...
        StreamJDBCExecuteQueryResult queryResult = new StreamJDBCExecuteQueryResult(result);
        queryResult.next();
    ...
    public void assertGetCalendarValueWithTime() throws SQLException {
        ...
        Calendar calendar = Calendar.getInstance();
        StreamJDBCExecuteQueryResult queryResult = new StreamJDBCExecuteQueryResult(resultSet);
        queryResult.next();
