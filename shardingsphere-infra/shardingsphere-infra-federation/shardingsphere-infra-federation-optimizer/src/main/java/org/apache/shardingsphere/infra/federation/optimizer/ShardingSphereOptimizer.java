...
public final class ShardingSphereOptimizer {
    ...
    private RelNode optimize(final SqlToRelConverter converter, final RelRoot relRoot) {
        ...
        RelNode optimizedRelNode = planner.changeTraits(relRoot.rel, replaceRelTraitSet(converter.getCluster().traitSet(), EnumerableConvention.INSTANCE, relRoot.collation));
    ...
    private RelTraitSet replaceRelTraitSet(final RelTraitSet relTraitSet, final Convention convention, final RelCollation collation) {
