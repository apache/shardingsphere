...
public final class PartialSQLRouteExecutorTest {
    ...
    public void setup() {
        ...
        when(databaseMetaData.getResource().getDataSources()).thenReturn(dataSourceMap);
    }
    ...
    public void assertRouteBySQLCommentHint() {
        ...
        RouteContext routeContext = partialSQLRouteExecutor.route(logicSQL, databaseMetaData);
    ...
    public void assertRouteBySQLCommentHintWithException() {
        ...
        LogicSQL logicSQL = new LogicSQL(commonSQLStatementContext, "", Collections.emptyList());
        partialSQLRouteExecutor.route(logicSQL, databaseMetaData);
    }
