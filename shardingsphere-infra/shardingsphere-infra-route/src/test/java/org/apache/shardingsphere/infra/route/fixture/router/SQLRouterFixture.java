...
public final class SQLRouterFixture implements SQLRouter<RouteRuleFixture> {
    ...
    @Override
    public RouteContext createRouteContext(final LogicSQL logicSQL, final ShardingSphereDatabaseMetaData databaseMetaData, final RouteRuleFixture rule, final ConfigurationProperties props) {
    ...
    public void decorateRouteContext(final RouteContext routeContext,
                                     final LogicSQL logicSQL, final ShardingSphereDatabaseMetaData databaseMetaData, final RouteRuleFixture rule, final ConfigurationProperties props) {
