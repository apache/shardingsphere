...
public final class SqlNodeConverter {
    ...
    /**
     *  Convert.
     * @param sqlStatement statement context
     * @return sqlNode optional
     */
    public static Optional<SqlNode> convert(final SQLStatement sqlStatement) {
        try {
    ...
    public static Map.Entry<SqlNode, SqlNode> convertPagination(final LimitSegment limitSegment) {
        ...
        return new AbstractMap.SimpleEntry<>(offsetSqlNode, fetchSqlNode);
    }
