...
import org.apache.shardingsphere.infra.optimize.execute.raw.context.OptimizeDataContext;
...
/**
 * Optimize raw executor.
 */
@RequiredArgsConstructor
public final class OptimizeRawExecutor implements CalciteExecutor {
    ...
    private Enumerable<Object[]> execute(final RelNode bestPlan) {
        ...
        return new CalciteInterpretableConverter(cluster, cluster.traitSetOf(InterpretableConvention.INSTANCE), bestPlan).bind(new OptimizeDataContext(context));
    }
