...
/**
 * Optimize table execution context generator.
 */
@RequiredArgsConstructor
public final class OptimizeExecutionContextGenerator {
    
    private final String table;
    
    private final ExecutionContext initialExecutionContext;
    
    private final OptimizeExecutionSQLGenerator filter;
    ...
    private Collection<ExecutionUnit> getExecutionUnits(final Collection<RouteUnit> routeUnits, final OptimizeExecutionSQLGenerator filter) {
    ...
    private void fillExecutionUnits(final Collection<ExecutionUnit> executionUnits, final OptimizeExecutionSQLGenerator filter, final RouteUnit routeUnit) {
