...
import org.apache.shardingsphere.infra.optimize.schema.table.OptimizeFilterableTable;
...
/**
 * Optimize logic table generator.
 */
public final class OptimizeLogicTableGenerator {
    ...
    public OptimizeLogicTableGenerator(final String name, final Map<String, DataSource> dataSources, final Map<String, Collection<String>> dataSourceRules,
     ...
     * @return table
     */
    public Table create(final OptimizeRowExecutor executor) {
        return new OptimizeFilterableTable(name, tableMetaData, relProtoDataType, executor);
    }
}
