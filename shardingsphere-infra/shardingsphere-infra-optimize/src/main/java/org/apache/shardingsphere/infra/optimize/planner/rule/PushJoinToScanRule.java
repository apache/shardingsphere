...
public class PushJoinToScanRule extends RelRule<PushJoinToScanRule.Config> implements TransformationRule {
     ...
     */
    public PushJoinToScanRule(Config config) {
        super(config);
    }
    ...
    private LogicalScan convert(LogicalJoin logicalJoin, LogicalScan left, LogicalScan right) {
     ...
     */
    private boolean canPushdown(Map<String, List<String>> schemaTablesMap) {
        ...
        List<String> tablesWithoutBroadcast = tableNames.stream().filter(table -> !broadcastTableNames.contains(table))
    ...
    private boolean allBindingTables(List<String> tablesNotBroadcase, Collection<BindingTableRule> bindingTableRules) {
    ...
    private boolean allSingleTableInSameDataNode(List<String> tablesWithoutBroadcast, Map<String, SingleTableRule> singleTableRuleMap) {
     ...
     */
    private Map<String, List<String>> parseAndMergeTableNames(Set<RelOptTable> leftTables, Set<RelOptTable> rightTables) {
     ...
     */
    private Map<String, List<String>> splitSchemaAndTableNames(Set<RelOptTable> tables) {
