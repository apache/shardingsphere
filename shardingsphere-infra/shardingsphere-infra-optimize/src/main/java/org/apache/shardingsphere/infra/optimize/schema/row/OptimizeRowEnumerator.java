...
/**
 * Optimize row enumerator.
 *
 */
public final class OptimizeRowEnumerator implements Enumerator<Object[]> {
    ...
    public OptimizeRowEnumerator(final Collection<QueryResult> queryResults) {
