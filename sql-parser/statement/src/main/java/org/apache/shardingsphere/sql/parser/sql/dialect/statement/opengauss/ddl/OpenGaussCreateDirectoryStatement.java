...
/**
 * OpenGauss create directory statement.
 */
@ToString(callSuper = true)
public final class OpenGaussCreateDirectoryStatement extends CreateDirectoryStatement implements OpenGaussStatement {
}
