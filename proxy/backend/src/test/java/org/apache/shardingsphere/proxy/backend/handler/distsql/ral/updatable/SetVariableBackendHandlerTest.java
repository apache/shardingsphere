...
public final class SetVariableBackendHandlerTest extends ProxyContextRestorer {
    ...
    public void setUp() {
        MetaDataContexts metaDataContexts = new MetaDataContexts(mock(MetaDataPersistService.class),
                new ShardingSphereMetaData(createDatabases(), mock(ShardingSphereRuleMetaData.class), new ConfigurationProperties(createProperties())), new ShardingSphereData());
    ...
    private Map<String, ShardingSphereDatabase> createDatabases() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            when(database.getResources()).thenReturn(new ShardingSphereResources("sharding_db", Collections.emptyMap()));
