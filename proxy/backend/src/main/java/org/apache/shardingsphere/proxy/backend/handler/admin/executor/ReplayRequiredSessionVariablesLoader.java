...
public final class ReplayRequiredSessionVariablesLoader {
    ...
    public static Collection<String> getVariables(final String databaseType) {
        return TypedSPIRegistry.findRegisteredService(ReplayRequiredSessionVariables.class, databaseType).orElseGet(() -> Collections::emptySet).getReplayRequiredVariables();
    }
}
