 ...
 */
public final class RefreshDatabaseMetadataHandler extends UpdatableRALBackendHandler<RefreshTableMetadataStatement> {
    
    @Override
    protected void update(final ContextManager contextManager) {
        contextManager.reloadDatabase(getDatabaseName());
    }
