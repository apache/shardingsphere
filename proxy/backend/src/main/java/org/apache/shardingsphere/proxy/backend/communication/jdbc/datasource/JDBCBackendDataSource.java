...
public final class JDBCBackendDataSource implements BackendDataSource {
    ...
    public List<Connection> getConnections(final String databaseName, final String dataSourceName,
        ...
        DataSource dataSource = ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().getDatabase(databaseName).getResources().getDataSources().get(dataSourceName);
