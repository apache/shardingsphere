...
public final class DistSQLScriptConstants {
    ...
    public static final String CIPHER_ALGORITHM = "CIPHER_ALGORITHM(%s)";
    
    public static final String ASSISTED_ALGORITHM = "ASSISTED_ALGORITHM(%s)";
    
    public static final String LIKE_ALGORITHM = "LIKE_ALGORITHM(%s)";
