...
class XAOtherOperationProxyBackendHandlerTest {
    
    @Test
    void assertExecuteDelegatesToDatabaseProxyConnector() throws SQLException {
        ...
        XAOtherOperationProxyBackendHandler handler = new XAOtherOperationProxyBackendHandler(databaseProxyConnector);
