...
class UnregisterStorageUnitBackendHandlerTest {
    ...
    void setUp() {
        ...
        NewStorageUnitMetaData storageUnitMetaData = new NewStorageUnitMetaData("foo_db", storageNode, mock(DataSourcePoolProperties.class), new MockedDataSource());
    ...
    void assertStorageUnitNameNotExistedExecute() {
        when(ProxyContext.getInstance().getDatabase("foo_db").getResourceMetaData().getStorageUnitMetaData().getMetaDataMap()).thenReturn(Collections.emptyMap());
