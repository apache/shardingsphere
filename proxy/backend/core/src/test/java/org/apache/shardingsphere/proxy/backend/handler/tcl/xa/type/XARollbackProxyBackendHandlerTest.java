...
class XARollbackProxyBackendHandlerTest {
    ...
    void assertExecuteSuccess() throws SQLException {
        ...
        XARollbackProxyBackendHandler handler = new XARollbackProxyBackendHandler(connectionSession, databaseProxyConnector);
