...
class RollbackProxyBackendHandlerTest {
    
    @Test
    void assertExecuteRollbackAndReturnUpdateResponseHeader() throws SQLException {
        ...
        try (MockedConstruction<ProxyBackendTransactionManager> mockedConstruction = mockConstruction(ProxyBackendTransactionManager.class)) {
            RollbackProxyBackendHandler handler = new RollbackProxyBackendHandler(sqlStatement, mock());
