...
class QueryableRALBackendHandlerTest {
    ...
    void assertExecuteWithUnknownDatabase() {
        ...
        MetaDataContext metaDataContext = MetaDataContextFactory.create(mock(MetaDataPersistService.class), metaData);
        ...
        ContextManager contextManager = new ContextManager(metaDataContext, computeNodeInstanceContext, mock(PersistRepository.class));
