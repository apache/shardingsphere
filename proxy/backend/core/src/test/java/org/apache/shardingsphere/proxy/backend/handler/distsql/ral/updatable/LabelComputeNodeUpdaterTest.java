...
class LabelComputeNodeUpdaterTest {
    ...
    void assertWithStandaloneMode() {
        ...
        assertThrows(UnsupportedSQLOperationException.class, () -> new LabelComputeNodeExecutor().executeUpdate(mock(LabelComputeNodeStatement.class), mock(ContextManager.class)));
    }
}
