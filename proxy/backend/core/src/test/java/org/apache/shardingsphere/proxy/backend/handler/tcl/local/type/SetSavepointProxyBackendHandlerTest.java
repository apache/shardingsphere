...
class SetSavepointProxyBackendHandlerTest {
    ...
    void assertExecuteWithTransaction() throws SQLException {
        ...
        try (
            ...
            new SetSavepointProxyBackendHandler(sqlStatement, connectionSession).execute();
    ...
    void assertExecuteWithInvalidStatus() {
        ...
        try (
            ...
            mockedStatic.when(() -> DatabaseTypedSPILoader.getService(DialectDatabaseMetaData.class, databaseType)).thenReturn(dialectDatabaseMetaData);
            assertThrows(SQLFeatureNotSupportedException.class, () -> new SetSavepointProxyBackendHandler(sqlStatement, connectionSession).execute());
        }
    }
