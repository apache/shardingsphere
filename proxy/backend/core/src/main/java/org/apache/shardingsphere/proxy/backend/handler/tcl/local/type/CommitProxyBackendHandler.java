...
/**
 * Commit proxy backend handler.
 */
public final class CommitProxyBackendHandler implements ProxyBackendHandler {
    ...
    public CommitProxyBackendHandler(final TCLStatement sqlStatement, final ConnectionSession connectionSession) {
    ...
    public ResponseHeader execute() throws SQLException {
        ...
        return new UpdateResponseHeader(isReturnRollbackStatement() ? new RollbackStatement(connectionSession.getProtocolType()) : sqlStatement);
    }
