...
public final class ProxySQLExecutor {
    ...
    private boolean isValidExecutePrerequisites(final SQLStatementContext sqlStatementContext) {
        return !(sqlStatementContext instanceof DDLStatement) || isSupportDDLInTransaction(sqlStatementContext.getDatabaseType(), (DDLStatement) sqlStatementContext.getSqlStatement());
    }
