...
public final class ProxySQLExecutor {
    ...
    public static boolean isReturnGeneratedKeys(final SQLStatementContext sqlStatementContext, final DialectDatabaseMetaData dialectDatabaseMetaData) {
        ...
        String type = databaseType == null ? "" : databaseType.getType();
        if ("MySQL".equalsIgnoreCase(type) || "MariaDB".equalsIgnoreCase(type)) {
            ...
            if (columnIndex != -1) {
                try {
                    ...
                    for (Object valueContext : valueContexts) {
                        ...
                        if (expressions != null && columnIndex < expressions.size()) {
                            ...
                            if (expr != null) {
                                ...
                                if ("ParameterMarkerExpressionSegment".equals(className)) {
                                    ...
                                    if (parameters != null && paramOffset < parameters.size()) {
                                        Object paramValue = parameters.get(paramOffset);
                                        if (isAutoGeneratedValue(paramValue)) {
                                            return true;
                                        }
                                    }
                                    continue;
                                ...
                                if ("LiteralExpressionSegment".equals(className)) {
                                    ...
                                    if (isAutoGeneratedValue(literal)) {
                                        return true;
                                    }
                                }
                                try {
                                    ...
                                    if (text != null && ("0".equals(text.toString()) || "NULL".equalsIgnoreCase(text.toString()))) {
                                        return true;
                                    }
