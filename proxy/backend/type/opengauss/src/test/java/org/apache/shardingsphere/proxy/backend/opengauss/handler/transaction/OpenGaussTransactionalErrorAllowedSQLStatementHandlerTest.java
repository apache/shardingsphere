...
class OpenGaussTransactionalErrorAllowedSQLStatementHandlerTest {
    ...
    private final TransactionalErrorAllowedSQLStatementHandler allowedSQLStatementHandler = DatabaseTypedSPILoader.getService(
            TransactionalErrorAllowedSQLStatementHandler.class, TypedSPILoader.getService(DatabaseType.class, "openGauss"));
    ...
    void assertJudgeContinueToExecuteWithNotAllowedStatement() {
        assertThrows(SQLFeatureNotSupportedException.class, () -> allowedSQLStatementHandler.judgeContinueToExecute(mock(SimpleSelectStatement.class)));
    }
}
