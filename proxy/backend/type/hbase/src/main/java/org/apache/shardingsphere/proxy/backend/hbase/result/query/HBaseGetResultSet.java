...
public final class HBaseGetResultSet implements HBaseQueryResultSet {
    ...
    private void initResultNum(final SQLStatementContext sqlStatementContext) {
        ...
        Optional<PaginationValueSegment> paginationSegment = ((MySQLSimpleSelectStatement) sqlStatementContext.getSqlStatement()).getLimit().flatMap(LimitSegment::getRowCount);
    ...
    @Override
    public Class<MySQLSimpleSelectStatement> getType() {
        return MySQLSimpleSelectStatement.class;
    }
}
