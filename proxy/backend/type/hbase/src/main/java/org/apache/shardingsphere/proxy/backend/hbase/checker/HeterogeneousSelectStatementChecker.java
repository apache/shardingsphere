...
public final class HeterogeneousSelectStatementChecker extends CommonHeterogeneousSQLStatementChecker {
    ...
    public HeterogeneousSelectStatementChecker(final GenericSelectStatement sqlStatement) {
        super(sqlStatement);
    ...
    private void checkDoNotSupportedSegment() {
        ...
        MySQLGenericSelectStatement selectStatement = (MySQLGenericSelectStatement) sqlStatement;
