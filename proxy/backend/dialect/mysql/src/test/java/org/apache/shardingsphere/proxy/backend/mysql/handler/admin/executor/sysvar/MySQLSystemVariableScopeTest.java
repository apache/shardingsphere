...
class MySQLSystemVariableScopeTest {
    ...
    void assertValueFromKnownValue() {
        assertThat(MySQLSystemVariableScope.valueFrom("session"), is(MySQLSystemVariableScope.SESSION));
    }
    
    @Test
    void assertValueFromUnknownValue() {
        assertThat(MySQLSystemVariableScope.valueFrom("unknown"), is(MySQLSystemVariableScope.DEFAULT));
    }
}
