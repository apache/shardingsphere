...
class MySQLSessionCharsetContextTest {
    ...
    void assertGetDefaultContext() {
        assertThat(MySQLSessionCharsetContext.get(new DefaultAttributeMap()).getClientCharacterSetName(), is(MySQLConstants.DEFAULT_CHARSET.getCharacterSetName()));
    }
    ...
    void assertWithConnectionCollation() {
        ...
        assertThat(actual.getConnectionCollationName(), is("utf8mb4_bin"));
    }
