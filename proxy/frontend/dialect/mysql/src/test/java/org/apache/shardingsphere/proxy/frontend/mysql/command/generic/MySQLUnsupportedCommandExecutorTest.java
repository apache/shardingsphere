...
class MySQLUnsupportedCommandExecutorTest {
    ...
    @Test
    void assertExecute() {
        UnsupportedCommandException ex = assertThrows(UnsupportedCommandException.class, () -> new MySQLUnsupportedCommandExecutor(MySQLCommandPacketType.COM_QUERY).execute());
