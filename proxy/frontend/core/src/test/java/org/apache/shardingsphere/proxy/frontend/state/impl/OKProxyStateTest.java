...
class OKProxyStateTest {
    ...
    private ContextManager mockContextManager() {
        ...
        return new ContextManager(MetaDataContextFactory.create(mock(MetaDataPersistService.class), metaData), computeNodeInstanceContext, mock(PersistRepository.class));
    }
