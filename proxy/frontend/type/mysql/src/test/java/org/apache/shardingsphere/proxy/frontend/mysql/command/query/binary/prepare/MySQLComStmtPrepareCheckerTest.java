...
class MySQLComStmtPrepareCheckerTest {
    ...
    void assertIsStatementAllowed() {
        ...
        Collection<SQLStatement> sqlStatements = Arrays.asList(
                ...
                new MySQLCreateIndexStatement(), new MySQLDropIndexStatement(), new CreateDatabaseStatement(null, false), new DropDatabaseStatement(null, false), createTableStatement,
                ...
                new LoadIndexInfoStatement(Collections.emptyList()), new OptimizeTableStatement(null), new RenameTableStatement(Collections.emptyList()), new RepairTableStatement(Collections.emptyList()),
