...
public final class PostgreSQLAuthenticationHandlerTest extends ProxyContextRestorer {
    ...
    public void assertGetAuthenticator() {
        ...
        PostgreSQLAuthenticator authenticator = new PostgreSQLAuthenticationHandler().getAuthenticator(mock(AuthorityRule.class), mock(ShardingSphereUser.class), new Grantee(username, ""));
