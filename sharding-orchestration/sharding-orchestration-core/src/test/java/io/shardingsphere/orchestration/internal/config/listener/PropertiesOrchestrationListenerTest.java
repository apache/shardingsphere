...
public final class PropertiesOrchestrationListenerTest {
    
    private PropertiesOrchestrationListener propertiesOrchestrationListener;
    ...
    public void assertWatch() {
        propertiesOrchestrationListener.watch();
