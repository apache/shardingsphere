...
public final class OrchestrationMasterSlaveMain {
    ...
    // CHECKSTYLE:ON
        ...
        DataSource dataSource = OrchestrationMasterSlaveDataSourceFactory.createDataSource(
                createDataSourceMap(), crateMasterSlaveRuleConfig(), new OrchestrationConfiguration("orchestration-master-slave-data-source", regCenter, false), new HashMap<String, Object>());
