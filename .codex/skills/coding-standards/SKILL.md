...
- For every affected Java file, read the [Java naming and Lombok rules](references/java-naming.md) through EOF and add each applicable rule to the checklist.
...
- When the scope contains Java, read the [Java naming and Lombok rules](references/java-naming.md) through EOF.
