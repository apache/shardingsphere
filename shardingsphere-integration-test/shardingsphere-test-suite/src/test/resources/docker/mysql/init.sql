...
CREATE DATABASE primary_db_0;
CREATE DATABASE primary_db_1;
CREATE DATABASE primary_db_2;
CREATE DATABASE primary_db_3;
CREATE DATABASE primary_db_4;
CREATE DATABASE primary_db_5;
CREATE DATABASE primary_db_6;
CREATE DATABASE primary_db_7;
CREATE DATABASE primary_db_8;
CREATE DATABASE primary_db_9;
CREATE DATABASE replica_db_0;
CREATE DATABASE replica_db_1;
CREATE DATABASE replica_db_2;
CREATE DATABASE replica_db_3;
CREATE DATABASE replica_db_4;
CREATE DATABASE replica_db_5;
CREATE DATABASE replica_db_6;
CREATE DATABASE replica_db_7;
CREATE DATABASE replica_db_8;
CREATE DATABASE replica_db_9;
