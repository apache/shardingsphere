...
/**
 * SQL hint sharding strategy.
 */
@Getter
public final class SQLHintShardingStrategy implements ShardingStrategy {
    
    private final Collection<String> shardingColumns;
    
    private final ShardingAlgorithm shardingAlgorithm;
    
    public SQLHintShardingStrategy(final ShardingAlgorithm shardingAlgorithm) {
