...
public final class ShardingRuleTest {
    ...
    public void assertIsAllBindingTableWithUpdateStatementContext() {
        ...
        assertTrue(createMaximumShardingRule().isAllBindingTables(mock(ShardingSphereMetaData.class, RETURNS_DEEP_STUBS), sqlStatementContext, Arrays.asList("logic_Table", "sub_Logic_Table")));
    }
    ...
    public void assertIsAllBindingTableWithJoinQueryWithoutJoinCondition() {
        ...
        assertFalse(createMaximumShardingRule().isAllBindingTables(mock(ShardingSphereMetaData.class, RETURNS_DEEP_STUBS), sqlStatementContext, Arrays.asList("logic_Table", "sub_Logic_Table")));
    }
