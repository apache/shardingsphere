...
public final class ShardingDALResultMergerTest {
    ...
    public void assertMergeForShowDatabasesStatement() throws SQLException {
        ...
        assertThat(resultMerger.merge(queryResults, sqlStatementContext, database, mock(SessionContext.class)), instanceOf(LocalDataMergedResult.class));
    }
    ...
    public void assertMergeForShowShowTablesStatement() throws SQLException {
        ...
        ShardingSphereDatabase database = mock(ShardingSphereDatabase.class, RETURNS_DEEP_STUBS);
        when(database.getName()).thenReturn(DefaultDatabase.LOGIC_NAME);
        assertThat(resultMerger.merge(queryResults, sqlStatementContext, database, mock(SessionContext.class)), instanceOf(LogicTablesMergedResult.class));
    }
    ...
    public void assertMergeForShowCreateTableStatement() throws SQLException {
        ...
        ShardingSphereDatabase database = mock(ShardingSphereDatabase.class, RETURNS_DEEP_STUBS);
        when(database.getName()).thenReturn(DefaultDatabase.LOGIC_NAME);
        assertThat(resultMerger.merge(queryResults, sqlStatementContext, database, mock(SessionContext.class)), instanceOf(ShowCreateTableMergedResult.class));
    }
    ...
    public void assertMergeForShowOtherStatement() throws SQLException {
        ...
        ShardingSphereDatabase database = mock(ShardingSphereDatabase.class, RETURNS_DEEP_STUBS);
        when(database.getName()).thenReturn(DefaultDatabase.LOGIC_NAME);
        assertThat(resultMerger.merge(queryResults, sqlStatementContext, database, mock(SessionContext.class)), instanceOf(TransparentMergedResult.class));
    }
    ...
    public void assertMergeForShowIndexStatement() throws SQLException {
        ...
        ShardingSphereDatabase database = mock(ShardingSphereDatabase.class, RETURNS_DEEP_STUBS);
        when(database.getName()).thenReturn(DefaultDatabase.LOGIC_NAME);
        assertThat(resultMerger.merge(queryResults, sqlStatementContext, database, mock(SessionContext.class)), instanceOf(ShowIndexMergedResult.class));
    }
    ...
    public void assertMergeForShowTableStatusStatement() throws SQLException {
        ...
        ShardingSphereDatabase database = mock(ShardingSphereDatabase.class, RETURNS_DEEP_STUBS);
        when(database.getName()).thenReturn(DefaultDatabase.LOGIC_NAME);
        assertThat(resultMerger.merge(queryResults, sqlStatementContext, database, mock(SessionContext.class)), instanceOf(ShowTableStatusMergedResult.class));
    }
