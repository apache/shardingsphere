...
public final class ShardingDropTableStatementValidatorTest {
    ...
    public void assertValidateDropTableForMySQL() {
        ...
        sqlStatement.getTables().add(new SimpleTableSegment(0, 0, new TableNameSegment(0, 0, new IdentifierValue("t_order_item"))));
    ...
    public void assertPostValidateDropTableWithSameRouteResultShardingTableForPostgreSQL() {
        ...
        sqlStatement.getTables().add(new SimpleTableSegment(0, 0, new TableNameSegment(0, 0, new IdentifierValue("t_order"))));
    ...
    public void assertPostValidateDropTableWithSameRouteResultBroadcastTableForPostgreSQL() {
        PostgreSQLDropTableStatement sqlStatement = new PostgreSQLDropTableStatement();
        sqlStatement.getTables().add(new SimpleTableSegment(0, 0, new TableNameSegment(0, 0, new IdentifierValue("t_config"))));
    ...
    public void assertPostValidateDropTableWithSameRouteResultSingleTableForPostgreSQL() {
        PostgreSQLDropTableStatement sqlStatement = new PostgreSQLDropTableStatement();
        sqlStatement.getTables().add(new SimpleTableSegment(0, 0, new TableNameSegment(0, 0, new IdentifierValue("t_single"))));
        Collection<RouteUnit> routeUnits = new LinkedList<>();
