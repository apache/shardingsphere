...
public final class ShardingAlterTableStatementValidatorTest {
    ...
    public void assertPostValidateAlterTableWithSameRouteResultShardingTableForPostgreSQL() {
        ...
        new ShardingAlterTableStatementValidator().postValidate(shardingRule, new AlterTableStatementContext(sqlStatement), Collections.emptyList(), schema, mock(ConfigurationProperties.class), routeContext);
    }
