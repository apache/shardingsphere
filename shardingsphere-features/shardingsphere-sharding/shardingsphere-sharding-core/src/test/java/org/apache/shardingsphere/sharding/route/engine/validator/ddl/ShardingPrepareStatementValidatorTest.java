...
public final class ShardingPrepareStatementValidatorTest {
    ...
    public void assertPostValidatePrepareWithEmptyRouteResultForPostgreSQL() {
        ...
        new ShardingPrepareStatementValidator().postValidate(shardingRule, new PrepareStatementContext(sqlStatement), Collections.emptyList(), schema, mock(ConfigurationProperties.class), routeContext);
    }
