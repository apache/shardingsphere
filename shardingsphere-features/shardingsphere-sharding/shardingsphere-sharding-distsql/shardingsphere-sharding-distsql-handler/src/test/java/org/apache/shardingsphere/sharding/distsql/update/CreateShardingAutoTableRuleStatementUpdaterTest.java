...
import org.apache.shardingsphere.sharding.distsql.handler.update.CreateShardingAutoTableRuleStatementUpdater;
...
public final class CreateShardingAutoTableRuleStatementUpdaterTest {
    ...
    private final CreateShardingAutoTableRuleStatementUpdater updater = new CreateShardingAutoTableRuleStatementUpdater();
    ...
    public void assertExecuteWithDuplicateTables() throws DistSQLException {
        AutoTableRuleSegment ruleSegment = new AutoTableRuleSegment("t_order", Collections.emptyList(), null, null, null);
    ...
    public void assertCheckSQLStatementWithoutToBeCreatedShardingAlgorithms() throws DistSQLException {
        AutoTableRuleSegment ruleSegment = new AutoTableRuleSegment("t_order", Collections.emptyList(), "order_id", new AlgorithmSegment("INVALID_TYPE", new Properties()), null);
        updater.checkSQLStatement(shardingSphereMetaData, createSQLStatement(ruleSegment), null);
    }
    ...
    public void assertExecuteWithNotExistsResource() throws DistSQLException {
        ...
        AutoTableRuleSegment ruleSegment = new AutoTableRuleSegment("t_order", dataSources, null, null, null);
        updater.checkSQLStatement(shardingSphereMetaData, createSQLStatement(ruleSegment), null);
    }
    ...
    public void assertExecuteWithExtraResources() throws DistSQLException {
        ...
        AutoTableRuleSegment ruleSegment = new AutoTableRuleSegment("t_order", dataSources, "order_id", new AlgorithmSegment("MOD_TEST", new Properties()), null);
        updater.checkSQLStatement(shardingSphereMetaData, createSQLStatement(ruleSegment), null);
    }
    ...
    private CreateShardingAutoTableRuleStatement createSQLStatement(final AutoTableRuleSegment... ruleSegments) {
        return new CreateShardingAutoTableRuleStatement(Arrays.asList(ruleSegments));
    }
}
