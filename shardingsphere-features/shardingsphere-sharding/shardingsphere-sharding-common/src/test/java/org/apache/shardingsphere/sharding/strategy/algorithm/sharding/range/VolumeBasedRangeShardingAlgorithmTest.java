...
public final class VolumeBasedRangeShardingAlgorithmTest {
    ...
    public void setUp() {
        ...
        shardingAlgorithm.getProps().setProperty(VolumeBasedRangeShardingAlgorithm.RANGE_LOWER_KEY, "10");
        shardingAlgorithm.getProps().setProperty(VolumeBasedRangeShardingAlgorithm.RANGE_UPPER_KEY, "45");
        shardingAlgorithm.getProps().setProperty(VolumeBasedRangeShardingAlgorithm.SHARDING_VOLUME_KEY, "10");
