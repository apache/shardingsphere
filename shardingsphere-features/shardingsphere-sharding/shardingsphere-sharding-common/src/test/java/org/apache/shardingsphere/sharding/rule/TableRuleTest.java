...
import org.apache.shardingsphere.sharding.strategy.algorithm.sharding.ModShardingAlgorithm;
...
public final class TableRuleTest {
    ...
    public void assertCreateAutoTableRuleWithModAlgorithm() {
        ...
        shardingAlgorithm.getProps().setProperty(ModShardingAlgorithm.SHARDING_COUNT_KEY, "4");
