 ...
 */
@Setter
public final class ShardingReplaceValuesTokenGenerator implements OptionalSQLTokenGenerator<ReplaceStatementContext>, RouteContextAware {
    
    private RouteContext routeContext;
    
    @Override
    public boolean isGenerateSQLToken(final SQLStatementContext sqlStatementContext) {
        return sqlStatementContext instanceof ReplaceStatementContext && !(((ReplaceStatementContext) sqlStatementContext).getSqlStatement()).getValues().isEmpty();
    }
    
    @Override
    public InsertValuesToken generateSQLToken(final ReplaceStatementContext replaceStatementContext) {
        Collection<InsertValuesSegment> insertValuesSegments = (replaceStatementContext.getSqlStatement()).getValues();
