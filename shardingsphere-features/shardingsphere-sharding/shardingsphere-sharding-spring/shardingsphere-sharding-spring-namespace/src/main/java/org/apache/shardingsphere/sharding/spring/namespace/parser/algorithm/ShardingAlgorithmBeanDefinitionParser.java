 ...
 */
public final class ShardingAlgorithmBeanDefinitionParser extends ShardingSphereAlgorithmBeanDefinitionParser {
    
    public ShardingAlgorithmBeanDefinitionParser() {
        super(ShardingAlgorithmFactoryBean.class);
    }
}
