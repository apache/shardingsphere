...
public abstract class EncryptGeneratorBaseTest {
    ...
    protected static EncryptRuleConfiguration createEncryptRuleConfiguration() {
        ...
        return new EncryptRuleConfiguration(Collections.singleton(new EncryptTableRuleConfiguration(TABLE_NAME, Collections.singletonList(pwdColumnConfig), null)),
    ...
    protected static InsertStatementContext createInsertStatementContext(final List<Object> parameters) {
        ...
        when(schema.getAllColumnNames(TABLE_NAME)).thenReturn(Arrays.asList("id", "name", "status", "pwd"));
