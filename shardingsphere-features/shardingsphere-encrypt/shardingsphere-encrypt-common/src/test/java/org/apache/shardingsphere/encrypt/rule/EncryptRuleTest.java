...
public final class EncryptRuleTest {
    ...
    public void setUp() {
        ...
        EncryptAlgorithmConfiguration encryptAlgorithmConfiguration = new EncryptAlgorithmConfiguration("aes", "assistedTest", props);
        ...
        encryptRuleConfig = new EncryptRuleConfiguration(Collections.singleton(encryptAlgorithmConfiguration), Collections.singleton(tableConfig));
    }
