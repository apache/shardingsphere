...
public final class ShadowInsertStatementRoutingEngineTest {
    ...
    private InsertStatementContext createInsertStatementContext() {
        ...
        when(result.getInsertColumnNames()).thenReturn(Collections.singletonMap(0, Arrays.asList("user_id", "order_code", "order_name")));
        ...
        when(result.getInsertValueContexts()).thenReturn(Collections.singletonMap(0, Collections.singletonList(new InsertValueContext(valueExpressions, Collections.emptyList(), 0))));
