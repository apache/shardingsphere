...
public final class ShadowRuleBuilder implements FeatureRuleBuilder, SchemaRuleBuilder<ShadowRuleConfiguration> {
    ...
    @Override
    public SchemaRule build(final ShardingSphereRulesBuilderMaterials materials, final ShadowRuleConfiguration config, final Collection<ShardingSphereRule> rules) {
