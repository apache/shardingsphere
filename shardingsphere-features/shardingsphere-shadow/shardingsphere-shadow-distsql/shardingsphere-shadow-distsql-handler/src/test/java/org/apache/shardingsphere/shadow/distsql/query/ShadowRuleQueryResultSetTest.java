...
public final class ShadowRuleQueryResultSetTest {
    ...
    private RuleConfiguration createRuleConfiguration() {
        ...
        result.getTables().put("t_order", new ShadowTableConfiguration(List.of("shadow_rule"), Collections.emptyList()));
        result.getTables().put("t_order_1", new ShadowTableConfiguration(List.of("shadow_rule"), Collections.emptyList()));
        return result;
    }
}
