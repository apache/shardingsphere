...
/**
 * Disable shadow rules statement updater.
 */
public final class DisableShadowRulesStatementUpdater implements RuleDefinitionAlterUpdater<DisableShadowRulesStatement, ShadowRuleConfiguration> {
    
    @Override
    public void checkSQLStatement(final ShardingSphereMetaData metaData, final DisableShadowRulesStatement sqlStatement, final ShadowRuleConfiguration currentRuleConfig) throws DistSQLException {
    ...
    public String getType() {
        return DisableShadowRulesStatement.class.getCanonicalName();
    }
}
