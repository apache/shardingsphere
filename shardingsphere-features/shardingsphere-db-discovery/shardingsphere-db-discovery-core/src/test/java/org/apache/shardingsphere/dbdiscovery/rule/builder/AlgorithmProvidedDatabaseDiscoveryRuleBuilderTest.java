...
public final class AlgorithmProvidedDatabaseDiscoveryRuleBuilderTest {
    ...
    public void assertBuild() {
        ...
        DatabaseDiscoveryDataSourceRuleConfiguration ruleConfig = new DatabaseDiscoveryDataSourceRuleConfiguration("name", Collections.singletonList("name"), "discoveryTypeName", "heartbeat");
