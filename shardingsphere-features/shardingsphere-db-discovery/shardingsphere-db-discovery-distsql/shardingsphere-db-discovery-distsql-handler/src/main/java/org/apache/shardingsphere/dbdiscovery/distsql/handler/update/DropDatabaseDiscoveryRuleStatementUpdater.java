...
public final class DropDatabaseDiscoveryRuleStatementUpdater implements RDLDropUpdater<DropDatabaseDiscoveryRuleStatement, DatabaseDiscoveryRuleConfiguration> {
    ...
    private void checkCurrentRuleConfiguration(final String schemaName, final DatabaseDiscoveryRuleConfiguration currentRuleConfig) throws RuleNotExistedException {
        if (null == currentRuleConfig) {
            throw new RuleNotExistedException("Database discovery", schemaName);
        }
    }
    
    private void checkToBeDroppedRuleNames(final String schemaName, final DropDatabaseDiscoveryRuleStatement sqlStatement, 
                                           final DatabaseDiscoveryRuleConfiguration currentRuleConfig) throws RuleNotExistedException {
        ...
        if (!notExistedRuleNames.isEmpty()) {
            throw new RuleNotExistedException("Database discovery", schemaName, notExistedRuleNames);
        }
    }
