...
public final class DropDatabaseDiscoveryRuleStatementUpdater implements RDLDropUpdater<DropDatabaseDiscoveryRuleStatement, DatabaseDiscoveryRuleConfiguration> {
    ...
    private void checkCurrentRuleConfiguration(final String schemaName, final DatabaseDiscoveryRuleConfiguration currentRuleConfig) throws NotExistedRuleException {
        if (null == currentRuleConfig) {
            throw new NotExistedRuleException("Database discovery", schemaName);
        }
    }
    
    private void checkToBeDroppedRuleNames(final String schemaName, final DropDatabaseDiscoveryRuleStatement sqlStatement, 
                                           final DatabaseDiscoveryRuleConfiguration currentRuleConfig) throws NotExistedRuleException {
        ...
        if (!notExistedRuleNames.isEmpty()) {
            throw new NotExistedRuleException("Database discovery", schemaName, notExistedRuleNames);
        }
    }
