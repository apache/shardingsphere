...
public final class DropReadwriteSplittingRuleStatementUpdater implements RDLDropUpdater<DropReadwriteSplittingRuleStatement, ReadwriteSplittingRuleConfiguration> {
    ...
    private void checkCurrentRuleConfiguration(final String schemaName, final ReadwriteSplittingRuleConfiguration currentRuleConfig) throws RuleNotExistedException {
        if (null == currentRuleConfig) {
            throw new RuleNotExistedException("Readwrite splitting", schemaName);
        }
    }
    
    private void checkToBeDroppedRuleNames(final String schemaName, final DropReadwriteSplittingRuleStatement sqlStatement, 
                                           final ReadwriteSplittingRuleConfiguration currentRuleConfig) throws RuleNotExistedException {
        ...
        if (!notExistedRuleNames.isEmpty()) {
            throw new RuleNotExistedException("Readwrite splitting", schemaName, sqlStatement.getRuleNames());
        }
    }
