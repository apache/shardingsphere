...
public final class ReadwriteSplittingStrategyFactory {
    ...
    private static DynamicReadwriteSplittingStrategy createDynamicReadwriteSplittingStrategy(final DynamicReadwriteSplittingStrategyConfiguration dynamicConfig, final Collection<ShardingSphereRule> builtRules) {
        ...
        return new DynamicReadwriteSplittingStrategy(dynamicConfig.getAutoAwareDataSourceName(), allowWriteDataSourceQuery, (DynamicStatusContainedRule) dynamicDataSourceStrategy.get());
    }
}
