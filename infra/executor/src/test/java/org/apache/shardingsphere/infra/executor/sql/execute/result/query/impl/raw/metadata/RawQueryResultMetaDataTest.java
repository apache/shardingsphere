...
class RawQueryResultMetaDataTest {
    ...
    void assertGetResultSetMetaData() {
        RawQueryResultMetaData queryResultMetaData = new RawQueryResultMetaData(Collections.singletonList(new RawQueryResultColumnMetaData("foo_table", "foo_column", "foo_label",
