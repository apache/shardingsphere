...
public interface DatabaseConnectionManager<C> {
     ...
     */
    List<C> getConnections(String dataSourceName, String catalogName, int connectionOffset, int connectionSize, ConnectionMode connectionMode) throws SQLException;
}
