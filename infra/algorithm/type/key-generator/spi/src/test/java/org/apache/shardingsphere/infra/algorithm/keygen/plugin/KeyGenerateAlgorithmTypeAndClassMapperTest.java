...
package org.apache.shardingsphere.infra.algorithm.keygen.plugin;
...
class KeyGenerateAlgorithmTypeAndClassMapperTest {
    ...
    void assertGetPluginClass() {
        assertThat(TypedSPILoader.getService(PluginTypeAndClassMapper.class, "KEY_GENERATE_ALGORITHM").getPluginClass(), is(KeyGenerateAlgorithm.class));
    }
}
