 ...
 */
public final class UnrecognizedDatabaseURLException extends ResourceDefinitionException {
    ...
    public UnrecognizedDatabaseURLException(final String url, final String pattern) {
        super(XOpenSQLState.CONNECTION_EXCEPTION, 12, "The URL `%s` is not recognized, please refer to the pattern `%s`.", url, pattern);
    }
}
