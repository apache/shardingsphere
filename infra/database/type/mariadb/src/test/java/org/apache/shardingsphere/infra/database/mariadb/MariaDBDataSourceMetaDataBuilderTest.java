...
class MariaDBDataSourceMetaDataBuilderTest {
    ...
    @Test
    void assertBuild() {
        assertThat(builder.build("jdbc:mariadb://localhost:3306/foo_ds", "root", null), instanceOf(MariaDBDataSourceMetaData.class));
    }
}
