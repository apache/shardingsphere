...
class PostgreSQLDataSourceMetaDataBuilderTest {
    ...
    @Test
    void assertBuild() {
        assertThat(builder.build("jdbc:postgresql://localhost:5432/demo_ds_0", "postgres", null), instanceOf(PostgreSQLDataSourceMetaData.class));
    }
}
