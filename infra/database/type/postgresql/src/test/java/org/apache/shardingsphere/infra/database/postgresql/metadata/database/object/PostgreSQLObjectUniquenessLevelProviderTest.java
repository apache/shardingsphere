...
package org.apache.shardingsphere.infra.database.postgresql.metadata.database.object;
...
class PostgreSQLObjectUniquenessLevelProviderTest {
    ...
    private final DialectObjectUniquenessLevelProvider uniquenessLevelProvider =
            DatabaseTypedSPILoader.getService(DialectObjectUniquenessLevelProvider.class, TypedSPILoader.getService(DatabaseType.class, "PostgreSQL"));
