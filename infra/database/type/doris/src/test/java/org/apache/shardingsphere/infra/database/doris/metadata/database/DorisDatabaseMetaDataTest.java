...
package org.apache.shardingsphere.infra.database.doris.metadata.database;
...
class DorisDatabaseMetaDataTest {
    ...
    private final DialectDatabaseMetaData dialectDatabaseMetaData = DatabaseTypedSPILoader.getService(DialectDatabaseMetaData.class, TypedSPILoader.getService(DatabaseType.class, "Doris"));
