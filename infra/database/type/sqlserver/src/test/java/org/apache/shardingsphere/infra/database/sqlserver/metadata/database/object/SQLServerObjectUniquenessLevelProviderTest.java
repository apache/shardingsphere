...
class SQLServerObjectUniquenessLevelProviderTest {
    ...
    private final DialectObjectUniquenessLevelProvider uniquenessLevelProvider =
            DatabaseTypedSPILoader.getService(DialectObjectUniquenessLevelProvider.class, TypedSPILoader.getService(DatabaseType.class, "SQLServer"));
    
    @Test
    void assertGetIndexUniquenessLevel() {
        assertThat(uniquenessLevelProvider.getIndexUniquenessLevel(), is(UniquenessLevel.TABLE_LEVEL));
    }
}
