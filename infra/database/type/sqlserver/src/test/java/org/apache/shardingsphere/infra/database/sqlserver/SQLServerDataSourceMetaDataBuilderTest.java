...
class SQLServerDataSourceMetaDataBuilderTest {
    ...
    @Test
    void assertBuild() {
        assertThat(builder.build("jdbc:sqlserver://127.0.0.1;DatabaseName=ds_0", "root", null), instanceOf(SQLServerDataSourceMetaData.class));
        assertThat(builder.build("jdbc:microsoft:sqlserver://127.0.0.1;DatabaseName=ds_0", "sa", null), instanceOf(SQLServerDataSourceMetaData.class));
    }
}
