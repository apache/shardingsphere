...
class OpenGaussDataSourceMetaDataTest {
    ...
    private final DataSourceMetaDataBuilder builder = DatabaseTypedSPILoader.getService(DataSourceMetaDataBuilder.class, TypedSPILoader.getService(DatabaseType.class, "openGauss"));
    ...
    void assertNewConstructorFailure() {
        assertThrows(UnrecognizedDatabaseURLException.class, () -> builder.build("jdbc:opengauss:xxxxxxxx", null, null));
    }
