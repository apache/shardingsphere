...
class CatalogSwitchableDataSourceTest {
    ...
    void assertGetConnectionWhenCatalogIsNull() throws SQLException {
        ...
        CatalogSwitchableDataSource catalogSwitchableDataSource = new CatalogSwitchableDataSource(dataSource, null, "jdbc:mysql://localhost:3306/db");
    ...
    void assertGetConnectionWhenCatalogIsSame() throws SQLException {
        ...
        CatalogSwitchableDataSource catalogSwitchableDataSource = new CatalogSwitchableDataSource(dataSource, catalog, "jdbc:mysql://localhost:3306/db");
        catalogSwitchableDataSource.getConnection();
