...
class EtcdModeConfigurationURLLoaderTest {
    ...
    private final ShardingSphereModeConfigurationURLLoader urlLoader = TypedSPILoader.getService(ShardingSphereModeConfigurationURLLoader.class, "etcd:");
    ...
    void assertLoadWithoutNamespace() {
        ...
        assertThat(expectedException.getMessage(), is("Missing required property 'namespace' for ETCD URL loader."));
    }
}
