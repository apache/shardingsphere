...
public final class DropDatabaseRuleOperator implements DatabaseRuleOperator {
    ...
    public void operate(final DatabaseRuleDefinitionStatement sqlStatement, final ShardingSphereDatabase database, final RuleConfiguration currentRuleConfig) throws SQLException {
        ...
        if (null != toBeAlteredRuleConfig
            ...
            metaDataManagerPersistService.removeRuleConfiguration(database, Objects.requireNonNull(yamlRuleConfig.getClass().getAnnotation(RuleRepositoryTupleEntity.class)).value());
        } else {
