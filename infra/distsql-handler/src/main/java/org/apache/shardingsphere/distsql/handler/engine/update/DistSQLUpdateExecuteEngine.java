...
public final class DistSQLUpdateExecuteEngine {
    ...
    private void executeRuleDefinitionUpdate() {
        ...
        if (databaseExecutor.isPresent()) {
            ...
            new GlobalRuleDefinitionExecuteEngine((GlobalRuleDefinitionStatement) sqlStatement, contextManager,
                    TypedSPILoader.getService(GlobalRuleDefinitionExecutor.class, sqlStatement.getClass())).executeUpdate();
        }
    }
