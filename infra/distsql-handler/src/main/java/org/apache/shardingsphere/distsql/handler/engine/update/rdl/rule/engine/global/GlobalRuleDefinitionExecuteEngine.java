...
public final class GlobalRuleDefinitionExecuteEngine {
    ...
    public void executeUpdate() throws SQLException {
        ...
        contextManager.getPersistServiceFacade().getModePersistServiceFacade().getMetaDataManagerPersistService().alterGlobalRuleConfiguration(executor.buildToBeAlteredRuleConfiguration(sqlStatement));
    }
}
