...
class UnregisterStorageUnitExecutorTest {
    ...
    void assertExecuteUpdateSuccess() throws SQLException {
        ...
        verify(metaDataManagerPersistService).unregisterStorageUnits(new ShardingSphereDatabase("foo_db", mock(), mock(), mock(), Collections.emptyList()), sqlStatement.getStorageUnitNames());
    }
