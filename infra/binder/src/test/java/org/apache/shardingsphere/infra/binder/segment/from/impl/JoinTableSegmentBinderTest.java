...
class JoinTableSegmentBinderTest {
    ...
    void assertBindWithAlias() {
        ...
        JoinTableSegment actual = JoinTableSegmentBinder.bind(joinTableSegment, new SQLStatementBinderContext(metaData, DefaultDatabase.LOGIC_NAME, databaseType,
                Collections.emptySet()), tableBinderContexts, new CursorRecordTableBinderContext());
    ...
    void assertBindWithNaturalJoin() {
        ...
        JoinTableSegment actual =
                JoinTableSegmentBinder.bind(joinTableSegment, new SQLStatementBinderContext(metaData, DefaultDatabase.LOGIC_NAME, databaseType, Collections.emptySet()), tableBinderContexts,
