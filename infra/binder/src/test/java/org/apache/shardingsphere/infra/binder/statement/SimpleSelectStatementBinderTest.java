...
class SimpleSelectStatementBinderTest {
    ...
    void assertBind() {
        ...
        GenericSelectStatement actual = new SelectStatementBinder().bind(selectStatement, createMetaData(), DefaultDatabase.LOGIC_NAME);
