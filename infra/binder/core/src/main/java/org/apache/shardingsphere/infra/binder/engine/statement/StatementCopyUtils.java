...
/**
 * Statement copy utils.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class StatementCopyUtils {
     ...
     */
    public static void copyAttributes(final SQLStatement originalSQLStatement, final SQLStatement boundSQLStatement) {
