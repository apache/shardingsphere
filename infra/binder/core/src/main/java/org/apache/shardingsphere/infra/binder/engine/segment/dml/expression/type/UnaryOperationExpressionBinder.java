...
public final class UnaryOperationExpressionBinder {
     ...
     */
    public static UnaryOperationExpression bind(final UnaryOperationExpression segment, final SegmentType parentSegmentType,
        ...
        return new UnaryOperationExpression(segment.getStartIndex(), segment.getStopIndex(), boundExpression, segment.getOperator(), segment.getText());
    }
}
