...
class UnaryOperationExpressionBinderTest {
    ...
    void assertBind() {
        ...
        UnaryOperationExpression segment = new UnaryOperationExpression(0, 8, innerSegment, "+", "+user_id");
        ...
        when(ExpressionSegmentBinder.bind(innerSegment, SegmentType.PROJECTION, binderContext, tableBinderContexts, outerTableBinderContexts))
                .thenReturn(boundInnerSegment);
        UnaryOperationExpression actual = UnaryOperationExpressionBinder.bind(segment, SegmentType.PROJECTION, binderContext, tableBinderContexts, outerTableBinderContexts);
