...
class ColumnProjectionSegmentBinderTest {
    ...
    void assertBind() {
        ...
        AliasSegment aliasSegment = new AliasSegment(0, 0, new IdentifierValue("column_alias"));
        ...
        ColumnSegment boundColumnSegment = new ColumnSegment(0, 0, new IdentifierValue("status"));
        when(ColumnSegmentBinder.bind(columnSegment, SegmentType.PROJECTION, binderContext, tableBinderContexts, outerTableBinderContexts)).thenReturn(boundColumnSegment);
        ColumnProjectionSegment actual = ColumnProjectionSegmentBinder.bind(projectionSegment, binderContext, tableBinderContexts, outerTableBinderContexts);
