...
package org.apache.shardingsphere.infra.exception.external.sql.type.generic;
...
public abstract class GenericSQLException extends ShardingSphereSQLException {
    ...
    protected GenericSQLException(final SQLState sqlState, final int errorCode, final String reason, final Object... messageArgs) {
        super(sqlState, TYPE_OFFSET, errorCode, reason, messageArgs);
    }
    
    protected GenericSQLException(final String reason, final SQLState sqlState, final int errorCode, final Exception cause) {
