...
public final class ToggleFixtureDatabaseRuleConfigurationEmptyChecker implements DatabaseRuleConfigurationEmptyChecker<ToggleFixtureDatabaseRuleConfiguration> {
    
    @Override
    public boolean isEmpty(final ToggleFixtureDatabaseRuleConfiguration ruleConfig) {
