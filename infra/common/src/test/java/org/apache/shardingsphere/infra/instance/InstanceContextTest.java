...
public final class InstanceContextTest {
    ...
    public void assertUpdateInstanceStatus() {
        ...
        InstanceStateType actual = context.getInstance().getState().getCurrentState();
        assertThat(actual, is(InstanceStateType.OK));
        context.updateInstanceStatus(instanceMetaData.getId(), InstanceStateType.CIRCUIT_BREAK.name());
        actual = context.getInstance().getState().getCurrentState();
        assertThat(actual, is(InstanceStateType.CIRCUIT_BREAK));
        context.updateInstanceStatus(instanceMetaData.getId(), InstanceStateType.OK.name());
        actual = context.getInstance().getState().getCurrentState();
        assertThat(actual, is(InstanceStateType.OK));
    }
