...
class PostgreSQLStatisticsAppenderTest {
    ...
    void assertAppend() {
        ...
        assertTrue(databaseStatistics.getSchemaData().containsKey("pg_catalog"));
        assertTrue(databaseStatistics.getSchemaData().get("pg_catalog").getTableData().containsKey("pg_class"));
    }
