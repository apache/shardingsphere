...
public final class H2SchemaMetaDataLoaderTest {
    ...
    private DialectSchemaMetaDataLoader getDialectTableMetaDataLoader() {
        Optional<DialectSchemaMetaDataLoader> result = DialectSchemaMetaDataLoaderFactory.findInstance(TypedSPIRegistry.getRegisteredService(DatabaseType.class, "H2"));
