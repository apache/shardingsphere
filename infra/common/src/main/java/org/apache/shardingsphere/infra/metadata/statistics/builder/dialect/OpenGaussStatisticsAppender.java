...
/**
 * Statistics appender for openGauss.
 */
public final class OpenGaussStatisticsAppender implements DialectStatisticsAppender {
    
    private final PostgreSQLStatisticsAppender delegate = new PostgreSQLStatisticsAppender();
    
    @Override
    public void append(final DatabaseStatistics databaseStatistics, final ShardingSphereDatabase database) {
        delegate.append(databaseStatistics, database);
    }
