...
public final class StorageResourceWithProperties extends StorageResource {
    ...
    public StorageResourceWithProperties(final Map<String, DataSource> storageNodes, final Map<String, DatabaseType> storageNodesTypes,
                                         final Map<String, StorageUnit> storageUnits, final Map<String, DataSourceProperties> dataSourcePropertiesMap) {
        super(storageNodes, storageNodesTypes, storageUnits);
