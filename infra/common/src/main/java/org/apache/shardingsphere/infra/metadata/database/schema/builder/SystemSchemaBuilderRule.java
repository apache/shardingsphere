...
public enum SystemSchemaBuilderRule {
    ...
    MYSQL_SYS("MySQL", "sys", new HashSet<>(Arrays.asList("sys_config", "host_summary_by_statement_type", "innodb_buffer_stats_by_schema", "innodb_buffer_stats_by_table",
            "innodb_lock_waits", "io_by_thread_by_latency"))),
