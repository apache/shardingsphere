...
public final class YamlModeConfigurationSwapper implements YamlConfigurationSwapper<YamlModeConfiguration, ModeConfiguration> {
    ...
    public YamlModeConfiguration swapToYamlConfiguration(final ModeConfiguration data) {
        ...
        if (null != data.getRepository()) {
            YamlPersistRepositoryConfigurationSwapper<PersistRepositoryConfiguration> swapper = TypedSPIRegistry.getRegisteredService(YamlPersistRepositoryConfigurationSwapper.class, data.getType());
    ...
    public ModeConfiguration swapToObject(final YamlModeConfiguration yamlConfig) {
        ...
        YamlPersistRepositoryConfigurationSwapper<PersistRepositoryConfiguration> swapper = TypedSPIRegistry.getRegisteredService(YamlPersistRepositoryConfigurationSwapper.class, yamlConfig.getType());
