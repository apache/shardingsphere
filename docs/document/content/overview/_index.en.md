...
Apache ShardingSphere began to focus on pluggable architecture from version 5.x, and its features can be embedded into projects flexibily.
...
Developers can customize their ShardingSphere systems just like building with LEGO blocks. There are lots of SPI extensions for Apache ShardingSphere now, and the number is continuously growing.

ShardingSphere became an [Apache](https://apache.org/index.html#projects-list) Top-Level Project on April 16, 2020.

You're welcome to communicate with the community via [mail list](mailto:dev@shardingsphere.apache.org) or engage with other members on [ShardingSphere's Slack channel](https://app.slack.com/client/T026JKU2DPF/C026MLH7F34).
...
Friendlier to DBAs, the MySQL version provided now can use any kind of terminal (such as MySQL Command Client, MySQL Workbench, etc.) that is compatible of MySQL protocol to operate data.
...
ShardingSphere is an ecosystem consisting of multiple endpoints brought together.
Through a mixed use of ShardingSphere-JDBC and ShardingSphere-Proxy and a unified sharding strategy by the same registry center, ShardingSphere can build an application system applicable to all kinds of scenarios. 
Architects can adjust the system architecture to the most applicable one that fits their current business more freely.
