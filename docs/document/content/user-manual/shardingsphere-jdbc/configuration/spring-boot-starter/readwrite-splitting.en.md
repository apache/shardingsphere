...
spring.shardingsphere.rules.readwrite-splitting.data-sources.<readwrite-splitting-data-source-name>.consistency-enabled= # Whether to enable consistent routing
...
Please refer to [Use Norms](/en/features/readwrite-splitting/use-norms) for more details about consistent routing.
