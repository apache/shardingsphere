...
primaryDataSource0.setJdbcUrl("jdbc:mysql://localhost:3306/db?serverTimezone=UTC&useSSL=false&useUnicode=true&characterEncoding=UTF-8");
...
datasourceMap.put("primary_ds0", primaryDataSource0);
datasourceMap.put("primary_ds0_replica0", replica0OfPrimaryDataSource0);
datasourceMap.put("primary_ds0_replica1", replica1OfPrimaryDataSource0);

datasourceMap.put("primary_ds1", primaryDataSource1);
datasourceMap.put("primary_ds1_replica0", replica0OfPrimaryDataSource1);
datasourceMap.put("primary_ds1_replica1", replica1OfPrimaryDataSource1);
...
DataSource shardingDataSource = ShardingSphereDataSourceFactory.createDataSource(createDataSourceMap(), Arrays.asList(shardingRuleConfiguration, replicaQueryRuleConfiguration, encryptRuleConfiguration), otherProperties);
