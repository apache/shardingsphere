...
| default-key-generate-strategy-ref (?) | 属性  | 默认自增列值生成器引用，缺省使用`org.apache.shardingsphere.core.keygen.generator.impl.SnowflakeKeyGenerator` |
...
| properties-ref | 属性  | 属性配置, 注意：使用AES加密算法，需要配置 AES 加密算法的 KEY 属性：aes.key.value |
