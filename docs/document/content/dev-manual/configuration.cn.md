...
| SQLParserRuleConfiguration          | 用于将 SQL 解析用户配置转化为 SQL 解析规则对象 | [`org.apache.shardingsphere.parser.rule.builder.SQLParserRuleBuilder`](https://github.com/apache/shardingsphere/blob/master/kernel/parser/core/src/main/java/org/apache/shardingsphere/sql-parser/rule/builder/SQLParserRuleBuilder.java)                                                |
...
| SingleRuleConfiguration             | 用于将单表用户配置转化为单表规则对象           | [`org.apache.shardingsphere.single.rule.builder.SingleRuleBuilder`](https://github.com/apache/shardingsphere/blob/master/kernel/single/core/src/main/java/org/apache/shardingsphere/single/rule/builder/SingleRuleBuilder.java)                                                     |
...
| SINGLE              | 用于将单表的 YAML 配置转化为单表标准配置           | [`org.apache.shardingsphere.single.yaml.config.swapper.YamlSingleRuleConfigurationSwapper`](https://github.com/apache/shardingsphere/blob/master/kernel/single/core/src/main/java/org/apache/shardingsphere/single/yaml/config/swapper/YamlSingleRuleConfigurationSwapper.java)                                  |
