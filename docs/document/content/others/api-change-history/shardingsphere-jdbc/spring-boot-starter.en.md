...
spring.shardingsphere.datasource.<data-source-name>.url= #Database url connection.for dbcp is url,for hikari is jdbc-url
...
sharding.jdbc.datasource.<data-source-name>.url= #Database URL.for dbcp is url,for hikari is jdbc-url
