...
public final class MySQLUnsupportedCommandPacketTest {
    ...
    public void assertExecute() {
        ...
        assertThat(((MySQLErrPacket) ((CommandResponsePackets) actual.get()).getHeadPacket()).getErrorCode(), CoreMatchers.is(CommonErrorCode.UNSUPPORTED_COMMAND.getErrorCode()));
        assertThat(((MySQLErrPacket) ((CommandResponsePackets) actual.get()).getHeadPacket()).getSqlState(), CoreMatchers.is(CommonErrorCode.UNSUPPORTED_COMMAND.getSqlState()));
