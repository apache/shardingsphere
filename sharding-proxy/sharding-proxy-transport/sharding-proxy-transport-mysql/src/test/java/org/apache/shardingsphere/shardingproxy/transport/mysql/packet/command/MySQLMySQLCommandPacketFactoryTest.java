...
public final class MySQLMySQLCommandPacketFactoryTest {
    ...
    public void assertNewInstanceWithComQuitPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_QUIT.getValue());
    ...
    public void assertNewInstanceWithComInitDbPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_INIT_DB.getValue());
    ...
    public void assertNewInstanceWithComFieldListPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_FIELD_LIST.getValue());
    ...
    public void assertNewInstanceWithComQueryPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_QUERY.getValue());
    ...
    public void assertNewInstanceWithComStmtPreparePacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STMT_PREPARE.getValue());
    ...
    public void assertNewInstanceWithComStmtExecutePacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STMT_EXECUTE.getValue(), MySQLNewParametersBoundFlag.PARAMETER_TYPE_EXIST.getValue());
    ...
    public void assertNewInstanceWithComStmtClosePacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STMT_CLOSE.getValue());
    ...
    public void assertNewInstanceWithComPingPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_PING.getValue());
    ...
    public void assertNewInstanceWithComSleepPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_SLEEP.getValue());
    ...
    public void assertNewInstanceWithComCreateDbPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_CREATE_DB.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComDropDbPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_DROP_DB.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComRefreshPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_REFRESH.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComShutDownPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_SHUTDOWN.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComStatisticsPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STATISTICS.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComProcessInfoPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_PROCESS_INFO.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComConnectPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_CONNECT.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComProcessKillPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_PROCESS_KILL.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComDebugPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_DEBUG.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComTimePacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_TIME.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComDelayedInsertPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_DELAYED_INSERT.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComChangeUserPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_CHANGE_USER.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComBinlogDumpPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_BINLOG_DUMP.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComTableDumpPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_TABLE_DUMP.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComConnectOutPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_CONNECT_OUT.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComRegisterSlavePacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_REGISTER_SLAVE.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComStmtSendLongDataPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STMT_SEND_LONG_DATA.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComStmtResetPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STMT_RESET.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComSetOptionPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_SET_OPTION.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComStmtFetchPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_STMT_FETCH.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComDaemonPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_DAEMON.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComBinlogDumpGTIDPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_BINLOG_DUMP_GTID.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
    
    @Test
    public void assertNewInstanceWithComResetConnectionPacket() throws SQLException {
        when(payload.readInt1()).thenReturn(1, MySQLCommandPacketType.COM_RESET_CONNECTION.getValue());
        assertThat(MySQLCommandPacketFactory.newInstance(payload, backendConnection), instanceOf(MySQLUnsupportedCommandPacket.class));
    }
}
