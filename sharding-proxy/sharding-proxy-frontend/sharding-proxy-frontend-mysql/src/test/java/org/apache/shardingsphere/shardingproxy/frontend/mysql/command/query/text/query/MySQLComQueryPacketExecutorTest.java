...
public class MySQLComQueryPacketExecutorTest {
    ...
    public void assertExecuteHasError() {
        ...
        when(textProtocolBackendHandler.execute()).thenReturn(new ErrorResponse(new SQLException()));
        mySQLComQueryPacketExecutor.execute();
        Assert.assertThat(mySQLComQueryPacketExecutor.hasError(), Matchers.is(true));
    }
}
