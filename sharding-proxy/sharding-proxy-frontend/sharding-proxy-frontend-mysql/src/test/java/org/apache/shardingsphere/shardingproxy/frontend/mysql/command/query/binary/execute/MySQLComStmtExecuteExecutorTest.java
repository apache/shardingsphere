...
public class MySQLComStmtExecuteExecutorTest {
    ...
    public void assertExecuteHasError() {
        ...
        when(databaseCommunicationEngine.execute()).thenReturn(new ErrorResponse(new SQLException()));
        mySQLComStmtExecuteExecutor.execute();
        Assert.assertThat(mySQLComStmtExecuteExecutor.hasError(), Matchers.is(true));
    }
}
