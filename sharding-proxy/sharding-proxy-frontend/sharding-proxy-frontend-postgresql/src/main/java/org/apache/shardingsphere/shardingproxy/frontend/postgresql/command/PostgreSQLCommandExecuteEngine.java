...
public final class PostgreSQLCommandExecuteEngine implements CommandExecuteEngine {
    ...
    public void writeQueryData(final ChannelHandlerContext context,
        ...
        int count = 0;
        int proxyFrontendFlushThreshold = ProxyContext.getInstance().getShardingProperties().<Integer>getValue(ShardingPropertiesConstant.PROXY_FRONTEND_FLUSH_THRESHOLD);
