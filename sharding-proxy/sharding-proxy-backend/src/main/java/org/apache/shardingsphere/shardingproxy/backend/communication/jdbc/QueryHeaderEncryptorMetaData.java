...
import org.apache.shardingsphere.core.merge.encrypt.EncryptorMetaData;
...
public final class QueryHeaderEncryptorMetaData implements EncryptorMetaData {
    ...
    public Optional<ShardingEncryptor> findEncryptor(final int columnIndex) {
        ...
        return encryptRule.isCipherColumn(tableName, columnName) ? encryptRule.findShardingEncryptor(tableName, encryptRule.getLogicColumn(tableName, columnName))
