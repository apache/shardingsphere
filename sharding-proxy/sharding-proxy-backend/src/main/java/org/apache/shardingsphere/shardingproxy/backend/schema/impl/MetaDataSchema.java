 ...
 */
@Getter
public abstract class MetaDataSchema extends LogicSchema {

    private final ShardingSphereMetaData metaData;

    public MetaDataSchema(final String name, final Map<String, YamlDataSourceParameter> dataSources) throws SQLException {
