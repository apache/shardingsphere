...
public class OrchestrationSpringBootRegistryShardingTest {
    ...
    public static void init() {
        ...
        testRegistryCenter.persist("/demo_spring_boot_ds_registry/config/schema/logic_db/datasource", "ds: !!org.apache.shardingsphere.orchestration.temp.yaml.config.YamlDataSourceConfiguration\n"
            ...
            + "    password: ''\n"
            + "    username: sa\n"
            + "ds_0: !!org.apache.shardingsphere.orchestration.temp.yaml.config.YamlDataSourceConfiguration\n"
            + "  dataSourceClassName: org.apache.commons.dbcp2.BasicDataSource\n"
            + "  properties:\n"
            ...
            + "    password: ''\n"
            + "    username: sa\n"
            + "ds_1: !!org.apache.shardingsphere.orchestration.temp.yaml.config.YamlDataSourceConfiguration\n"
            + "  dataSourceClassName: org.apache.commons.dbcp2.BasicDataSource\n"
            + "  properties:\n"
