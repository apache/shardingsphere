...
/**
 * SQL parser for global clock DistSQL.
 */
public final class GlobalClockDistSQLParser extends GlobalClockDistSQLStatementParser implements SQLParser {
    
    public GlobalClockDistSQLParser(final TokenStream input) {
        super(input);
    }
