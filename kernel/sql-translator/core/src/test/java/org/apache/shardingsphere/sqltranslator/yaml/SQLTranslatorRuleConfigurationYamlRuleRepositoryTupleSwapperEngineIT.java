...
class SQLTranslatorRuleConfigurationYamlRuleRepositoryTupleSwapperEngineIT extends YamlRuleRepositoryTupleSwapperEngineIT {
    
    SQLTranslatorRuleConfigurationYamlRuleRepositoryTupleSwapperEngineIT() {
    ...
    protected void assertRepositoryTuples(final List<RuleRepositoryTuple> actualTuples, final YamlRuleConfiguration expectedYamlRuleConfig) {
        ...
        assertRepositoryTuple(actualTuples.get(0), "sql_translator", expectedYamlRuleConfig);
    }
}
