...
class SQLTranslatorRuleConfigurationYamlRuleNodeTupleSwapperEngineIT extends YamlRuleNodeTupleSwapperEngineIT {
    
    SQLTranslatorRuleConfigurationYamlRuleNodeTupleSwapperEngineIT() {
    ...
    protected void assertRuleNodeTuples(final List<RuleNodeTuple> actualTuples, final YamlRuleConfiguration expectedYamlRuleConfig) {
        ...
        assertRuleNodeTuple(actualTuples.get(0), "sql_translator", expectedYamlRuleConfig);
    }
}
