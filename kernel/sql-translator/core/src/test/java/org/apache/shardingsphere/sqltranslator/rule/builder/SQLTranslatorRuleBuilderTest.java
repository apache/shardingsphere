...
class SQLTranslatorRuleBuilderTest {
    ...
    void assertBuild() {
        ...
        SQLTranslatorRuleBuilder builder = (SQLTranslatorRuleBuilder) OrderedSPILoader.getServices(GlobalRuleBuilder.class, Collections.singleton(ruleConfig)).get(ruleConfig);
        assertThat(builder.build(ruleConfig, Collections.emptyList(), null), isA(SQLTranslatorRule.class));
    }
}
