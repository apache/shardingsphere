...
package org.apache.shardingsphere.transaction.xa.jakarta;
...
import org.apache.shardingsphere.transaction.xa.jakarta.jta.datasource.XATransactionDataSource;
...
public final class XAShardingSphereTransactionManager implements ShardingSphereDistributedTransactionManager {
     ...
     * It is intentional that the Jakarta EE 8 namespace counterpart {@link org.apache.shardingsphere.transaction.api.TransactionType#XA} is still used,
     * because {@code org.apache.shardingsphere:shardingsphere-transaction-xa-jakarta-core} and
     * {@code org.apache.shardingsphere:shardingsphere-transaction-xa-jakarta-core} cannot be used in the same Maven module at the same time,
     * as the two modules use different versions of the same set of third-party dependencies.
     * TODO Going forward,
     *  ShardingSphere Proxy should be updated to use the Jakarta Transactions impl of Jakarta EE 9 Spec.
     *
