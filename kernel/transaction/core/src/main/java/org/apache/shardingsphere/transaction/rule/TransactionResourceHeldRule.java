...
/**
 * Transaction resource held rule.
 */
@Slf4j
public final class TransactionResourceHeldRule implements ResourceHeldRule<ShardingSphereTransactionManagerEngine> {
    ...
    public TransactionResourceHeldRule(final TransactionType defaultType, final String providerType, final Map<String, ShardingSphereDatabase> databases) {
