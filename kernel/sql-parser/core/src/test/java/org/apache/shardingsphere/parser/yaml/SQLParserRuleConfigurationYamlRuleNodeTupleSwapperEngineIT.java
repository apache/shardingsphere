...
class SQLParserRuleConfigurationYamlRuleNodeTupleSwapperEngineIT extends YamlRuleNodeTupleSwapperEngineIT {
    
    SQLParserRuleConfigurationYamlRuleNodeTupleSwapperEngineIT() {
    ...
    protected void assertRuleNodeTuples(final List<RuleNodeTuple> actualTuples, final YamlRuleConfiguration expectedYamlRuleConfig) {
        ...
        assertRuleNodeTuple(actualTuples.get(0), "sql_parser", expectedYamlRuleConfig);
    }
}
