...
class SingleRuleBuilderTest {
    ...
    void assertBuild() {
        ...
        DatabaseRule actual = builder.build(mock(SingleRuleConfiguration.class), "",
                new MySQLDatabaseType(), Collections.emptyMap(), Collections.singleton(mock(ShardingSphereRule.class, RETURNS_DEEP_STUBS)), mock(ComputeNodeInstanceContext.class));
