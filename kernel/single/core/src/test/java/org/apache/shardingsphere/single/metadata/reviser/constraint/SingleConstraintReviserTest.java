...
class SingleConstraintReviserTest {
    ...
    @Test
    void assertRevise() {
        ConstraintMetaData originalMetaData = new ConstraintMetaData("idx_foo_tbl_id_foo_tbl_0", "foo_tbl");
        Optional<ConstraintMetaData> actual = new SingleConstraintReviser().revise("foo_tbl_0", originalMetaData, mock(SingleRule.class));
