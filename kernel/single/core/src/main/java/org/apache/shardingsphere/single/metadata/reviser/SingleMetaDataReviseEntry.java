...
public final class SingleMetaDataReviseEntry implements MetaDataReviseEntry<SingleRule> {
    ...
    @Override
    public Optional<SingleIndexReviser> getIndexReviser(final SingleRule rule, final String tableName, final String dataSourceName) {
        return Optional.of(new SingleIndexReviser());
    }
    
    @Override
    public Optional<SingleConstraintReviser> getConstraintReviser(final SingleRule rule, final String tableName, final String dataSourceName) {
