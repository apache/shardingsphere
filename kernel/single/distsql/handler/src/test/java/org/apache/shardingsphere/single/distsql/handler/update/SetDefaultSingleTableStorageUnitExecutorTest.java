...
class SetDefaultSingleTableStorageUnitExecutorTest {
    ...
    void assertExecuteUpdateWithNotExistedDefaultStorageUnit() {
        ...
        DistSQLUpdateExecuteEngine engine = new DistSQLUpdateExecuteEngine(new SetDefaultSingleTableStorageUnitStatement("foo_ds"), "foo_db", mockContextManager(rule, database));
