...
@Getter
@Setter
public final class YamlSQLParserConfiguration implements YamlRuleConfiguration {
    
    private boolean sqlCommentParseEnabled;
    
    private YamlSQLParserCacheOptionConfiguration sqlStatementCache;
    
    private YamlSQLParserCacheOptionConfiguration parseTreeCache;
    ...
    /**
     * Convert to yaml sql parser rule configuration.
     *
     * @return yaml sql parser rule configuration
     */
