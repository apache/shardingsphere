...
public final class PostgreSQLWALDumper extends AbstractPipelineLifecycleRunnable implements IncrementalDumper {
    ...
    private void dump() throws SQLException {
        ...
        try (
                ...
                PGReplicationStream stream = logicalReplication.createReplicationStream(connection, PostgreSQLIngestPositionInitializer.getUniqueSlotName(connection, dumperContext.getJobId()),
