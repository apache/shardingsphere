...
class OpenGaussPipelineJobDataSourcePrepareOptionTest {
    ...
    private final DialectPipelineJobDataSourcePrepareOption dataSourcePrepareOption = TypedSPILoader.getService(DialectPipelineJobDataSourcePrepareOption.class, databaseType);
    ...
    void assertGetIgnoredExceptionMessages() {
        assertThat(dataSourcePrepareOption.getIgnoredExceptionMessages(), is(Arrays.asList("multiple primary keys for table", "already exists")));
    }
}
