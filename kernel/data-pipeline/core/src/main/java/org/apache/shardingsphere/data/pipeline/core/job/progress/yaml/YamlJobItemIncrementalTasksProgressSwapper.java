...
public final class YamlJobItemIncrementalTasksProgressSwapper {
    ...
    public JobItemIncrementalTasksProgress swapToObject(final String databaseType, final YamlJobItemIncrementalTasksProgress yamlProgress) {
        ...
        // TODO databaseType
        PositionInitializer positionInitializer = TypedSPIRegistry.findRegisteredService(PositionInitializer.class, databaseType).orElseGet(() -> RequiredSPIRegistry.getRegisteredService(PositionInitializer.class));
