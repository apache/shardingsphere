...
public final class JobRateLimitAlgorithmInitializationException extends ShardingSQLException {
    ...
    public JobRateLimitAlgorithmInitializationException(final String jobRateLimitType, final String reason) {
        super(XOpenSQLState.GENERAL_ERROR, 97, "Job rate limit algorithm `%s` initialization failed, reason is: %s.", jobRateLimitType, reason);
    }
}
