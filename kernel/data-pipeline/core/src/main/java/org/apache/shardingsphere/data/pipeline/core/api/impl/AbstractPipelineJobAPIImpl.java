...
import org.apache.shardingsphere.data.pipeline.core.listener.PipelineJobListener;
...
public abstract class AbstractPipelineJobAPIImpl implements PipelineJobAPI {
    ...
    protected JobConfigurationPOJO convertJobConfiguration(final PipelineJobConfiguration jobConfig) {
        ...
        result.setJobListenerTypes(Collections.singletonList(PipelineJobListener.class.getName()));
        return result;
    }
