...
public final class CRC32MatchDataConsistencyCalculateAlgorithmTest {
    ...
    public void assertCalculateSuccess() throws SQLException {
        ...
        mockSelectUniqueKeyPrepareStatement();
    ...
    private void mockSelectUniqueKeyPrepareStatement() throws SQLException {
        PreparedStatement mockPrepareStatement = mock(PreparedStatement.class, RETURNS_DEEP_STUBS);
