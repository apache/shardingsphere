...
class ExternalMetaDataFactoryTest {
    ...
    void assertCreateSingleDatabase() throws SQLException {
        ...
        assertTrue(actual.getResourceMetaData().getStorageUnitMetaDataMap().isEmpty());
    }
    ...
    void assertCreateDatabaseMap() throws SQLException {
        ...
        assertTrue(actual.get("foo_db").getResourceMetaData().getStorageUnitMetaDataMap().isEmpty());
    }
