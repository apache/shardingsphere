...
class ExternalMetaDataFactoryTest {
    ...
    void assertCreateSingleDatabase() throws SQLException {
        ...
        assertTrue(actual.getResourceMetaData().getStorageUnitMetaData().getMetaDataMap().isEmpty());
    }
    ...
    void assertCreateDatabaseMap() throws SQLException {
        ...
        assertTrue(actual.get("foo_db").getResourceMetaData().getStorageUnitMetaData().getMetaDataMap().isEmpty());
    }
