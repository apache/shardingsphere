...
public class DataSourceNodePersistServiceTest {
    ...
    void testPersistVersionNotExists() {
        ...
        // Act
        dataSourceNodeService.persist(databaseName, dataSourceConfigs);
    ...
    void testLoad() {
        ...
        // Act
        Map<String, DataSourcePoolProperties> actualDataSourceConfigs = dataSourceNodeService.load(databaseName);
    ...
    void testLoadDataSource() {
        ...
        // Act
        Map<String, DataSourcePoolProperties> actualDataSourceConfigs = dataSourceNodeService.load(databaseName, dataSourceName);
    ...
    void testDelete() {
        ...
        // Act
        dataSourceNodeService.delete(databaseName, dataSourceName);
    ...
    void testDeleteConfig() {
        ...
        // Act
        Collection<MetaDataVersion> actual = dataSourceNodeService.deleteConfig(databaseName, expectedDataSourceConfigs);
    ...
    void testPersistConfig() {
        ...
        // Act
        Collection<MetaDataVersion> actual = dataSourceNodeService.persistConfig(databaseName, expectedDataSourceConfigs);
