...
import org.apache.shardingsphere.infra.yaml.config.swapper.rule.YamlGlobalRuleConfigurationSwapperEngine;
...
public final class GlobalRulePersistService extends AbstractPersistService implements GlobalPersistService<Collection<RuleConfiguration>> {
    ...
    public void persist(final Collection<RuleConfiguration> globalRuleConfigs) {
        Map<RuleConfiguration, YamlGlobalRuleConfigurationSwapper> yamlConfigs = new YamlGlobalRuleConfigurationSwapperEngine().swapToYamlRuleConfigurations(globalRuleConfigs);
        for (Entry<RuleConfiguration, YamlGlobalRuleConfigurationSwapper> entry : yamlConfigs.entrySet()) {
    ...
    public Collection<RuleConfiguration> load() {
        ...
        return dataNodes.isEmpty() ? Collections.emptyList() : new YamlGlobalRuleConfigurationSwapperEngine().swapToRuleConfigurations(dataNodes);
    }
    ...
    public RuleConfiguration load(final String ruleName) {
        ...
        return new YamlGlobalRuleConfigurationSwapperEngine().swapSingleRuleToRuleConfiguration(ruleName, dataNodes).orElse(null);
    }
