...
package org.apache.shardingsphere.linkedserver.rule.builder;
...
import org.apache.shardingsphere.linkedserver.rule.LinkedServerRule;

import java.util.Collection;

/**
 * Linked server rule builder.
 */
public final class LinkedServerRuleBuilder implements DatabaseRuleBuilder<LinkedServerRuleConfiguration> {
    
    @Override
    public LinkedServerRule build(final LinkedServerRuleConfiguration ruleConfig, final String databaseName, final DatabaseType protocolType,
        ...
        return new LinkedServerRule(ruleConfig);
    }
