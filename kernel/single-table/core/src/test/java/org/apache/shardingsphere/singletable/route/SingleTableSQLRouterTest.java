...
public final class SingleTableSQLRouterTest {
    ...
    private ShardingSphereDatabase mockSingleDatabase() {
        ...
        when(result.getResources().getDataSources()).thenReturn(Collections.singletonMap("foo_ds", new MockedDataSource()));
        return result;
    }
    ...
    private ShardingSphereDatabase mockReadwriteSplittingDatabase() {
        ...
        when(result.getResources().getDataSources()).thenReturn(Collections.singletonMap("write_ds", new MockedDataSource()));
        return result;
    }
    ...
    private ShardingSphereDatabase mockDatabaseWithMultipleResources() {
        ...
        when(result.getResources().getDataSources()).thenReturn(dataSourceMap);
