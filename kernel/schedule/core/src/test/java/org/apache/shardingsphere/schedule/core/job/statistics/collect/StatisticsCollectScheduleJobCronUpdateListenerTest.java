...
import org.apache.shardingsphere.schedule.core.job.statistics.collect.listener.StatisticsCollectScheduleJobCronUpdateListener;
...
class StatisticsCollectScheduleJobCronUpdateListenerTest {
    ...
    void assertUpdateWithNormal() {
        try (MockedConstruction<StatisticsCollectJobWorker> mocked = mockConstruction(StatisticsCollectJobWorker.class)) {
            ...
            verify(mocked.constructed().get(0), times(1)).updateJobConfiguration();
        }
    }
