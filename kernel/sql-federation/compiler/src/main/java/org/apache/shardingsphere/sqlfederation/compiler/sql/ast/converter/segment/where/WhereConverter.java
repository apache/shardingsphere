...
package org.apache.shardingsphere.sqlfederation.compiler.sql.ast.converter.segment.where;
...
public final class WhereConverter {
     ...
     * @return SQL node
     */
    public static Optional<SqlNode> convert(final WhereSegment segment, final String databaseType) {
