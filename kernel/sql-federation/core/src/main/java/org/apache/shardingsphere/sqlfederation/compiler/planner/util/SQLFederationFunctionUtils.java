...
public final class SQLFederationFunctionUtils {
    ...
    public static void registryUserDefinedFunction(final String schemaName, final SchemaPlus schemaPlus) {
        ...
        if ("pg_catalog".equalsIgnoreCase(schemaName) && null != subSchema) {
            ...
            subSchema.add("pg_table_is_visible", ScalarFunctionImpl.create(SQLFederationFunctionUtils.class, "pgTableIsVisible"));
            subSchema.add("pg_get_userbyid", ScalarFunctionImpl.create(SQLFederationFunctionUtils.class, "pgGetUserById"));
        }
    }
