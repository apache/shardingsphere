...
public final class VariableConverter implements SQLSegmentConverter<VariableSegment, SqlNode> {
    
    @Override
    public Optional<SqlNode> convert(final VariableSegment segment) {
        return Optional.of(new SqlIdentifier(segment.getVariableType() == VariableType.USER_VARIABLE ? "@" : "@@" + segment.getText(), SqlParserPos.ZERO));
    }
}
