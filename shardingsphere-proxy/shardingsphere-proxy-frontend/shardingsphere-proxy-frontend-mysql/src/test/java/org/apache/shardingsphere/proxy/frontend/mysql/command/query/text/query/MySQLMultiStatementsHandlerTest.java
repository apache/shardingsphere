...
public final class MySQLMultiStatementsHandlerTest {
    ...
    public void assertExecute() throws SQLException {
        ...
        try (MockedStatic<ProxyContext> mockedStatic = mockStatic(ProxyContext.class)) {
            ...
            when(ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().get("").getResource().getDatabaseType()).thenReturn(new MySQLDatabaseType());
            when(ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().get("").getProtocolType()).thenReturn(new MySQLDatabaseType());
