...
public final class MySQLAuthenticationHandlerTest extends ProxyContextRestorer {
    ...
    public void assertLoginWithAbsentUser() {
        initProxyContext(new ShardingSphereUser("root", "root", ""), true);
        byte[] authResponse = {-27, 89, -20, -27, 65, -120, -64, -101, 86, -100, -108, -100, 6, -125, -37, 117, 14, -43, 95, -113};
        assertThat(authenticationHandler.login("root1", "", authResponse, "db1").orElse(null), is(MySQLErrorCode.ER_ACCESS_DENIED_ERROR));
    }
    ...
    public void assertLoginWithIncorrectPassword() {
        ...
        assertThat(authenticationHandler.login("root", "", authResponse, "db1").orElse(null), is(MySQLErrorCode.ER_ACCESS_DENIED_ERROR));
    }
    ...
    public void assertLoginWithUnauthorizedSchema() {
        ...
        byte[] authResponse = {-27, 89, -20, -27, 65, -120, -64, -101, 86, -100, -108, -100, 6, -125, -37, 117, 14, -43, 95, -113};
        assertThat(authenticationHandler.login("root", "", authResponse, "db11").orElse(null), is(MySQLErrorCode.ER_DBACCESS_DENIED_ERROR));
    }
