...
public final class MySQLAuthenticationHandler {
     ...
     */
    public Optional<MyVendorError> login(final String username, final String hostname, final byte[] authenticationResponse, final String databaseName) {
        ...
        return null == databaseName || SQLCheckEngine.check(databaseName, rules, grantee) ? Optional.empty() : Optional.of(MyVendorError.ER_DBACCESS_DENIED_ERROR);
    }
