...
public final class MySQLAuthenticationHandler {
     ...
     */
    public Optional<MySQLErrorCode> login(final String username, final String hostname, final byte[] authenticationResponse, final String databaseName) {
        ...
        return null == databaseName || SQLCheckEngine.check(databaseName, rules, grantee) ? Optional.empty() : Optional.of(MySQLErrorCode.ER_DBACCESS_DENIED_ERROR);
    }
