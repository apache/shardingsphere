...
public final class MySQLErrPacketFactory {
    ...
    public static MySQLErrPacket newInstance(final Exception cause) {
        ...
        if (cause instanceof UnsupportedCommandException) {
            return new MySQLErrPacket(1, CommonSQLErrorCode.UNSUPPORTED_COMMAND, ((UnsupportedCommandException) cause).getCommandType());
        }
        ...
        if (cause instanceof PipelineJobNotFoundException) {
            return new MySQLErrPacket(1, CommonSQLErrorCode.SCALING_JOB_NOT_EXIST, ((PipelineJobNotFoundException) cause).getJobId());
        }
        ...
        return new MySQLErrPacket(1, CommonSQLErrorCode.UNKNOWN_EXCEPTION, cause.getMessage());
    }
