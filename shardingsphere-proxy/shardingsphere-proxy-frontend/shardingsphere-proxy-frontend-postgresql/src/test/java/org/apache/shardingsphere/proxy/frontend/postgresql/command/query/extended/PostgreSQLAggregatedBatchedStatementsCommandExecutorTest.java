...
public final class PostgreSQLAggregatedBatchedStatementsCommandExecutorTest {
    ...
    private static final ShardingSphereSQLParserEngine SQL_PARSER_ENGINE = new ShardingSphereSQLParserEngine("PostgreSQL", new CacheOption(2000, 65535L, 4), new CacheOption(128, 1024L, 4), false);
