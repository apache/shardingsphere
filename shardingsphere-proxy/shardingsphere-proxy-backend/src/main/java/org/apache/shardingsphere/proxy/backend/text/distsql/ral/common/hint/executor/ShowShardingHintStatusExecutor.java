...
public final class ShowShardingHintStatusExecutor extends AbstractHintQueryExecutor<ShowShardingHintStatusStatement> {
    ...
    protected MergedResult createMergedResult() {
        ...
        ShardingSphereDatabaseMetaData databaseMetaData = ProxyContext.getInstance().getMetaData(connectionSession.getDatabaseName());
        ...
        Collection<String> tableNames = databaseMetaData.getDatabase().getSchema(schemaName).getAllTableNames();
