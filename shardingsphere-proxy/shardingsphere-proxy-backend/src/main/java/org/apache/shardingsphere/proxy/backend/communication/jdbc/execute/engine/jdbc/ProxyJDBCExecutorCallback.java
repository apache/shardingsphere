...
import org.apache.shardingsphere.infra.executor.sql.execute.result.query.jdbc.MemoryJDBCExecuteQueryResult;
import org.apache.shardingsphere.infra.executor.sql.execute.result.query.jdbc.StreamJDBCExecuteQueryResult;
...
public final class ProxyJDBCExecutorCallback extends JDBCExecutorCallback<ExecuteResult> {
    ...
    private ExecuteQueryResult createQueryResult(final ResultSet resultSet, final ConnectionMode connectionMode) throws SQLException {
        return connectionMode == ConnectionMode.MEMORY_STRICTLY ? new StreamJDBCExecuteQueryResult(resultSet) : new MemoryJDBCExecuteQueryResult(resultSet);
    }
