...
public abstract class AbstractBackendHandler<T extends SQLStatement> implements TextProtocolBackendHandler {
    ...
    protected String getSchemaName(final String schemaName, final T sqlStatement) {
        ...
        return schemaFromSQL.isPresent() ? schemaFromSQL.get().getIdentifier().getValue() : schemaName;
    }
}
