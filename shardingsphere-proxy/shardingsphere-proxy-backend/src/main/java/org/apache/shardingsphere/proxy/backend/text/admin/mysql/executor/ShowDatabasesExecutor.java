...
public final class ShowDatabasesExecutor implements DatabaseAdminQueryExecutor {
    ...
    public QueryResultMetaData getQueryResultMetaData() {
        return new RawQueryResultMetaData(Collections.singletonList(new RawQueryResultColumnMetaData("SCHEMATA", "Database", "database_name", Types.VARCHAR, "VARCHAR", 255, 0)));
    }
}
