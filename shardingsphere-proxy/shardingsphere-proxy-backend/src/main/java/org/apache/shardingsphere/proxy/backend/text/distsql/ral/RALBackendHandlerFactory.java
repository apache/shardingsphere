...
public final class RALBackendHandlerFactory {
    ...
    private static void initQueryableHandlerMap() {
        ...
        QUERYABLE_HANDLER_MAP.put(ParseStatement.class.getName(), ParseHandler.class);
        QUERYABLE_HANDLER_MAP.put(PreviewStatement.class.getName(), PreviewHandler.class);
    }
