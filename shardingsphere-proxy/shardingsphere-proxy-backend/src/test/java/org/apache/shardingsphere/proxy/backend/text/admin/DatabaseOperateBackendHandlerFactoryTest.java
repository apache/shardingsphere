...
public final class DatabaseOperateBackendHandlerFactoryTest extends ProxyContextRestorer {
    ...
    private MetaDataContexts mockMetaDataContexts() {
        ...
        when(result.getMetaData().get("db").getResource().getDataSources()).thenReturn(Collections.emptyMap());
        when(result.getMetaData().get("db").getResource().getNotExistedResources(any())).thenReturn(Collections.emptyList());
        return result;
    }
