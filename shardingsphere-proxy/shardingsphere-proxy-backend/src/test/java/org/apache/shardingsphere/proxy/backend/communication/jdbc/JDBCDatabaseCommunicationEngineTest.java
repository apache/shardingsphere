...
public final class JDBCDatabaseCommunicationEngineTest {
    ...
    public void setUp() {
        ...
        MetaDataContexts metaDataContexts = new MetaDataContexts(mock(MetaDataPersistService.class), 
                mockMetaDataMap(), mock(ShardingSphereRuleMetaData.class), mock(OptimizerContext.class, RETURNS_DEEP_STUBS), new ConfigurationProperties(new Properties()));
    ...
    private ShardingSphereMetaData createMetaData() {
        ...
        when(result.getSchemaByName(DefaultDatabase.LOGIC_NAME).get("t_logic_order")).thenReturn(
