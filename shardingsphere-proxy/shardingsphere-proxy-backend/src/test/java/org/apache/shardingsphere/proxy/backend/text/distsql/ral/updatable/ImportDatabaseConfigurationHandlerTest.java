...
public final class ImportDatabaseConfigurationHandlerTest extends ProxyContextRestorer {
    ...
    public void assertImportDatabaseExecutorForSharding() throws Exception {
        ...
        assertNotNull(ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().get(sharding).getRuleMetaData().getConfigurations());
    ...
    public void assertImportDatabaseExecutorForReadwriteSplitting() throws Exception {
        ...
        assertNotNull(ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().get(readwriteSplitting).getRuleMetaData().getConfigurations());
        assertThat(importDatabaseConfigurationHandler.execute(), instanceOf(UpdateResponseHeader.class));
    }
    ...
    public void assertImportDatabaseExecutorForDatabaseDiscovery() throws Exception {
        ...
        assertNotNull(ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().get(databaseDiscovery).getRuleMetaData().getConfigurations());
        assertThat(importDatabaseConfigurationHandler.execute(), instanceOf(UpdateResponseHeader.class));
    }
