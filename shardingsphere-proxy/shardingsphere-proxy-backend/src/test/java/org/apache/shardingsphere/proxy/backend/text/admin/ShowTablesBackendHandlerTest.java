...
public final class ShowTablesBackendHandlerTest {
    ...
    public void setUp() {
        ...
        schemaContexts.set(ProxyContext.getInstance(), 
                new StandardSchemaContexts(schemaContextMap, mock(ExecutorKernel.class), getAuthentication(), new ConfigurationProperties(new Properties()), new MySQLDatabaseType()));
    }
