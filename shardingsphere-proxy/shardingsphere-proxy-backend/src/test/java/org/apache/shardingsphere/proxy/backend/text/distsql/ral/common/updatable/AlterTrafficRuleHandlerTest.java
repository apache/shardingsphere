...
public final class AlterTrafficRuleHandlerTest extends ProxyContextRestorer {
    ...
    public void assertExecute() throws SQLException {
        ...
        TrafficRuleSegment trafficRuleSegment2 = new TrafficRuleSegment("rule_name_2", Collections.emptyList(), new AlgorithmSegment("DISTSQL.FIXTURE", new Properties()), null);
        AlterTrafficRuleHandler handler = new AlterTrafficRuleHandler();
