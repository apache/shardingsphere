...
```java
    ...
    dataSourceMap.put("ds_slave_0", DataSourceUtil.createDataSource("demo_ds_slave_0"));
    dataSourceMap.put("ds_slave_1", DataSourceUtil.createDataSource("demo_ds_slave_1"));
