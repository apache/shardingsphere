...
#### 6. 如果SQL在ShardingSphere中执行不正确，该如何调试？
...
#### 8. ShardingSphere提供的默认分布式自增主键策略为什么是不连续的，且尾数大多为偶数？
...
在3.1.0版本中，此问题已彻底解决，参见：https://github.com/sharding-sphere/sharding-sphere/issues/1617
...
#### 10. ShardingSphere除了支持自带的分布式自增主键之外，还能否支持原生的自增主键？
