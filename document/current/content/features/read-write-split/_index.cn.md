...
![读写分离](http://ovfotjrsi.bkt.clouddn.com/read-write-split/read-write-split.png)
...
![数据分片 + 读写分离](http://ovfotjrsi.bkt.clouddn.com/read-write-split/sharding-read-write-split.png)
