...
![排序归并示例1](/img/sharding/order_by_merge_1.png)
...
![排序归并示例2](/img/sharding/order_by_merge_2.png)
...
![分组归并示例1](/img/sharding/group_by_merge_1.png)

进行归并时，逻辑与排序归并类似。
下图展现了进行next调用的时候，流式分组归并是如何进行的。

![分组归并示例2](/img/sharding/group_by_merge_2.png)
...
![归并引擎结构](/img/sharding/merge_architecture.png)
