...
![不改写SQL的分页执行结果](/img/sharding/pagination_without_rewrite.png)
...
![改写SQL的分页执行结果](/img/sharding/pagination_with_rewrite.png)
...
![改写引擎结构](/img/sharding/rewrite_architecture_v2.png)
