...
1. Proxy: Enforce authorization checks for DistSQL statements in ProxyBackendHandlerFactory, resolving the actual execution-target database the same way the DistSQL execute engines resolve it - [#38845](https://github.com/apache/shardingsphere/pull/38845) 
