...
1. Proxy: Fix Firebird transaction isolation resolution to avoid NullPointerException when concurrency flag is absent - [#39136](https://github.com/apache/shardingsphere/pull/39136)
