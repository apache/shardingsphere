...
1. JDBC: Add show database name for JDBC when execute SHOW COMPUTE NODES and SHOW COMPUTE NODE INFO - [#33437](https://github.com/apache/shardingsphere/pull/33437)
