 ...
 * @author zhangliang
 */
public final class PreparedStatementExecutorWapper extends AbstractExecutorWapper {
    ...
    public PreparedStatementExecutorWapper(final PreparedStatement preparedStatement, final List<Object> parameters, 
