...
import com.dangdang.ddframe.rdb.sharding.parsing.parser.statement.truncate.AbstractTruncateParser;

/**
 * SQLServer Truncate语句解析器.
 *
 * @author zhangliang
 */
public final class SQLServerTruncateParser extends AbstractTruncateParser {
    
    public SQLServerTruncateParser(final SQLParser sqlParser) {
        super(sqlParser);
    }
