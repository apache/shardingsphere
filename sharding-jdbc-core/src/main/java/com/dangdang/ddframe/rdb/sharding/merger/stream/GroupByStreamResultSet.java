 ...
 * @author zhangliang
 */
public final class GroupByStreamResultSet extends AbstractMemoryResultSet {
    ...
    public GroupByStreamResultSet(final ResultSet resultSet, final ResultSetMergeContext resultSetMergeContext) throws SQLException {
