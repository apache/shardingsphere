...
public final class UpdateStatementParserTest extends AbstractStatementParserTest {
    ...
    public void parseWithoutParameter()  {
        ShardingRule shardingRule = createShardingRule();
        List<Object> parameters = Collections.emptyList();
        SQLParserEngine statementParser = new SQLParserEngine(DatabaseType.MySQL, "UPDATE TABLE_XXX xxx SET TABLE_XXX.field1=field1+1,xxx.field2=2 WHERE TABLE_XXX.field4<10 AND"
    ...
    public void parseWithParameter() {
        ...
        SQLParserEngine statementParser = new SQLParserEngine(DatabaseType.MySQL, 
    ...
    public void parseWithOr() {
        ShardingRule shardingRule = createShardingRule();
        List<Object> parameters = Collections.emptyList();
        new SQLParserEngine(DatabaseType.Oracle, "UPDATE TABLE_XXX SET field1=1 WHERE field1<1 AND (field1 >2 OR field2 =1)", shardingRule, parameters).parseStatement();
    }
