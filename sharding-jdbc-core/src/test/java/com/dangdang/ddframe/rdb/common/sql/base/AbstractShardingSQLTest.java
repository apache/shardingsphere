...
public abstract class AbstractShardingSQLTest extends AbstractSQLAssertTest {
    
    protected AbstractShardingSQLTest(final String testCaseName, final String sql, final Set<DatabaseType> types, final List<SqlShardingRule> sqlShardingRules) {
