...
import com.dangdang.ddframe.rdb.sharding.merger.resultset.memory.row.aggregation.AccumulationAggregationUnitTest;
import com.dangdang.ddframe.rdb.sharding.merger.resultset.memory.row.aggregation.AggregationUnitFactoryTest;
import com.dangdang.ddframe.rdb.sharding.merger.resultset.memory.row.aggregation.AverageAggregationUnitTest;
import com.dangdang.ddframe.rdb.sharding.merger.resultset.memory.row.aggregation.ComparableAggregationUnitTest;
