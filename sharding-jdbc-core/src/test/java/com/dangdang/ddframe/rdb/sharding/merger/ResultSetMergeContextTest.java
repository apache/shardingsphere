...
public final class ResultSetMergeContextTest {
    ...
    public void assertNewResultSetMergeContext() throws SQLException {
        ...
        assertThat(actual.getSqlStatement().getOrderByItems().get(0).getIndex(), is(1));
        assertThat(actual.getSqlStatement().getGroupByItems().get(0).getIndex(), is(2));
    ...
    private SQLStatement createSQLStatement() {
        ...
        result.getOrderByItems().add(new OrderItem("order_col", OrderType.ASC, Optional.<String>absent()));
        result.getGroupByItems().add(new OrderItem("group_col", OrderType.ASC, Optional.<String>absent()));
