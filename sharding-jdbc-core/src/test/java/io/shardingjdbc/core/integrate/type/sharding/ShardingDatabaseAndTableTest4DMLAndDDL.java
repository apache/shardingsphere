...
public class ShardingDatabaseAndTableTest4DMLAndDDL extends AbstractShardingDatabaseAndTableTest {
    
    public ShardingDatabaseAndTableTest4DMLAndDDL(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
