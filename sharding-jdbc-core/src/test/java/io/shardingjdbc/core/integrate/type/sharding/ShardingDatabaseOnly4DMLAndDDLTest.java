...
public class ShardingDatabaseOnly4DMLAndDDLTest extends AbstractShardingDatabaseOnlyTest {
    
    public ShardingDatabaseOnly4DMLAndDDLTest(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
