...
public class ShardingMasterSlaveTest4DMLAndDDL extends AbstractShardingMasterSlaveTest {
    
    public ShardingMasterSlaveTest4DMLAndDDL(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
