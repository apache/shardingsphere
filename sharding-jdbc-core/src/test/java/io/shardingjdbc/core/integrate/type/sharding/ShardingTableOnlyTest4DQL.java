...
public class ShardingTableOnlyTest4DQL extends AbstractShardingTableOnlyTest {
    
    public ShardingTableOnlyTest4DQL(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
