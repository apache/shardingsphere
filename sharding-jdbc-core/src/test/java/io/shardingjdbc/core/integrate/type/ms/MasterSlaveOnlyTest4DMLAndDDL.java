...
public class MasterSlaveOnlyTest4DMLAndDDL extends AbstractMasterSlaveOnlyTest {
    
    public MasterSlaveOnlyTest4DMLAndDDL(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
