...
public class ShardingDatabaseAndTable4DQLTest extends AbstractShardingDatabaseAndTableTest {
    
    public ShardingDatabaseAndTable4DQLTest(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
