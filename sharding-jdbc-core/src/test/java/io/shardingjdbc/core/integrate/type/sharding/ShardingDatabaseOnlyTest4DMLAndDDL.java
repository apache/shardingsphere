...
public class ShardingDatabaseOnlyTest4DMLAndDDL extends AbstractShardingDatabaseOnlyTest {
    
    public ShardingDatabaseOnlyTest4DMLAndDDL(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
