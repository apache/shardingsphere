...
public class ShardingDatabaseOnlyTest4DQL extends AbstractShardingDatabaseOnlyTest {
    
    public ShardingDatabaseOnlyTest4DQL(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
