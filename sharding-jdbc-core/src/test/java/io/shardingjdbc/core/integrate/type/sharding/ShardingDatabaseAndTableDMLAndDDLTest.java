...
public class ShardingDatabaseAndTableDMLAndDDLTest extends AbstractShardingDatabaseAndTableTest {
    
    public ShardingDatabaseAndTableDMLAndDDLTest(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
