...
public class ShardingMasterSlaveDQLTest extends AbstractShardingMasterSlaveTest {
    
    public ShardingMasterSlaveDQLTest(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
