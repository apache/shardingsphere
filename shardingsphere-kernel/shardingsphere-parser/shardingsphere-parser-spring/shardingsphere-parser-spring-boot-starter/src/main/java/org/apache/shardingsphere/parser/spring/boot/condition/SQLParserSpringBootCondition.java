...
public final class SQLParserSpringBootCondition extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(final ConditionContext conditionContext, final AnnotatedTypeMetadata annotatedTypeMetadata) {
        return PropertyUtil.containPropertyPrefix(conditionContext.getEnvironment(), SQL_PARSER_PREFIX)
                ? ConditionOutcome.match() : ConditionOutcome.noMatch("Can't find ShardingSphere sql-parser rule configuration in local file.");
    }
}
