...
/**
 * SQL parser rule configuration YAML swapper.
 */
public final class SQLParserRuleConfigurationYamlSwapper implements YamlRuleConfigurationSwapper<YamlSQLParserRuleConfiguration, SQLParserRuleConfiguration> {
    
    private final SQLParserCacheOptionConfigurationYamlSwapper cacheOptionSwapper = new SQLParserCacheOptionConfigurationYamlSwapper();
    ...
    public SQLParserRuleConfiguration swapToObject(final YamlSQLParserRuleConfiguration yamlConfig) {
        CacheOption parseTreeCacheOption = null == yamlConfig.getParseTreeCache() 
                ? DefaultSQLParserRuleConfigurationBuilder.PARSER_TREE_CACHE_OPTION : cacheOptionSwapper.swapToObject(yamlConfig.getParseTreeCache());
