...
public final class YamlJobProgressSwapper {
    ...
    public YamlJobProgress swapToYaml(final JobProgress jobProgress) {
        ...
        result.setInventory(new InventoryTaskProgressSwapper().swapToYaml(jobProgress.getInventory()));
        result.setIncremental(new IncrementalTaskProgressSwapper().swapToYaml(jobProgress.getIncremental()));
        return result;
    }
    ...
    public JobProgress swapToObject(final YamlJobProgress yamlJobProgress) {
        ...
        result.setInventory(new InventoryTaskProgressSwapper().swapToObject(yamlJobProgress.getInventory()));
        result.setIncremental(new IncrementalTaskProgressSwapper().swapToObject(yamlJobProgress.getSourceDatabaseType(), yamlJobProgress.getIncremental()));
        return result;
    }
}
