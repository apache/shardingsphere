...
public final class PipelineAPIFactory {
    ...
    private static final class ElasticJobAPIHolder {
        ...
        private ElasticJobAPIHolder() {
            ...
            String namespace = repositoryConfig.getNamespace() + PipelineMetaDataNode.getScalingRootPath();
    ...
    private static final class RegistryCenterHolder {
        ...
        private static CoordinatorRegistryCenter createRegistryCenter() {
            ...
            return registryCenterInitializer.createRegistryCenter(modeConfig, PipelineMetaDataNode.getScalingRootPath());
        }
    }
}
