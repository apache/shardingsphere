...
public final class JobProgressYamlSwapper {
    ...
    private Function<Entry<String, String>, InventoryTaskProgress> getInventoryTaskProgressFunction() {
        // TODO now PrimaryKeyPosition.init
        return entry -> new InventoryTaskProgress(Strings.isNullOrEmpty(entry.getValue()) ? new PlaceholderPosition() : IntegerPrimaryKeyPosition.init(entry.getValue()));
    }
