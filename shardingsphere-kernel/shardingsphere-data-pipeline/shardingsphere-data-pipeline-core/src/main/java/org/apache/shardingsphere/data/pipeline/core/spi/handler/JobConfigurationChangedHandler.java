...
public final class JobConfigurationChangedHandler implements PipelineMetaDataChangedHandler {
    ...
    public void handle(final DataChangedEvent event) {
        ...
        PipelineJobConfigurationChangedEventProcessor processor = PipelineJobConfigurationChangedEventProcessorFactory.getInstance(PipelineJobIdUtils.parseJobType(jobId));
