...
public final class AuthorityRuleBuilder implements GlobalRuleBuilder<AuthorityRuleConfiguration> {
    ...
    @Override
    public AuthorityRule build(final AuthorityRuleConfiguration ruleConfig, final Map<String, ShardingSphereDatabaseMetaData> databaseMetaDataMap) {
        return new AuthorityRule(ruleConfig, databaseMetaDataMap);
    }
