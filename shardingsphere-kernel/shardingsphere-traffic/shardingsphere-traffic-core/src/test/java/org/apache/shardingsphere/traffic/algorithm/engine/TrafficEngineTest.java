...
public final class TrafficEngineTest {
    ...
    public void assertDispatchWhenExistTrafficStrategyRuleExistComputeNodeInstances() {
        ...
        when(loadBalancer.getInstanceId("traffic", instanceIds)).thenReturn(new ServerInstanceDefinition("127.0.0.1@3307", "Proxy", 3307));
    ...
    private List<InstanceDefinition> mockComputeNodeInstances() {
        ...
        result.add(new ServerInstanceDefinition("127.0.0.1@3307", "Proxy", "127.0.0.1@3307"));
        result.add(new ServerInstanceDefinition("127.0.0.1@3308", "Proxy", "127.0.0.1@3308"));
        return result;
    }
}
