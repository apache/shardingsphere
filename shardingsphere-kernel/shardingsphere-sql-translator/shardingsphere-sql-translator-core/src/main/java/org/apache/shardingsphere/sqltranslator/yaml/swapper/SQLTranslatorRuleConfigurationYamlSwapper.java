...
/**
 * SQL translator rule configuration YAML swapper.
 */
public final class SQLTranslatorRuleConfigurationYamlSwapper implements YamlRuleConfigurationSwapper<YamlSQLTranslatorRuleConfiguration, SQLTranslatorRuleConfiguration> {
