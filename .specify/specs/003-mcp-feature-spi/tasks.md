...
- feature provider 粒度与 registry 聚合方式
...
- [ ] T004 Create the SPI elevation set in `mcp/features/spi/src/main/java/org/apache/shardingsphere/mcp/feature/spi/`, including `MCPFeatureProvider.java`, `tool/ToolHandler.java`, `resource/ResourceHandler.java`, `tool/descriptor/MCPToolDescriptor.java`, `tool/descriptor/MCPToolFieldDefinition.java`, `tool/descriptor/MCPToolValueDefinition.java`, and feature-facing response contracts under `protocol/response/`.
...
## Phase 3: User Story 1 - Keep core feature-agnostic through SPI loading (Priority: P1)

**Goal**: Make `mcp/core` discover encrypt and mask only through feature SPI, while keeping shared MCP infrastructure in core.
**Independent Test**: Start MCP with encrypt and mask feature providers on the classpath and verify discovery comes from SPI-aggregated surfaces with no hard-coded encrypt/mask dispatch in core.
...
- [ ] T011 [US1] Create `mcp/core/src/main/java/org/apache/shardingsphere/mcp/feature/registry/FeatureProviderRegistry.java` and `mcp/core/src/main/java/org/apache/shardingsphere/mcp/feature/registry/FeatureSurfaceCatalog.java` to load `MCPFeatureProvider` instances with deterministic ordering.
- [ ] T012 [US1] Rewrite `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/handler/ToolHandlerRegistry.java`, `mcp/core/src/main/java/org/apache/shardingsphere/mcp/resource/handler/ResourceHandlerRegistry.java`, `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/MCPToolController.java`, and `mcp/core/src/main/java/org/apache/shardingsphere/mcp/resource/MCPResourceController.java` so core merges shared handlers with feature-provider contributions through SPI.
...
- [ ] T014 [US1] Update `mcp/core/src/main/java/org/apache/shardingsphere/mcp/capability/service/MCPServiceCapabilityProvider.java`, `mcp/core/src/main/resources/META-INF/services/org.apache.shardingsphere.mcp.tool.handler.ToolHandler`, and `mcp/core/src/main/resources/META-INF/services/org.apache.shardingsphere.mcp.resource.handler.ResourceHandler` so core publishes only shared surfaces and feature modules publish feature surfaces.

**Checkpoint**: `mcp/core` is feature-agnostic and runtime discovery depends on SPI aggregation rather than hard-coded encrypt/mask classes.

---

## Phase 4: User Story 2 - Let feature modules own their own workflow surface (Priority: P1)

**Goal**: Move encrypt and mask tools, resources, planning, execution-preparation, recommendation, and validation into their own feature modules.
...
- [ ] T015 [P] [US2] Create encrypt feature tests in `mcp/features/encrypt/src/test/java/org/apache/shardingsphere/mcp/feature/encrypt/provider/EncryptFeatureProviderTest.java`, `mcp/features/encrypt/src/test/java/org/apache/shardingsphere/mcp/feature/encrypt/tool/PlanEncryptRuleToolHandlerTest.java`, and `mcp/features/encrypt/src/test/java/org/apache/shardingsphere/mcp/feature/encrypt/resource/EncryptResourceHandlerTest.java`.
- [ ] T016 [P] [US2] Create mask feature tests in `mcp/features/mask/src/test/java/org/apache/shardingsphere/mcp/feature/mask/provider/MaskFeatureProviderTest.java`, `mcp/features/mask/src/test/java/org/apache/shardingsphere/mcp/feature/mask/tool/PlanMaskRuleToolHandlerTest.java`, and `mcp/features/mask/src/test/java/org/apache/shardingsphere/mcp/feature/mask/resource/MaskResourceHandlerTest.java`.

### Implementation for User Story 2

- [ ] T017 [US2] Create `mcp/features/encrypt/src/main/java/org/apache/shardingsphere/mcp/feature/encrypt/provider/EncryptFeatureProvider.java` and `mcp/features/encrypt/src/main/resources/META-INF/services/org.apache.shardingsphere.mcp.feature.spi.MCPFeatureProvider`, then move encrypt tools and resources into `mcp/features/encrypt/src/main/java/org/apache/shardingsphere/mcp/feature/encrypt/tool/` and `/resource/`.
- [ ] T018 [US2] Move encrypt workflow services and models from `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/service/workflow/` and `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/model/workflow/` into `mcp/features/encrypt/src/main/java/org/apache/shardingsphere/mcp/feature/encrypt/workflow/`, including planning, execution, validation, rule inspection, algorithm recommendation, property template, DistSQL planning, DDL planning, and index planning.
- [ ] T019 [US2] Create `mcp/features/mask/src/main/java/org/apache/shardingsphere/mcp/feature/mask/provider/MaskFeatureProvider.java` and `mcp/features/mask/src/main/resources/META-INF/services/org.apache.shardingsphere.mcp.feature.spi.MCPFeatureProvider`, then move mask tools and resources into `mcp/features/mask/src/main/java/org/apache/shardingsphere/mcp/feature/mask/tool/` and `/resource/`.
- [ ] T020 [US2] Move mask workflow services and models from `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/service/workflow/` and `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/model/workflow/` into `mcp/features/mask/src/main/java/org/apache/shardingsphere/mcp/feature/mask/workflow/`, keeping only shared workflow-store/runtime adapters in core.
- [ ] T021 [US2] Delete or replace feature-specific classes under `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/handler/workflow/`, `mcp/core/src/main/java/org/apache/shardingsphere/mcp/resource/handler/rule/`, `mcp/core/src/main/java/org/apache/shardingsphere/mcp/resource/handler/plugin/`, and matching tests under `mcp/core/src/test/java/org/apache/shardingsphere/mcp/tool/handler/workflow/` and `mcp/core/src/test/java/org/apache/shardingsphere/mcp/resource/handler/` once feature modules fully own them.
...
## Phase 5: User Story 3 - Add future MCP features without changing core (Priority: P2)

**Goal**: Make the provider/registry model reusable for future MCP feature modules beyond encrypt and mask.
**Independent Test**: Register a hypothetical future feature provider in tests and verify it can be discovered without adding any feature-specific branching to core.

### Tests for User Story 3

- [ ] T022 [P] [US3] Create `mcp/core/src/test/java/org/apache/shardingsphere/mcp/feature/registry/FeatureProviderRegistryTest.java` and extend `mcp/core/src/test/java/org/apache/shardingsphere/mcp/tool/handler/ToolHandlerRegistryTest.java` plus `mcp/core/src/test/java/org/apache/shardingsphere/mcp/resource/handler/ResourceHandlerRegistryTest.java` to cover duplicate feature type, duplicate tool name, duplicate URI pattern, and overlapping URI pattern failures.
...
- [ ] T024 [US3] Add deterministic ordering and provider completeness validation to `mcp/core/src/main/java/org/apache/shardingsphere/mcp/feature/registry/FeatureProviderRegistry.java`, `mcp/core/src/main/java/org/apache/shardingsphere/mcp/feature/registry/FeatureSurfaceCatalog.java`, `mcp/core/src/main/java/org/apache/shardingsphere/mcp/tool/handler/ToolHandlerRegistry.java`, and `mcp/core/src/main/java/org/apache/shardingsphere/mcp/resource/handler/ResourceHandlerRegistry.java`.
- [ ] T025 [US3] Create reusable future-feature fixtures in `mcp/core/src/test/java/org/apache/shardingsphere/mcp/feature/fixture/` and add onboarding Javadoc/examples to `mcp/features/spi/src/main/java/org/apache/shardingsphere/mcp/feature/spi/MCPFeatureProvider.java` and related SPI contracts.
...
- US2 depends on US1 because feature modules need the provider registry and aggregated surface path to exist first.
...
- Increment 2: complete US2 so encrypt and mask truly own their workflow surfaces in separate modules.
