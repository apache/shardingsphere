...
public final class MetaDataContexts implements AutoCloseable {
    ...
    private final AbstractMetaDataPersistService persistService;
    
    private final ShardingSphereMetaData metaData;
    
    private final ShardingSphereData shardingSphereData;
    
    public MetaDataContexts(final AbstractMetaDataPersistService persistService, final ShardingSphereMetaData metaData) {
