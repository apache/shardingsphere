...
class SwitchingResourceTest {
    ...
    void assertCloseStaleDataSources() {
        ...
        StorageResource newStorageResource = new StorageResource(Collections.singletonMap("new_ds", new MockedDataSource()), Collections.emptyMap(), Collections.emptyMap());
        StorageResource staleStorageResource = new StorageResource(Collections.singletonMap("stale_ds", staleDataSource), Collections.emptyMap(), Collections.emptyMap());
