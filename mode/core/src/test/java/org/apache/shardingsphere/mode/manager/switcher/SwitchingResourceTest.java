...
class SwitchingResourceTest {
    ...
    void assertCloseStaleDataSources() {
        ...
        StorageResource newStorageResource = new StorageResource(Collections.singletonMap(new StorageNodeIdentifier("new_ds"), new MockedDataSource()), Collections.emptyMap());
        StorageResource staleStorageResource = new StorageResource(Collections.singletonMap(new StorageNodeIdentifier("stale_ds"), staleDataSource), Collections.emptyMap());
