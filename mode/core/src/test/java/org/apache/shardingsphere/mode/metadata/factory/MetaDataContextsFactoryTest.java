...
class MetaDataContextsFactoryTest {
    ...
    @Mock(answer = Answers.RETURNS_DEEP_STUBS)
    private InternalMetaDataPersistFacade metaDataPersistFacade;
    ...
    void setUp() {
        ...
        when(metaDataPersistService.getDatabaseRuleService()).thenReturn(databaseRulePersistService);
        ...
        when(metaDataPersistService.getMetaDataService()).thenReturn(metaDataPersistFacade);
