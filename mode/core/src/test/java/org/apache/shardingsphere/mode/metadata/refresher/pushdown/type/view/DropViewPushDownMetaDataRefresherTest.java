...
class DropViewPushDownMetaDataRefresherTest {
    ...
    void assertRefresh() {
        ...
        DropViewStatement sqlStatement = new DropViewStatement(databaseType, Arrays.asList(
                new SimpleTableSegment(new TableNameSegment(0, 0, new IdentifierValue("foo_view"))), new SimpleTableSegment(new TableNameSegment(0, 0, new IdentifierValue("bar_view"))) 
        ), false);
