...
class SchemaMetaDataPersistServiceTest {
    ...
    void assertAlterByRefreshWithTables() {
        ...
        persistService.alterByRefresh("foo_db", new ShardingSphereSchema("foo_schema", Collections.singleton(table), Collections.emptyList(), databaseType));
    ...
    void assertAlterByRefreshWithViews() {
        ...
        persistService.alterByRefresh("foo_db", new ShardingSphereSchema("foo_schema", Collections.emptyList(), Collections.singleton(view), databaseType));
        verify(repository, never()).persist("/metadata/foo_db/schemas/foo_schema/tables", "");
        verify(tableMetaDataPersistService).persist("foo_db", "foo_schema", Collections.emptyList());
    }
