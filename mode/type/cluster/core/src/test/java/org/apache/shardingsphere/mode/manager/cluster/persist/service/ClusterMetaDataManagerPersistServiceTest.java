...
class ClusterMetaDataManagerPersistServiceTest {
    ...
    void assertAlterSchema() {
        ...
        verify(metaDataPersistService.getMetaDataService().getTable()).persist("foo_db", "foo_schema", Collections.emptyList());
        verify(metaDataPersistService.getMetaDataService().getView()).persist("foo_db", "foo_schema", Collections.emptyList());
    }
    ...
    void assertRenameNotEmptySchemaName() {
        ...
        verify(metaDataPersistService.getMetaDataService().getTable()).persist(eq("foo_db"), eq("bar_schema"), anyCollection());
        verify(metaDataPersistService.getMetaDataService().getView()).persist(eq("foo_db"), eq("bar_schema"), anyCollection());
        verify(metaDataPersistService.getMetaDataService().getSchema()).drop("foo_db", "foo_schema");
        verify(metaDataPersistService.getMetaDataService().getSchema(), times(0)).add("foo_db", "bar_schema");
    }
    ...
    void assertRenameEmptySchemaName() {
        ...
        metaDataManagerPersistService.renameSchema("foo_db", "foo_schema", "bar_schema");
        verify(metaDataPersistService.getMetaDataService().getSchema()).drop("foo_db", "foo_schema");
        verify(metaDataPersistService.getMetaDataService().getSchema()).add("foo_db", "bar_schema");
    }
    ...
    void assertAlterSingleRuleConfiguration() {
        ...
        when(metaDataPersistService.getDatabaseRuleService().persist("foo_db", Collections.singleton(singleRuleConfig))).thenReturn(Collections.emptyList());
    ...
    void assertAlterNullRuleConfiguration() {
        ...
        verify(metaDataPersistService.getDatabaseRuleService(), times(0)).persist(eq("foo_db"), any());
    }
    ...
    void assertAlterRuleConfiguration() {
        ...
        verify(metaDataPersistService.getDatabaseRuleService()).persist("foo_db", Collections.singleton(ruleConfig));
    }
    
    @Test
    void assertRemoveNullRuleConfigurationItem() {
        metaDataManagerPersistService.removeRuleConfigurationItem("foo_db", null);
        verify(metaDataPersistService.getDatabaseRuleService(), times(0)).delete(eq("foo_db"), anyCollection());
    }
    ...
    void assertRemoveRuleConfigurationItem() {
        ...
        verify(metaDataPersistService.getDatabaseRuleService()).delete("foo_db", Collections.singleton(ruleConfig));
    }
    
    @Test
    void assertRemoveRuleConfiguration() {
        metaDataManagerPersistService.removeRuleConfiguration("foo_db", "fixtureRule");
        verify(metaDataPersistService.getDatabaseRuleService()).delete("foo_db", "fixtureRule");
    }
