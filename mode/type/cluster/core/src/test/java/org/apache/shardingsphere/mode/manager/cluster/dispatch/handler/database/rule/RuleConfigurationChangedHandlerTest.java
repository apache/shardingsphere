...
class RuleConfigurationChangedHandlerTest {
    ...
    void setUp() {
        ...
        when(databaseRuleNodePathProvider.getDatabaseRuleNodePath()).thenReturn(new DatabaseRuleNode("foo_rule", Collections.singleton("named"), Collections.singleton("unique")));
