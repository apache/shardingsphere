    ...
    private static class TestCaseArgumentsProvider implements ArgumentsProvider {
        ...
        public final Stream<? extends Arguments> provideArguments(final ExtensionContext extensionContext) {
            return Stream.of(
                    ...
                    Arguments.of("addView", "/metadata/foo_db/schemas/foo_schema/views/foo_tbl/active_version/0", Type.ADDED, CreateOrAlterViewEvent.class),
                    Arguments.of("updateView", "/metadata/foo_db/schemas/foo_schema/views/foo_tbl/active_version/0", Type.UPDATED, CreateOrAlterViewEvent.class),
                    Arguments.of("deleteView", "/metadata/foo_db/schemas/foo_schema/views/foo_tbl", Type.DELETED, DropViewEvent.class),
                    Arguments.of("invalidAddView", "/metadata/foo_db/schemas/foo_schema/views/foo_tbl", Type.ADDED, null),
                    Arguments.of("invalidDeleteView", "/metadata/foo_db/schemas/foo_schema/views/foo_tbl/active_version/0", Type.DELETED, null),
