...
class ClusterStateChangedWatcherTest {
    ...
    void assertCreateEventWhenReadOnly() {
        ...
        assertThat(((ClusterStateEvent) actual.get()).getClusterState(), is(ClusterState.READ_ONLY.name()));
    }
    ...
    void assertCreateEventWhenUnavailable() {
        ...
        assertTrue(actual.isPresent());
        assertThat(((ClusterStateEvent) actual.get()).getClusterState(), is(ClusterState.UNAVAILABLE.name()));
    }
    ...
    void assertCreateEventWhenEnabled() {
        ...
        assertTrue(actual.isPresent());
        assertThat(((ClusterStateEvent) actual.get()).getClusterState(), is(ClusterState.OK.name()));
    }
}
