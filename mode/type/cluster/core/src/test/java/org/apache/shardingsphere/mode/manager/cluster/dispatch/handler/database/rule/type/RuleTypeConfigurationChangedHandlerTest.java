...
class RuleTypeConfigurationChangedHandlerTest {
    ...
    void assertGetSubscribedNodePath() {
        NodePath actual = new RuleTypeConfigurationChangedHandler(mock()).getSubscribedNodePath("foo_db");
        assertThat(NodePathGenerator.toPath(actual), is("/metadata/foo_db/rules/([\\w-]+)"));
    }
}
