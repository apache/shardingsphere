...
class UniqueRuleItemConfigurationChangedHandlerTest {
    ...
    void assertHandleWithAddItem() {
        ...
        verify(contextManager.getMetaDataContextManager().getDatabaseRuleItemManager())
                .alter(ShardingSphereArgumentVerifyMatchers.deepEq(new DatabaseRuleNodePath("foo_db", "fixture", new DatabaseRuleItem("unique"))));
    }
    ...
    void assertHandleWitDropItem() {
        ...
        verify(contextManager.getMetaDataContextManager().getDatabaseRuleItemManager())
                .drop(ShardingSphereArgumentVerifyMatchers.deepEq(new DatabaseRuleNodePath("foo_db", "fixture", new DatabaseRuleItem("unique"))));
    }
}
