...
class MetaDataChangedHandlerTest {
    ...
    void assertHandleTableCreated() {
        ...
        when(contextManager.getPersistServiceFacade().getMetaDataPersistService().getMetaDataService().getTable().load("foo_db", "foo_schema", "foo_tbl"))
                .thenReturn(table);
    ...
    void assertHandleViewCreated() {
        ...
        when(contextManager.getPersistServiceFacade().getMetaDataPersistService().getMetaDataService().getView().load("foo_db", "foo_schema", "foo_view"))
                .thenReturn(view);
