...
public final class KillProcessHandler implements GlobalDataChangedEventHandler {
    ...
    public String getSubscribedKey() {
        return NodePathGenerator.toPath(new KillProcessTriggerNodePath(null, null), false);
    }
    ...
    private Matcher getKillProcessTriggerMatcher(final DataChangedEvent event) {
        return Pattern.compile(NodePathGenerator.toPath(new KillProcessTriggerNodePath(null, null), false) + "/([\\S]+):([\\S]+)$", Pattern.CASE_INSENSITIVE).matcher(event.getKey());
    }
}
