...
/**
 * Unique rule item configuration changed handler.
 */
public final class UniqueRuleItemConfigurationChangedHandler extends RuleItemConfigurationChangedHandler {
    
    public UniqueRuleItemConfigurationChangedHandler(final ContextManager contextManager) {
