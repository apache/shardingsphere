...
public final class ViewChangedHandler {
    ...
    public void handleCreatedOrAltered(final String databaseName, final String schemaName, final DataChangedEvent event) {
        ...
        ShardingSphereView view = contextManager.getPersistServiceFacade().getMetaDataPersistService().getMetaDataService().getView().load(databaseName, schemaName, viewName);
