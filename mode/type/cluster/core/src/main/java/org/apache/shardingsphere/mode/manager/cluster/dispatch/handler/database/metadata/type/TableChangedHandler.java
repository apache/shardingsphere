...
public final class TableChangedHandler {
    ...
    public void handleCreatedOrAltered(final String databaseName, final String schemaName, final DataChangedEvent event) {
        ...
        ShardingSphereTable table = contextManager.getPersistServiceFacade().getMetaDataPersistService().getMetaDataService().getTable().load(databaseName, schemaName, tableName);
