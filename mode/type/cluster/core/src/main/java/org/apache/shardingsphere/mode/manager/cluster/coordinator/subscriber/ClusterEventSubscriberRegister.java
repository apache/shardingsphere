...
/**
 * Cluster event subscriber register.
 */
public final class ClusterEventSubscriberRegister {
    
    private final EventBusContext eventBusContext;
    
    private final Collection<EventSubscriber> subscribers;
    
    public ClusterEventSubscriberRegister(final RegistryCenter registryCenter, final ContextManager contextManager) {
