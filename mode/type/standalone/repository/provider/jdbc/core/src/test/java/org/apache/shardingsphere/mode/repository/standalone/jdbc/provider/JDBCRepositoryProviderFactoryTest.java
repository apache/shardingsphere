...
public final class JDBCRepositoryProviderFactoryTest {
    ...
    public void assertGetInstanceWithType() {
        assertThat(JDBCRepositoryProviderFactory.getInstance("FIXTURE"), instanceOf(JDBCRepositoryProviderFixture.class));
    }
    
    @Test
    public void assertGetInstanceWithoutType() {
        assertThat(JDBCRepositoryProviderFactory.getInstance(null), instanceOf(JDBCRepositoryProviderFixture.class));
    }
}
