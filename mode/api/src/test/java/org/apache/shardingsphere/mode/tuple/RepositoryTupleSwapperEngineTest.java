...
class RepositoryTupleSwapperEngineTest {
    ...
    void assertSwapToRepositoryTuplesWithLeafYamlRuleConfiguration() {
        LeafYamlRuleConfiguration yamlRuleConfig = new LeafYamlRuleConfiguration();
        yamlRuleConfig.setValue("foo");
        Collection<RepositoryTuple> actual = new RepositoryTupleSwapperEngine().swapToRepositoryTuples(yamlRuleConfig);
