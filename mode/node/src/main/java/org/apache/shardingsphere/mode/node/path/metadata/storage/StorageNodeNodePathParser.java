...
public final class StorageNodeNodePathParser {
    ...
    private static final Pattern PATTERN = Pattern.compile(new StorageNodeNodePath(NodePathPattern.IDENTIFIER).getPath(NodePathPattern.IDENTIFIER) + "$", Pattern.CASE_INSENSITIVE);
