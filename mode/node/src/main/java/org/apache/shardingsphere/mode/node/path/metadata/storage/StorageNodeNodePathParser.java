...
public final class StorageNodeNodePathParser {
    ...
    private static final Pattern PATTERN = Pattern.compile(new StorageNodeNodePathGenerator(NodePathPattern.IDENTIFIER).getPath(NodePathPattern.IDENTIFIER) + "$", Pattern.CASE_INSENSITIVE);
