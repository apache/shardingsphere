...
public final class StatisticsNodePath {
    ...
    public static Optional<String> findDatabaseName(final String path, final boolean containsChildPath) {
        ...
        Pattern pattern = Pattern.compile(getDatabasePath(DataNodePathPattern.IDENTIFIER) + endPattern, Pattern.CASE_INSENSITIVE);
    ...
    public static Optional<String> findSchemaName(final String path, final boolean containsChildPath) {
        String endPattern = containsChildPath ? "?" : "$";
        Pattern pattern = Pattern.compile(getSchemaPath(DataNodePathPattern.IDENTIFIER, DataNodePathPattern.IDENTIFIER) + endPattern, Pattern.CASE_INSENSITIVE);
        Matcher matcher = pattern.matcher(path);
    ...
    public static Optional<String> findTableName(final String path, final boolean containsChildPath) {
        String endPattern = containsChildPath ? "?" : "$";
        Pattern pattern = Pattern.compile(getTablePath(DataNodePathPattern.IDENTIFIER, DataNodePathPattern.IDENTIFIER, DataNodePathPattern.IDENTIFIER) + endPattern, Pattern.CASE_INSENSITIVE);
        Matcher matcher = pattern.matcher(path);
    ...
    public static Optional<String> findRowUniqueKey(final String path) {
        Pattern pattern = Pattern.compile(
                getTableRowPath(DataNodePathPattern.IDENTIFIER, DataNodePathPattern.IDENTIFIER, DataNodePathPattern.IDENTIFIER, UNIQUE_KEY_PATTERN) + "$", Pattern.CASE_INSENSITIVE);
        Matcher matcher = pattern.matcher(path);
