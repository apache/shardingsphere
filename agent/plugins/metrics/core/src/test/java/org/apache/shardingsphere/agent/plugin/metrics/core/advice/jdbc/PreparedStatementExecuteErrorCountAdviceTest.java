...
public final class PreparedStatementExecuteErrorCountAdviceTest {
    ...
    private final PreparedStatementExecuteErrorCountAdvice advice = new PreparedStatementExecuteErrorCountAdvice();
