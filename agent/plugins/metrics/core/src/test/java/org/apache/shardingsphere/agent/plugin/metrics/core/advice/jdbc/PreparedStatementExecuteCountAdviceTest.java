...
public final class PreparedStatementExecuteCountAdviceTest {
    ...
    private final PreparedStatementExecuteCountAdvice advice = new PreparedStatementExecuteCountAdvice();
