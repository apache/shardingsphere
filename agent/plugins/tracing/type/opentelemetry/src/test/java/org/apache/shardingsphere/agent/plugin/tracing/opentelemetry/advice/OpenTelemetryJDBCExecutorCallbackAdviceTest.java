...
class OpenTelemetryJDBCExecutorCallbackAdviceTest {
    ...
    private void prepare() {
        ...
        JDBCExecutorCallback jdbcExecutorCallback = new JDBCExecutorCallbackFixture(TypedSPILoader.getService(DatabaseType.class, "MySQL"), resourceMetaData, new MySQLSimpleSelectStatement(), true);
