...
public final class AgentSPIRegistry {
     ...
     */
    public static <T extends PluginBootService> Optional<T> getRegisteredService(final Class<T> typedSPIClass, final String type) {
     ...
     */
    public static <T extends PluginBootService> Collection<T> getAllRegisteredServices(final Class<T> typedSPIClass) {
