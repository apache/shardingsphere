...
class AgentYamlConstructorTest {
    ...
    void assertAcceptRootClass() throws ClassNotFoundException {
        AgentYamlConstructor constructor = new AgentYamlConstructor(YamlAgentConfiguration.class, new LoaderOptions());
        assertThat(constructor.getClassForName(YamlAgentConfiguration.class.getName()), is((Object) YamlAgentConfiguration.class));
    }
}
