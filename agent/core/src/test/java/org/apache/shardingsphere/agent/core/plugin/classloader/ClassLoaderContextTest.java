...
class ClassLoaderContextTest {
    ...
    void assertGetPluginClassLoader() {
        ClassLoaderContext context = new ClassLoaderContext(new URLClassLoader(new URL[0], getClass().getClassLoader()), Collections.emptyList());
        assertThat(context.getPluginClassLoader(), is(context.getPluginClassLoader()));
    }
}
