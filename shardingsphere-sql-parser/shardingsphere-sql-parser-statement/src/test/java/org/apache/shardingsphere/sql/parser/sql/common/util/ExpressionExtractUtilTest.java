...
public final class ExpressionExtractUtilTest {
    ...
    @Test
    public void assertFindNotContainsNullLiteralsExpression() {
    ...
    private void assertFindNotContainsNullLiteralsExpressionIsPresent(final ExpressionSegment expression, final Boolean result) {
        if (result) {
            assertTrue(ExpressionExtractUtil.findNotContainsNullLiteralsExpression(expression).isPresent());
        } else {
            assertFalse(ExpressionExtractUtil.findNotContainsNullLiteralsExpression(expression).isPresent());
        }
    }
}
