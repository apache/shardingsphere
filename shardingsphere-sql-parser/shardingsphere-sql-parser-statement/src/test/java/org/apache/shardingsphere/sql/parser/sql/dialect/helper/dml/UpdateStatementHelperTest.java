...
public class UpdateStatementHelperTest {
    ...
    public void assertGetOrderBySegmentWithOrderBySegmentForMySQL() {
        ...
        Optional<OrderBySegment> orderBySegment = UpdateStatementHelper.getOrderBySegment(updateStatement);
    ...
    public void assertGetLimitSegmentWithLimitSegmentForMySQL() {
        ...
        Optional<LimitSegment> limitSegment = UpdateStatementHelper.getLimitSegment(updateStatement);
