...
public class DeleteStatementHelperTest {
    ...
    public void assertGetOrderBySegmentWithOrderBySegmentForMySQL() {
        ...
        Optional<OrderBySegment> orderBySegment = DeleteStatementHelper.getOrderBySegment(deleteStatement);
    ...
    public void assertGetLimitSegmentWithLimitSegmentForMySQL() {
        ...
        Optional<LimitSegment> limitSegment = DeleteStatementHelper.getLimitSegment(deleteStatement);
