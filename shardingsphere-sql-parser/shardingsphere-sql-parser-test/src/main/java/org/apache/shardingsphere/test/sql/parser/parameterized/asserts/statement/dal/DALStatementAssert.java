...
public final class DALStatementAssert {
    ...
    public static void assertIs(final SQLCaseAssertContext assertContext, final DALStatement actual, final SQLParserTestCase expected) {
        if (actual instanceof UseStatement) {
            MySQLUseStatementAssert.assertIs(assertContext, (UseStatement) actual, (UseStatementTestCase) expected);
        ...
        } else if (actual instanceof SQLShowStatement) {
            ShowStatementAssert.assertIs(assertContext, (SQLShowStatement) actual, (ShowStatementTestCase) expected);
