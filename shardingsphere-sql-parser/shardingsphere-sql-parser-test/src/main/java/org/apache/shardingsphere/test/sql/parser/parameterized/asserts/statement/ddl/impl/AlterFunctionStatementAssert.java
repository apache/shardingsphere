...
/**
 * Alter function statement assert.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class AlterFunctionStatementAssert {
    /**
     ...
     */
    public static void assertIs(final SQLCaseAssertContext assertContext, final AlterFunctionStatement actual, final AlterFunctionStatementTestCase expected) {
    }
}
