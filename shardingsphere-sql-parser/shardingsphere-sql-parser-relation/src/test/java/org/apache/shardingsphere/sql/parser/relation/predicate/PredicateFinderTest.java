...
public final class PredicateFinderTest {
    ...
    public void assertFindTableNameWhenSingleTable() {
        ...
        Optional<String> actual = new PredicateFinder(mock(RelationMetas.class), Collections.singletonList(tableSegment)).findTableName(predicateSegment);
    ...
    public void assertFindTableNameWhenColumnSegmentOwnerPresent() {
        ...
        Optional<String> actual = new PredicateFinder(mock(RelationMetas.class), Arrays.asList(tableSegment1, tableSegment2)).findTableName(predicateSegment);
        assertTrue(actual.isPresent());
        assertThat(actual.get(), is("table_1"));
    }
    ...
    public void assertFindTableNameWhenColumnSegmentOwnerAbsentAndRelationMetasContainsColumn() {
        ...
        Optional<String> actual = new PredicateFinder(relationMetas, Arrays.asList(tableSegment1, tableSegment2)).findTableName(predicateSegment);
        assertTrue(actual.isPresent());
        assertThat(actual.get(), is("table_1"));
    }
