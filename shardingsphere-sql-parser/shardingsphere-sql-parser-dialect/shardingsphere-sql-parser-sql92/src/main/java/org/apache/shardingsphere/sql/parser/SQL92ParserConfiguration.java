...
import org.apache.shardingsphere.sql.parser.lexer.SQL92Lexer;
import org.apache.shardingsphere.sql.parser.parser.SQL92Parser;
...
public final class SQL92ParserConfiguration implements SQLParserConfiguration {
    ...
    public Class<? extends SQLVisitorFacade> getVisitorFacadeClass() {
        return SQL92VisitorFacade.class;
    }
}
