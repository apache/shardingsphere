...
dataTypeName
    : CHARACTER | CHARACTER_VARYING | NATIONAL_CHARACTER | NATIONAL_CHARACTER_VARYING | CHAR | VARCHAR | NCHAR
    | NATIONAL_CHAR | NATIONAL_CHAR_VARYING | BIT | BIT_VARYING | NUMERIC | DECIMAL | DEC | INTEGER | SMALLINT
    | FLOAT | REAL | DOUBLE_PRECISION | DATE | TIME | TIMESTAMP | INTERVAL | TIME_WITH_TIME_ZONE | TIMESTAMP_WITH_TIME_ZONE
    | identifier
    ;
