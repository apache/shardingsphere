...
import org.apache.shardingsphere.sql.parser.autogen.MySQLStatementParser.CreateUdfContext;
...
import org.apache.shardingsphere.sql.parser.sql.dialect.statement.mysql.dal.MySQLCreateUdfStatement;
...
public final class MySQLDALStatementSQLVisitor extends MySQLStatementSQLVisitor implements DALSQLVisitor, SQLStatementVisitor {
    ...
    @Override
    public ASTNode visitCreateUdf(final CreateUdfContext ctx) {
        return new MySQLCreateUdfStatement();
    }
}
