    ...
    static {
        ...
        testUnits.add(new String[]{"create_table", "CREATE TABLE IF NOT EXISTS `runoob_tbl`(\n"
                ...
                "CREATE TABLE IF NOT EXISTS `runoob_tbl` (\n"
                        ...
                        + "\tPRIMARY KEY (`runoob_id`)\n"
                        + ") ENGINE = InnoDB DEFAULT CHARSET = utf8"});
        testUnits.add(new String[]{"select_with_column", "select id, name, age, count(table1.id) as n, (select id, name, age, sex from table2 where id=2) as sid, yyyy from table1 where id=1", "SELECT id ,"
                + " name , age , \n"
