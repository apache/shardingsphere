...
/**
 * Binary protocol value for string for Firebird.
 */
public final class FirebirdStringBinaryProtocolValue implements FirebirdBinaryProtocolValue {
    ...
    public void write(final FirebirdPacketPayload payload, final Object value) {
        if (value instanceof byte[]) {
            ...
            payload.writeString(null != value ? value.toString() : "");
        }
    }
