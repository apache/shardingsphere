...
class PostgreSQLCloseCompletePacketTest {
    ...
    void assertGetInstanceAndWrite() {
        ...
        PostgreSQLCloseCompletePacket packet = PostgreSQLCloseCompletePacket.getInstance();
        packet.write(payload);
        verify(byteBuf).writeBytes(new byte[]{'3', 0, 0, 0, 4});
    }
}
