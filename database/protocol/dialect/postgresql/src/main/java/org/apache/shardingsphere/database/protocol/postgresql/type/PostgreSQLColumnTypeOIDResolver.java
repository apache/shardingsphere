 ...
 */
public final class PostgreSQLColumnTypeOIDResolver implements ColumnTypeOIDResolver {
    
    @Override
    public Optional<Integer> findTypeOID(final Connection connection, final String columnTypeName) throws SQLException {
