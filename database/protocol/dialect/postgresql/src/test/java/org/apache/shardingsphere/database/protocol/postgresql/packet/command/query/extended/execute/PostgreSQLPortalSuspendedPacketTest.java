...
package org.apache.shardingsphere.database.protocol.postgresql.packet.command.query.extended.execute;
...
class PostgreSQLPortalSuspendedPacketTest {
    ...
    void assertGetIdentifier() {
        assertThat(new PostgreSQLPortalSuspendedPacket().getIdentifier(), is(PostgreSQLMessagePacketType.PORTAL_SUSPENDED));
    }
}
