...
/**
 * Firebird batch release command packet.
 */
@Getter
public final class FirebirdBatchReleaseCommandPacket extends FirebirdCommandPacket {
    
    private final int statementHandle;
    
    public FirebirdBatchReleaseCommandPacket(final FirebirdPacketPayload payload) {
