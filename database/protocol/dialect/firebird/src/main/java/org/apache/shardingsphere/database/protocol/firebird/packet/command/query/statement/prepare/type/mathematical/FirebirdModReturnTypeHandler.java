...
/**
 * Firebird Mod function return type handler.
 */
@RequiredArgsConstructor
public final class FirebirdModReturnTypeHandler implements FirebirdFunctionReturnTypeHandler {
    ...
    static {
        ...
        COLUMN_TYPE_MAP.put(Types.DOUBLE, FirebirdBinaryColumnType.INT64);
        COLUMN_TYPE_MAP.put(Types.FLOAT, FirebirdBinaryColumnType.INT64);
        COLUMN_TYPE_MAP.put(Types.INTEGER, FirebirdBinaryColumnType.LONG);
        COLUMN_TYPE_MAP.put(Types.SMALLINT, FirebirdBinaryColumnType.SHORT);
