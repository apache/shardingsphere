...
/**
 * Firebird SUM function return type handler.
 */
@RequiredArgsConstructor
public final class FirebirdSUMReturnTypeHandler implements FirebirdFunctionReturnTypeHandler {
    
    private static final Map<Integer, FirebirdBinaryColumnType> COLUMN_TYPE_MAP = new HashMap<>(0, 1F);
    
    static {
        COLUMN_TYPE_MAP.put(Types.BIGINT, FirebirdBinaryColumnType.INT128);
