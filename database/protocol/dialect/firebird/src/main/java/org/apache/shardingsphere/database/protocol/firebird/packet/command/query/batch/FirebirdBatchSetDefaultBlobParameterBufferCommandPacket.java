...
/**
 * Firebird batch set default blob parameter buffer command packet.
 */
@Getter
public final class FirebirdBatchSetDefaultBlobParameterBufferCommandPacket extends FirebirdCommandPacket {
    
    private final int statementHandle;
    
    private final ByteBuf blobParameterBuffer;
    
    public FirebirdBatchSetDefaultBlobParameterBufferCommandPacket(final FirebirdPacketPayload payload) {
        payload.skipReserved(4);
        statementHandle = payload.readInt4();
        blobParameterBuffer = payload.readBuffer();
    }
