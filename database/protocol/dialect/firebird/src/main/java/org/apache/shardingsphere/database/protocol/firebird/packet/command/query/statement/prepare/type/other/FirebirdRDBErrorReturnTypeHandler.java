...
package org.apache.shardingsphere.database.protocol.firebird.packet.command.query.statement.prepare.type.other;
...
/**
 * Firebird RDB$ERROR functions return type handler.
 */
@RequiredArgsConstructor
public final class FirebirdRDBErrorReturnTypeHandler implements FirebirdFunctionReturnTypeHandler {
    ...
    public FirebirdBinaryColumnType getReturnType(final ShardingSphereSchema schema, final Collection<ExpressionSegment> parameters) {
        // TODO add support for RDB$ERROR function
