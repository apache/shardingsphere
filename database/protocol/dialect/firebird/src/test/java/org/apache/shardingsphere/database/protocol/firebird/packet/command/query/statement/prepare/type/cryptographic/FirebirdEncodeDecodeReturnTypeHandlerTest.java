...
package org.apache.shardingsphere.database.protocol.firebird.packet.command.query.statement.prepare.type.cryptographic;
...
class FirebirdEncodeDecodeReturnTypeHandlerTest {
    
    private final FirebirdEncodeDecodeReturnTypeHandler handler = new FirebirdEncodeDecodeReturnTypeHandler();
