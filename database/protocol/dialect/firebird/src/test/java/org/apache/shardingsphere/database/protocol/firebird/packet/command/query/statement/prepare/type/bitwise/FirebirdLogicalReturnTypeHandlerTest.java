...
class FirebirdLogicalReturnTypeHandlerTest {
    
    private final FirebirdLogicalReturnTypeHandler handler = new FirebirdLogicalReturnTypeHandler();
    ...
    private void stubColumn(final int dataType) {
        ...
        ShardingSphereColumn columnInfo = new ShardingSphereColumn("order_id", dataType, false, false, false, true, false, false);
