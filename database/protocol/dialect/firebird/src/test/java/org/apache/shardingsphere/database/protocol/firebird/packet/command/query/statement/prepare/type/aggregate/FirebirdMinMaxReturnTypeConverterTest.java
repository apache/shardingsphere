...
class FirebirdMinMaxReturnTypeConverterTest {
    
    private final FirebirdMinMaxReturnTypeConverter handler = new FirebirdMinMaxReturnTypeConverter();
    ...
    void assertGetReturnTypeWithOtherSegment() {
        assertThat(handler.getReturnType(schema, Collections.singletonList(otherSegment)), is(FirebirdBinaryColumnType.LONG));
    }
