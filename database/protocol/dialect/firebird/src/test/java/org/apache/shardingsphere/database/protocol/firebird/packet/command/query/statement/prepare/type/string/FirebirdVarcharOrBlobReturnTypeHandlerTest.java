...
class FirebirdVarcharOrBlobReturnTypeHandlerTest {
    
    private final FirebirdVarcharOrBlobReturnTypeHandler handler = new FirebirdVarcharOrBlobReturnTypeHandler();
