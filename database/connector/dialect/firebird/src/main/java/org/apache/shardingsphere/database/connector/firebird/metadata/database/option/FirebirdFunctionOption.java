...
public final class FirebirdFunctionOption implements DialectFunctionOption {
    ...
    private static final Collection<String> UNPARENTHESIZED_FUNCTION_NAMES = new HashSet<>(Arrays.asList("CURRENT_DATE", "CURRENT_TIME", "CURRENT_TIMESTAMP", "CURRENT_USER"));
