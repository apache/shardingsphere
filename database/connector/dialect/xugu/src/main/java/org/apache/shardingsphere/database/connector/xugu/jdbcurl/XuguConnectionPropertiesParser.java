...
package org.apache.shardingsphere.database.connector.xugu.jdbcurl;
...
/**
 * Connection properties parser of xugu.
 */
public final class XuguConnectionPropertiesParser implements ConnectionPropertiesParser {
    ...
    public ConnectionProperties parse(final String url, final String username, final String catalog) {
        ...
        return new ConnectionProperties(properties.getHostname(), properties.getPort(),
                null == catalog ? properties.getCatalog() : catalog, currentSchema == null ? username : currentSchema,
