...
class H2ConnectionPropertiesParserTest {
    ...
    void assertParse(final String url, final String expectedHost, final int expectedPort, final String expectedCatalog, final String expectedModel, final boolean expectException) {
        if (expectException) {
    ...
    private static Stream<Arguments> provideArguments() {
        return Stream.of(
                Arguments.of(Named.named("mem", "jdbc:h2:mem:ds_mem;MODE=MySQL"), "", -1, "ds_mem", "mem", false),
                Arguments.of(Named.named("tcp", "jdbc:h2:tcp://127.0.0.1:9092/~/demo/name;DB_CLOSE_DELAY=-1"), "127.0.0.1", 9092, "name", "tcp:", false),
                Arguments.of(Named.named("file", "jdbc:h2:file:/data/demo/db_file;MODE=MySQL"), "", -1, "db_file", "file:", false),
                Arguments.of(Named.named("invalid", "jdbc:invalid:h2"), "", -1, "", "", true));
    }
}
