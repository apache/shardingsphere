...
public final class PostgreSQLDatabaseMetaData implements DialectDatabaseMetaData {
    ...
    public DialectTransactionOption getTransactionOption() {
        return new DialectTransactionOption(false, true, false, true, true, Connection.TRANSACTION_READ_COMMITTED, true, true, Collections.singleton("org.postgresql.xa.PGXADataSource"));
    }
