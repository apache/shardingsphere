...
class HiveIdentifierCasePolicyProviderTest {
    ...
    void assertProvide() {
        ...
        assertThat(actual.normalizeForDefinition("FooTable", QuoteCharacter.NONE), is("footable"));
        assertThat(actual.normalizeForDefinition("FooTable", QuoteCharacter.BACK_QUOTE), is("footable"));
        assertTrue(actual.matches("foo_table", "FOO_TABLE", QuoteCharacter.NONE));
        assertTrue(actual.matches("foo_table", "FOO_TABLE", QuoteCharacter.BACK_QUOTE));
    }
}
