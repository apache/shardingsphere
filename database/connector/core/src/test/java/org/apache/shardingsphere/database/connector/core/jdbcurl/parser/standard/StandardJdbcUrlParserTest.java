...
class StandardJdbcUrlParserTest {
    ...
    private static class TestCaseArgumentsProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(final ParameterDeclarations parameters, final ExtensionContext context) {
            return Stream.of(
                    Arguments.arguments("simple", "jdbc:mock://127.0.0.1/?schema=foo_schema", "127.0.0.1", -1, "", "foo_schema", PropertiesBuilder.build(new Property("schema", "foo_schema"))),
                    Arguments.arguments("MySQL_v4", "jdbc:mysql://127.0.0.1:3306/foo_ds?useSSL=false&sessionVariables=group_concat_max_len=204800,SQL_SAFE_UPDATES=0", "127.0.0.1", 3306, "foo_ds",
                            null, PropertiesBuilder.build(new Property("useSSL", Boolean.FALSE.toString()), new Property("sessionVariables", "group_concat_max_len=204800,SQL_SAFE_UPDATES=0"))),
                    Arguments.arguments("MySQL_v6", "jdbc:mysql://[fe80::d114:22b3:a0d9:2b3]:3306/foo_ds", "fe80::d114:22b3:a0d9:2b3", 3306, "foo_ds", null, new Properties()),
                    Arguments.arguments("MySQL_with_replication", "jdbc:mysql:replication://master-ip:3306,slave-1-ip:3306,slave-2-ip:3306/foo_ds?useUnicode=true", "master-ip", 3306, "foo_ds", null,
                            PropertiesBuilder.build(new Property("useUnicode", Boolean.TRUE.toString()))),
                    Arguments.arguments("PostgreSQL_v4", "jdbc:postgresql://127.0.0.1:5432/foo_ds?prepareThreshold=1&preferQueryMode=extendedForPrepared", "127.0.0.1", 5432, "foo_ds", null,
                            PropertiesBuilder.build(new Property("prepareThreshold", "1"), new Property("preferQueryMode", "extendedForPrepared"))),
                    Arguments.arguments("testcontainers_MySQL", "jdbc:tc:mysql:5.7.34:///foo_ds", "", -1, "foo_ds", null, new Properties()),
                    ...
                    Arguments.arguments("testcontainers_INITSCRIPT", "jdbc:tc:mysql:5.7.34:///foo_ds?TC_INITSCRIPT=file:src/main/resources/init_mysql.sql", "", -1, "foo_ds", null,
                            PropertiesBuilder.build(new Property("TC_INITSCRIPT", "file:src/main/resources/init_mysql.sql"))),
                    Arguments.arguments("testcontainers_INITFUNCTION", "jdbc:tc:mysql:5.7.34:///foo_ds?TC_INITFUNCTION=org.testcontainers.jdbc.JDBCDriverTest::sampleInitFunction", "", -1, "foo_ds",
                            null, PropertiesBuilder.build(new Property("TC_INITFUNCTION", "org.testcontainers.jdbc.JDBCDriverTest::sampleInitFunction"))),
                    Arguments.arguments("testcontainers_DAEMON", "jdbc:tc:mysql:5.7.34:///foo_ds?TC_DAEMON=true", "", -1, "foo_ds", null,
                            PropertiesBuilder.build(new Property("TC_DAEMON", Boolean.TRUE.toString()))),
                    Arguments.arguments("testcontainers_TMPFS", "jdbc:tc:postgresql:9.6.8:///foo_ds?TC_TMPFS=/testtmpfs:rw", "", -1, "foo_ds", null,
