...
@PrepareForTest(OptimizeIPIdGenerator.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
@SuppressWarnings("all")
public class OptimizeIPIdGeneratorTest {
    ...
    public void testIPV4() throws UnknownHostException {
        ...
        OptimizeIPIdGenerator.initWorkerId();
        assertThat(CommonSelfIdGenerator.getWorkerId(), is(362L));
    }
    ...
    public void testIPV6() throws UnknownHostException {
        ...
        OptimizeIPIdGenerator.initWorkerId();
        assertThat(CommonSelfIdGenerator.getWorkerId(), is(1008L));
    }
    ...
    public void generateId() throws Exception {
        ...
        final OptimizeIPIdGenerator optimizeIPIdGenerator = new OptimizeIPIdGenerator();
        Set<Long> hashSet = new HashSet<>();
        for (int i = 0; i < taskNumber; i++) {
            hashSet.add(executor.submit(new Callable<Long>() {
                @Override
                public Long call() throws Exception {
                    return (Long) optimizeIPIdGenerator.generateId();
                }
            }).get());
        }
