...
public class ShardingDatabaseAndTableDQLTest extends AbstractShardingDatabaseAndTableTest {
    
    public ShardingDatabaseAndTableDQLTest(final String testCaseName, final String sql, final DatabaseType type, final List<SQLShardingRule> sqlShardingRules) {
