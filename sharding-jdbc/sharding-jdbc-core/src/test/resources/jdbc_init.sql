...
CREATE TABLE IF NOT EXISTS t_query_and_plain_encrypt (id INT NOT NULL AUTO_INCREMENT, cipher_pwd VARCHAR(45) NULL, assist_pwd VARCHAR(45) NULL, plain_pwd VARCHAR(45) NULL, PRIMARY KEY (id));