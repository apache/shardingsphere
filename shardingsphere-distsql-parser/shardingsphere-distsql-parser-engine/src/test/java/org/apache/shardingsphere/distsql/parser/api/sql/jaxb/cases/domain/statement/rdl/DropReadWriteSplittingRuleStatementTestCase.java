...
import org.apache.shardingsphere.distsql.parser.api.sql.jaxb.cases.domain.segment.resource.ExpectedRule;
...
public final class DropReadWriteSplittingRuleStatementTestCase extends SQLParserTestCase {
    ...
    @XmlElement(name = "readwrite-splitting-rule")
    private final List<ExpectedRule> readWriteSplittingRule = new LinkedList<>();
}
