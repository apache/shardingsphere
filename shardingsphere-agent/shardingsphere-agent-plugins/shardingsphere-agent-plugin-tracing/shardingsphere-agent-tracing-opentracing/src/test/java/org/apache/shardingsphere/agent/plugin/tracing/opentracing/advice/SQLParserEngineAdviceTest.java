...
public final class SQLParserEngineAdviceTest extends AbstractSQLParserEngineAdviceTest {
    ...
    public void assertExceptionHandle() {
        ...
        assertThat(fields.get(OpenTracingConstants.ErrorLogTagKeys.EVENT), is("error"));
        assertThat(fields.get(OpenTracingConstants.ErrorLogTagKeys.ERROR_KIND), is("java.io.IOException"));
