...
public final class CommandExecutorTaskAdviceTest {
    ...
    public static void setup() {
        ...
        executeCommandMethod = CommandExecutorTask.class.getDeclaredMethod("executeCommand", ChannelHandlerContext.class, PacketPayload.class, JDBCBackendConnection.class);
    }
