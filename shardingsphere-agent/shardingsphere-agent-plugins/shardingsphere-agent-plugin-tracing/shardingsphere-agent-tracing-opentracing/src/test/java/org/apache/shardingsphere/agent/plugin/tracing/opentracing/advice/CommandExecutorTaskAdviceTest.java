...
public final class CommandExecutorTaskAdviceTest extends AbstractCommandExecutorTaskAdviceTest {
    ...
    public static void setup() {
        EXPECTED.put(Tags.COMPONENT.getKey(), OpenTracingConstants.COMPONENT_NAME);
        EXPECTED.put(OpenTracingConstants.ShardingSphereTags.CONNECTION_COUNT.getKey(), 0);
    }
    ...
    public void assertExceptionHandle() {
        ...
        map.put(OpenTracingConstants.ErrorLogTagKeys.EVENT_ERROR_TYPE, true);
