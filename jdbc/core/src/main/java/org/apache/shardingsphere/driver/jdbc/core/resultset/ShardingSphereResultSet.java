...
public final class ShardingSphereResultSet extends AbstractResultSetAdapter {
    ...
    public ShardingSphereResultSet(final List<ResultSet> resultSets, final MergedResult mergeResultSet, final Statement statement, final boolean singleTable,
                                   final ExecutionContext executionContext) throws SQLException {
        super(resultSets, statement, singleTable, executionContext);
