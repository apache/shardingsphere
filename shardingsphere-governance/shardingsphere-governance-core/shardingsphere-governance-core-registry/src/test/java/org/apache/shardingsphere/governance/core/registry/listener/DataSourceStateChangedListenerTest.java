...
public final class DataSourceStateChangedListenerTest {
    ...
    @Before
    public void setUp() {
        dataSourceStateChangedListener = new DataSourceStateChangedListener(registryRepository, Arrays.asList("sharding_db", "primaryreplica_db", "encrypt_db"));
    }
    ...
    public void assertCreateGovernanceEvent() {
        Optional<GovernanceEvent> actual = dataSourceStateChangedListener.createGovernanceEvent(
                new DataChangedEvent("/registry/datasources/primary_replica_db/replica_ds_0", "disabled", ChangedType.UPDATED));
