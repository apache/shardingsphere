...
public final class MetaDataChangedListenerTest extends MetaDataListenerTest {
    ...
    @Before
    public void setUp() {
        metaDataChangedListener = new MetaDataChangedListener(getRegistryRepository(), Arrays.asList("sharding_db", "replica_query_db"));
    }
    ...
    public void assertCreateDeletedEvent() {
        ...
        assertThat(((MetaDataDeletedEvent) actual.get()).getSchemaName(), is("replica_query_db"));
    }
}
