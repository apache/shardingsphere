...
public final class GlobalRuleChangedListenerTest {
    ...
    public void assertCreateEvent() {
        Optional<GovernanceEvent> event = globalRuleChangedListener.createEvent(new DataChangedEvent("rule", "", Type.UPDATED));
