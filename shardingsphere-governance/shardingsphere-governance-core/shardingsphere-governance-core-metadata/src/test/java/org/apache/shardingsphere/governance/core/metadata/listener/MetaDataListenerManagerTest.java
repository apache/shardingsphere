...
import org.apache.shardingsphere.governance.core.metadata.util.FieldUtil;
...
public final class MetaDataListenerManagerTest {
    ...
    public void assertInitListeners() {
        MetaDataListenerManager actual = new MetaDataListenerManager(governanceRepository, Collections.singleton("sharding_db"));
