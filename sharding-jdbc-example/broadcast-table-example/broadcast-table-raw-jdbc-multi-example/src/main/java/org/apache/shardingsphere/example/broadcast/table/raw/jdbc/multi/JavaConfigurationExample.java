...
package org.apache.shardingsphere.example.broadcast.table.raw.jdbc.multi;

import org.apache.shardingsphere.example.broadcast.table.raw.jdbc.multi.config.ShardingDatabasesConfiguration;
...
public class JavaConfigurationExample {
    ...
    public static void main(final String[] args) throws SQLException {
        ...
        CommonService countryService = geSportsmanService(dataSource);
        countryService.initEnvironment();
        countryService.processSuccess();
        countryService.cleanEnvironment();
    }

    private static CommonService geSportsmanService(final DataSource dataSource) {
