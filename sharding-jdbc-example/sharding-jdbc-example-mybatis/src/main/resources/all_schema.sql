...
CREATE TABLE IF NOT EXISTS `ds_0`.`t_order_0` (`order_id` BIGINT, `user_id` INT NOT NULL, `status` VARCHAR(50), PRIMARY KEY (`order_id`));
CREATE TABLE IF NOT EXISTS `ds_0`.`t_order_1` (`order_id` BIGINT, `user_id` INT NOT NULL, `status` VARCHAR(50), PRIMARY KEY (`order_id`));
...
CREATE TABLE IF NOT EXISTS `ds_1`.`t_order_0` (`order_id` BIGINT, `user_id` INT NOT NULL, `status` VARCHAR(50), PRIMARY KEY (`order_id`));
CREATE TABLE IF NOT EXISTS `ds_1`.`t_order_1` (`order_id` BIGINT, `user_id` INT NOT NULL, `status` VARCHAR(50), PRIMARY KEY (`order_id`));
