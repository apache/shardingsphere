...
@ContextConfiguration("/META-INF/zookeeper/local/application-master-slave.xml")
public class SpringNamespaceLocalZookeeperMasterSlaveTest extends SpringNamespaceBaseTest {
