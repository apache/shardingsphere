...
@ContextConfiguration("/META-INF/zookeeper/cloud/application-sharding-tables.xml")
public class SpringNamespaceCloudZookeeperShardingTablesTest extends SpringNamespaceBaseTest {
