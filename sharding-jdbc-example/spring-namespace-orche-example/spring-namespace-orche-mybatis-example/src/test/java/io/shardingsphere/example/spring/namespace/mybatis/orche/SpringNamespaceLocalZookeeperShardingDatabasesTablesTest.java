...
@ContextConfiguration("/META-INF/zookeeper/local/application-sharding-databases-tables.xml")
public class SpringNamespaceLocalZookeeperShardingDatabasesTablesTest extends SpringNamespaceBaseTest {
