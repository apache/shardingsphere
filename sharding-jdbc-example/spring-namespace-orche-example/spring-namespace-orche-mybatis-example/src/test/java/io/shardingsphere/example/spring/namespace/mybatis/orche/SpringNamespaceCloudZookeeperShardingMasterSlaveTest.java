...
@ContextConfiguration("/META-INF/zookeeper/cloud/application-sharding-master-slave.xml")
public class SpringNamespaceCloudZookeeperShardingMasterSlaveTest extends SpringNamespaceBaseTest {
