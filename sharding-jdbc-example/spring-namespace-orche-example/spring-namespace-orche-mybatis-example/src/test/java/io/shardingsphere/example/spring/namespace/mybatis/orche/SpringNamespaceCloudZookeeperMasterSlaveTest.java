...
@ContextConfiguration("/META-INF/zookeeper/cloud/application-master-slave.xml")
public class SpringNamespaceCloudZookeeperMasterSlaveTest extends SpringNamespaceBaseTest {
