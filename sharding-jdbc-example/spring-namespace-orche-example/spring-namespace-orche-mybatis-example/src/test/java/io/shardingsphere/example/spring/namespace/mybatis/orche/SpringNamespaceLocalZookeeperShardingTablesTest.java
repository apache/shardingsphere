...
@ContextConfiguration("/META-INF/zookeeper/local/application-sharding-tables.xml")
public class SpringNamespaceLocalZookeeperShardingTablesTest extends SpringNamespaceBaseTest {
