...
@ContextConfiguration("/META-INF/zookeeper/cloud/application-sharding-databases.xml")
public class SpringNamespaceCloudZookeeperShardingDatabasesTest extends SpringNamespaceBaseTest {
