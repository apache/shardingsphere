...
@ContextConfiguration("/META-INF/zookeeper/local/application-sharding-databases.xml")
public class SpringNamespaceLocalZookeeperShardingDatabasesTest extends SpringNamespaceBaseTest {
