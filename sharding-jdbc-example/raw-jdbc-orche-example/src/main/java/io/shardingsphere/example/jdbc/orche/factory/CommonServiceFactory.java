...
public class CommonServiceFactory {
    ...
    public static CommonService newInstance(final ShardingType shardingType, final RegistryCenterType registryCenterType, final boolean loadConfigFromRegCenter) throws SQLException {
        ...
        switch (shardingType) {
            case SHARDING_DATABASES:
                ...
                return createCommonService(exampleConfig);
            case SHARDING_DATABASES_RANGE:
                ...
                return createRangeCommonService(exampleConfig);
            ...
            case SHARDING_DATABASES_AND_TABLES_RANGE:
                exampleConfig = loadConfigFromRegCenter ? new CloudShardingDatabasesAndTablesConfiguration(registryCenterConfig) : new LocalShardingDatabasesAndTablesConfigurationRange(registryCenterConfig);
                return createRangeCommonService(exampleConfig);
            case MASTER_SLAVE:
    ...
    private static CommonService createCommonService(final ExampleConfiguration exampleConfiguration) throws SQLException {
    ...
    private static CommonService createRangeCommonService(final ExampleConfiguration exampleConfiguration) throws SQLException {
        DataSource dataSource = exampleConfiguration.getDataSource();
