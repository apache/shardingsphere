...
public class YamlCommonServiceFactory {
    ...
    public static CommonService newInstance(final ShardingType shardingType, final RegistryCenterType registryCenterType, final boolean loadConfigFromRegCenter) throws SQLException, IOException {
        String yamlFilePath;
        switch (shardingType) {
            case SHARDING_DATABASES:
                ...
                return createCommonService(YamlOrchestrationShardingDataSourceFactory.createDataSource(getFile(yamlFilePath)));
            ...
            case MASTER_SLAVE:
                ...
                return createCommonService(YamlOrchestrationMasterSlaveDataSourceFactory.createDataSource(getFile(yamlFilePath)));
