...
public class ZooKeeperShardingDatabasesConfiguration extends ZooKeeperExampleConfiguration {
    
    public ZooKeeperShardingDatabasesConfiguration(final boolean loadConfigFromRegCenter) {
