...
public class OrchestrationEtcdYamlMasterSlaveMain {
    ...
    public static void main(final String[] args) throws Exception {
        DataSource dataSource = YamlOrchestrationMasterSlaveDataSourceFactory.createDataSource(new File(
                OrchestrationEtcdYamlMasterSlaveMain.class.getResource("/META-INF/orche/etcd/yamlMasterSlaveByLocalConfig.yaml").getFile()));
//        DataSource dataSource = YamlOrchestrationMasterSlaveDataSourceFactory.createDataSource(new File(
//                OrchestrationEtcdYamlMasterSlaveMain.class.getResource("/META-INF/orche/etcd/yamlMasterSlaveByCloudConfig.yaml").getFile()));
