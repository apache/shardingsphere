...
public class ShardingOnlyWithDatabasesAndTables {
    ...
    private static File getYamlFile() {
        String path = LOAD_CONFIG_FROM_REG_CENTER ? "/META-INF/orche/zookeeper/cloud/sharding-databases-tables.yaml" : "/META-INF/orche/zookeeper/local/sharding-databases-tables.yaml";
