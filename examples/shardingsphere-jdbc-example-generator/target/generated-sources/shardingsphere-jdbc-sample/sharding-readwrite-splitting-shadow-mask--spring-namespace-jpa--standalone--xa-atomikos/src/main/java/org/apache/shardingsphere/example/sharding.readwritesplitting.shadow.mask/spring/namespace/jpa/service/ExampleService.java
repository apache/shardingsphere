...
package org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.service;

import org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.entity.Address;
import org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.entity.Order;
import org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.entity.OrderItem;
import org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.repository.AddressRepository;
import org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.repository.OrderItemRepository;
import org.apache.shardingsphere.example.sharding.readwritesplitting.shadow.mask.spring.namespace.jpa.repository.OrderRepository;
