...
package org.apache.shardingsphere.example.sharding.spring.boot.starter.jpa;

import org.apache.shardingsphere.example.sharding.spring.boot.starter.jpa.entity.Address;
import org.apache.shardingsphere.example.sharding.spring.boot.starter.jpa.entity.Order;
import org.apache.shardingsphere.example.sharding.spring.boot.starter.jpa.entity.OrderItem;
...
public final class MemoryLocalShardingSpringBootStarterJpaExampleService {
    ...
    public MemoryLocalShardingSpringBootStarterJpaExampleService(final OrderRepository orderRepository, final OrderItemRepository orderItemRepository, final AddressRepository addressRepository) {
