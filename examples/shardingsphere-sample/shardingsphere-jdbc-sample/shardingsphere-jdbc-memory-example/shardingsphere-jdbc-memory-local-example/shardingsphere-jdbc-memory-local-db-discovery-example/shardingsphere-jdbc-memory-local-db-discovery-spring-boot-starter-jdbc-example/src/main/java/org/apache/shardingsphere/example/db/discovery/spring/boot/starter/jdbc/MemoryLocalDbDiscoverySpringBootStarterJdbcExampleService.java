...
import org.apache.shardingsphere.example.db.discovery.spring.boot.starter.jdbc.entity.Address;
...
import org.apache.shardingsphere.example.db.discovery.spring.boot.starter.jdbc.repository.AddressRepository;
import org.apache.shardingsphere.example.db.discovery.spring.boot.starter.jdbc.repository.OrderItemRepository;
import org.apache.shardingsphere.example.db.discovery.spring.boot.starter.jdbc.repository.OrderRepository;
...
public final class MemoryLocalDbDiscoverySpringBootStarterJdbcExampleService {
    ...
    public MemoryLocalDbDiscoverySpringBootStarterJdbcExampleService(final DataSource dataSource) {
