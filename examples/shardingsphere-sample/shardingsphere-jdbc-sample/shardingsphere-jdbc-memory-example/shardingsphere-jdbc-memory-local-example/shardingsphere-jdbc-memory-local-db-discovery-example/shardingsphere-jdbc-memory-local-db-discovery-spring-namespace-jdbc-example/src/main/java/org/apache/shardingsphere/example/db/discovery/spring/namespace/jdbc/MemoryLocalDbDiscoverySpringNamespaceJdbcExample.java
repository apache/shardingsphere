...
public class MemoryLocalDbDiscoverySpringNamespaceJdbcExample {
    ...
    public static void main(final String[] args) throws SQLException {
        try (ConfigurableApplicationContext applicationContext = new ClassPathXmlApplicationContext("application.xml")) {
            MemoryLocalDbDiscoverySpringNamespaceJdbcExampleService exampleService = applicationContext.getBean(MemoryLocalDbDiscoverySpringNamespaceJdbcExampleService.class);
            exampleService.run();
        }
    }
}
