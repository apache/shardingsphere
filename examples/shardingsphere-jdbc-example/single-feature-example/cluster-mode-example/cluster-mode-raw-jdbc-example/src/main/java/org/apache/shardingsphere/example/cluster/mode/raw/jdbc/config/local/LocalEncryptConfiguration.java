...
public final class LocalEncryptConfiguration implements ExampleConfiguration {
    ...
    private EncryptTableRuleConfiguration createEncryptTableRuleConfiguration() {
        EncryptColumnRuleConfiguraEncryptDatabasesConfiguration.javation encryptColumnRuleConfig = new EncryptColumnRuleConfiguration("status", "status", "", "", "status_encryptor", "", null);
