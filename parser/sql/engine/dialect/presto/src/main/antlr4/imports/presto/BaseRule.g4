...
import Symbol, Keyword, PrestoKeyword, Literals;
...
rowFunciton
    ...
    | ROW LP_ columnDefinition (COMMA_ columnDefinition)* RP_
    ;
...
columnDefinition
    : column_name=identifier fieldDefinition?
    ;
...
dataType
    ...
    | dataTypeName = ROW LP_ columnDefinition (COMMA_ columnDefinition)* RP_
