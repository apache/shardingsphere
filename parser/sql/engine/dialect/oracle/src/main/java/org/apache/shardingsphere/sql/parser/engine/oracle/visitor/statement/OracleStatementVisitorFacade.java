...
import org.apache.shardingsphere.sql.parser.engine.oracle.visitor.statement.type.OracleDALStatementVisitor;
import org.apache.shardingsphere.sql.parser.engine.oracle.visitor.statement.type.OracleDCLStatementVisitor;
import org.apache.shardingsphere.sql.parser.engine.oracle.visitor.statement.type.OracleDDLStatementVisitor;
import org.apache.shardingsphere.sql.parser.engine.oracle.visitor.statement.type.OracleDMLStatementVisitor;
import org.apache.shardingsphere.sql.parser.engine.oracle.visitor.statement.type.OracleLCLStatementVisitor;
...
public final class OracleStatementVisitorFacade implements SQLStatementVisitorFacade {
    ...
    public Class<? extends LCLStatementVisitor> getLCLVisitorClass() {
        return OracleLCLStatementVisitor.class;
    }
