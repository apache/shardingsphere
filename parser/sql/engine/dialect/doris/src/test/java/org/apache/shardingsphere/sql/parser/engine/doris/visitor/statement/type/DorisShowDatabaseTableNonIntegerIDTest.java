...
class DorisShowDatabaseTableNonIntegerIDTest {
    
    @ParameterizedTest(name = "{0}")
    @ValueSource(strings = {"SHOW DATABASE 1.2", "SHOW DATABASE 1e2", "SHOW TABLE 1.2", "SHOW TABLE 1e2"})
    void assertNonIntegerIDRejected(final String sql) {
