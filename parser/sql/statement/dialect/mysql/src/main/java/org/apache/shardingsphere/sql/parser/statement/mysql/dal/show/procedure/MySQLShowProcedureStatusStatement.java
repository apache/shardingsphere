...
/**
 * Show procedure status statement for MySQL.
 */
@Getter
public final class MySQLShowProcedureStatusStatement extends DALStatement {
    
    private SQLStatementAttributes attributes;
    
    private final ShowFilterSegment filter;
    
    public MySQLShowProcedureStatusStatement(final DatabaseType databaseType, final ShowFilterSegment filter) {
        super(databaseType);
        this.filter = filter;
    }
