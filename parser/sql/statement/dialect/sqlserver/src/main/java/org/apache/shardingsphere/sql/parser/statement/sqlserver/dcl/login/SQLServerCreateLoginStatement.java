 ...
 */
@Getter
public final class SQLServerCreateLoginStatement extends DCLStatement {
    
    private final LoginSegment loginSegment;
    
    public SQLServerCreateLoginStatement(final DatabaseType databaseType, final LoginSegment loginSegment) {
        super(databaseType);
