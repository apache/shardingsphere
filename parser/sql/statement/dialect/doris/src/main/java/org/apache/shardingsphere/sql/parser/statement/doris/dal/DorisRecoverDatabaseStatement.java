...
/**
 * Recover database statement for Doris.
 */
@Getter
@Setter
public final class DorisRecoverDatabaseStatement extends DALStatement {
    
    private DatabaseSegment databaseName;
    
    private DatabaseIdSegment databaseId;
    
    private DatabaseSegment newDatabaseName;
    
    public DorisRecoverDatabaseStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
