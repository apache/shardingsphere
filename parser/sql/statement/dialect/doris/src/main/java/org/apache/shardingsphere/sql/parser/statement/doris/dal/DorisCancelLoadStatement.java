...
/**
 * Cancel load statement for Doris.
 */
@Getter
@Setter
public final class DorisCancelLoadStatement extends DALStatement {
    ...
    public DorisCancelLoadStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
