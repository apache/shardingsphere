...
/**
 * Load data statement for Doris.
 */
@Getter
@Setter
public final class DorisLoadDataStatement extends DMLStatement {
    
    private final boolean local;
    
    private final LiteralValueSegment fileName;
    ...
    public DorisLoadDataStatement(final DatabaseType databaseType, final boolean local, final LiteralValueSegment fileName, final SimpleTableSegment table) {
        super(databaseType);
        this.local = local;
