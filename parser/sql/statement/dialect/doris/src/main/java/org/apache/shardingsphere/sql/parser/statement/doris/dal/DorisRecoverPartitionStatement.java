...
/**
 * Recover partition statement for Doris.
 */
@Getter
@Setter
public final class DorisRecoverPartitionStatement extends DALStatement {
    ...
    public DorisRecoverPartitionStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
