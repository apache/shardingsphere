...
/**
 * Recover table statement for Doris.
 */
@Getter
@Setter
public final class DorisRecoverTableStatement extends DALStatement {
    
    private SimpleTableSegment tableName;
    
    private TableIdSegment tableId;
    
    private SimpleTableSegment newTableName;
    
    public DorisRecoverTableStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
