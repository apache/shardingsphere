...
/**
 * Show load warnings statement for Doris.
 */
@Getter
@Setter
public final class DorisShowLoadWarningsStatement extends DALStatement {
    ...
    public DorisShowLoadWarningsStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
     ...
     */
    public Optional<String> getConditionType() {
