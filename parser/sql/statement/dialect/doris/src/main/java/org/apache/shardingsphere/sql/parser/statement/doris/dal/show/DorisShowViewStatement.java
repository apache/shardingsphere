...
/**
 * Show view statement for Doris.
 */
@Getter
public final class DorisShowViewStatement extends DALStatement {
    
    private final FromTableSegment fromTable;
    
    private final DatabaseSegment database;
    
    public DorisShowViewStatement(final DatabaseType databaseType, final FromTableSegment fromTable, final DatabaseSegment database) {
        super(databaseType);
