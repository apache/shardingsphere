...
/**
 * Alter SQL block rule statement for Doris.
 */
@Getter
@Setter
public final class DorisAlterSqlBlockRuleStatement extends DALStatement {
    
    private String ruleName;
    
    private PropertiesSegment properties;
    
    public DorisAlterSqlBlockRuleStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
