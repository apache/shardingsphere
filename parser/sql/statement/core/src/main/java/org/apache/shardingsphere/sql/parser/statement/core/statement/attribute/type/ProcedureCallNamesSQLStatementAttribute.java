...
/**
 * Procedure call names SQL statement attribute.
 */
@RequiredArgsConstructor
@Getter
public final class ProcedureCallNamesSQLStatementAttribute implements SQLStatementAttribute {
    
    private final Collection<ProcedureCallNameSegment> procedureCallNames;
}
