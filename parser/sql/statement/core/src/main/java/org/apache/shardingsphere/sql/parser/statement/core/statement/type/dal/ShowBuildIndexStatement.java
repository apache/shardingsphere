...
/**
 * Show build index statement.
 */
@Getter
@Setter
public final class ShowBuildIndexStatement extends DALStatement {
    ...
    public ShowBuildIndexStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
