...
/**
 * MySQL statement option.
 */
public final class MySQLStatementOption implements DialectSQLStatementOption {
    
    @Override
    public boolean isShowColumns(final SQLStatement sqlStatement) {
        return sqlStatement instanceof MySQLExplainStatement || sqlStatement instanceof MySQLShowColumnsStatement;
    }
    
    @Override
    public boolean isShowCreateTable(final SQLStatement sqlStatement) {
        return sqlStatement instanceof MySQLShowCreateTableStatement;
    }
