...
public final class ColumnExtractor {
     ...
     */
    public static void extractFromSelectStatement(final Collection<ColumnSegment> columnSegments, final SimpleSelectStatement statement, final boolean containsSubQuery) {
     ...
     * @param containsSubQuery whether contains sub query
     */
    public static void extractFromSelectStatementWithoutProjection(final Collection<ColumnSegment> columnSegments, final SimpleSelectStatement statement, final boolean containsSubQuery) {
