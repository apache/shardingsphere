...
unreservedWord
    ...
    | LPAD | ZONE | SESSIONTIMEZONE | TO_CHAR | XMLELEMENT | COLUMN_VALUE | EVALNAME | LEVEL | CONTENT | ABS | ACCESS | ACCOUNT
    | ACOS | ACTIVE_COMPONENT | ACTIVE_FUNCTION | ACTIVE_TAG | ADD | ADD_COLUMN | ADD_GROUP | ADD_MONTHS | ADJ_DATE | ADMIN
    | ADMINISTRATOR | ALL | ALL_ROWS | ALTER | AND | AND_EQUAL | ANTIJOIN | APPEND | APPENDCHILDXML | APPEND_VALUES | AS | ASC
    | ASCII | ASCIISTR | ASIN | ASSEMBLY | ASYNC | ATAN | ATAN2 | AUDIT | AUTHENTICATION | AUTHORIZATION | BEGIN_OUTLINE_DATA
    | BEHALF | BETWEEN | BFILENAME | BINARY_DOUBLE_INFINITY | BINARY_DOUBLE_NAN | BINARY_FLOAT_INFINITY | BINARY_FLOAT_NAN
    | BIND_AWARE | BIN_TO_NUM | BITAND | BITMAPS | BITMAP_TREE | BITS | BLOCKS | BLOCK_RANGE | BOUND | BRANCH | BROADCAST
    | BUFFER | BULK | BY | BYPASS_RECURSIVE_CHECK | BYPASS_UJVC | BYTE | CACHE_CB | CACHE_INSTANCES | CACHE_TEMP_TABLE
    | CARDINALITY | CEIL | CERTIFICATE | CFILE | CHANGE_DUPKEY_ERROR_INDEX | CHAR | CHARTOROWID | CHAR_CS | CHECK
    | CHECK_ACL_REWRITE | CHOOSE | CHR | CLOSE_CACHED_OPEN_CURSORS | CLUSTER | CLUSTERING_FACTOR | CLUSTER_ID
    | CLUSTER_PROBABILITY | CLUSTER_SET | COALESCE_SQ | COLD | COLLECT | COLUMN | COLUMNAR | COLUMN_AUTH_INDICATOR
    | COLUMN_STATS | COMMENT | COMPLIANCE | COMPOSE | COMPOSITE | COMPOSITE_LIMIT | COMPOUND | COMPRESS | CONCAT | CONFORMING
    | CONNECT | CONNECT_BY_CB_WHR_ONLY | CONNECT_BY_COMBINE_SW | CONNECT_BY_COST_BASED | CONNECT_BY_ELIM_DUPS
    | CONNECT_BY_FILTERING | CONNECT_BY_ISCYCLE | CONNECT_BY_ISLEAF | CONNECT_BY_ROOT | CONST | CORR | CORRUPT_XID
    | CORRUPT_XID_ALL | CORR_K | CORR_S | COS | COSH | COST_XML_QUERY_REWRITE | COVAR_POP | COVAR_SAMP | CO_AUTH_IND
    | CPU_COSTING | CPU_PER_CALL | CRASH | CREATE | CREATE_STORED_OUTLINES | CROSSEDITION | CSCONVERT | CUBE_GB | CUME_DIST
    | CUME_DISTM | CURRENT | CURRENTV | CURRENT_DATE | CURRENT_SCHEMA | CURRENT_TIME | CURRENT_TIMESTAMP | CURSOR_SHARING_EXACT
    | CURSOR_SPECIFIC_SEGMENT | CV | DATABASE_DEFAULT | DATAOBJNO | DATAOBJ_TO_PARTITION | DATE | DATE_MODE | DBA
    | DBMS_STATS | DB_ROLE_CHANGE | DB_VERSION | DEBUGGER | DECIMAL | DECLARE | DECOMPOSE | DECR | DEFAULT | DEFAULTS | DEFINED
    | DEGREE | DELAY | DELETE | DELETEXML | DENSE_RANKM | DEQUEUE | DEREF | DEREF_NO_REWRITE | DESC | DETACHED | DIRECT_LOAD
    | DISABLE_PRESET | DISABLE_RPKE | DISTINCT | DISTINGUISHED | DML_UPDATE | DOCFIDELITY | DOCUMENT | DOMAIN_INDEX_FILTER
    | DOMAIN_INDEX_NO_SORT | DOMAIN_INDEX_SORT | DRIVING_SITE | DROP | DROP_COLUMN | DROP_GROUP | DST_UPGRADE_INSERT_CONV
    | DUMP | DYNAMIC | DYNAMIC_SAMPLING | DYNAMIC_SAMPLING_EST_CDN | EACH | EDITIONING | EDITIONS | ELIMINATE_JOIN
    | ELIMINATE_OBY | ELIMINATE_OUTER_JOIN | ELSE | EMPTY_BLOB | EMPTY_CLOB | ENABLE_PRESET | ENCODING | END_OUTLINE_DATA
    | ENFORCE | ENQUEUE | ENTERPRISE | ENTITYESCAPING | ENTRY | ERROR_ARGUMENT | ERROR_ON_OVERLAP_TIME | ESTIMATE | EVALUATION
    | EVENTS | EXCLUSIVE | EXISTS | EXISTSNODE | EXP | EXPAND_GSET_TO_UNION | EXPAND_TABLE | EXPIRE | EXPLAIN | EXPLOSION
    ...
    | FLAGGER | FLOAT | FLOB | FLOOR | FOLLOWS | FOR | FORCE_XML_QUERY_REWRITE | FOREVER | FORWARD | FROM | FROM_TZ
    | GATHER_PLAN_STATISTICS | GBY_CONC_ROLLUP | GBY_PUSHDOWN | GRANT | GREATEST | GROUP | GROUPING_ID | GROUP_BY | GROUP_ID
    | GUARANTEED | HASHKEYS | HASH_AJ | HASH_SJ | HAVING | HEADER | HELP | HEXTORAW | HEXTOREF | HIDE
    | HINTSET_BEGIN | HINTSET_END | HOT | HWM_BROKERED | HYBRID | IDENTIFIED | IDGENERATORS | IDLE_TIME
    | IGNORE_OPTIM_EMBEDDED_HINTS | IGNORE_ROW_ON_DUPKEY_INDEX | IGNORE_WHERE_CLAUSE | IMMEDIATE | IMPACT | IMPORT | IN
    | INCLUDE_VERSION | INCR | INCREMENT | INCREMENTAL | INDENT | INDEX | INDEXED | INDEX_ASC | INDEX_COMBINE | INDEX_DESC
    | INDEX_FFS | INDEX_FILTER | INDEX_JOIN | INDEX_ROWS | INDEX_RRS | INDEX_RS | INDEX_RS_ASC | INDEX_RS_DESC | INDEX_SCAN
    | INDEX_SKIP_SCAN | INDEX_SS | INDEX_SS_ASC | INDEX_SS_DESC | INDEX_STATS | INFORMATIONAL | INITCAP | INITIAL | INLINE
    | INLINE_XMLTYPE_NT | INSERT | INSERTCHILDXML | INSERTCHILDXMLAFTER | INSERTCHILDXMLBEFORE | INSERTXMLAFTER
    | INSERTXMLBEFORE | INSTANTIABLE | INSTANTLY | INSTEAD | INSTR | INSTR2 | INSTR4 | INSTRB | INSTRC | INTEGER | INTERMEDIATE
    | INTERNAL_CONVERT | INTERNAL_USE | INTERPRETED | INTERSECT | INTO | IN_MEMORY_METADATA | IN_XQUERY | IS | ISOLATION_LEVEL
    | ITERATION_NUMBER | KERBEROS | KEYSIZE | KEY_LENGTH | LAST_DAY | LAST_VALUE | LAYER | LDAP_REGISTRATION
    | LDAP_REGISTRATION_ENABLED | LDAP_REG_SYNC_INTERVAL | LEADING | LEAST | LENGTH2 | LENGTH4 | LENGTHB | LENGTHC | LIFE
    | LIFETIME | LIKE | LIKE_EXPAND | LISTAGG | LN | LNNVL | LOBNVL | LOCAL_INDEXES | LOCK | LOGICAL_READS_PER_CALL | LOGOFF
    | LOGON | LONG | LOWER | LTRIM | MAKE_REF | MAXARCHLOGS | MAXEXTENTS | MAXTRANS | MEDIAN | MERGE_AJ
    | MERGE_CONST_ON | MERGE_SJ | METHOD | MINIMIZE | MINUS | MINUS_NULL | MIRRORCOLD | MIRRORHOT | MLSLABEL | MODE
    | MODEL_COMPILE_SUBQUERY | MODEL_DONTVERIFY_UNIQUENESS | MODEL_DYNAMIC_SUBQUERY | MODEL_MIN_ANALYSIS | MODEL_NO_ANALYSIS
    | MODEL_PBY | MODEL_PUSH_REF | MODIFY | MONITOR | MONTHS_BETWEEN | MOUNTPATH | MULTISET | MV_MERGE | NAMED | NANVL | NATIVE
    | NATIVE_FULL_OUTER_JOIN | NCHAR_CS | NCHR | NEEDED | NESTED_TABLE_FAST_INSERT | NESTED_TABLE_GET_REFS | NESTED_TABLE_ID
    | NESTED_TABLE_SET_REFS | NESTED_TABLE_SET_SETID | NETWORK | NEVER | NEW_TIME | NEXT_DAY | NLJ_BATCHING | NLJ_INDEX_FILTER
    | NLJ_INDEX_SCAN | NLJ_PREFETCH | NLSSORT | NLS_CALENDAR | NLS_CHARACTERSET | NLS_CHARSET_DECL_LEN | NLS_CHARSET_ID
    | NLS_CHARSET_NAME | NLS_COMP | NLS_CURRENCY | NLS_DATE_FORMAT | NLS_DATE_LANGUAGE | NLS_INITCAP | NLS_ISO_CURRENCY
    | NLS_LANG | NLS_LANGUAGE | NLS_LENGTH_SEMANTICS | NLS_LOWER | NLS_NCHAR_CONV_EXCP | NLS_NUMERIC_CHARACTERS | NLS_SORT
    | NLS_SPECIAL_CHARS | NLS_TERRITORY | NLS_UPPER | NL_AJ | NL_SJ | NOAPPEND | NOAUDIT | NOCOMPRESS | NOCPU_COSTING
    | NOENTITYESCAPING | NOGUARANTEE | NOLOCAL | NOMINIMIZE | NOOVERRIDE | NOPARALLEL_INDEX | NOREPAIR | NOREVERSE | NOREWRITE
    | NOSCHEMACHECK | NOSEGMENT | NOSTRICT | NOT | NOWAIT | NO_ACCESS | NO_BASETABLE_MULTIMV_REWRITE | NO_BIND_AWARE
    | NO_BUFFER | NO_CARTESIAN | NO_CHECK_ACL_REWRITE | NO_COALESCE_SQ | NO_CONNECT_BY_CB_WHR_ONLY | NO_CONNECT_BY_COMBINE_SW
    | NO_CONNECT_BY_COST_BASED | NO_CONNECT_BY_ELIM_DUPS | NO_CONNECT_BY_FILTERING | NO_COST_XML_QUERY_REWRITE | NO_CPU_COSTING
    | NO_DOMAIN_INDEX_FILTER | NO_DST_UPGRADE_INSERT_CONV | NO_ELIMINATE_JOIN | NO_ELIMINATE_OBY | NO_ELIMINATE_OUTER_JOIN
    | NO_EXPAND | NO_EXPAND_GSET_TO_UNION | NO_EXPAND_TABLE | NO_FACT | NO_FACTORIZE_JOIN | NO_FILTERING | NO_GBY_PUSHDOWN
    | NO_INDEX | NO_INDEX_FFS | NO_INDEX_SS | NO_LOAD | NO_MERGE | NO_MODEL_PUSH_REF | NO_MONITOR | NO_MONITORING
    | NO_MULTIMV_REWRITE | NO_NATIVE_FULL_OUTER_JOIN | NO_NLJ_BATCHING | NO_NLJ_PREFETCH | NO_ORDER_ROLLUPS
    | NO_OUTER_JOIN_TO_INNER | NO_PARALLEL | NO_PARALLEL_INDEX | NO_PARTIAL_COMMIT | NO_PLACE_DISTINCT | NO_PLACE_GROUP_BY
    | NO_PQ_MAP | NO_PRUNE_GSETS | NO_PULL_PRED | NO_PUSH_PRED | NO_PUSH_SUBQ | NO_PX_JOIN_FILTER | NO_QKN_BUFF
    | NO_QUERY_TRANSFORMATION | NO_REF_CASCADE | NO_RESULT_CACHE | NO_REWRITE | NO_SEMIJOIN | NO_SET_TO_JOIN | NO_SQL_TUNE
    | NO_STAR_TRANSFORMATION | NO_STATEMENT_QUEUING | NO_STATS_GSETS | NO_SUBQUERY_PRUNING | NO_SUBSTRB_PAD
    | NO_SWAP_JOIN_INPUTS | NO_TEMP_TABLE | NO_TRANSFORM_DISTINCT_AGG | NO_UNNEST | NO_USE_HASH | NO_USE_HASH_AGGREGATION
    | NO_USE_INVISIBLE_INDEXES | NO_USE_MERGE | NO_USE_NL | NO_XMLINDEX_REWRITE | NO_XMLINDEX_REWRITE_IN_SELECT
    | NO_XML_DML_REWRITE | NO_XML_QUERY_REWRITE | NTH_VALUE | NTILE | NULL | NULLIF | NUMBER | NUMTODSINTERVAL
    | NUMTOYMINTERVAL | NUM_INDEX_KEYS | NVL | NVL2 | OBJECTTOXML | OBJNO | OBJNO_REUSE | OCCURENCES | OF | OFFLINE | OID
    | OLAP | OLD | OLD_PUSH_PRED | OLTP | ON | ONLINE | OPAQUE | OPAQUE_TRANSFORM | OPAQUE_XCANONICAL | OPCODE | OPERATIONS
    | OPTIMIZER_FEATURES_ENABLE | OPTIMIZER_GOAL | OPTION | OPT_ESTIMATE | OPT_PARAM | OR | ORADEBUG | ORA_BRANCH
    | ORA_CHECKACL | ORA_DST_AFFECTED | ORA_DST_CONVERT | ORA_DST_ERROR | ORA_GET_ACLIDS | ORA_GET_PRIVILEGES | ORA_HASH
    | ORA_ROWSCN | ORA_ROWSCN_RAW | ORA_ROWVERSION | ORA_TABVERSION | ORDER | ORDERED | ORDERED_PREDICATES | ORDINALITY
    | OR_EXPAND | OR_PREDICATES | OTHER | OUTER_JOIN_TO_INNER | OUTLINE_LEAF | OUT_OF_LINE | OVERFLOW_NOMOVE | OVERLAPS | OWN
    | OWNER | OWNERSHIP | PARALLEL_INDEX | PARAM | PARITY | PARTIALLY | PARTITION_HASH | PARTITION_LIST
    | PARTITION_RANGE | PASSWORD | PASSWORD_GRACE_TIME | PASSWORD_LIFE_TIME | PASSWORD_LOCK_TIME | PASSWORD_REUSE_MAX
    | PASSWORD_REUSE_TIME | PASSWORD_VERIFY_FUNCTION | PATH | PATHS | PBL_HS_BEGIN | PBL_HS_END | PCTFREE | PENDING
    | PERCENTILE_CONT | PERCENTILE_DISC | PERCENT_RANKM | PERMANENT | PERMISSION | PIKEY | PIV_GB | PIV_SSF | PLACE_DISTINCT
    | PLACE_GROUP_BY | PLAN | PLSCOPE_SETTINGS | PLSQL_CCFLAGS | PLSQL_CODE_TYPE | PLSQL_DEBUG | PLSQL_OPTIMIZE_LEVEL
    | PLSQL_WARNINGS | POWER | POWERMULTISET | POWERMULTISET_BY_CARDINALITY | PQ_DISTRIBUTE | PQ_MAP | PQ_NOMAP | PREBUILT
    | PRECEDES | PRECOMPUTE_SUBQUERY | PREDICATE_REORDERS | PREDICTION | PREDICTION_BOUNDS | PREDICTION_COST
    | PREDICTION_DETAILS | PREDICTION_PROBABILITY | PREDICTION_SET | PRESENTNNV | PRESENTV | PRESERVE_OID | PREVIOUS | PRIOR
    | PROJECT | PROPAGATE | PROTECTED | PULL_PRED | PUSH_PRED | PUSH_SUBQ | PX_GRANULE | PX_JOIN_FILTER | QB_NAME | QUERY_BLOCK
    | QUEUE | QUEUE_CURR | QUEUE_ROWP | RANDOM | RANDOM_LOCAL | RANKM | RAPIDLY | RATIO_TO_REPORT | RAW | RAWTOHEX | RAWTONHEX
    | RBA | RBO_OUTLINE | RDBA | RECORDS_PER_BLOCK | RECOVERABLE | REDUCED | REFERENCED | REFERENCING | REFTOHEX
    | REF_CASCADE_CURSOR | REGEXP_COUNT | REGEXP_INSTR | REGEXP_REPLACE | REGEXP_SUBSTR | REGR_AVGX | REGR_AVGY | REGR_COUNT
    | REGR_INTERCEPT | REGR_R2 | REGR_SLOPE | REGR_SXX | REGR_SXY | REGR_SYY | REMAINDER | REMOTE_MAPPED | RENAME | REPAIR
    | REQUIRED | RESOURCE | RESPECT | RESTORE_AS_INTERVALS | RESTRICT_ALL_REF_CONS | RETRY_ON_ROW_CHANGE | REVOKE
    | REWRITE_OR_ERROR | ROUND | ROW | ROWIDTOCHAR | ROWIDTONCHAR | ROWNUM | ROWS | ROW_LENGTH | RPAD | RTRIM | RULE
    | SAVE_AS_INTERVALS | SB4 | SCALE_ROWS | SCAN_INSTANCES | SCHEMACHECK | SCN_ASCENDING | SD_ALL | SD_INHIBIT | SD_SHOW
    | SECUREFILE_DBA | SECURITY | SEG_BLOCK | SEG_FILE | SELECT | SEMIJOIN | SEMIJOIN_DRIVER | SEQUENCED | SERVERERROR
    | SESSION | SESSIONS_PER_USER | SESSIONTZNAME | SESSION_CACHED_CURSORS | SET | SET_TO_JOIN | SEVERE | SHARE | SHOW | SIGN
    | SIGNAL_COMPONENT | SIGNAL_FUNCTION | SIMPLE | SIN | SINGLETASK | SINH | SIZE | SKIP_EXT_OPTIMIZER
    | SKIP_UNQ_UNUSABLE_IDX | SKIP_UNUSABLE_INDEXES | SMALLINT | SOUNDEX | SPLIT | SPREADSHEET | SQLLDR | SQL_TRACE | SQRT
    | STALE | STANDALONE | STANDBY_MAX_DATA_DELAY | STAR | START | STARTUP | STAR_TRANSFORMATION | STATEMENTS | STATEMENT_ID
    ...
    | SWAP_JOIN_INPUTS | SYNONYM | SYSASM | SYSDATE | SYSTEM_DEFINED | SYS_AUDIT | SYS_CHECKACL | SYS_CONNECT_BY_PATH
    | SYS_CONTEXT | SYS_DBURIGEN | SYS_DL_CURSOR | SYS_DM_RXFORM_CHR | SYS_DM_RXFORM_NUM | SYS_DOM_COMPARE | SYS_DST_PRIM2SEC
    ...
    | SYS_OP_DESCEND | SYS_OP_DISTINCT | SYS_OP_DRA | SYS_OP_DUMP | SYS_OP_EXTRACT | SYS_OP_GROUPING
    | SYS_OP_GUID | SYS_OP_IIX | SYS_OP_ITR | SYS_OP_LBID | SYS_OP_LOBLOC2BLOB | SYS_OP_LOBLOC2CLOB | SYS_OP_LOBLOC2ID
    | SYS_OP_LOBLOC2NCLOB | SYS_OP_LOBLOC2TYP | SYS_OP_LSVI | SYS_OP_LVL | SYS_OP_MAKEOID | SYS_OP_MAP_NONNULL | SYS_OP_MSR
    | SYS_OP_NICOMBINE | SYS_OP_NIEXTRACT | SYS_OP_NII | SYS_OP_NIX | SYS_OP_NOEXPAND | SYS_OP_NUMTORAW
    | SYS_OP_OIDVALUE | SYS_OP_OPNSIZE | SYS_OP_PAR | SYS_OP_PARGID | SYS_OP_PARGID_1 | SYS_OP_PAR_1 | SYS_OP_PIVOT
    | SYS_OP_R2O | SYS_OP_RAWTONUM | SYS_OP_RDTM | SYS_OP_REF | SYS_OP_RMTD | SYS_OP_ROWIDTOOBJ | SYS_OP_RPB | SYS_OP_TOSETID
    | SYS_OP_TPR | SYS_OP_TRTB | SYS_OP_UNDESCEND | SYS_OP_VECAND | SYS_OP_VECBIT | SYS_OP_VECOR | SYS_OP_VECXOR
    | SYS_OP_VERSION | SYS_OP_VREF | SYS_OP_VVD | SYS_OP_XPTHATG | SYS_OP_XPTHIDX | SYS_OP_XPTHOP | SYS_OP_XTXT2SQLT
    | SYS_ORDERKEY_DEPTH | SYS_ORDERKEY_MAXCHILD | SYS_ORDERKEY_PARENT | SYS_PARALLEL_TXN | SYS_PATHID_IS_ATTR
    | SYS_PATHID_IS_NMSPC | SYS_PATHID_LASTNAME | SYS_PATHID_LASTNMSPC | SYS_PATH_REVERSE | SYS_PXQEXTRACT | SYS_RID_ORDER
    | SYS_ROW_DELTA | SYS_SC_2_XMLT | SYS_SYNRCIREDO | SYS_TYPEID | SYS_UMAKEXML | SYS_XMLANALYZE | SYS_XMLCONTAINS
    | SYS_XMLCONV | SYS_XMLEXNSURI | SYS_XMLGEN | SYS_XMLI_LOC_ISNODE | SYS_XMLI_LOC_ISTEXT | SYS_XMLLOCATOR_GETSVAL
    | SYS_XMLNODEID | SYS_XMLNODEID_GETCID | SYS_XMLNODEID_GETLOCATOR | SYS_XMLNODEID_GETOKEY | SYS_XMLNODEID_GETPATHID
    | SYS_XMLNODEID_GETPTRID | SYS_XMLNODEID_GETRID | SYS_XMLNODEID_GETSVAL | SYS_XMLNODEID_GETTID | SYS_XMLTRANSLATE
    | SYS_XMLTYPE2SQL | SYS_XMLT_2_SC | SYS_XQBASEURI | SYS_XQCASTABLEERRH | SYS_XQCODEP2STR | SYS_XQCODEPEQ | SYS_XQCON2SEQ
    | SYS_XQCONCAT | SYS_XQDELETE | SYS_XQDFLTCOLATION | SYS_XQDOC | SYS_XQDOCURI | SYS_XQED4URI | SYS_XQENDSWITH | SYS_XQERR
    | SYS_XQERRH | SYS_XQESHTMLURI | SYS_XQEXLOBVAL | SYS_XQEXSTWRP | SYS_XQEXTRACT | SYS_XQEXTRREF | SYS_XQEXVAL
    | SYS_XQFB2STR | SYS_XQFNBOOL | SYS_XQFNCMP | SYS_XQFNDATIM | SYS_XQFNLNAME | SYS_XQFNNM | SYS_XQFNNSURI
    | SYS_XQFNPREDTRUTH | SYS_XQFNQNM | SYS_XQFNROOT | SYS_XQFORMATNUM | SYS_XQFTCONTAIN | SYS_XQFUNCR | SYS_XQGETCONTENT
    | SYS_XQINDXOF | SYS_XQINSERT | SYS_XQINSPFX | SYS_XQIRI2URI | SYS_XQLANG | SYS_XQLLNMFRMQNM | SYS_XQMKNODEREF
    | SYS_XQNILLED | SYS_XQNODENAME | SYS_XQNORMSPACE | SYS_XQNORMUCODE | SYS_XQNSP4PFX | SYS_XQNSPFRMQNM | SYS_XQPFXFRMQNM
    | SYS_XQPOLYABS | SYS_XQPOLYADD | SYS_XQPOLYCEL | SYS_XQPOLYCST | SYS_XQPOLYCSTBL | SYS_XQPOLYDIV | SYS_XQPOLYFLR
    | SYS_XQPOLYMOD | SYS_XQPOLYMUL | SYS_XQPOLYRND | SYS_XQPOLYSQRT | SYS_XQPOLYSUB | SYS_XQPOLYUMUS | SYS_XQPOLYUPLS
    | SYS_XQPOLYVEQ | SYS_XQPOLYVGE | SYS_XQPOLYVGT | SYS_XQPOLYVLE | SYS_XQPOLYVLT | SYS_XQPOLYVNE | SYS_XQREF2VAL
    | SYS_XQRENAME | SYS_XQREPLACE | SYS_XQRESVURI | SYS_XQRNDHALF2EVN | SYS_XQRSLVQNM | SYS_XQRYENVPGET | SYS_XQRYVARGET
    | SYS_XQRYWRP | SYS_XQSEQ2CON | SYS_XQSEQ2CON4XC | SYS_XQSEQDEEPEQ | SYS_XQSEQINSB | SYS_XQSEQRM | SYS_XQSEQRVS
    | SYS_XQSEQSUB | SYS_XQSEQTYPMATCH | SYS_XQSTARTSWITH | SYS_XQSTATBURI | SYS_XQSTR2CODEP | SYS_XQSTRJOIN | SYS_XQSUBSTRAFT
    | SYS_XQSUBSTRBEF | SYS_XQTOKENIZE | SYS_XQTREATAS | SYS_XQXFORM | SYS_XQ_ASQLCNV | SYS_XQ_ATOMCNVCHK | SYS_XQ_NRNG
    | SYS_XQ_PKSQL2XML | SYS_XQ_UPKXML2SQL | TABLE | TABLESPACE_NO | TABLE_STATS | TABNO | TAN | TANH
    | TEMP_TABLE | THE | THEN | THROUGH | TIMES | TIMEZONE_ABBR | TIMEZONE_HOUR | TIMEZONE_MINUTE | TIMEZONE_OFFSET
    | TIMEZONE_REGION | TIV_GB | TIV_SSF | TO | TOPLEVEL | TO_BINARY_DOUBLE | TO_BINARY_FLOAT | TO_BLOB | TO_CLOB | TO_DATE
    | TO_DSINTERVAL | TO_LOB | TO_MULTI_BYTE | TO_NCHAR | TO_NCLOB | TO_NUMBER | TO_SINGLE_BYTE | TO_TIME | TO_TIMESTAMP
    | TO_TIMESTAMP_TZ | TO_TIME_TZ | TO_YMINTERVAL | TRACING | TRAILING | TRANSFORM_DISTINCT_AGG | TRANSITION | TRANSITIONAL
    | TRIGGER | TRUNC | TX | TZ_OFFSET | UB2 | UBA | UID | UNBOUND | UNION | UNIQUE | UNISTR | UNLOCK | UNNEST | UNPACKED
    | UNRESTRICTED | UPDATABLE | UPDATE | UPDATEXML | UPD_INDEXES | UPD_JOININDEX | UPPER | USER | USERENV | USERGROUP
    | USER_DEFINED | USER_RECYCLEBIN | USE_ANTI | USE_CONCAT | USE_HASH | USE_HASH_AGGREGATION | USE_INVISIBLE_INDEXES
    | USE_MERGE | USE_MERGE_CARTESIAN | USE_NL | USE_NL_WITH_INDEX | USE_PRIVATE_OUTLINES | USE_SEMI | USE_TTT_FOR_GSETS
    | USE_WEAK_NAME_RESL | VALIDATE | VALIDATION | VALUES | VARCHAR | VARCHAR2 | VARIANCE | VAR_POP | VAR_SAMP | VECTOR_READ
    | VECTOR_READ_TRACE | VERSIONING | VERSIONS_ENDSCN | VERSIONS_ENDTIME | VERSIONS_OPERATION | VERSIONS_STARTSCN
    | VERSIONS_STARTTIME | VERSIONS_XID | VIEW | VOLUME | VSIZE | WELLFORMED | WHENEVER | WHERE | WHITESPACE | WIDTH_BUCKET
    | WITH | WRAPPED | XID | XMLATTRIBUTES | XMLCAST | XMLCDATA | XMLCOLATTVAL | XMLCOMMENT | XMLCONCAT | XMLDIFF | XMLEXISTS
    | XMLEXISTS2 | XMLFOREST | XMLINDEX_REWRITE | XMLINDEX_REWRITE_IN_SELECT | XMLINDEX_SEL_IDX_TBL | XMLISNODE | XMLISVALID
    | XMLNAMESPACES | XMLPARSE | XMLPATCH | XMLPI | XMLQUERY | XMLROOT | XMLSERIALIZE | XMLTABLE | XMLTOOBJECT | XMLTRANSFORM
    | XMLTRANSFORMBLOB | XML_DML_RWT_STMT | XPATHTABLE | XS_SYS_CONTEXT | X_DYN_PRUNE
    ;
