...
public abstract class SQLServerStatementVisitor extends SQLServerStatementBaseVisitor<ASTNode> {
    ...
    public ASTNode visitCreateTableAsSelectClause(final CreateTableAsSelectClauseContext ctx) {
        ...
        if (null != ctx.createTableAsSelect()) {
            ...
            result.setSimpleSelectStatement((SQLServerGenericSelectStatement) visit(ctx.createTableAsSelect().select()));
            ...
            result.setSimpleSelectStatement((SQLServerGenericSelectStatement) visit(ctx.createRemoteTableAsSelect().select()));
        }
        return result;
    }
