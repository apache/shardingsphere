...
unreservedWord
    ...
    | STDIFFERENCE | STINTERSECTION | STUNION | STBUFFER | STDISJOINT | STDISTANCE | STENDPOINT | STEQUALS | STGEOMETRYN | STGEOMETRYTYPE | STISEMPTY | STISVALID | STWITHIN | TOSTRING | STGEOMFROMTEXT | STGEOMFROMWKB
    ;
...
variableMethodCall
    : variableName (DOT_ methodName LP_ (expr (COMMA_ expr)*)? RP_)*
    ;
