 ...
 * @author zhangliang 
 */
public abstract class AbstractSoftTransactionManager {
    ...
    protected final void beginInternal(final Connection connection, final SoftTransactionType type) throws SQLException {
