...
@Getter
@Setter
public final class NestedBestEffortsDeliveryJobConfiguration {
     ...
     * 作业的命名空间.
     */
    private String jobNamespace = "Nested-Best-Efforts-Delivery-Job";
     ...
     * 内嵌的最大努力送达型异步作业名称.
     */
    private String jobName = String.format("nestedBestEffortsDeliveryJob_%s", System.nanoTime());
