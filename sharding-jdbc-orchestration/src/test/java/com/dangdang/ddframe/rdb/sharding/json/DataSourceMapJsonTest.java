...
public final class DataSourceMapJsonTest {
    
    @Test
    public void assertToJson() {
        assertThat(DataSourceMapJson.toJson(createDataSourceMap()), is(
                "[{\"name\":\"ds_jdbc_1\",\"class\":\"org.apache.commons.dbcp.BasicDataSource\",\"maxIdle\":\"8\",\"testOnBorrow\":\"true\","
                        ...
                        + "{\"name\":\"ds_jdbc_0\",\"class\":\"org.apache.commons.dbcp.BasicDataSource\",\"maxIdle\":\"8\",\"testOnBorrow\":\"true\",\"defaultTransactionIsolation\":\"-1\","
