...
import io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestComplexKeysShardingAlgorithm;
import io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestHintShardingAlgorithm;
import io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestPreciseShardingAlgorithm;
import io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestRangeShardingAlgorithm;
...
public final class ShardingRuleConfigurationConverterTest {
    ...
    private String getJsonForStandardStrategy() {
        return commonShardingRuleConfigJson
                ...
                + "\"preciseAlgorithmClassName\":\"io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestPreciseShardingAlgorithm\","
                + "\"rangeAlgorithmClassName\":\"io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestRangeShardingAlgorithm\"}"
    ...
    private String getJsonForComplexStrategy() {
        return commonShardingRuleConfigJson + "\"defaultTableShardingStrategyConfig\":{\"type\":\"COMPLEX\",\"shardingColumns\":\"order_id,item_id\","
                + "\"algorithmClassName\":\"io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestComplexKeysShardingAlgorithm\"}"
                + defaultKeyGenerator + masterSlaveRuleConfigJson;
    }
    ...
    private String getJsonForHintStrategy() {
        return commonShardingRuleConfigJson + "\"defaultTableShardingStrategyConfig\":{\"type\":\"HINT\","
                + "\"algorithmClassName\":\"io.shardingsphere.jdbc.orchestration.internal.json.fixture.TestHintShardingAlgorithm\"}" + defaultKeyGenerator + masterSlaveRuleConfigJson;
    }
