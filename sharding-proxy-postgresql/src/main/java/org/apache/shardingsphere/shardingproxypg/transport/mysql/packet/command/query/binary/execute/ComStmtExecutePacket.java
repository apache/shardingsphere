...
import org.apache.shardingsphere.shardingproxypg.transport.mysql.constant.NewParametersBoundFlag;
...
import org.apache.shardingsphere.shardingproxypg.transport.mysql.packet.command.query.binary.BinaryStatementParameterType;
import org.apache.shardingsphere.shardingproxypg.transport.mysql.packet.command.query.binary.BinaryStatementRegistry;
import org.apache.shardingsphere.shardingproxypg.transport.mysql.packet.command.query.binary.execute.protocol.BinaryProtocolValue;
...
public final class ComStmtExecutePacket implements QueryCommandPacket {
    ...
    public ComStmtExecutePacket(final int sequenceId, final MySQLPacketPayload payload, final BackendConnection backendConnection) throws SQLException {
        ...
        databaseCommunicationEngine = DatabaseCommunicationEngineFactory.getInstance().newBinaryProtocolInstance(
                backendConnection.getLogicSchema(), sequenceId, binaryStatement.getSql(), parameters, backendConnection, DatabaseType.PostgreSQL);
    }
