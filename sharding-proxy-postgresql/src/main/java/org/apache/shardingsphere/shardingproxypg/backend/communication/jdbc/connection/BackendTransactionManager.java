...
package org.apache.shardingsphere.shardingproxypg.backend.communication.jdbc.connection;
...
public final class BackendTransactionManager implements TransactionManager {
    ...
    public BackendTransactionManager(final BackendConnection backendConnection) {
        ...
        shardingTransactionManager = GlobalRegistry.getInstance().getShardingTransactionManagerEngine().getTransactionManager(transactionType);
    }
