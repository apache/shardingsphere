...
if "%PORT%"=="" (
set MAIN_CLASS=org.apache.shardingsphere.shardingproxypg.Bootstrap
) else ( if "%CONFIG%"=="" (
    set MAIN_CLASS=org.apache.shardingsphere.shardingproxypg.Bootstrap %PORT%
    echo The port is configured as %PORT%
    ) else (
    set MAIN_CLASS=org.apache.shardingsphere.shardingproxypg.Bootstrap %PORT% %CONFIG%
    echo The port is configured as %PORT%
