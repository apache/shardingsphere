...
public final class MetaDataContextsTest {
    ...
    public void assertGetDefaultMetaData() {
        ...
        assertThat(new MetaDataContexts(mock(MetaDataPersistService.class), metaData, mock(OptimizerContext.class)).getMetaData().get(DefaultDatabase.LOGIC_NAME), is(database));
    }
}
