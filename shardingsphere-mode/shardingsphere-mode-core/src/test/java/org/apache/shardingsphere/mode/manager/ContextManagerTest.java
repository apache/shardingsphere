...
public final class ContextManagerTest {
    ...
    public void assertGetDataSourceMap() {
        ...
        when(metaDataContexts.getMetaData(DefaultDatabase.LOGIC_NAME)).thenReturn(
                new ShardingSphereMetaData(mock(DatabaseType.class), resource, mock(ShardingSphereRuleMetaData.class), new ShardingSphereDatabase(DefaultDatabase.LOGIC_NAME, Collections.emptyMap())));
    ...
    public void assertAddResource() throws SQLException {
        ...
        when(metaDataContexts.getMetaDataMap()).thenReturn(new HashMap<>(Collections.singletonMap("foo_db", new ShardingSphereMetaData(new MySQLDatabaseType(), resource, 
                new ShardingSphereRuleMetaData(new LinkedList<>(), new LinkedList<>()), new ShardingSphereDatabase(DefaultDatabase.LOGIC_NAME, Collections.emptyMap())))));
    ...
    private ShardingSphereMetaData createOriginalMetaData() {
        ...
        return new ShardingSphereMetaData(new MySQLDatabaseType(), resource, ruleMetaData, new ShardingSphereDatabase(DefaultDatabase.LOGIC_NAME, Collections.emptyMap()));
    }
    ...
    public void assertAlterRuleConfiguration() {
        ...
        when(metaDataContexts.getMetaDataMap()).thenReturn(Collections.singletonMap("foo_db",
                new ShardingSphereMetaData(new MySQLDatabaseType(), resource, mock(ShardingSphereRuleMetaData.class), new ShardingSphereDatabase(DefaultDatabase.LOGIC_NAME, Collections.emptyMap()))));
    ...
    public void assertAlterDataSourceConfiguration() {
        ShardingSphereMetaData originalMetaData = new ShardingSphereMetaData(new MySQLDatabaseType(), 
                createOriginalResource(), createOriginalRuleMetaData(), new ShardingSphereDatabase(DefaultDatabase.LOGIC_NAME, Collections.emptyMap()));
