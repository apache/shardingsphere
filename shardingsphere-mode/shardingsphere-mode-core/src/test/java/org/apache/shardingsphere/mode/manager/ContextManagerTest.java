...
public final class ContextManagerTest {
    ...
    public void assertAddSchema() {
        ...
        assertTrue(contextManager.getMetaDataContexts().getMetaData().getDatabase("foo_db").getSchemas().containsKey("bar_schema"));
    ...
    public void assertUpdateResources() throws SQLException {
        ...
        when(metaDataContexts.getMetaData()).thenReturn(new ShardingSphereMetaData(originalDatabases, mock(ShardingSphereRuleMetaData.class), new ConfigurationProperties(new Properties())));
