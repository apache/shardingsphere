...
/**
 * Reentrant lock implemented ShardingSphereLock.
 */
@RequiredArgsConstructor
public final class ShardingSphereReentrantLock implements ShardingSphereLock {
    ...
    private synchronized boolean innerTryLock(final long timeout) {
        try {
            return innerLock.tryLock(timeout, TimeUnit.MILLISECONDS);
