...
public final class DatabaseLockChangedWatcherTest {
    ...
    public void assertLocksCreateGovernanceEvent() {
        ...
        assertThat(((DatabaseLockedEvent) addGovernanceEvent.get()).getLockDefinition().getDatabaseName(), is("sharding_db"));
        ...
        assertThat(((DatabaseLockReleasedEvent) deleteGovernanceEvent.get()).getLockDefinition().getDatabaseName(), is("sharding_db"));
    ...
    public void assertLocksAckCreateGovernanceEvent() {
        ...
        assertThat(((DatabaseAckLockedEvent) addGovernanceEvent.get()).getLockDefinition().getDatabaseName(), is("sharding_db"));
        ...
        assertThat(((DatabaseAckLockReleasedEvent) deleteGovernanceEvent.get()).getLockDefinition().getDatabaseName(), is("sharding_db"));
