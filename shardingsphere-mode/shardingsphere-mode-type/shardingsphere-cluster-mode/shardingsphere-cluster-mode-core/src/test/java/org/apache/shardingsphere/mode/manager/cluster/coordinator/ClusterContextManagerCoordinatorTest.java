...
public final class ClusterContextManagerCoordinatorTest {
    ...
    private ContextManagerBuilderParameter createContextManagerBuilderParameter() {
        ...
        InstanceDefinition instanceDefinition = new ServerInstanceDefinition("foo_instance_id", "Proxy", 3307);
    ...
    public void assertRenewInstanceOfflineEvent() {
        ...
        assertThat(((ServerInstanceDefinition) contextManager.getInstanceContext().getInstance().getInstanceDefinition()).getPort(), is(3307));
    }
    ...
    public void assertRenewInstanceOnlineEvent() {
        InstanceDefinition instanceDefinition1 = new ServerInstanceDefinition("foo_instance_3307", "Proxy", 3307);
        ...
        InstanceDefinition instanceDefinition2 = new ServerInstanceDefinition("foo_instance_3308", "Proxy", 3308);
