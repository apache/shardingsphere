...
public final class MySQLErrPacketTest {
    ...
    public void assertNewErrPacketWithServerErrorCode() {
        MySQLErrPacket actual = new MySQLErrPacket(1, MyVendorError.ER_ACCESS_DENIED_ERROR, "root", "localhost", "root");
        assertThat(actual.getSequenceId(), is(1));
        assertThat(actual.getErrorCode(), is(MyVendorError.ER_ACCESS_DENIED_ERROR.getVendorCode()));
        assertThat(actual.getSqlState(), is(MyVendorError.ER_ACCESS_DENIED_ERROR.getSqlState().getValue()));
        assertThat(actual.getErrorMessage(), is(String.format(MyVendorError.ER_ACCESS_DENIED_ERROR.getReason(), "root", "localhost", "root")));
    }
    ...
    public void assertNewErrPacketWithPayload() {
        ...
        when(payload.readStringEOF()).thenReturn(String.format(MyVendorError.ER_ACCESS_DENIED_ERROR.getReason(), "root", "localhost", "root"));
