...
public final class PostgreSQLUnsupportedCommandPacketTest {
    ...
    public void assertWrite() {
        PostgreSQLUnsupportedCommandPacket rowPacket = new PostgreSQLUnsupportedCommandPacket(PostgreSQLIdentifierTagType.AUTHENTICATION_REQUEST.getValue());
    ...
    public void assertGetMessageType() {
        PostgreSQLUnsupportedCommandPacket rowPacket = new PostgreSQLUnsupportedCommandPacket(PostgreSQLIdentifierTagType.AUTHENTICATION_REQUEST.getValue());
        assertThat(rowPacket.getIdentifier(), is(PostgreSQLIdentifierTagType.AUTHENTICATION_REQUEST.getValue()));
    }
}
