...
import org.apache.shardingsphere.shardingproxy.transport.postgresql.PostgreSQLPacket;
...
public final class PostgreSQLPacketCodec extends PacketCodec<PostgreSQLPacket> {
    ...
    protected boolean isValidHeader(final int readableBytes) {
        return readableBytes > PostgreSQLPacket.PAYLOAD_LENGTH + PostgreSQLPacket.MESSAGE_TYPE_LENGTH;
    }
