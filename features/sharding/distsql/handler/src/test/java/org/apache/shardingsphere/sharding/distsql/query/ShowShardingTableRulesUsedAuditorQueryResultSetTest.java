...
public final class ShowShardingTableRulesUsedAuditorQueryResultSetTest {
    ...
    public void assertGetRowData() {
        ...
        DatabaseDistSQLResultSet resultSet = new ShardingTableRulesUsedAuditorQueryResultSet();
