...
class ShardingTableRuleStatementConverterTest {
    ...
    private Collection<AbstractTableRuleSegment> createTableRuleSegment1() {
        ...
        AutoTableRuleSegment autoTableRuleSegment2 = new AutoTableRuleSegment("t_order_2", Arrays.asList("ds0", "ds1"),
                new KeyGenerateStrategySegment("order_id", new AlgorithmSegment("snowflake", new Properties())),
                new AuditStrategySegment(Collections.singleton(new ShardingAuditorSegment("sharding_key_required_auditor", new AlgorithmSegment("DML_SHARDING_CONDITIONS", new Properties()))), true));
