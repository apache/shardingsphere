 ...
 */
public final class ShowShardingAuditorsStatement extends ShowDatabaseRulesStatement {
    
    public ShowShardingAuditorsStatement(final FromDatabaseSegment fromDatabase) {
        super(fromDatabase);
    }
}
