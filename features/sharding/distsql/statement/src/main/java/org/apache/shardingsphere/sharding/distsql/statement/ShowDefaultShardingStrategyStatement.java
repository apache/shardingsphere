 ...
 */
public final class ShowDefaultShardingStrategyStatement extends ShowDatabaseRulesStatement {
    
    public ShowDefaultShardingStrategyStatement(final FromDatabaseSegment fromDatabase) {
        super(fromDatabase);
    }
}
