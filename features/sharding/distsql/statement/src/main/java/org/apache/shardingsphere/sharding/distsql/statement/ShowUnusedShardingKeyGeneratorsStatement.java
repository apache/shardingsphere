 ...
 */
public final class ShowUnusedShardingKeyGeneratorsStatement extends ShowDatabaseRulesStatement {
    
    public ShowUnusedShardingKeyGeneratorsStatement(final FromDatabaseSegment fromDatabase) {
        super(fromDatabase);
    }
}
