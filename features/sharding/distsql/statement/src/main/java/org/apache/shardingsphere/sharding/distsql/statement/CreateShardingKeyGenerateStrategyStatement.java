...
public final class CreateShardingKeyGenerateStrategyStatement extends CreateRuleStatement {
    ...
    public CreateShardingKeyGenerateStrategyStatement(final boolean ifNotExists, final String name, final AbstractKeyGenerateStrategyDefinitionSegment keyGenerateStrategySegment) {
        super(ifNotExists);
        this.name = name;
