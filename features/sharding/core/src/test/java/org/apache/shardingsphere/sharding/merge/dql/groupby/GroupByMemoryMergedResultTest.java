...
public final class GroupByMemoryMergedResultTest {
    ...
    public void assertNextForResultSetsAllEmpty() throws SQLException {
        ...
        ShardingDQLResultMerger resultMerger = new ShardingDQLResultMerger(TypedSPIRegistry.getService(DatabaseType.class, "MySQL"));
    ...
    public void assertNextForDistinctShorthandResultSetsEmpty() throws SQLException {
        ...
        ShardingDQLResultMerger merger = new ShardingDQLResultMerger(TypedSPIRegistry.getService(DatabaseType.class, "MySQL"));
