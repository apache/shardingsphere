...
class YamlKeyGenerateStrategyConfigurationSwapperTest {
    ...
    void assertSwapToYamlConfiguration() {
        KeyGenerateStrategyConfiguration data = new KeyGenerateStrategyConfiguration("id", "default");
        YamlKeyGenerateStrategyConfigurationSwapper swapper = new YamlKeyGenerateStrategyConfigurationSwapper();
        YamlKeyGenerateStrategyConfiguration actual = swapper.swapToYamlConfiguration(data);
    ...
    void assertSwapToObject() {
        ...
        YamlKeyGenerateStrategyConfigurationSwapper swapper = new YamlKeyGenerateStrategyConfigurationSwapper();
        KeyGenerateStrategyConfiguration actual = swapper.swapToObject(yamlConfig);
        assertThat(actual.getColumn(), is("id"));
        assertThat(actual.getKeyGeneratorName(), is("default"));
    }
}
