...
class ShardingAlterIndexSupportedCheckerTest {
    ...
    void assertCheckWhenIndexExistRenameIndexNotExistForPostgreSQL() {
        ...
        assertDoesNotThrow(() -> new ShardingAlterIndexSupportedChecker().check(shardingRule, database, mock(ShardingSphereSchema.class),
    ...
    void assertCheckAlterIndexWhenIndexExistRenameIndexExistForPostgreSQL() {
        ...
        assertThrows(DuplicateIndexException.class, () -> new ShardingAlterIndexSupportedChecker().check(shardingRule, database, mock(ShardingSphereSchema.class),
                new AlterIndexStatementContext(sqlStatement, DefaultDatabase.LOGIC_NAME)));
    }
}
