...
class ShardingAlgorithmChangedProcessorTest {
    ...
    void assertChangeRuleItemConfiguration() {
        ...
        assertThat(currentRuleConfig.getShardingAlgorithms().get("foo_algo").getType(), is("FOO_FIXTURE"));
        assertThat(currentRuleConfig.getShardingAlgorithms().get("bar_algo").getType(), is("BAR_FIXTURE"));
    }
    ...
    private ShardingRuleConfiguration createCurrentRuleConfiguration() {
        ...
        result.getShardingAlgorithms().put("foo_algo", new AlgorithmConfiguration("FOO_FIXTURE", new Properties()));
        return result;
    }
}
