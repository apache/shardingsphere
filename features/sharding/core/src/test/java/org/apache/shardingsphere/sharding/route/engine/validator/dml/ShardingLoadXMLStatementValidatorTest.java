...
class ShardingLoadXMLStatementValidatorTest {
    ...
    void assertPreValidateLoadXMLWithSingleTable() {
        ...
        assertDoesNotThrow(() -> new ShardingLoadXMLStatementValidator().preValidate(shardingRule, new LoadXMLStatementContext(sqlStatement, DefaultDatabase.LOGIC_NAME), mock(HintValueContext.class),
    ...
    void assertPreValidateLoadXMLWithShardingTable() {
        ...
        assertThrows(UnsupportedShardingOperationException.class,
                () -> new ShardingLoadXMLStatementValidator().preValidate(shardingRule, new LoadXMLStatementContext(sqlStatement, DefaultDatabase.LOGIC_NAME), mock(HintValueContext.class),
