...
class ShardingParameterRewritersProviderTest {
    ...
    void assertGetParameterRewriters() {
        ...
        Collection<ParameterRewriter> actual = new ShardingParameterRewritersProvider(mock(RouteContext.class), statementContext).getParameterRewriters();
