...
class SnowflakeKeyGenerateAlgorithmTest {
    ...
    @Test
    void assertMaxTolerateTimeDifferenceMillisecondsWhenOutOfRange() {
        assertThrows(KeyGenerateAlgorithmInitializationException.class,
                () -> TypedSPILoader.getService(KeyGenerateAlgorithm.class, "SNOWFLAKE", PropertiesBuilder.build(new Property("max-tolerate-time-difference-milliseconds", "0"))).generateKey());
    }
}
