...
class CachedShardingSQLRouterTest {
    ...
    @Mock
    private ShardingCache shardingCacheRule;
    
    @Test
    void assertCreateRouteContextWithSQLExceedMaxAllowedLength() {
        when(shardingCacheRule.getConfiguration()).thenReturn(new ShardingCacheConfiguration(1, null));
        QueryContext queryContext = new QueryContext(null, "select 1", Collections.emptyList());
        RouteContext actual = new CachedShardingSQLRouter().createRouteContext(null, queryContext, mock(ShardingSphereRuleMetaData.class), null, shardingCacheRule, null, null);
    ...
    void assertCreateRouteContextWithNotCacheableQuery() {
        ...
        when(shardingCacheRule.getConfiguration()).thenReturn(new ShardingCacheConfiguration(100, null));
    ...
    void assertCreateRouteContextWithCacheableQueryButCacheMissed() {
        ...
        RouteContext actual = new CachedShardingSQLRouter().createRouteContext(router, queryContext, mock(ShardingSphereRuleMetaData.class), null, shardingCacheRule, null, null);
    ...
    void assertCreateRouteContextWithQueryRoutedToMultiDataNodes() {
        ...
        RouteContext actual = new CachedShardingSQLRouter().createRouteContext(router, queryContext, globalRuleMetaData, null, shardingCacheRule, null, null);
        assertThat(actual, is(expected));
