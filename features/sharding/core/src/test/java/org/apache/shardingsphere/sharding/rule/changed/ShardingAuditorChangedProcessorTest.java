...
class ShardingAuditorChangedProcessorTest {
    ...
    void assertChangeRuleItemConfiguration() {
        ...
        currentRuleConfig.setAuditors(new HashMap<>(Collections.singletonMap("foo_algo", mock(AlgorithmConfiguration.class))));
        ...
        assertThat(currentRuleConfig.getAuditors().get("foo_algo").getType(), is("FIXTURE"));
    }
