...
public final class ConditionValueBetweenOperatorGenerator implements ConditionValueGenerator<BetweenExpression> {
    ...
    @Override
    public Optional<ShardingConditionValue> generate(final BetweenExpression predicate, final QualifiedColumn column, final List<Object> params, final TimestampServiceRule timestampServiceRule) {
