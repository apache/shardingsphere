...
@Setter
public final class ShardingFetchDirectionTokenGenerator implements OptionalSQLTokenGenerator<CommonSQLStatementContext>, ConnectionContextAware {
    ...
    @Override
    public SQLToken generateSQLToken(final CommonSQLStatementContext sqlStatementContext) {
