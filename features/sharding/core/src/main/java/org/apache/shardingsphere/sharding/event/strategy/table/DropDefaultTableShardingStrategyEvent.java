 ...
 */
public final class DropDefaultTableShardingStrategyEvent extends DropUniqueRuleItemEvent {
    
    public DropDefaultTableShardingStrategyEvent(final String databaseName) {
        super(databaseName);
    }
}
