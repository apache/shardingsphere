...
public final class ConditionValueInOperatorGenerator implements ConditionValueGenerator<InExpression> {
    ...
    @Override
    public Optional<ShardingConditionValue> generate(final InExpression predicate, final QualifiedColumn column, final List<Object> params, final TimestampServiceRule timestampServiceRule) {
        if (predicate.isNot()) {
