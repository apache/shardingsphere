...
/**
 * SQL parser for broadcast DistSQL.
 */
public final class BroadcastDistSQLParser extends BroadcastDistSQLStatementParser implements SQLParser {
    
    public BroadcastDistSQLParser(final TokenStream input) {
        super(input);
    }
