...
class MaskAlgorithmChangedProcessorTest {
    ...
    void assertFindRuleConfigurationWhenAbsent() {
        assertThat(processor.findRuleConfiguration(mockDatabase()), ShardingSphereAssertionMatchers.deepEqual(new MaskRuleConfiguration(new LinkedList<>(), new LinkedHashMap<>())));
    }
