...
class ReadwriteSplittingRuleBuilderTest {
    ...
    void assertBuild() {
        ...
        assertThat(builder.build(ruleConfig, "", mock(StorageResource.class), Collections.emptyList(), mock(InstanceContext.class)), instanceOf(ReadwriteSplittingRule.class));
    }
}
