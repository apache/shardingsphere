...
class ReadwriteSplittingSPIImplementationsResultRowBuilderTest {
    
    @Test
    void assertGetRowData() {
        ReadwriteSplittingSPIImplementationsResultRowBuilder rowBuilder = new ReadwriteSplittingSPIImplementationsResultRowBuilder();
