...
/**
 * Shadow algorithm initialization exception.
 */
public final class ShadowAlgorithmInitializationException extends ShadowSQLException {
    ...
    public ShadowAlgorithmInitializationException(final String shadowType, final String reason) {
        super(XOpenSQLState.GENERAL_ERROR, 80, "Shadow algorithm `%s` initialization failed, reason is: %s.", shadowType, reason);
    }
}
