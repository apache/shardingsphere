...
class ShadowRuleBuilderTest {
    ...
    void assertBuild() {
        ...
        assertThat(builder.build(ruleConfig, "", new MySQLDatabaseType(), Collections.emptyMap(), Collections.emptyList(), mock(ComputeNodeInstanceContext.class)), instanceOf(ShadowRule.class));
    }
}
