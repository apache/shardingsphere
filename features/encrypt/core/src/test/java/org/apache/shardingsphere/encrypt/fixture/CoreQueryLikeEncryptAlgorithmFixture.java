...
public final class CoreQueryLikeEncryptAlgorithmFixture implements EncryptAlgorithm {
    ...
    private final EncryptAlgorithmMetaData metaData = new EncryptAlgorithmMetaData(false, false, true, byte[].class);
    
    @Override
    public byte[] encrypt(final Object plainValue, final AlgorithmSQLContext algorithmSQLContext) {
        return "likeEncryptValue".getBytes(StandardCharsets.UTF_8);
    }
