...
class EncryptCreateTableTokenGeneratorTest {
    ...
    void assertGenerateSQLTokens() {
        ...
        assertThat(assistedToken.toString(), is("assisted_certificate_number VARCHAR(1024)"));
        assertThat(assistedToken.getStartIndex(), is(25));
        ColumnDefinitionToken likeToken = (ColumnDefinitionToken) actualIterator.next();
        assertThat(likeToken.toString(), is("like_certificate_number VARCHAR(1024)"));
        assertThat(likeToken.getStartIndex(), is(25));
        assertThat(token.toString(), is("cipher_certificate_number VARCHAR(1024), assisted_certificate_number VARCHAR(1024), like_certificate_number VARCHAR(1024)"));
