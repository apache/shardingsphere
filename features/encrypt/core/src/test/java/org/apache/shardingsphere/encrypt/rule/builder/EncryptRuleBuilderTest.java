...
class EncryptRuleBuilderTest {
    ...
    void assertBuild() {
        ...
        assertThat(builder.build(ruleConfig, "", new MockedDatabaseType(), Collections.emptyMap(), Collections.emptyList(), mock(ComputeNodeInstanceContext.class)), instanceOf(EncryptRule.class));
    }
}
