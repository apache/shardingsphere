 ...
 */
@Getter
public abstract class EncryptInsertColumnToken extends SQLToken {
    ...
    protected EncryptInsertColumnToken(final int columnIndex, final ExpressionSegment expressionSegment) {
        super(columnIndex);
        stopIndex = columnIndex;
