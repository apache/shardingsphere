...
/**
 * Compatible encrypt table changed generator.
...
public final class CompatibleEncryptTableChangedGenerator implements RuleItemConfigurationChangedGenerator<CompatibleEncryptRuleConfiguration, EncryptTableRuleConfiguration> {
    ...
    public String getType() {
        return AlterCompatibleEncryptTableEvent.class.getName();
    }
    
    @Override
    public Collection<String> getTypeAliases() {
        return Collections.singleton(DropCompatibleEncryptTableEvent.class.getName());
    }
}
