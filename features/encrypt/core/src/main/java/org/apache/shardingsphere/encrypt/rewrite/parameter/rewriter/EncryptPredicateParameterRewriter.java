...
public final class EncryptPredicateParameterRewriter implements ParameterRewriter {
    ...
    private List<Object> getEncryptedLikeValues(final String databaseName, final String schemaName, final List<Object> originalValues, final EncryptColumn encryptColumn,
