 ...
 */
@Deprecated
public final class AlterCompatibleEncryptTableEvent extends AlterNamedRuleItemEvent {
    
    public AlterCompatibleEncryptTableEvent(final String databaseName, final String itemName, final String activeVersionKey, final String activeVersion) {
