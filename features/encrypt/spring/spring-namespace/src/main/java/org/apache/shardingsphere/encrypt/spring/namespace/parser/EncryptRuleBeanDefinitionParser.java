...
public final class EncryptRuleBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    private static AbstractBeanDefinition parseEncryptColumnRuleConfiguration(final Element element) {
        ...
        factory.addConstructorArgValue(element.getAttribute(EncryptRuleBeanDefinitionTag.LIKE_QUERY_COLUMN_ATTRIBUTE));
        ...
        factory.addConstructorArgValue(element.getAttribute(EncryptRuleBeanDefinitionTag.LIKE_QUERY_ENCRYPT_ALGORITHM_REF_ATTRIBUTE));
        factory.addConstructorArgValue(element.getAttribute(EncryptRuleBeanDefinitionTag.QUERY_WITH_CIPHER_COLUMN));
        return factory.getBeanDefinition();
    }
}
