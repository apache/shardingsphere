...
package org.apache.shardingsphere.encrypt.config.fixture;
...
public final class EncryptAlgorithmFixture implements EncryptAlgorithm {
    ...
    public EncryptAlgorithmMetaData getMetaData() {
        return new EncryptAlgorithmMetaData(true, true, true, Object.class);
    }
